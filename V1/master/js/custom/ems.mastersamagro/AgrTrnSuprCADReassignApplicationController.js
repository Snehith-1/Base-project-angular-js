(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCADReassignApplicationController', AgrTrnSuprCADReassignApplicationController);

    AgrTrnSuprCADReassignApplicationController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSuprCADReassignApplicationController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCADReassignApplicationController';
        ...
        $scope.reassign_application = function (application_gid, cadgroup_gid, menu_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprCAD/GetCADGroupDtl';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                var url = 'api/AgrTrnSuprCAD/GetReassignApplicationView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.reassign = function () {
                    ...
                    var url = 'api/AgrTrnSuprCAD/PostReassignCADApplication';
                    lockUI();
