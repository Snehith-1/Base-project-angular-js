(function () {
    ...
    angular
        .module('angle')
        .controller('AgrGSPGSTINAuthenticationViewController', AgrGSPGSTINAuthenticationViewController);

    AgrGSPGSTINAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrGSPGSTINAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrGSPGSTINAuthenticationViewController';
