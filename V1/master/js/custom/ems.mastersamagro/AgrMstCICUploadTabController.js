(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCICUploadTabController', AgrMstCICUploadTabController);

        AgrMstCICUploadTabController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrMstCICUploadTabController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCICUploadTabController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstApplicationAdd/GetCICIndividualSummary';
            SocketService.get(url).then(function (resp) {
                unlockUI();
