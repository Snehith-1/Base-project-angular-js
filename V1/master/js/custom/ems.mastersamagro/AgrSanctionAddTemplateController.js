(function () {
    ...
    angular
        .module('angle')
        .controller('AgrSanctionAddTemplateController', AgrSanctionAddTemplateController);

    AgrSanctionAddTemplateController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route','$modal'];

    function AgrSanctionAddTemplateController($rootScope, $scope, $state, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $modal) {
    
        $scope.title = 'AgrSanctionAddTemplateController';
        ...
        $scope.submitTemplate = function () {
            ...
            var url = 'api/AgrTemplate/PostTemplateDtl';
