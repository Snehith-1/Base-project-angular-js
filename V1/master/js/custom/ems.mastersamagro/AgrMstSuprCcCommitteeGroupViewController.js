(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCcCommitteeGroupViewController', AgrMstSuprCcCommitteeGroupViewController);

    AgrMstSuprCcCommitteeGroupViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function AgrMstSuprCcCommitteeGroupViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCcCommitteeGroupViewController';
