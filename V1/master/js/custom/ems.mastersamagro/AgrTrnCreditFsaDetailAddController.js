(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditFsaDetailAddController', AgrTrnCreditFsaDetailAddController);

    AgrTrnCreditFsaDetailAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', '$resource', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnCreditFsaDetailAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, $resource, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditFsaDetailAddController';
        ...
        const lspagename = 'AgrTrnCreditFsaDetailAdd';
        ...
        $scope.uploadExcel_balancesheet1 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/ImportExcelBalanceSheetTemplate1';
                lockUI();
        ...
        $scope.uploadExcel_balancesheet2 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/ImportExcelBalanceSheetTemplate2';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadexcel_pltemp1 = function () {
            if ($scope.fileinputpathPL == '' || $scope.fileinputpathPL == undefined || $scope.fileinputpathPL == null) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/ImportProfitLoss';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        if ($scope.fileinputvaluePL2 == '' || $scope.fileinputvaluePL2 == undefined || $scope.fileinputvaluePL2 == null) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/ImportProfitLossTemp2';
            lockUI();
            SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadExcel_summarytemp1 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/ImportExcelSummaryTemplate1';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadExcel_summarytemp2 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/ImportExcelSummaryTemplate2';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.view = function (application_gid, credit_gid, template_name) {
            $location.url('app/AgrTrnCreditFSAView?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&template_name=' + template_name + '&lspage=' + lspage + '&lspagename=' + lspagename);
        }
