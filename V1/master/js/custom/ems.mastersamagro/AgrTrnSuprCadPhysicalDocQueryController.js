(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCadPhysicalDocQueryController', AgrTrnSuprCadPhysicalDocQueryController);

    AgrTrnSuprCadPhysicalDocQueryController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

        function AgrTrnSuprCadPhysicalDocQueryController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCadPhysicalDocQueryController';
        ...
        function activate() {
            lockUI();
            var url = 'api/AgrTrnSuprPhysicalDocument/tmpphysicalclearQueryuploaded';
            ...
            var url = 'api/AgrTrnSuprPhysicalDocument/GetPhysicalAppcadQuerySummary';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnSuprPhysicalDocument/GetMakerCheckerConversation';
        ...
        $scope.query_add = function () {
            ...
            var url = 'api/AgrTrnSuprPhysicalDocument/PostAppcadPhysicalqueryadd';
            lockUI();
        ...
        $scope.QueryDocumentUpload = function (val, val1, name) {
            ...
            if ($scope.uploadfrm != undefined) {
                var url = 'api/AgrTrnSuprPhysicalDocument/PhysicalQueryDocumentUpload';
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    var url = 'api/AgrTrnSuprPhysicalDocument/GetTmpPhysicalQueryDocument';
                    SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.responseclick = function () {
            ...
            var url = 'api/AgrTrnSuprPhysicalDocument/postPhysicalMakerCheckerConversation';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
