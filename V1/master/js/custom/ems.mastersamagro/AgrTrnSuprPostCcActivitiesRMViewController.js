(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprPostCcActivitiesRMViewController', AgrTrnSuprPostCcActivitiesRMViewController);

        AgrTrnSuprPostCcActivitiesRMViewController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function AgrTrnSuprPostCcActivitiesRMViewController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprPostCcActivitiesRMViewController';
