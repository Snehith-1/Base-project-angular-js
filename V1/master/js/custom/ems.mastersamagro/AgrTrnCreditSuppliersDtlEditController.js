(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditSuppliersDtlEditController', AgrTrnCreditSuppliersDtlEditController);

        AgrTrnCreditSuppliersDtlEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrTrnCreditSuppliersDtlEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditSuppliersDtlEditController';
        ...
        function activate() { 
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetSupplierList';
            SocketService.get(url).then(function (resp) {
                unlockUI();
                $scope.supplier_list = resp.data.supplier_list;
              });
            var url = 'api/AgrTrnAppCreditUnderWriting/EditGetCreditSupplier';
        ...
        $scope.update_supplierdtl = function () {
            ...
            ($scope.txtBankDebitamt == undefined) || ($scope.txtrelationship_supplier == undefined) )
           {
             ...
             var url = 'api/AgrTrnAppCreditUnderWriting/UpdateCreditSupplier';
            lockUI();
