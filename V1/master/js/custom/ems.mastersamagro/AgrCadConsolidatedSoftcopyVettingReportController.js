(function () {
    ...
    angular
        .module('angle')
        .controller('AgrCadConsolidatedSoftcopyVettingReportController', AgrCadConsolidatedSoftcopyVettingReportController);

    AgrCadConsolidatedSoftcopyVettingReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrCadConsolidatedSoftcopyVettingReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrCadConsolidatedSoftcopyVettingReportController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstApplicationReport/GetConsolidatedSoftcopyVettingReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
