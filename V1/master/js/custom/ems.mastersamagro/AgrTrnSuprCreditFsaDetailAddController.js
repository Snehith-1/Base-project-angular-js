(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditFsaDetailAddController', AgrTrnSuprCreditFsaDetailAddController);

    AgrTrnSuprCreditFsaDetailAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', '$resource', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnSuprCreditFsaDetailAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, $resource, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditFsaDetailAddController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetFSASummary';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.uploadExcel_balancesheet1 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/ImportExcelBalanceSheetTemplate1';
                lockUI();
        ...
        $scope.uploadExcel_balancesheet2 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/ImportExcelBalanceSheetTemplate2';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadexcel_pltemp1 = function () {
            if ($scope.fileinputpathPL == '' || $scope.fileinputpathPL == undefined || $scope.fileinputpathPL == null) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/ImportProfitLoss';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadexcel_pltemp2 = function () {
            if ($scope.fileinputvaluePL2 == '' || $scope.fileinputvaluePL2 == undefined || $scope.fileinputvaluePL2 == null) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/ImportProfitLossTemp2';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadExcel_summarytemp1 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/ImportExcelSummaryTemplate1';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.uploadExcel_summarytemp2 = function () {
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/ImportExcelSummaryTemplate2';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.view = function (application_gid, credit_gid, template_name) {
            $location.url('app/AgrTrnSuprCreditFSAView?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&template_name=' + template_name + '&lspage=' + lspage);
        }
        ...
        $scope.downloadall = function () {
            for (var i = 0; i < $scope.FSASummary_list.length; i++) {
                DownloaddocumentService.Downloaddocument($scope.FSASummary_list[i].document_path, $scope.FSASummary_list[i].document_name);
            }
        }
    }
})();
