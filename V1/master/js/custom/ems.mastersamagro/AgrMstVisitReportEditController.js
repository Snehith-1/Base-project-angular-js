(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstVisitReportEditController', AgrMstVisitReportEditController);

    AgrMstVisitReportEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];


    function AgrMstVisitReportEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstVisitReportEditController';
        ...
        $scope.Back = function () {
            ...
            $location.url('app/AgrMstVisitReportAdd?application_gid=' + application_gid);
        }
