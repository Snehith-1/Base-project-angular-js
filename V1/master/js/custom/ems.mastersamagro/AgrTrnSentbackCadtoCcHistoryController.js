(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSentbackCadtoCcHistoryController', AgrTrnSentbackCadtoCcHistoryController);

    AgrTrnSentbackCadtoCcHistoryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSentbackCadtoCcHistoryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSentbackCadtoCcHistoryController';
        ...
        function activate() {
            ...
            lockUI();
            var url = 'api/AgrTrnCC/GetScheduleMeetingBasicLog';
            ...
            var url = 'api/AgrTrnCAD/GetCADtoCCMeetingLog';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/AgrTrnCAD/GetAppRevertReasonRemarks';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.Back = function () {
            if (lspage == 'Pending') {
                ...
                $state.go('app.AgrTrnPendingCADReview');
            }
            else {
