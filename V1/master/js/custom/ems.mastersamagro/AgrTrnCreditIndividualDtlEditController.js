(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualDtlEditController', AgrTrnCreditIndividualDtlEditController);

    AgrTrnCreditIndividualDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

        function AgrTrnCreditIndividualDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualDtlEditController';
        ...
        function activate() {
            ...
            vm.dateOptions = {
             ...
             var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualTempClear';
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualMobileNoList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactmobileno_list = resp.data.contactmobileno_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualEmailAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactemail_list = resp.data.contactemail_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactaddress_list = resp.data.contactaddress_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualProofList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactidproof_list = resp.data.contactidproof_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualDocList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/EditIndividual';
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetPANForm60List';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/EditPANAbsenceReasonList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/ContactPANAbsenceReasonList';
            SocketService.getparams(url, param).then(function (resp) {
        ...
        $scope.pandtl_update = function () {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/UpdatePANAbsenceReasons';
            lockUI();
    ...
    /*    $scope.PANAadhaarLink = function () {
        ...
        $scope.IndividualPANForm60DocumentUpload = function (val, val1, name) {
            ...
            if ($scope.uploadfrm != undefined) {
                var url = 'api/AgrTrnAppCreditUnderWriting/PANForm60DocumentUpload';
        ...
        function panform60_templist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetPANForm60TempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactpanform60_list = resp.data.contactpanform60_list;
            });
        }
        ...
        $scope.IndividualPANForm60DocumentDelete = function (contact2panform60_gid) {
            ...
            lockUI();
            var url = 'api/AgrTrnAppCreditUnderWriting/PANForm60Delete';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.individualmobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_status == undefined) || ($scope.rdbwhatsapp_no == undefined) || ($scope.rdbwhatsapp_no == '') || ($scope.rdbprimary_status == '')) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/PostIndividualMobileNumber';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function mobileno_templist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualMobileNoTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactmobileno_list = resp.data.contactmobileno_list;
            });
        }
        ...
        $scope.individualmobileno_edit = function (contact2mobileno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditIndividualMobileNo';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateIndividualMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.individualmobileno_delete = function (contact2mobileno_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteIndividualMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.individualemail_add = function () {
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbemailprimary_status == undefined) || ($scope.rdbemailprimary_status == '')) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/PostIndividualEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function email_templist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualEmailAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactemail_list = resp.data.contactemail_list;
            });
        }
        ...
        $scope.individualemail_edit = function (contact2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditIndividualEmailAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateIndividualEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.individualemail_delete = function (contact2email_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteIndividualEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.address_add = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/PostIndividualAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        function address_templist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactaddress_list = resp.data.contactaddress_list;
            });
        }
        ...
        $scope.address_edit = function (contact2address_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditIndividualAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.address_update = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateIndividualAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.address_delete = function (contact2address_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteIndividualAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
       ...
       $scope.idproofdocument_upload = function (val, val1, name) {
        ...
        function idproof_templist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualProofTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactidproof_list = resp.data.contactidproof_list;
            });
        }
        ...
        $scope.idproof_delete = function (contact2idproof_gid) {
            ...
            lockUI();
            var url = 'api/AgrTrnAppCreditUnderWriting/IndividualProofDelete';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
        ...
        $scope.individualdocument_add = function () {
            ...
            if ($scope.uploadfrm != undefined) {
                lockUI();
                var url = 'api/AgrTrnAppCreditUnderWriting/IndividualDocumentUpload';
        ...
        function individualdoc_templist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIndividualDocTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.uploadindividualdoc_list = resp.data.uploadindividualdoc_list;
            });
        }
        ...
        $scope.individualdocument_delete = function (contact2document_gid) {
            ...
            lockUI();
            var url = 'api/AgrTrnAppCreditUnderWriting/IndividualDocDelete';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.upload_list = resp.data.upload_list;
                if (resp.data.status == true) {
        ...
        $scope.update_individual = function () {
            ...
            //else
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/UpdateIndividual';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
