(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditSuppliersDtlAddController', AgrTrnCreditSuppliersDtlAddController);

        AgrTrnCreditSuppliersDtlAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function AgrTrnCreditSuppliersDtlAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditSuppliersDtlAddController';
        ...
        $scope.add_creditsupplierdtl = function () {
            ...
            )
           {
             ...
             var url = 'api/AgrTrnAppCreditUnderWriting/PostCreditSupplier';
              lockUI();
        ...
        var url = 'api/AgrTrnAppCreditUnderWriting/DeleteCreditSupplier';
        SocketService.getparams(url, params).then(function (resp) {
            unlockUI();
            if (resp.data.status == true) {
                $scope.institutionsupplier_list=resp.data.supplier_list;
        ...
        $scope.creditsupplier_edit = function (creditsupplier_gid) {
            $location.url('app/AgrTrnCreditSuppliersDtlEdit?application_gid=' + application_gid + '&creditsupplier_gid=' + creditsupplier_gid + '&institution_gid=' + institution_gid + '&lspage=' + lspage);
        }
