(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditCommitteeSummaryController', AgrTrnCreditCommitteeSummaryController);

    AgrTrnCreditCommitteeSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnCreditCommitteeSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditCommitteeSummaryController';
        lockUI();
        activate();
        function activate() {
            var url = 'api/AgrTrnCC/GetCCPendingSummary';
        ...
        $scope.advance_appl = function () {
            $location.url('app/AgrTrnACAutoApprovalSummary?lsparent=CreditCommittee');
        }
