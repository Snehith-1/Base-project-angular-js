(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCreditAssessedScoreAddController', AgrMstCreditAssessedScoreAddController);

    AgrMstCreditAssessedScoreAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrMstCreditAssessedScoreAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCreditAssessedScoreAddController';
        ...
        $scope.gradingtooldetails_edit = function (val) {
            $location.url('app/AgrMstCreditAssessedScoreEdit?application2gradingtool_gid=' + val + '&application_gid=' + application_gid + '&lstab=' + lstab);
        }
        ...
        $scope.gradingtooldetails_view = function (application2gradingtool_gid) {
            ...
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstCreditAssessedScoreView";
        ...
        $scope.RMassessedscore_view = function (application2gradingtool_gid) {
            ...
            localStorage.setItem('application2gradingtool_gid', application2gradingtool_gid);
            localStorage.setItem('application_gid', application_gid);
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstRMAssessedScoreView";
            window.open(URL, '_blank');
        }
