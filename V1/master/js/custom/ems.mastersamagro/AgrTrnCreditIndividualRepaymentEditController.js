(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualRepaymentEditController', AgrTrnCreditIndividualRepaymentEditController);

    AgrTrnCreditIndividualRepaymentEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrTrnCreditIndividualRepaymentEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualRepaymentEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/EditRepaymentTrack';
            ...
            ($scope.txtBalanceTenure_month == undefined) || ($scope.txtBalanceTenure_days == undefined) || ($scope.cboAcctClassification == undefined) || ($scope.txtOverdue_Amount == undefined) || ($scope.txtnoofdays_overdue == undefined) || ($scope.txtremarks == undefined)) {
                ...
                if((lendertypename =='Bank'))
                {
                         ...
                         ($scope.txtifsc_code == '' ) || ($scope.txtBank_Name == '' ))
                    {
                        ...
                        var url = 'api/AgrTrnAppCreditUnderWriting/UpdateRepaymentTrack';
                        lockUI();
