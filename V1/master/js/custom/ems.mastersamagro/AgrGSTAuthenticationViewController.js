(function () {
    ...
    angular
        .module('angle')
        .controller('AgrGSTAuthenticationViewController', AgrGSTAuthenticationViewController);

    AgrGSTAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrGSTAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrGSTAuthenticationViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstAPIVerifications/GSTAuthenticationViewDetails';
