(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditIndividualDtlEditController', AgrTrnSuprCreditIndividualDtlEditController);

    AgrTrnSuprCreditIndividualDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnSuprCreditIndividualDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditIndividualDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualTempClear';
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualMobileNoList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactmobileno_list = resp.data.contactmobileno_list;
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualEmailAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactemail_list = resp.data.contactemail_list;
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactaddress_list = resp.data.contactaddress_list;
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualProofList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactidproof_list = resp.data.contactidproof_list;
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualDocList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditIndividual';
            ...
            SocketService.getparams(url, param).then(function (resp) {
                ...
                {
                    $scope.txtannual_income_edit = (parseInt($scope.txtmonthly_income.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountseperator = (parseInt($scope.txtannual_income_edit.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountwords = defaultamountwordschange($scope.lblamountseperator);
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetPANForm60List';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditPANAbsenceReasonList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/ContactPANAbsenceReasonList';
            SocketService.getparams(url, param).then(function (resp) {
        ...
        $scope.pandtl_update = function () {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdatePANAbsenceReasons';
            lockUI();
        ...
        $scope.IDProofValidation = function () {
            ...
            if ($scope.cboIndividualProof.individualproof_name == "Voter ID" && $scope.txtidproof_no.length == 10) {
                var params = {
        ...
        $scope.PassportAndDLValidation = function () {
            ...
            if ($scope.cboIndividualProof.individualproof_name == "Driving License" && $scope.txtidproof_no.length == 16 && $scope.txtidproof_dob.length == 10) {
                var params = {
            ...
            else if ($scope.cboIndividualProof.individualproof_name == "Passport" && $scope.txtfile_no.length == 15 && $scope.txtidproof_dob.length == 10) {
                var params = {
        ...
        $scope.onchangeIDType = function () {
            if (($scope.cboIndividualProof.individualproof_name == "Driving License")) {
                $scope.idprooffilenoshow = false;
                $scope.idproofdobshow = true;
            }
            else if (($scope.cboIndividualProof.individualproof_name == "Passport")) {
                $scope.idproofdobshow = true;
        ...
        $scope.IndividualPANForm60DocumentUpload = function (val, val1, name) {
            ...
            if ($scope.uploadfrm != undefined) {
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PANForm60DocumentUpload';
        ...
        function panform60_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetPANForm60TempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactpanform60_list = resp.data.contactpanform60_list;
            });
        }
        ...
        $scope.IndividualPANForm60DocumentDelete = function (contact2panform60_gid) {
            ...
            lockUI();
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/PANForm60Delete';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.individualmobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_status == undefined) || ($scope.rdbwhatsapp_no == undefined) || ($scope.rdbwhatsapp_no == '') || ($scope.rdbprimary_status == '')) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PostIndividualMobileNumber';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function mobileno_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualMobileNoTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactmobileno_list = resp.data.contactmobileno_list;
            });
        }
        ...
        $scope.individualmobileno_edit = function (contact2mobileno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditIndividualMobileNo';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateIndividualMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.individualmobileno_delete = function (contact2mobileno_gid) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/DeleteIndividualMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.individualemail_add = function () {
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbemailprimary_status == undefined) || ($scope.rdbemailprimary_status == '')) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PostIndividualEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function email_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualEmailAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactemail_list = resp.data.contactemail_list;
            });
        }
        ...
        $scope.individualemail_edit = function (contact2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditIndividualEmailAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateIndividualEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.individualemail_delete = function (contact2email_gid) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/DeleteIndividualEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.address_add = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/PostIndividualAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        function address_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactaddress_list = resp.data.contactaddress_list;
            });
        }
        ...
        $scope.address_edit = function (contact2address_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditIndividualAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.address_update = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateIndividualAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.address_delete = function (contact2address_gid) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/DeleteIndividualAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.idproofdocument_upload = function (val, val1, name) {
            ...
            if (($scope.cboIndividualProof == null) || ($scope.cboIndividualProof == '') || ($scope.cboIndividualProof == undefined) || ($scope.txtidproof_no == null) || ($scope.txtidproof_no == '') || ($scope.txtidproof_no == undefined)) {
                ...
                $scope.uploadfrm = frm;
                if ($scope.uploadfrm != undefined) {
                    var url = 'api/AgrMstSuprApplicationAdd/IndividualProofDocumentUpload';
                    SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                        $("#file").val('');
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        function idproof_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualProofTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactidproof_list = resp.data.contactidproof_list;
            });
        }
        ...
        $scope.idproof_delete = function (contact2idproof_gid) {
            ...
            lockUI();
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/IndividualProofDelete';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
        ...
        $scope.individualdocument_add = function () {
            ...
            if ($scope.uploadfrm != undefined) {
                lockUI();
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/IndividualDocumentUpload';
        ...
        function individualdoc_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetIndividualDocTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.uploadindividualdoc_list = resp.data.uploadindividualdoc_list;
            });
        }
        ...
        $scope.individualdocument_delete = function (contact2document_gid) {
            ...
            lockUI();
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/IndividualDocDelete';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.upload_list = resp.data.upload_list;
                if (resp.data.status == true) {
        ...
        $scope.update_individual = function () {
            ...
            //else
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateIndividual';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
