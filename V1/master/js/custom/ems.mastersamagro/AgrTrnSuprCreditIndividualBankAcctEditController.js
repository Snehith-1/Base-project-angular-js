(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditIndividualBankAcctEditController', AgrTrnSuprCreditIndividualBankAcctEditController);

    AgrTrnSuprCreditIndividualBankAcctEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnSuprCreditIndividualBankAcctEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditIndividualBankAcctEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditGetCreditBankAccDtl';
               ...
               ($scope.rdbCheque_Book == undefined) || ($scope.rdbCheque_Book == '')) {
                ...
                if ($scope.rdbJoint_Account == 'Yes') {
                    ...
                    if (($scope.txtjointacctholder_name == undefined) || ($scope.txtjointacctholder_name == '')) {
                        ...
                        var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateCreditBankAccDtl';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
