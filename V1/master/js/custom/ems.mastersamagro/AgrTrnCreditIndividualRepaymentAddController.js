(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualRepaymentAddController', AgrTrnCreditIndividualRepaymentAddController);

        AgrTrnCreditIndividualRepaymentAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function AgrTrnCreditIndividualRepaymentAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualRepaymentAddController';
        ...
        $scope.creditrepayment_edit = function (creditrepaymentdtl_gid) {
            $location.url('app/AgrTrnCreditIndividualRepaymentEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&creditrepaymentdtl_gid=' + creditrepaymentdtl_gid + '&lspage=' + lspage);
        }
