(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditGroupDtlViewController', AgrTrnCreditGroupDtlViewController);

        AgrTrnCreditGroupDtlViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function AgrTrnCreditGroupDtlViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditGroupDtlViewController';
