(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstRMAssessedScoreViewController', AgrMstRMAssessedScoreViewController);

    AgrMstRMAssessedScoreViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];


    function AgrMstRMAssessedScoreViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstRMAssessedScoreViewController';
