(function () {
    ...
    angular
        .module('angle')
        .controller('AgrCadConsolidatedDocumentChecklistReportController', AgrCadConsolidatedDocumentChecklistReportController);

    AgrCadConsolidatedDocumentChecklistReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrCadConsolidatedDocumentChecklistReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrCadConsolidatedDocumentChecklistReportController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstApplicationReport/GetConsolidatedDocumentChecklistReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
