(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprVisitReportEditController', AgrMstSuprVisitReportEditController);

    AgrMstSuprVisitReportEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];


    function AgrMstSuprVisitReportEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprVisitReportEditController';
        ...
        $scope.Back = function () {
            ...
            $location.url('app/AgrMstSuprVisitReportAdd?application_gid=' + application_gid);
        }
