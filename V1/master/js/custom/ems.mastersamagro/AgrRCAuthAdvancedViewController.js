(function () {
    ...
    angular
        .module('angle')
        .controller('AgrRCAuthAdvancedViewController', AgrRCAuthAdvancedViewController);

    AgrRCAuthAdvancedViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrRCAuthAdvancedViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrRCAuthAdvancedViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstAPIVerifications/RCAuthAdvancedViewDetails';
