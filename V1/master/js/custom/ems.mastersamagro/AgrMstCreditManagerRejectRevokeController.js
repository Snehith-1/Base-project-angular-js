(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCreditManagerRejectRevokeController', AgrMstCreditManagerRejectRevokeController);

        AgrMstCreditManagerRejectRevokeController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService'];

    function AgrMstCreditManagerRejectRevokeController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCreditManagerRejectRevokeController';
        ...
        $scope.revoke_submit = function () {
            ...
            var url = 'api/AgrAdminApplication/PostCreditManagerRevokeApplication';
            lockUI();
