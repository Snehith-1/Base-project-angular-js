(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprRMDeferralCloseQueryController', AgrTrnSuprRMDeferralCloseQueryController);

    AgrTrnSuprRMDeferralCloseQueryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService'];

    function AgrTrnSuprRMDeferralCloseQueryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprRMDeferralCloseQueryController';
        ...
        $scope.query_close = function (tagquery_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.submit = function () {
                    ...
                    var url = 'api/AgrMstSuprScannedDocument/PostAppcadresponsequery';
                    lockUI();
