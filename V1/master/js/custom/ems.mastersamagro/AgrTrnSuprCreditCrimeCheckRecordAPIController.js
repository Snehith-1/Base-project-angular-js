(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditCrimeCheckRecordAPIController', AgrTrnSuprCreditCrimeCheckRecordAPIController);

    AgrTrnSuprCreditCrimeCheckRecordAPIController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnSuprCreditCrimeCheckRecordAPIController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditCrimeCheckRecordAPIController';
        ...
        function activate() {
            ...
            var url = 'api/AgrSuprCrimeCheckAPI/GetCrimeRecordIndividualDetail';
            ...
            var url = 'api/AgrSuprCrimeCheckAPI/GetTaggedCaseIndividualSummary';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.CrimeCheck_Tag = function (data) {
            ...
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    ...
                    lockUI();
                    var url = 'api/AgrSuprCrimeCheckAPI/TagCaseIndividual';
        ...
        $scope.TaggedCase_Delete = function (crimecasetaggedcontact_gid) {
            ...
            var url = 'api/AgrSuprCrimeCheckAPI/DeleteTaggedCaseIndividual';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.search_crimecheck = function () {
            ...
            if ($scope.cboaddress == undefined || $scope.rdbSearchmode == undefined || searchIn == '') {
                ...
                var url = 'api/AgrSuprCrimeCheckAPI/GetCrimeRecordsIndividual';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    setTimeout(function () {
