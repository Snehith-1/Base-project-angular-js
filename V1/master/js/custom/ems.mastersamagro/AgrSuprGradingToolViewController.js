(function () {
    ...
    angular
        .module('angle')
        .controller('AgrSuprGradingToolViewController', AgrSuprGradingToolViewController);

    AgrSuprGradingToolViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];


    function AgrSuprGradingToolViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrSuprGradingToolViewController';
        ...
        $scope.ViewAssessmentCriteria = function (val) {
            $location.url('app/AgrSuprAssessmentCriteriaDetailsView?application2gradingassesment_gid=' + val + '&application2gradingtool_gid=' + application2gradingtool_gid + '&application_gid=' + application_gid);
