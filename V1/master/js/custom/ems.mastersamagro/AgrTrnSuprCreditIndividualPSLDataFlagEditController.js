(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditIndividualPSLDataFlagEditController', AgrTrnSuprCreditIndividualPSLDataFlagEditController);

    AgrTrnSuprCreditIndividualPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSuprCreditIndividualPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditIndividualPSLDataFlagEditController';
        ...
        $scope.update_psldata = function () {
            ...
            ($scope.cboTurnover == undefined) || ($scope.cboMSMEClassification == undefined) || ($scope.txtDateofEntity == undefined) || ($scope.rdbmetropolitan == undefined) || ($scope.cboClientDetails == undefined)
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PSLDataFlaggingUpdate';
                lockUI();
