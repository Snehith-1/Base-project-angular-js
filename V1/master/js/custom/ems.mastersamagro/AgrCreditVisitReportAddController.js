(function () {
    ...
    angular
        .module('angle')
        .controller('AgrCreditVisitReportAddController', AgrCreditVisitReportAddController);

    AgrCreditVisitReportAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrCreditVisitReportAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrCreditVisitReportAddController';
       ...
       lockUI();
        ...
        $scope.edit_creditvisitreport = function (val) {         
            $location.url('app/AgrMstCreditVisitReportEdit?visitreport_gid=' + val + '&application_gid=' + application_gid + '&lstab=' + lstab);
        }
        ...
        $scope.view_creditvisitreport = function (visitreport_gid) {
            ...
            localStorage.setItem('visitreport_gid', visitreport_gid);
            localStorage.setItem('application_gid', application_gid);
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstCreditVisitReportView";
            window.open(URL, '_blank');
        }
