(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCcCommitteeIndividualViewController', AgrMstCcCommitteeIndividualViewController);

    AgrMstCcCommitteeIndividualViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstCcCommitteeIndividualViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCcCommitteeIndividualViewController';
        ...
        const lspagename = 'AgrMstCcCommitteeIndividualView';
