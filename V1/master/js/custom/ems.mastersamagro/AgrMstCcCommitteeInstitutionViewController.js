(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCcCommitteeInstitutionViewController', AgrMstCcCommitteeInstitutionViewController);

    AgrMstCcCommitteeInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstCcCommitteeInstitutionViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCcCommitteeInstitutionViewController';
        ...
        const lspagename = 'AgrMstCcCommitteeInstitutionView';
        // const lspagetype = 'CC';
