(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditEconomicCapitalEditController', AgrTrnSuprCreditEconomicCapitalEditController);

    AgrTrnSuprCreditEconomicCapitalEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSuprCreditEconomicCapitalEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditEconomicCapitalEditController';
        ...
        $scope.update_SocialTradeCapital = function () {
            if (($scope.SocialCapital == undefined) || ($scope.TradeCapital == undefined) || ($scope.SocialCapital == null) || ($scope.TradeCapital == null) || ($scope.SocialCapital == '') || ($scope.TradeCapital == '')) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/SocialAndTradeCapitalUpdate';
                lockUI();
