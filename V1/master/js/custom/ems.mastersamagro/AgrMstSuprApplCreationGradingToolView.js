(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprApplCreationGradingToolViewController', AgrMstSuprApplCreationGradingToolViewController);

    AgrMstSuprApplCreationGradingToolViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function AgrMstSuprApplCreationGradingToolViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprApplCreationGradingToolViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprApplicationView/GetGradingView';
