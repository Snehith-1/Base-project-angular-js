(function () {
    ...
    angular
        .module('angle')
        .controller('AgrRptScannedDeferralStatusController', AgrRptScannedDeferralStatusController);

    AgrRptScannedDeferralStatusController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function AgrRptScannedDeferralStatusController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrRptScannedDeferralStatusController';
