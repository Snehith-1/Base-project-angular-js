(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualAPIController', AgrTrnCreditIndividualAPIController);

    AgrTrnCreditIndividualAPIController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnCreditIndividualAPIController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualAPIController';
        ...
        $scope.crimereport_view = function (crimereportcontact_gid) {
            ...
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrTrnCrimeReportIndividualView";
            window.open(URL, '_blank');
        }
