(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualExistingBankAddController', AgrTrnCreditIndividualExistingBankAddController);

        AgrTrnCreditIndividualExistingBankAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function AgrTrnCreditIndividualExistingBankAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualExistingBankAddController';
    ...
    $scope.Overduedpd = function () {
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/AgrTrnCreditIndividualExistingBankEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
        //KYC API
