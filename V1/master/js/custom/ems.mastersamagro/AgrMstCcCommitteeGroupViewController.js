(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCcCommitteeGroupViewController', AgrMstCcCommitteeGroupViewController);

    AgrMstCcCommitteeGroupViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function AgrMstCcCommitteeGroupViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCcCommitteeGroupViewController';
