(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditCompanyAPIController', AgrTrnCreditCompanyAPIController);

    AgrTrnCreditCompanyAPIController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnCreditCompanyAPIController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditCompanyAPIController';
        ...
        function activate() {
            ...
            $scope.lsapi_name = $location.search().lsapi_name;
            var url = 'api/AgrMstAPIVerifications/GetStateList';
            SocketService.get(url).then(function (resp) {
                unlockUI();
                $scope.mstgst_list = resp.data.mstgst_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetGSTList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutiongst_list = resp.data.mstgst_list;
            });
            var url = 'api/AgrProbeAPI/GetInstitutionDetails';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/AgrProbeAPI/InstitutionProbeList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutionprobe_list = resp.data.institutionprobe_list;
            });
            var url = 'api/AgrProbeAPI/InstitutionProbeDocList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutionprobedoc_list = resp.data.institutionprobedoc_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetTAN';
            var params = {
            ...
            var url = 'api/AgrMstAPIVerifications/GetMCASignature';
            var params = {
                function_gid: institution_gid,
            }           
            SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/AgrMstAPIVerifications/GetCompanyLLP';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.cin_list = resp.data.cin_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetIECDetailed';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.IECDetailed_list = resp.data.IECDetailed_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetFDA';
            ...
            var url = 'api/AgrMstAPIVerifications/GetFSSAI';
            ...
            var url = 'api/AgrMstAPIVerifications/GetLPGIDList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.LPGID_list = resp.data.LPGID_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetShopList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.shop_list = resp.data.shop_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetRCAuthAdvancedList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.RCAuthAdvanced_list = resp.data.RCAuthAdvanced_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetRCSearchList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.RCSearch_list = resp.data.RCSearch_list;
            });
            var url = 'api/AgrMstAPIVerifications/GetPropertyTaxList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/AgrCrimeCheckAPI/GetCrimeRecordCompanyDetail';
            ...
            var url = 'api/AgrCrimeCheckAPI/GetCompanyReportList';
            SocketService.getparams(url, paramcrime).then(function (resp) {
        ...
        $scope.verify_gstreturnfilling = function (gst_no, institution2branch_gid) {
            ...
            lockUI();
            var url = 'api/AgrKyc/GSPGSTReturnFiling';
            SocketService.post(url, params).then(function (resp) {
        ...
        $scope.verify_gstauthentication = function (gst_no, institution2branch_gid) {
            ...
            var url = 'api/AgrKyc/GSTAuthentication';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                list();
       ...
       $scope.returnfillingView = function (institution2branch_gid) {
        ...
        $scope.verify_tan = function (txttan_no)
        {
            if (txttan_no == '' || txttan_no == undefined || txttan_no == null) {
                ...
                var url = 'api/AgrKyc/TANauthetication';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        {  
            if ($scope.status == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostTAN';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verify_llp = function (txtllp_no) {
            if (txtllp_no == '' || txtllp_no == undefined || txtllp_no == null) {
                ...
                var url = 'api/AgrKyc/CompanyLLP_no';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addllp_no = function () {
            if ($scope.llpstatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostCompanyLLP';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifymca_sign = function (txtmca_sign) {
            ...
            var url = 'api/AgrKyc/mcasignatories';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.addmca_sign = function () {
            ...
            var url = 'api/AgrMstAPIVerifications/PostMCASignature';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.verifyiec_detailed = function (txtiec_detailed) {
            if (txtiec_detailed == '' || txtiec_detailed == undefined || txtiec_detailed == null) {
                ...
                var url = 'api/AgrKyc/IECDetailed';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addiec_detailed = function () {
            ...
            var url = 'api/AgrMstAPIVerifications/PostIECDetailed';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
        ...
        $scope.addfssai = function () {
            if ($scope.fssaistatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostFSSAI';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.addfda = function () {
            if ($scope.fdastatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostFDA';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.verifylpgid = function (txtlpgid) {
            if (txtlpgid == '' || txtlpgid == undefined || txtlpgid == null) {
                ...
                var url = 'api/AgrKyc/LPGIDAuthentication';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addlpgid = function () {
            if ($scope.lpgidstatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostLPGID';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.verifyshop = function () {
            if ($scope.txtregNo == '' || $scope.txtregNo == undefined || $scope.txtregNo == null) {
                ...
                var url = 'api/AgrKyc/ShopAndEstablishment';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addshop = function () {
            if ($scope.shopstatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostShop';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.verifyrcauthadv = function (txtregistrationNumber) {
            if (txtregistrationNumber == '' || txtregistrationNumber == undefined || txtregistrationNumber == null) {
                ...
                var url = 'api/AgrKyc/VehicleRCAuthAdvanced';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addrcauthadv = function () {
            if ($scope.rcauthadvstatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostRCAuthAdvanced';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.verifyrcsearch = function () {
            if ($scope.txtengine_no == '' || $scope.txtengine_no == undefined || $scope.txtengine_no == null) {
                ...
                var url = 'api/AgrKyc/VehicleRCSearch';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addrcsearch = function () {
            if ($scope.rcsearchstatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostRCSearch';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.verifypropertytax = function () {
            if ($scope.txtpropertyNo == '' || $scope.txtpropertyNo == undefined || $scope.txtpropertyNo == null) {
                ...
                var url = 'api/AgrKyc/PropertyTax';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addpropertytax = function () {
            if ($scope.propertytaxstatus == 'checked') {
                ...
                var url = 'api/AgrMstAPIVerifications/PostPropertyTax';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
        ...
        $scope.baseDetails = function () {
            var probecompanypan_no = $scope.probecompanypan_no;
                ...
                lockUI();
                var url = 'api/AgrProbeAPI/GetBaseDetails';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
                        Notify.alert(resp.data.message, {
                            status: 'success',
        ...
        $scope.comprehensiveDetails = function () {
            ...
            var probecompanypan_no = $scope.probecompanypan_no;
                ...
                lockUI();
                var url = 'api/AgrProbeAPI/GetComprehensiveDetails';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
                        Notify.alert(resp.data.message, {
                            status: 'success',
        ...
        $scope.dataStatus = function () {
            ...
            lockUI();
            var url = 'api/AgrProbeAPI/GetDataStatus';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.ProbeDetailsView = function (data) {
            if (data.api_name == "Base Details") {
                ...
                var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrBaseDetailsView?institutionprobedetails_gid=" + institutionprobedetails_gid;
                window.open(URL, '_blank');
            }
            else if (data.api_name == "Comprehensive Details") {
                var institutionprobedetails_gid = data.institutionprobedetails_gid;              
                var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrComprehensiveDetailsView?institutionprobedetails_gid=" + institutionprobedetails_gid + "&lsdetail_name=BASICDETAIL";
                window.open(URL, '_blank');
            }
        ...
        function ProbeDataStatusView(institutionprobedetails_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrProbeAPI/DataStatusView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.articleOfAssociationDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrProbeAPI/GetArticleOfAssociationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.memorandumOfAssociationDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrProbeAPI/GetMemorandumOfAssociationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.certificateOfIncorporationDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrProbeAPI/GetCertificateOfIncorporationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.mgt7formDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrProbeAPI/GetFormMGT7Doc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.aoc4formDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrProbeAPI/GetFormAOC4Doc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.tandelete = function (tandtl_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/TANdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.companyLLPnoDelete = function (companyllpno_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/CompanyLLPNodelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.mcasignDelete = function (mcasignatories_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/MCASigndelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.IECdelete = function (iecdtl_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/IECdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.FSSAIdelete = function (fssailicenseauthentication_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/FSSAIdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.FDAdelete = function (fdalicenseauthentication_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/FDAdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.LPGIDdelete = function (lpgiddtl_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/LPGIDdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Shopdelete = function (shopandestablishment_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/Shopdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.RCAuthAdvanceddelete = function (vehiclercauthadvanced_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/RCAuthAdvanceddelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.RCSearchdelete = function (vehiclercsearch_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/RCSearchdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.PropertyTaxdelete = function (propertytax_gid) {
            ...
            var url = 'api/AgrMstAPIVerifications/PropertyTaxdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
    ...
    $scope.raise_crimereportrequest = function () {
        ...
        if($scope.cboaddress == '' || $scope.cboaddress == null || $scope.cboaddress == undefined ) {
            ...
            var url = 'api/AgrCrimeCheckAPI/RequestCrimeReportCompany';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
    ...
    $scope.crimereport_view = function (crimereportinstitution_gid) {
        ...
        var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrTrnCrimeReportCompanyView";
        window.open(URL, '_blank');
    }
    ...
    $scope.downloadall = function () {
        for (var i = 0; i < $scope.institutionprobedoc_list.length; i++) {
            DownloaddocumentService.Downloaddocument($scope.institutionprobedoc_list[i].probedocument_path, $scope.institutionprobedoc_list[i].probedocument_name);
        }
    }
    $scope.downloadall_2 = function () {
        for (var i = 0; i < $scope.companycrimereport_list.length; i++) {
            DownloaddocumentService.Downloaddocument($scope.companycrimereport_list[i].report_link, $scope.companycrimereport_list[i].request_id);
        }
    }
