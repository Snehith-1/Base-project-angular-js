(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditIndividualDtlViewController', AgrTrnSuprCreditIndividualDtlViewController);

    AgrTrnSuprCreditIndividualDtlViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function AgrTrnSuprCreditIndividualDtlViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditIndividualDtlViewController';
