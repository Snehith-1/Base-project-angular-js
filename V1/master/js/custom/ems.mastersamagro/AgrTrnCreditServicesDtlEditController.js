(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditServicesDtlEditController', AgrTrnCreditServicesDtlEditController);

        AgrTrnCreditServicesDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrTrnCreditServicesDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditServicesDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/ServicechargeEdit';
        ...
        $scope.update_ServiceCharges = function () {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/ServicechargeUpdate';
            lockUI();
