(function () {
    ...
    angular
        .module('angle')
        .controller('AgrIECDetailedProfileViewController', AgrIECDetailedProfileViewController);

    AgrIECDetailedProfileViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrIECDetailedProfileViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrIECDetailedProfileViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstAPIVerifications/IECProfileViewDetails';
