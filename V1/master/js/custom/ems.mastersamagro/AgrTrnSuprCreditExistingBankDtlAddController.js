(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditExistingBankDtlAddController', AgrTrnSuprCreditExistingBankDtlAddController);

    AgrTrnSuprCreditExistingBankDtlAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce','cmnfunctionService'];

    function AgrTrnSuprCreditExistingBankDtlAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditExistingBankDtlAddController';
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/AgrTrnSuprCreditExistingBankDtlEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
