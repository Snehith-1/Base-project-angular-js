(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditPSLDataFlaggingEditController', AgrTrnCreditPSLDataFlaggingEditController);

    AgrTrnCreditPSLDataFlaggingEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnCreditPSLDataFlaggingEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditPSLDataFlaggingEditController';
