(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprAppEditProductAdd', AgrMstSuprAppEditProductAdd);

    AgrMstSuprAppEditProductAdd.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstSuprAppEditProductAdd($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprAppEditProductAdd';
        ...
        $scope.addLoan = function () {
            ...
            if ((txtloanfaility_amount) > (lsoveralllimit_amount - lsloanfacility_amount)) {
                ...
                if ($scope.txtfacilityreqon_date == null || $scope.txtfacilityreqon_date == '' || $scope.cboProductTypelist == null || $scope.cboProductTypelist == '' ||
                    ...
                    $scope.cboFacilitymodelist == null || $scope.cboFacilitymodelist == '') {
