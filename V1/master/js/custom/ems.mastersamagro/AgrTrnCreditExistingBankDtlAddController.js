(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditExistingBankDtlAddController', AgrTrnCreditExistingBankDtlAddController);

        AgrTrnCreditExistingBankDtlAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce','cmnfunctionService'];

    function AgrTrnCreditExistingBankDtlAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditExistingBankDtlAddController';
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/AgrTrnCreditExistingBankDtlEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
