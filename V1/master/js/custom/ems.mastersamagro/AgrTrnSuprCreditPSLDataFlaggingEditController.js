(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditPSLDataFlaggingEditController', AgrTrnSuprCreditPSLDataFlaggingEditController);

    AgrTrnSuprCreditPSLDataFlaggingEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSuprCreditPSLDataFlaggingEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditPSLDataFlaggingEditController';
