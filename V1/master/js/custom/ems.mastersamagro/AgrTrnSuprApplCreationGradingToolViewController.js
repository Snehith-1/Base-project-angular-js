(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprApplCreationGradingToolViewController', AgrTrnSuprApplCreationGradingToolViewController);

    AgrTrnSuprApplCreationGradingToolViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function AgrTrnSuprApplCreationGradingToolViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprApplCreationGradingToolViewController';
