(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditGroupObservationAddController', AgrTrnCreditGroupObservationAddController);

        AgrTrnCreditGroupObservationAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce'];

    function AgrTrnCreditGroupObservationAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditGroupObservationAddController';
