(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCreditVisitReportEditController', AgrMstSuprCreditVisitReportEditController);

    AgrMstSuprCreditVisitReportEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstSuprCreditVisitReportEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCreditVisitReportEditController';
        ...
        function activate() {
            var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpDocument';
            SocketService.get(url).then(function (resp) {

            });
            var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpPhoto';
            SocketService.get(url).then(function (resp) {

            });
            var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpContact';
            SocketService.get(url).then(function (resp) {

            });
            var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmppersondtl';
            SocketService.get(url).then(function (resp) {

            });
            var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpAddress';
            SocketService.get(url).then(function (resp) {
            ...
            var url = 'api/AgrMstSuprApplicationVisitReport/EditApplicationVisitReport';
            ...
            var url = 'api/AgrMstSuprApplicationVisitReport/GetVisitPersondtlList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersondtl_list = resp.data.mstVisitpersondtl_list;

            });
            var url = 'api/AgrMstSuprApplicationVisitReport/GetVisitAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersonaddressdtl_list = resp.data.mstVisitpersonaddress_list;

            });

            var url = 'api/AgrMstSuprApplicationVisitReport/GetVisitPhotosList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.UploadphotoList = resp.data.UploadphotoList;

            });

            var url = 'api/AgrMstSuprApplicationVisitReport/GetVisitDocumentList';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.Back = function () {
            $location.url('app/AgrSuprCreditVisitReportAdd?application_gid=' + application_gid + '&lstab=' + lstab);
        }
        ...
        $scope.addaddress = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/AgrMstSuprApplicationVisitReport/PostVisitAddress';
                    lockUI();
        ...
        $scope.addressdelete = function (val) {
            ...
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    lockUI();
                    var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpAddressList';
        ...
        function address_list() {
            ...
            var url = 'api/AgrMstSuprApplicationVisitReport/GetEditVisitAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersonaddressdtl_list = resp.data.mstVisitpersonaddress_list;
        ...
        $scope.addvisitedpersondetails = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.mobileno_add = function () {
                    ...
                    var url = 'api/AgrMstSuprApplicationVisitReport/PostVisitContactNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
                            var url = 'api/AgrMstSuprApplicationVisitReport/GetVisittmpContactList';
                            SocketService.get(url).then(function (resp) {
                ...
                $scope.mobileno_delete = function (applicationvisitperson2contact_gid) {
                    ...
                    SweetAlert.swal({
                        ...
                        if (isConfirm) {
                            var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpContactList';
                            SocketService.getparams(url, params).then(function (resp) {
                                if (resp.data.status == true) {
                                    var url = 'api/AgrMstSuprApplicationVisitReport/GetVisittmpContactList';
                                    SocketService.get(url).then(function (resp) {
                ...
                $scope.visitpersondtlSubmit = function () {
                    ...
                    var url = 'api/AgrMstSuprApplicationVisitReport/PostPersonDetails';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.visitpersondtldelete = function (val) {
            ...
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmppersondtlList';
                    lockUI();
                    SocketService.getparams(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        function visitedpersondetails_list() {
            ...
            var url = 'api/AgrMstSuprApplicationVisitReport/GetEditVisitPersondtlList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersondtl_list = resp.data.mstVisitpersondtl_list;
        ...
        $scope.editaddress = function (val) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrMstSuprApplicationVisitReport/EditApplicationVisitaddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.addressUpdate = function () {
                    ...
                    var url = 'api/AgrMstSuprApplicationVisitReport/PostPersonaddressUpdate';
                    var params = {
        ...
        $scope.saveasdraft_update = function () {
            if ($scope.txtdateof_visit == '' || $scope.txtdateof_visit == null || $scope.txtdateof_visit == undefined) {
                ...
                var url = 'api/AgrMstSuprApplicationVisitReport/PostSaveApplicationVisitReportUpdate';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
                        ...
                        $location.url('app/AgrSuprCreditVisitReportAdd?application_gid=' + application_gid);
                    }
                    else {
                        Notify.alert(resp.data.message, {
                            status: 'warning',
        ...
        $scope.visitreportSubmit = function () {
            ...
            var url = 'api/AgrMstSuprApplicationVisitReport/PostSubmitApplicationVisitReportUpdate';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.visitreportUpdate = function () {
            ...
            var url = 'api/AgrMstSuprApplicationVisitReport/PostUpdateApplicationVisitReportUpdate';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.VisitReportDocumentUpload = function () {
            ...
            if (fi.files.length > 0) {
                ...
                $scope.uploadfrm = frm;
                var url = 'api/AgrMstSuprApplicationVisitReport/VisitDocumentUpload';
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    if (resp.data.status == true) {
                        ...
                        var url = 'api/AgrMstSuprApplicationVisitReport/GetEditVisitDocumentList';
                        SocketService.getparams(url, params).then(function (resp) {
                            $scope.UploadDocumentList = resp.data.UploadDocumentList;
        ...
        $scope.uploaddocumentcancel = function (val) {
            ...
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    lockUI();
                    var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpDocumentList';
                    SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.VisitReportPhotoUpload = function () {
            ...
            if (fi.files.length > 0) {
                ...
                $scope.uploadfrm = frm;
                var url = 'api/AgrMstSuprApplicationVisitReport/VisitPhotoUpload';
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    $("#photo").val('');
                    unlockUI();
                    if (resp.data.status == true) {
                        ...
                        var url = 'api/AgrMstSuprApplicationVisitReport/GetEditVisitPhotosList';
                        SocketService.getparams(url, params).then(function (resp) {
                            $scope.UploadphotoList = resp.data.UploadphotoList;
        ...
        $scope.uploadphotocancel = function (val) {
            ...
            SweetAlert.swal({
                ...
                if (isConfirm) {
                    lockUI();
                    var url = 'api/AgrMstSuprApplicationVisitReport/DeleteVisittmpPhotoList';
                    SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.editvisitedpersondetails = function (val) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrMstSuprApplicationVisitReport/EditApplicationVisitpersondtl';
                SocketService.getparams(url, params).then(function (resp) {
                        ...
                        if (isConfirm) {
                            ...
                            SocketService.getparams(url, params).then(function (resp) {
                                if (resp.data.status == true) {
                                    ...
                                    var url = 'api/AgrMstSuprApplicationVisitReport/GetEditVisitContactList';
                                    SocketService.getparams(url, params).then(function (resp) {
                                        $scope.Visitpersoncontact_list = resp.data.mstVisitpersoncontact_list;
                                    });
                                }
                ...
                $scope.visitpersondtlupdate = function () {
                    ...
                    var url = 'api/AgrMstSuprApplicationVisitReport/PostPersonDetailsUpdate';
                    var params = {
                        applicationvisit2person_gid: applicationvisit2person_gid,
