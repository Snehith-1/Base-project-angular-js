(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprApplCreationVisitReportViewController', AgrTrnSuprApplCreationVisitReportViewController);

    AgrTrnSuprApplCreationVisitReportViewController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'SweetAlert', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$cookies', '$filter', 'ngTableParams', '$resource', '$timeout', 'ngTableDataService', '$anchorScroll', '$sce', 'DownloaddocumentService'];

    function AgrTrnSuprApplCreationVisitReportViewController($rootScope, $scope, $modal, $state, SweetAlert, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $cookies, $filter, ngTableParams, $resource, $timeout, ngTableDataService, $anchorScroll, $sce, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprApplCreationVisitReportViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprApplicationView/GetVisitReportDtls';
        ...
        $scope.visitreportmobileno_view = function (applicationvisit2person_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                lockUI();
                var url = 'api/AgrMstSuprApplicationView/GetVisitContactList';
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
