(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnIndividualCovenantDoccontroller', AgrTrnIndividualCovenantDoccontroller);

    AgrTrnIndividualCovenantDoccontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnIndividualCovenantDoccontroller($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnIndividualCovenantDoccontroller';
