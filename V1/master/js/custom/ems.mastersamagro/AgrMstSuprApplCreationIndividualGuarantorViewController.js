(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprApplCreationIndividualGuarantorViewController', AgrMstSuprApplCreationIndividualGuarantorViewController);

    AgrMstSuprApplCreationIndividualGuarantorViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function AgrMstSuprApplCreationIndividualGuarantorViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprApplCreationIndividualGuarantorViewController';
