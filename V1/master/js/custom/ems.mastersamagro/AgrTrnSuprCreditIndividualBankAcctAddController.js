(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditIndividualBankAcctAddController', AgrTrnSuprCreditIndividualBankAcctAddController);

    AgrTrnSuprCreditIndividualBankAcctAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnSuprCreditIndividualBankAcctAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditIndividualBankAcctAddController';
