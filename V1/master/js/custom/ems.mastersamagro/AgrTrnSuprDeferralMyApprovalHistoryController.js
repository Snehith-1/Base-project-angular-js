(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprDeferralMyApprovalHistorycontroller', AgrTrnSuprDeferralMyApprovalHistorycontroller);

    AgrTrnSuprDeferralMyApprovalHistorycontroller.$inject = ['DownloaddocumentService','$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function AgrTrnSuprDeferralMyApprovalHistorycontroller(DownloaddocumentService,$rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprDeferralMyApprovalHistorycontroller';
