(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstContractRejectedSummaryController', AgrMstContractRejectedSummaryController);

        AgrMstContractRejectedSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService'];

    function AgrMstContractRejectedSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstContractRejectedSummaryController';
        ...
        function activate() {
            lockUI();
            var url = "api/AgrTrnContract/ContractRejectedSummary";
        ...
        $scope.checkerapprovalview = function (customer2sanction_gid, application_gid) {
            $location.url('app/AgrMstContractDtlViewSummary?sanction_gid=' + customer2sanction_gid + '&application_gid=' + application_gid + '&lspage=ContractRejected' + '&lsresubmit=submit_flag');
        }
