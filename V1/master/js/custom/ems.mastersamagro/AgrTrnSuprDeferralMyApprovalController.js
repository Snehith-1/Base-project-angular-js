(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprDeferralMyApprovalController', AgrTrnSuprDeferralMyApprovalController);

    AgrTrnSuprDeferralMyApprovalController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams','DownloaddocumentService'];

    function AgrTrnSuprDeferralMyApprovalController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprDeferralMyApprovalController';
        ...
        $scope.reject_submit = function () {
            ...
            var url = "";
            if ($scope.lblfromphysical_document == 'Y')
                url = 'api/AgrTrnSuprPhysicalDocument/PostPhysicalextenstionwaiverApproval';
            else
                url = 'api/AgrMstSuprScannedDocument/PostextenstionwaiverApproval';
            lockUI();
