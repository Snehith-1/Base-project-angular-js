(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCcCommitteeGroupViewController', AgrTrnSuprCcCommitteeGroupViewController);

    AgrTrnSuprCcCommitteeGroupViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function AgrTrnSuprCcCommitteeGroupViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCcCommitteeGroupViewController';
