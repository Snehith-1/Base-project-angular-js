(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCADReassignApplicationController', AgrTrnCADReassignApplicationController);

    AgrTrnCADReassignApplicationController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnCADReassignApplicationController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCADReassignApplicationController';
        ...
        $scope.reassign_application = function (application_gid, cadgroup_gid, menu_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnCAD/GetCADGroupDtl';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                var url = 'api/AgrTrnCAD/GetReassignApplicationView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.reassign = function () {
                    ...
                    var url = 'api/AgrTrnCAD/PostReassignCADApplication';
                    lockUI();
