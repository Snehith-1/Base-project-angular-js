...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingIndividualApprovalViewController', MstSAOnboardingIndividualApprovalViewController);

    MstSAOnboardingIndividualApprovalViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSAOnboardingIndividualApprovalViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingIndividualApprovalViewController';
        ...
        $scope.back = function () {
            ...
            else if (lspage == 'Individualcodecreate') {
