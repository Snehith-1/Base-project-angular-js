...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstGeneralTabEditController', MstGeneralTabEditController);

    MstGeneralTabEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstGeneralTabEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstGeneralTabEditController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationEdit/GetEditHypothecation';
        ...
        $scope.edit_basicdetails = function (application_gid, application_status, product_gid, variety_gid) {
            $location.url('app/MstApplcreationBasicdtlEdit?lsapplication_gid=' + application_gid + '&product_gid=' + product_gid + '&variety_gid=' + variety_gid + '&lstab=edit&lsstatus=' + application_status);
        }

        $scope.edit_individual = function (contact_gid, application_gid) {
            $location.url('app/MstApplcreationIndividualdtlEdit?lscontact_gid=' + contact_gid + '&application_gid=' + application_gid + '&lstab=edit');
        }

        $scope.edit_institution = function (institution_gid, application_gid) {
            $location.url('app/MstApplcreationInstitutiondtlEdit?lsinstitution_gid=' + institution_gid + '&application_gid=' + application_gid + '&lstab=edit');
        }

        $scope.edit_group = function (group_gid) {
            $location.url('app/MstApplcreationGroupdtlEdit?lsgroup_gid=' + group_gid + '&lstab=edit');
        }
        ...
        $scope.bureauupdate_individual = function (contact_gid) {
            $location.url('app/BureauUpdateIndividual?lscontact_gid=' + contact_gid + '');
        }

        $scope.bureauupdate_institution = function (institution_gid) {
            $location.url('app/BureauUpdateInstitution?lsinstitution_gid=' + institution_gid + '');
        }
