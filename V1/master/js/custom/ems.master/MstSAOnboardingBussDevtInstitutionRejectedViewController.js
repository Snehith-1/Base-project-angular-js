(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBussDevtInstitutionRejectedViewController', MstSAOnboardingBussDevtInstitutionRejectedViewController);

    MstSAOnboardingBussDevtInstitutionRejectedViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAOnboardingBussDevtInstitutionRejectedViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBussDevtInstitutionRejectedViewController';
