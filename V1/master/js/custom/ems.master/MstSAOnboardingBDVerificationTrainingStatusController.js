(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBDVerificationTrainingStatusController', MstSAOnboardingBDVerificationTrainingStatusController);

    MstSAOnboardingBDVerificationTrainingStatusController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAOnboardingBDVerificationTrainingStatusController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBDVerificationTrainingStatusController';
        ...
        $scope.verify_update = function () {
            ...
            if ($scope.cbotrainingstatus == undefined || $scope.cbotrainingstatus == "") {
                ...
                var url = 'api/MstSAOnboardingBussDevtVerification/InstitutionVerifyUpdate';
                ...
                SocketService.post(url, params).then(function (resp) {
                    ...
                    if (resp.data.status == true) {
                        ...
                        $location.url('app/MstSAOnboardingBDVerificationPending');
                    }
                    else {
                        Notify.alert(resp.data.message, {
                            status: 'warning',
