(function () {
    ...
    angular
        .module('angle')
        .controller('MstPSLCSAGroupPSLDataFlagAddController', MstPSLCSAGroupPSLDataFlagAddController);

        MstPSLCSAGroupPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstPSLCSAGroupPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPSLCSAGroupPSLDataFlagAddController';
        ...
        $scope.Editpsldataflag = function () {
            $location.url('app/MstPSLCSAGroupPSLDataFlagEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
