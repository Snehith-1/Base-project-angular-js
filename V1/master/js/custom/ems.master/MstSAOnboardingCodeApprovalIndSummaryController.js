(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingCodeApprovalIndSummaryController', MstSAOnboardingApprovalIndSummaryController);

    MstSAOnboardingApprovalIndSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAOnboardingApprovalIndSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingCodeApprovalIndSummaryController';

        activate();

        function activate() {
            var url = 'api/MstSAOnboardingIndividual/GetCodecreationIndividualSummary';
            lockUI();
        ...
        $scope.IndividualCodePendingReport = function () {
            lockUI();
            var url = 'api/MstSAOnboardingIndividual/IndividualCodePendingReport';
            SocketService.get(url).then(function (resp) {
