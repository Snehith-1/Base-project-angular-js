(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADPSLCSAIndividualPSLDataFlagAddController', MstCADPSLCSAIndividualPSLDataFlagAddController);

        MstCADPSLCSAIndividualPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCADPSLCSAIndividualPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADPSLCSAIndividualPSLDataFlagAddController';
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/MstCADPSLCSAIndividualPSLDataFlagEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage);
        }
