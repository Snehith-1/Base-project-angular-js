...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingIndividualApprovalController', MstSAOnboardingIndividualApprovalController);

    MstSAOnboardingIndividualApprovalController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSAOnboardingIndividualApprovalController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
    /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingIndividualApprovalController';
        ...
        $scope.back=function(){
            ...
            if (lspage == 'IndividualPending') {
                $location.url('app/MstSAApprovalIndPendingSummary');
            }
            else if (lspage == 'IndividualInitiate') {
                $location.url('app/MstSAOnboardingApprovalIndSummary');
            }
        } 
        $scope.approverindividualraisequery = function (sacontact_gid) {
            var modalInstance = $modal.open({
                templateUrl: '/approverindividualClose.html',
                controller: ModalInstanceCtrl,
                backdrop: 'static',
                keyboard: false,
                size: 'md'
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.submit = function () {
                    ...
                    var url = 'api/MstSAOnboardingIndividual/PostApproverIndividualRaiseQuery';
                    lockUI();
        ...
        function address_list(sacontact_gid) {
            var params = {
                sacontact_gid: sacontact_gid,
