(function () {
    ...
    angular
        .module('angle')
        .controller('MstSanctionAddTemplateController', MstSanctionAddTemplateController);

        MstSanctionAddTemplateController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route','$modal'];

    function MstSanctionAddTemplateController($rootScope, $scope, $state, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $modal) {
    
        $scope.title = 'MstSanctionAddTemplateController';
