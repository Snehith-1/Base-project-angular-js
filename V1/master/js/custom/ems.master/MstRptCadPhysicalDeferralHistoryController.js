(function () {
    ...
    angular
        .module('angle')
        .controller('MstRptCadPhysicalDeferralHistoryController', MstRptCadPhysicalDeferralHistoryController);

    MstRptCadPhysicalDeferralHistoryController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstRptCadPhysicalDeferralHistoryController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstRptCadPhysicalDeferralHistoryController';
        ...
        function activate() {
            ...
            var url = 'api/MstPhysicalDocument/GetDeferralHistorySummary';
        ...
        $scope.deferraldoc_view = function (deferraltagdoc_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstPhysicalDocument/GettaggedHistoryDeferralinfo';
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
