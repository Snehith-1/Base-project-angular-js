(function () {
    ...
    angular
        .module('angle')
        .controller('MstApplicationEditKycViewController', MstApplicationEditKycViewController);

    MstApplicationEditKycViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll'];

    function MstApplicationEditKycViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstApplicationEditKycViewController';
       ...
       /*     var url = 'api/KycView/GetPANAadhaarLinkDtl';
        ...
        $scope.Back = function () {
            $location.url('app/MstApplicationCreationView?application_gid=' + application_gid + '&lstab=' + lstab);
        }
