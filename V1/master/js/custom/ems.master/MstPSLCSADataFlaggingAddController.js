(function () {
    ...
    angular
        .module('angle')
        .controller('MstPSLCSADataFlaggingAddController', MstPSLCSADataFlaggingAddController);

        MstPSLCSADataFlaggingAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstPSLCSADataFlaggingAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPSLCSADataFlaggingAddController';
        $scope.institution_gid = $location.search().credit_gid;
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/MstPSLCSADataFlaggingEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=' + lspage);
        }
