(function () {
    ...
    angular
        .module('angle')
        .controller('MstPSLCSAIndividualPSLDataFlagEditController', MstPSLCSAIndividualPSLDataFlagEditController);

        MstPSLCSAIndividualPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstPSLCSAIndividualPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPSLCSAIndividualPSLDataFlagEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstPSLCSAIndividualPSLDataFlagAdd?application_gid=' + application_gid + '&credit_gid=' + contact_gid + '&lspage=' + lspage);
        }
