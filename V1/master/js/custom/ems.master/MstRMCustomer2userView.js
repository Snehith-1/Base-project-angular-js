(function () {
    ...
    angular
        .module('angle')
        .controller('MstRMCustomer2userView', MstRMCustomer2userView);

    MstRMCustomer2userView.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function MstRMCustomer2userView($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstRMCustomer2userView';
        activate();
        ...
        function activate() {
            ...
            var url = 'api/MstRMMapping/GetRMCustomer2UserInfo';
        ...
        $scope.back = function () {
                $state.go('app.MstRMCustomerView');           
        }
    }
})();
