(function () {
    ...
    angular
        .module('angle')
        .controller('RCAuthAdvancedViewController', RCAuthAdvancedViewController);

    RCAuthAdvancedViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function RCAuthAdvancedViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'RCAuthAdvancedViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstAPIVerifications/RCAuthAdvancedViewDetails';
