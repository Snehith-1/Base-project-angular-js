...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSBAIndividualFinalApprovalViewController', MstSBAIndividualFinalApprovalViewController);

    MstSBAIndividualFinalApprovalViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSBAIndividualFinalApprovalViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSBAIndividualFinalApprovalViewController';
