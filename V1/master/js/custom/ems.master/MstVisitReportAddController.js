(function () {
    ...
    angular
        .module('angle')
        .controller('MstVisitReportAddController', MstVisitReportAddController);

    MstVisitReportAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstVisitReportAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstVisitReportAddController';
        ...
        $scope.editapplicationvisitreport = function (val) {
            ...
            $location.url('app/MstVisitReportEdit?visitreport_gid=' + val + '&application_gid='+application_gid);
         
        }

        $scope.viewapplicationvisitreport = function (val) {
            $location.url('app/MstVisitReportView?visitreport_gid=' + val + '&application_gid='+application_gid);
