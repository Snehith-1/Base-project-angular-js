(function () {
    ...
    angular
        .module('angle')
        .controller('MstCcCommitteeGroupViewController', MstCcCommitteeGroupViewController);

    MstCcCommitteeGroupViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstCcCommitteeGroupViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCcCommitteeGroupViewController';
        ...
        const lspagename = 'MstCcCommitteeGroupView';
