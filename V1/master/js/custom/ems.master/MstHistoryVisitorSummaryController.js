(function () {
    ...
    angular
        .module('angle')
        .controller('MstHistoryVisitorSummaryController', MstHistoryVisitorSummaryController);

    MstHistoryVisitorSummaryController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams', 'DownloaddocumentService'];

    function MstHistoryVisitorSummaryController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstHistoryVisitorSummaryController';
        lockUI();
        activate();

        function activate() {
            var url = 'api/MstVisitor/GetHistoryVisitor';
        ...
        $scope.visitor_view = function (visitor_gid) {
            $location.url('app/MstVisitorView?visitor_gid=' + visitor_gid + '&lstab=HistoryVisitor');
        }
