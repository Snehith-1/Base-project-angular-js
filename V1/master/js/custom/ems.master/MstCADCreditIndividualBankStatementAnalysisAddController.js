(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualBankStatementAnalysisAddController', MstCADCreditIndividualBankStatementAnalysisAddController);

    MstCADCreditIndividualBankStatementAnalysisAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce', '$resource', 'DownloaddocumentService'];

        function MstCADCreditIndividualBankStatementAnalysisAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, $resource, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualBankStatementAnalysisAddController';
