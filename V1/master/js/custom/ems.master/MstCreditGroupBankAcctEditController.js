(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupBankAcctEditController', MstCreditGroupBankAcctEditController);

    MstCreditGroupBankAcctEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstCreditGroupBankAcctEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupBankAcctEditController';
        ...
        $scope.Bankacctdtl_Back = function () {
            $location.url('app/MstCreditGroupBankAcctAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + $scope.lspage);
        }
