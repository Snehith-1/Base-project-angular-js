...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSABussDevtInstitutionDeferredViewController', MstSABussDevtInstitutionDeferredViewController);

    MstSABussDevtInstitutionDeferredViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSABussDevtInstitutionDeferredViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSABussDevtInstitutionDeferredViewController';
