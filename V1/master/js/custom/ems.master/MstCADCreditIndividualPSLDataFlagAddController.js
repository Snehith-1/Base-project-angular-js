(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualPSLDataFlagAddController', MstCADCreditIndividualPSLDataFlagAddController);

    MstCADCreditIndividualPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCADCreditIndividualPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualPSLDataFlagAddController';
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/MstCADCreditIndividualPSLDataFlagEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage);
        }
        //KYC API
