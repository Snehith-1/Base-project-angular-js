(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditGroupBankAcctEditController', MstCADCreditGroupBankAcctEditController);

    MstCADCreditGroupBankAcctEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstCADCreditGroupBankAcctEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditGroupBankAcctEditController';
        ...
        $scope.Bankacctdtl_Back = function () {
            $location.url('app/MstCADCreditGroupBankAcctAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=CADAcceptanceCustomers');
        }
