(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupExistingBankEditController', MstCreditGroupExistingBankEditController);

        MstCreditGroupExistingBankEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCreditGroupExistingBankEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupExistingBankEditController';
        ...
        $scope.ExistingBankacctdtl_Back = function () {
            $location.url('app/MstCreditGroupExistingBankAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + $scope.lspage);
        }
