(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBussDevtVerificationInstitutionPendingBDSummaryController', MstSAOnboardingBussDevtVerificationInstitutionPendingBDSummaryController);

    MstSAOnboardingBussDevtVerificationInstitutionPendingBDSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAOnboardingBussDevtVerificationInstitutionPendingBDSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBussDevtVerificationInstitutionPendingBDSummaryController';
        ...
        function activate() {
            ...
            var url = 'api/MstSAOnboardingBussDevtVerification/GetPendingBDVerificationInstitution';
        ...
        $scope.viewIndividual = function (sacontactinstitution_gid) {
            $location.url('app/MstSAOnboardingPendingRMInstitutionView?hash=' + cmnfunctionService.encryptURL('lssacontactinstitution_gid=' + sacontactinstitution_gid));
        ...
        $scope.rmtaggedemployee = function (sacontactinstitution_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.taggedsubmit = function () {
                    ...
                    var url = 'api/MstSAOnboardingBussDevtVerification/InstitutionVerificationPendingRMTaggedUpdate';
                    lockUI();
