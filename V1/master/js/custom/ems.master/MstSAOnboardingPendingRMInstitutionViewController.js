(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingPendingRMInstitutionViewController', MstSAOnboardingPendingRMInstitutionViewController);

    MstSAOnboardingPendingRMInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAOnboardingPendingRMInstitutionViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingPendingRMInstitutionViewController';
