(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditGroupRepaymentEditController', MstCADCreditGroupRepaymentEditController);

        MstCADCreditGroupRepaymentEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCADCreditGroupRepaymentEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditGroupRepaymentEditController';
        ...
        $scope.repaymentdtl_Back = function () {
            $location.url('app/MstCADCreditGroupRepaymentAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=CADAcceptanceCustomers');
        }
