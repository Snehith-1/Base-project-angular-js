(function () {
    ...
    angular
        .module('angle')
        .controller('MstMyAssignedCallSummaryController', MstMyAssignedCallSummaryController);

    MstMyAssignedCallSummaryController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstMyAssignedCallSummaryController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstMyAssignedCallSummaryController';
        activate();

        function activate() {
            var url = 'api/TeleCalling/GetEmpAssignedIBCallSummary';
