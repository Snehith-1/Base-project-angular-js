...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationInstitutionMakerTrashViewController', MstSAVerificationInstitutionMakerTrashViewController);

    MstSAVerificationInstitutionMakerTrashViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAVerificationInstitutionMakerTrashViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationInstitutionMakerTrashViewController';
        ...
        $scope.back = function () {
            ...
            if (lspage == 'InstitutePending') {
                $location.url('app/MstSAVerificationMakerInstitutionDistractSummary');
            }
