(function () {
    ...
    angular
        .module('angle')
        .controller('MstRptCadApplicationDeferralCovenantViewController', MstRptCadApplicationDeferralCovenantViewController);

    MstRptCadApplicationDeferralCovenantViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstRptCadApplicationDeferralCovenantViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstRptCadApplicationDeferralCovenantViewController';
