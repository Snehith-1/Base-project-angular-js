...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationInstitutionInitiatedController', MstSAVerificationInstitutionInitiatedController);

    MstSAVerificationInstitutionInitiatedController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstSAVerificationInstitutionInitiatedController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationInstitutionInitiatedController';
