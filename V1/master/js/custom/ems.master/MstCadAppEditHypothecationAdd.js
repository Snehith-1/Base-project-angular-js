...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadAppEditHypothecationAddController', MstCadAppEditHypothecationAddController);

    MstCadAppEditHypothecationAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','DownloaddocumentService','cmnfunctionService'];

    function MstCadAppEditHypothecationAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadAppEditHypothecationAddController';
        ...
        $scope.overalllimit = function () {
            var application_gid = $scope.application_gid;
            $location.url('app/MstApplcreationProductchargesEdit?application_gid=' + application_gid + '&lstab=add');
        }

        $scope.hypothecationdtl = function () {
            var application_gid = $scope.application_gid;
            $location.url('app/MstApplicationHypothecationEdit?application_gid=' + application_gid + '&lstab=edit');
        }
        ...
        $scope.uploadhypothecationdoc = function (val, val1, name) {
            if (($scope.cbohypodoc_title == null) || ($scope.cbohypodoc_title == '') || ($scope.cbohypodoc_title == undefined)) {
                ...
                $scope.uploadfrm = frm;
                var url = 'api/MstCADApplication/PostHypoDoc';
                lockUI();
        ...
        $scope.hypodoccancel = function (val, data) {
            ...
            var url = 'api/MstCADApplication/deleteHypoDoc';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    $scope.hypo_documentList = resp.data.DocumentList;
        ...
        $scope.DeleteHypothecation = function (application2hypothecation_gid) {
            ...
            var url = 'api/MstCADApplication/DeleteHypothecation';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
       ...
       $scope.downloads = function (val1, val2) {
        ...
        $scope.general_Tab = function () {
            ...
            if ($scope.application_status == 'Completed') {
                $location.url('app/MstApplicationGeneralEdit?application_gid=' + application_gid + '&lstab=edit&lsstatus=' + application_status);
            }
            else {
        ...
        $scope.company_add = function () {
            ...
            var application_status = $scope.application_status;
            if ($scope.application_status == 'Completed') {
                $location.url('app/MstApplicationInstitutionEdit?application_gid=' + application_gid + '&lstab=edit&lsstatus=' + application_status);
            }
            else {
        ...
        $scope.Group_add = function () {
            ...
            var application_status = $scope.application_status;
            if ($scope.application_status == 'Completed') {
                $location.url('app/MstApplicationGroupEdit?application_gid=' + application_gid + '&lstab=edit&lsstatus=' + application_status);
            }
            else {
        ...
        $scope.Individual_add = function () {
            ...
            var application_status = $scope.application_status;
            if ($scope.application_status == 'Completed') {
                $location.url('app/MstApplicationIndividualEdit?application_gid=' + application_gid + '&lstab=edit&lsstatus=' + application_status);
            }
            else {
        ...
        $scope.EconomicCapital_add = function () {
            ...
            if ($scope.application_status == 'Completed') {
                $location.url('app/MstApplicationSocialTradeCapitalEdit?application_gid=' + application_gid + '&lstab=edit&lsstatus=' + application_status);
            }
            else {
        ...
        $scope.ProductCharges_add = function () {
            ...
            if ($scope.applicant_type == null || $scope.applicant_type == '') {
                ...
                $location.url('app/MstApplcreationProductchargesEdit?application_gid=' + application_gid + '&lstab=edit&lsapplicant_type=' + applicant_type);
            }
        }
        ...
        $scope.Hypothecation_add = function () {
            ...
            if ($scope.applicant_type == null || $scope.applicant_type == '') {
                ...
                $location.url('app/MstAppEditHypothecationAdd?application_gid=' + application_gid + '&lstab=edit&lsapplicant_type=' + applicant_type);
            }
        }
        $scope.OverallLimit_add = function () {
            ...
            if ($scope.applicant_type == null || $scope.applicant_type == '') {
                ...
                $location.url('app/MstAppEditOverallLimitAdd?application_gid=' + application_gid + '&lstab=edit&lsapplicant_type=' + applicant_type);
            }
        }
        $scope.ProductCharges_add = function () {
            var application_gid = $scope.application_gid;
            ...
            if ($scope.applicant_type == null || $scope.applicant_type == '') {
                ...
                $location.url('app/MstAppEditProductAdd?application_gid=' + application_gid + '&lstab=edit&lsapplicant_type=' + applicant_type);
            }
        }
        $scope.ServiceCharges_add = function () {
            ...
            if ($scope.applicant_type == null || $scope.applicant_type == '') {
                ...
                $location.url('app/MstAppEditChargeAdd?application_gid=' + application_gid + '&lstab=edit&lsapplicant_type=' + applicant_type);
            }
        }
        $scope.BureauUpdates_add = function () {
            ...
            var application_status = $scope.application_status;
            if ($scope.application_status == 'Completed') {
                $location.url('app/MstApplicationEditCICUploadAdd?application_gid=' + application_gid + '&lstab=edit&lsstatus=' + application_status);
            }
            else {
