(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBDVerificationTrainingStatusIndividualController', MstSAOnboardingBDVerificationTrainingStatusIndividualController);

    MstSAOnboardingBDVerificationTrainingStatusIndividualController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAOnboardingBDVerificationTrainingStatusIndividualController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBDVerificationTrainingStatusIndividualController';
        ...
        $scope.verify_update = function () {
            ...
            if ($scope.cbotrainingstatus == undefined || $scope.cbotrainingstatus == "") {
                ...
                var url = 'api/MstSAOnboardingBussDevtVerification/IndividualVerifyUpdate';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
