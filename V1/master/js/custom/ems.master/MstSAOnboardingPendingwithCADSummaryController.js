(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingPendingwithCADSummaryController', MstSAOnboardingPendingwithCADSummaryController);

    MstSAOnboardingPendingwithCADSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAOnboardingPendingwithCADSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingPendingwithCADSummaryController';
        ...
        function activate() {
            ...
            var url = 'api/MstSAOnboardingBussDevtVerification/GetPendingwithCADInstitutionSummary';
