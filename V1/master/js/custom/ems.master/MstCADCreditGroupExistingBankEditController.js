(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditGroupExistingBankEditController', MstCADCreditGroupExistingBankEditController);

        MstCADCreditGroupExistingBankEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCADCreditGroupExistingBankEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditGroupExistingBankEditController';
        ...
        $scope.ExistingBankacctdtl_Back = function () {
            $location.url('app/MstCADCreditGroupExistingBankAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=CADAcceptanceCustomers');
        }
