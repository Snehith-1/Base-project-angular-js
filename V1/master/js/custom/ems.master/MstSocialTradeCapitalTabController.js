(function () {
    ...
    angular
        .module('angle')
        .controller('MstSocialTradeCapitalTabController', MstSocialTradeCapitalTabController);

    MstSocialTradeCapitalTabController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstSocialTradeCapitalTabController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSocialTradeCapitalTabController';
        ...
        $scope.save_socialtradecapital = function () {
            ...
            var url = 'api/MstApplicationAdd/SocialAndTradeCapitalSave';
            lockUI();
