(function () {
    ...
    angular
        .module('angle')
        .controller('MstEditTemplateController', MstEditTemplateController);

    MstEditTemplateController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route','$modal'];

    function MstEditTemplateController($rootScope, $scope, $state, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $modal) {

        $scope.title = 'MstEditTemplateController';
        var vm = this;
        ...
        function activate() { 
            ...
            lockUI();
            var url = "api/MstTemplate/GetTemplateDtl"
            var param = {
        ...
        $scope.updateTemplate = function () {
            ...
            var url = 'api/MstTemplate/UpdateTemplateDtl';
        ...
        function addsmalltextbox (getinputarray) { 
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {  
                ...
                GetInputDropdown($scope.groupnamelist,'text');
        ...
        function GetInputDropdown(groupnamelist, input_type){
            ...
            var url = "api/MstTemplate/GetInputDropdown";
            SocketService.getparams(url, param).then(function (resp) { 
                if(resp.data.status==true){
                    $scope.groupDBnamelist = resp.data.MdlInputDtls; 
                    if($scope.groupDBnamelist && $scope.groupDBnamelist.length !=0) {
                        angular.forEach($scope.groupDBnamelist, function (value, key) {
                            if(value.inputgroup_gid == 0){
                                var getgroupdtl = $scope.groupnamelist.filter(function (el) { return el.input_fieldid == value.input_fieldid});
                                if(getgroupdtl && getgroupdtl.length ==0){
                                    $scope.groupnamelist.push({input_fieldid: value.input_fieldid, 
                                        input_fieldname: value.input_fieldname, 
                                        inputgroup_gid: value.inputgroup_gid, 
                                        inputgroup_name: value.inputgroup_name,
                                        inputmax_length: value.inputmax_length,
                                        input_placeholder: value.input_placeholder,
                                        input_type: value.input_type,
                                        input_mandatory: value.input_mandatory,
                                        input_previewtext: value.input_previewtext,
                                        inputlistarray: value.inputlistarray});  
                                }
                            } 
                        }); 
                    }
                    ...
                    $scope.groupnamelist.push({ input_fieldid: 0, input_fieldname: 'New Group', inputgroup_gid: 0, inputgroup_name: 'New Group', input_placeholder:'', inputmax_length:'', input_mandatory:''}) 
                    $scope.groupnamelist = $scope.groupnamelist.concat($scope.grouptemplatenamelist);
                    unlockUI();
                } 
            }); 
        }
        ...
        function addlargetextbox (getinputarray) {
            lockUI();
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {  
                    ...
                    GetInputDropdown($scope.groupnamelist,'textarea');
        ...
        function adddropdownbox (getinputarray) {
                lockUI();
                    ...
                    function ModalInstanceCtrl($scope, $modalInstance) {  
                        ...
                        GetInputDropdown($scope.groupnamelist,'select-one');
                        unlockUI();  
                    $scope.onchangegroup = function (index) { 
                        $scope.txtdisabled = false; 
                        var getgroupdtl = $scope.groupnamelist.filter(function (el) { return el.input_fieldid === $scope.txtgroup_name.input_fieldid });
        ...
        function addradiobutton (getinputarray) {
            lockUI();
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {  
                    ...
                    GetInputDropdown($scope.groupnamelist,'radio');
                    unlockUI();  
                $scope.onchangegroup = function (index) { 
                    $scope.txtdisabled = false; 
                    var getgroupdtl = $scope.groupnamelist.filter(function (el) { return el.input_fieldid === $scope.txtgroup_name.input_fieldid });
      ...
      function addCheckboxbutton (getinputarray) { 
        ...
        function ModalInstanceCtrl($scope, $modalInstance) {  
            ...
            GetInputDropdown($scope.groupnamelist,'checkbox');
            unlockUI();  
        $scope.onchangegroup = function (index) { 
            $scope.txtdisabled = false; 
            var getgroupdtl = $scope.groupnamelist.filter(function (el) { return el.input_fieldid === $scope.txtgroup_name.input_fieldid });
