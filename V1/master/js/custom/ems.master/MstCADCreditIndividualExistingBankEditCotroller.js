(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualExistingBankEditCotroller', MstCADCreditIndividualExistingBankEditCotroller);

        MstCADCreditIndividualExistingBankEditCotroller.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCADCreditIndividualExistingBankEditCotroller($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualExistingBankEditCotroller';
        ...
        $scope.ExistingBankacctdtl_Back = function () {
            $location.url('app/MstCADCreditIndividualExistingBankAdd?application_gid=' + application_gid + '&contact_gid=' + contact_gid  + '&lspage=CADAcceptanceCustomers');
        }
