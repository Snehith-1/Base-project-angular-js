(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditVisitReportEditController', MstCreditVisitReportEditController);

    MstCreditVisitReportEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService', 'DownloaddocumentService'];

    function MstCreditVisitReportEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService, DownloaddocumentService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditVisitReportEditController';
        ...
        $scope.Back = function () {        
            ...
            if (lstab == "AssignmentVisit") {
                ...
                $location.url('app/MstCreditVisitReportAdd?application_gid=' + application_gid + '&lstab=' + lstab);
            }
        ...
        $scope.saveasdraft_update = function () {
            ...
            SocketService.post(url, params).then(function (resp) {
                ...
                if (resp.data.status == true) {
                    ...
                    $location.url('app/MstCreditVisitReportAdd?application_gid=' + application_gid);
                }
                else {
                    Notify.alert(resp.data.message, {
                        status: 'warning',
