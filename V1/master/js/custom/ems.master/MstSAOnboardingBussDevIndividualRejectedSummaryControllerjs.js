(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBussDevIndividualRejectedSummaryController', MstSAOnboardingBussDevIndividualRejectedSummaryController);

    MstSAOnboardingBussDevIndividualRejectedSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAOnboardingBussDevIndividualRejectedSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBussDevIndividualRejectedSummaryController';
        ...
        $scope.bd_verificationpendingRM = function () {
