(function () {
    ...
    angular
        .module('angle')
        .controller('IECDetailedProfileViewController', IECDetailedProfileViewController);

    IECDetailedProfileViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function IECDetailedProfileViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'IECDetailedProfileViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstAPIVerifications/IECProfileViewDetails';
