(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditIndividualAPIController', MstCreditIndividualAPIController);

    MstCreditIndividualAPIController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCreditIndividualAPIController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditIndividualAPIController';
        ...
        function activate() {
            ...
            var url = 'api/CrimeCheckAPI/GetIndividualReportList';
            SocketService.getparams(url, paramcrime).then(function (resp) {
                unlockUI();
        ...
        $scope.PropertyTaxdelete = function (propertytax_gid) {
         ...
         $scope.raise_crimereportrequest = function () {
            ...
            if($scope.cboaddress == '' || $scope.cboaddress == null || $scope.cboaddress == undefined ) {
                ...
                var url = 'api/CrimeCheckAPI/RequestCrimeReportIndividual';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
