(function () {
    ...
    angular
        .module('angle')
        .controller('MstGroupCovenantDocChecklistcontroller', MstGroupCovenantDocChecklistcontroller);

    MstGroupCovenantDocChecklistcontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', '$resource'];

    function MstGroupCovenantDocChecklistcontroller($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, $resource) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstGroupCovenantDocChecklistcontroller';
