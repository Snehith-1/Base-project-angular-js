(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadConsolidatedOriginalCopyVettingReportController', MstCadConsolidatedOriginalCopyVettingReportController);

    MstCadConsolidatedOriginalCopyVettingReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCadConsolidatedOriginalCopyVettingReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadConsolidatedOriginalCopyVettingReportController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationReport/CADConsolidatedReportCount';
            ...
            var url = 'api/MstApplicationReport/GetConsolidatedOriginalCopyVettingReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
        ...
        $scope.Sanction = function () {
            $state.go('app.MstCadConsolidatedSanctionReport');
        }
        $scope.LSA = function () {
            $state.go('app.MstCadConsolidatedLSAReport');
        }
        $scope.DocumentChecklist = function () {
            $state.go('app.MstCadConsolidatedDocumentChecklistReport');
        }
        $scope.SoftcopyVetting = function () {
            $state.go('app.MstCadConsolidatedSoftcopyVettingReport');
        }
        $scope.OriginalCopyVetting = function () {
            $state.go('app.MstCadConsolidatedOriginalCopyVettingReport');
        }
