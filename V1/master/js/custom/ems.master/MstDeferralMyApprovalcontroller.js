(function () {
    ...
    angular
        .module('angle')
        .controller('MstDeferralMyApprovalcontroller', MstDeferralMyApprovalcontroller);

    MstDeferralMyApprovalcontroller.$inject = ['DownloaddocumentService','$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstDeferralMyApprovalcontroller(DownloaddocumentService,$rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstDeferralMyApprovalcontroller';
        ...
        function activate() {
            ...
            if(lsfromphysical_document=="Y"){
                url = 'api/MstPhysicalDocument/GetInitiatedApprovalExtensionorwaiver';
            }
            else{
                url = 'api/MstScannedDocument/GetInitiatedApprovalExtensionorwaiver';
            }  
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.reject_submit = function () {
            ...
            if ($scope.lblfromphysical_document == 'Y')
                url = 'api/MstPhysicalDocument/PostPhysicalextenstionwaiverApproval';
            else
                url = 'api/MstScannedDocument/PostextenstionwaiverApproval';
            lockUI();
