(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditStatusSummaryController', MstCreditStatusSummaryController);

        MstCreditStatusSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCreditStatusSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditStatusSummaryController';
        ...
        function activate() {
            ...
            var url = 'api/MstCreditStatusAdd/GetbuyerToCreditSummary';
               SocketService.get(url).then(function (resp) {
        ...
        $scope.Addcredit_status = function (val, val1) {
            ...
            localStorage.setItem('lspage', 'CreditStatusSummary');
