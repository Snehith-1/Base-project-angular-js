(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditInstitutionDtlEditController', MstCreditInstitutionDtlEditController);

    MstCreditInstitutionDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstCreditInstitutionDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditInstitutionDtlEditController ';
        ...
        function activate() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIntitutionTempClear';
            lockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionGSTList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionMobileNoList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionEmailAddressList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionAddressList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionLicenseList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionDocumentList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionForm60DocumentList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionDetailsEdit';
            ...
            var url = 'api/MstAppCreditUnderWriting/GetInstitutionEquipmentHoldingList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstequipmentholding_list = resp.data.mstequipmentholding_list;
            });

            var url = 'api/MstAppCreditUnderWriting/GetInstitutionLivestockList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstlivestockholding_list = resp.data.mstlivestockholding_list;
            });

            var url = 'api/MstAppCreditUnderWriting/GetInstitutionReceivableList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            if ($scope.txtpan_number.length == 10) {
                ...
                SocketService.post(url, params).then(function (resp) {
                    ...
                    if (resp.data.statusCode == 101) {
                        ...
                        var url = 'api/MstAppCreditUnderWriting/PostInstitutionGSTList';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        function license_list() {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionLicenseTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutionlicense_list = resp.data.mstlicense_list;
        ...
        function institutiongstlist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionGSTTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutiongst_list = resp.data.mstgst_list;
        ...
        function institutionmobilenolist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionMobileNoTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutionmobileno_list = resp.data.mstmobileno_list;
        ...
        function institutionmail_list() {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionEmailAddressTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutionemailaddress_list = resp.data.mstemailaddress_list;
        ...
        function institutionaddresslist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionAddressTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutionaddress_list = resp.data.mstaddress_list;
        ...
        $scope.gstnumber_add = function () {
            if (($scope.rdbgstregistered == undefined) || ($scope.rdbgstregistered == '') || ($scope.txtgst_state == undefined) || ($scope.txtgst_state == '') || ($scope.txtgst_number == undefined) || ($scope.txtgst_number == '')) {
                ...
                var url = 'api/MstAppCreditUnderWriting/PostInstitutionGST';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.edit_gstdetails = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditInstitutionGST';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_gst = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateInstitutionGST';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deletegst_details = function (institution2branch_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionGST';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Form60DocumentUpload = function () {
            ...
            if (fi.files.length > 0) {
                ...
                var url = 'api/MstAppCreditUnderWriting/InstitutionEditForm_60DocumentUpload';
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    var url = "api/MstAppCreditUnderWriting/InstitutionEditForm60TmpList";
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.institutionform60upload_list = resp.data.institutionupload_list;
                    });
        ...
        $scope.uploaddocumentform60cancel = function (institution2form60documentupload_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionEditForm_60DocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                var params = {
                    institution_gid: $scope.institution_gid
                }
        ...
        $scope.institutionmobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimarymobile_no == undefined) || ($scope.rdbprimarywhatsapp_no == undefined)) {
                ...
                var url = 'api/MstAppCreditUnderWriting/PostInstitutionMobileNo';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionmobileno_edit = function (institution2mobileno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditInstitutionMobileNo';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateInstitutionMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.institutionmobileno_delete = function (institution2mobileno_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.institutionmaildetails_add = function () {
            if (($scope.txtinstitution_emailaddress == undefined) || ($scope.txtinstitution_emailaddress == '') || ($scope.rdbemailprimarymobile_no == undefined)) {
                ...
                var url = 'api/MstAppCreditUnderWriting/PostInstitutionEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionemailaddress_edit = function (institution2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditInstitutionEmailAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateInstitutionEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.institutionmaildetails_delete = function (institution2email_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addaddress = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/PostInstitutionAddressDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.editinstitution_address = function (institution2address_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditInstitutionAddressDetail';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_address = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateInstitutionAddressDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteinstitution_address = function (institution2address_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionAddressDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.institutionDoc_upload = function () {
            ...
            if ($scope.uploadfrm != undefined) {
                lockUI();
                var url = 'api/MstAppCreditUnderWriting/InstitutionEditDocumentUpload';
                ...
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    var url = "api/MstAppCreditUnderWriting/InstitutionEditDocumentTmpList";
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.institutionupload_list = resp.data.institutionupload_list;
                    });
        ...
        $scope.upload_documentcancel = function (institution2documentupload_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/InstitutionEditDocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                var params = {
                    institution_gid: $scope.institution_gid
                }
        ...
        $scope.licensetype_add = function () {
            ...
            if (($scope.cboLicenseType.licensetype_name == '') || ($scope.cboLicenseType.licensetype_name == undefined) || ($scope.txtnumber == '') || ($scope.txtnumber == undefined) || ($scope.txtissue_date == '') || ($scope.txtissue_date == undefined) || ($scope.txtexpiry_date == '') || ($scope.txtexpiry_date == undefined)) {
                ...
                var url = 'api/MstAppCreditUnderWriting/PostInstitutionLicenseDetail';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.editinstitution_licensetype = function (institution2licensedtl_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditInstitutionLicenseDetail';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                if ($scope.txteditissue_date > $scope.txteditExpiryDate) {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateInstitutionLicenseDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteinstitution_licensetype = function (institution2licensedtl_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionLicenseDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.update_institutiondtl = function () {
            if ($scope.rdburn_status == 'Yes' && ($scope.txt_urn == '' || $scope.txt_urn == undefined || $scope.txt_urn == null)) {
                ...
                var url = 'api/MstAppCreditUnderWriting/UpdateInstitutionDtl';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.addequipment_holding = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.equipment_submit = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/PostInstitutionEquipmentHolding';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteequipment_holding = function (institution2equipment_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionEquipmentHolding';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.equipment_View = function (institution2equipment_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/GetEquipmentHoldingView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        function equipmentholding_list() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetEditInstitutionEquipmentHoldingList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstequipmentholding_list = resp.data.mstequipmentholding_list;
        ...
        $scope.addlivestock_holding = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.livestock_submit = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/PostInstitutionLivestock';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deletelivestock_holding = function (institution2livestock_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteInstitutionLivestock';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.livestock_View = function (institution2livestock_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/GetLivestockHoldingView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        function livestock_list() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetEditInstitutionLivestockList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstlivestockholding_list = resp.data.mstlivestockholding_list;
        ...
        $scope.headoffice_confirm = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                $scope.headoffice_submit = function () {
                    ...
                    lockUI();
                    var url = 'api/MstAppCreditUnderWriting/UpdateGSTHeadOffice';
                    SocketService.post(url, params).then(function (resp) {
                        if (resp.data.status == true) {
                            unlockUI();
                            Notify.alert(resp.data.message, {
        ...
        $scope.downloadallUnderwriting = function () {
