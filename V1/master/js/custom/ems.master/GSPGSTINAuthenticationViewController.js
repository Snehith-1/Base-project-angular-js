(function () {
    ...
    angular
        .module('angle')
        .controller('GSPGSTINAuthenticationViewController', GSPGSTINAuthenticationViewController);

    GSPGSTINAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function GSPGSTINAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'GSPGSTINAuthenticationViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstAPIVerifications/GSTVerificationViewDetails';
