(function () {
    ...
    angular
        .module('angle')
        .controller('MstDisbursementODBelow30Controller', MstDisbursementODBelow30Controller);

    MstDisbursementODBelow30Controller.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstDisbursementODBelow30Controller($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstDisbursementODBelow30Controller';
        ...
        function activate() {
            ...
            var url = 'api/MstCreditOpsApplication/GetDisbursementODBelow30Summary';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                $scope.disbursementodbelow30_list = resp.data.disbursementodbelow30_list;
                unlockUI();
            });

            var url = 'api/MstCreditOpsApplication/GetDisbursementODBelow30ApprovalConfigSummary';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                $scope.disbursementodbelow30approvalconfig_list = resp.data.disbursementodbelow30approvalconfig_list;
                unlockUI();
            });
        ...
        $scope.disbursementodbelow30_submit = function () {
            var params = {
                vertical_gid: vertical_gid,
                wef_date: $scope.txtwef_date,
                customer_type: $scope.cbocustomer_type
            }
            var url = 'api/MstCreditOpsApplication/PostDisbursementODBelow30';
            lockUI();
        ...
        $scope.approval_config = function (disbursementodbelow30_gid) {
            var disbursementodbelow30_gid = disbursementodbelow30_gid;
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                var params = {
                    disbursementodbelow30_gid: disbursementodbelow30_gid
                }
                ...
                $scope.disbursementodbelow30approval_submit = function () {
                    ...
                    var url = 'api/MstCreditOpsApplication/PostDisbursementODBelow30ApprovalConfig';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.Status_update = function (disbursementodbelow30_gid) {
            var modalInstance = $modal.open({
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCreditOpsApplication/GetDisbursementODBelow30View';
                SocketService.getparams(url, params).then(function (resp) {
                    $scope.disbursementodbelow30_gid = resp.data.disbursementodbelow30_gid
                    $scope.lblwef_date = resp.data.wef_date;
                    $scope.lblcustomer_type = resp.data.customer_type;
                    $scope.rbodisbursementodbelow30_status = resp.data.disbursementodbelow30_status;
                });
                ...
                $scope.update_status = function () {
                    ...
                    var params = {
                        ...
                        disbursementodbelow30_status: $scope.rbodisbursementodbelow30_status,
                        wef_date: $scope.lblwef_date,
                        customer_type: $scope.lblcustomer_type,
                        vertical_gid: vertical_gid
                    }
                    var url = 'api/MstCreditOpsApplication/PostDisbursementODBelow30Inactive';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
                ...
                var url = 'api/MstCreditOpsApplication/GetDisbursementODBelow30InactiveLogview';
                lockUI();
                SocketService.getparams(url, param).then(function (resp) {
                    $scope.disbursementodbelow30log_list = resp.data.disbursementodbelow30log_list;
                    unlockUI();
                });
        ...
        $scope.approvalconfig_edit = function (disbursementodbelow30approvalconfig_gid) {
            var disbursementodbelow30approvalconfig_gid = disbursementodbelow30approvalconfig_gid;
            var modalInstance = $modal.open({
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var params = {
                    disbursementodbelow30approvalconfig_gid: disbursementodbelow30approvalconfig_gid
                }
                var url = 'api/MstCreditOpsApplication/GetDisbursementODBelow30Edit';
                SocketService.getparams(url, params).then(function (resp) {
                    $scope.disbursementodbelow30_gid = resp.data.disbursementodbelow30_gid;
                    var params = {
                        disbursementodbelow30_gid: $scope.disbursementodbelow30_gid
                    }
                    var url = 'api/MstCreditOpsApplication/GetDeviationApprovalGroupName';
                    lockUI();
                    SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.disbursementodbelow30_update = function () {
                    ...
                    var url = 'api/MstCreditOpsApplication/PostDisbursementODBelow30Update';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
