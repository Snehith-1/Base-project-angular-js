(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupPSLDataFlagAddController', MstCreditGroupPSLDataFlagAddController);

    MstCreditGroupPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCreditGroupPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupPSLDataFlagAddController';
        ...
        $scope.Editpsldataflag = function () {
            $location.url('app/MstCreditGroupPSLDataFlagEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
