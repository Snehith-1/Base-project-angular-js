(function () {
    ...
    angular
        .module('angle')
        .controller('MstCcCommitteeIndividualViewController', MstCcCommitteeIndividualViewController);

        MstCcCommitteeIndividualViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService','cmnfunctionService'];

    function MstCcCommitteeIndividualViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCcCommitteeIndividualViewController';
        ...
        const lspagename = 'MstCcCommitteeIndividualView';
        ...
        function activate() {
            ...
            SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.committee_aadharnumber = maskaadhar;
    ...
    ;
        ...
        $scope.uploadeddoc_bankacctdtl = function (creditbankdtl_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.documentviewer_chequeleafdoc = function (val1, val2) {
                    lockUI();
                    var IsValidExtension = cmnfunctionService.fnCheckValidDocType(val2, "DocumentViewerFormat");
                    if (IsValidExtension == false) {
                        Notify.alert("View is not supported for this format..!", {
