(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationPendingInstitutionViewController', MstSAVerificationPendingInstitutionViewController);

    MstSAVerificationPendingInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAVerificationPendingInstitutionViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationPendingInstitutionViewController';
        ...
        $scope.back = function () {
            $state.go('app.MstSAVerificationMappingPending');
        }
