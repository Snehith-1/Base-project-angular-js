(function () {
    ...
    angular
        .module('angle')
        .controller('MstCustomer2tmpuserView', MstCustomer2tmpuserView);

    MstCustomer2tmpuserView.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function MstCustomer2tmpuserView($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCustomer2tmpuserView';
        activate();
        ...
        function activate() {
            ...
            var url = 'api/MstCustomertmp/GetCustomer2UserInfo';
