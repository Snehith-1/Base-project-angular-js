(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADGeneralDtlEditController', MstCADGeneralDtlEditController);

        MstCADGeneralDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADGeneralDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADGeneralDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADApplication/GetGeneticCodeList';
            lockUI();
            ...
            var url = 'api/MstCADApplication/GetApplicationBasicDetailsTempClear';
               lockUI();
               SocketService.get(url).then(function (resp) {
                   unlockUI();
            });

               var url = 'api/MstCADApplication/EditAppBasicDetail';
               lockUI();
            ...
            SocketService.get(url).then(function (resp) {
               ...
               var url = 'api/MstCADApplication/GetAppMobileNoList';
               lockUI();
               SocketService.getparams(url, param).then(function (resp) {
                   unlockUI();
               ...
               var url = 'api/MstCADApplication/GetAppEmailAddressList';
               lockUI();
               SocketService.getparams(url, param).then(function (resp) {
                   unlockUI();
               ...
               var url = 'api/MstCADApplication/GetAppGeneticCodeList';
               lockUI();
               SocketService.getparams(url, param).then(function (resp) {
                   unlockUI();
        ...
        $scope.mobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_mobileno == undefined) || ($scope.rdbwhatsapp_mobileno == undefined)) {
                ...
                var url = 'api/MstCADApplication/PostAppMobileNo';
                lockUI();
        ...
        function mobileno_templist() {
            ...
            var url = 'api/MstCADApplication/GetAppMobileNoTempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.mstmobileno_list = resp.data.mstmobileno_list;
        ...
        $scope.mobileno_edit = function (application2contact_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditAppMobileNo';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateAppMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.mobileno_delete = function (application2contact_gid) {
            ...
            var url = 'api/MstCADApplication/DeleteAppMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.emailaddress_add = function () {
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbprimary_emailaddress == undefined)) {
                ...
                var url = 'api/MstCADApplication/PostAppEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function emailaddress_templist() {
            ...
            var url = 'api/MstCADApplication/GetAppEmailAddressTempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.mstemailaddress_list = resp.data.mstemailaddress_list;
        ...
        $scope.emailaddress_edit = function (application2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditAppEmailAddress';
                   lockUI();
                   SocketService.getparams(url, params).then(function (resp) {
                       unlockUI();
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateAppEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.emailaddress_delete = function (application2email_gid) {
            ...
            var url = 'api/MstCADApplication/DeleteAppEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.geneticcode_add = function () {
            if (($scope.cboGeneticCode.geneticcode_name == '') || ($scope.cboGeneticCode.geneticcode_name == undefined) || ($scope.rdbgenetic_status == undefined) || ($scope.txtgenetic_remarks == '')) {
                ...
                var url = 'api/MstCADApplication/PostAppGeneticCode';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function geneticcode_templist() {
            ...
            var url = 'api/MstCADApplication/GetAppGeneticCodeTempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.mstgeneticcode_list = resp.data.mstgeneticcode_list;
        ...
        $scope.geneticcode_edit = function (application2geneticcode_gid, application_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditAppGeneticCode';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_geneticcode = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateAppGeneticCode';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.geneticcode_delete = function (application2geneticcode_gid) {
            ...
            var url = 'api/MstCADApplication/DeleteAppGeneticCode';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.basicdetail_update = function () {
            ...
            var url = 'api/MstCADApplication/UpdateAppBasicDetail';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.productdtl_add = function () {
            if (($scope.cboproduct_name == undefined) || ($scope.cboproduct_name == '') || ($scope.cboproduct_name == null) ||
               ($scope.cbovariety_name == undefined) || ($scope.cbovariety_name == undefined) || ($scope.cbovariety_name == '')) {
                ...
                var url = 'api/MstCADApplication/PostProductDetailAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function Tempproductdetaillist() {
            ...
            var url = 'api/MstCADApplication/GetAppProductTempList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstproduct_list = resp.data.mstproduct_list;
            });
        }
