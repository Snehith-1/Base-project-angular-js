(function () {
    ...
    angular
        .module('angle')
        .controller('MstIndividualCovenantDoccontroller', MstIndividualCovenantDoccontroller);

    MstIndividualCovenantDoccontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstIndividualCovenantDoccontroller($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstIndividualCovenantDoccontroller';
        ...
        $scope.addDoc_checklist = function (covenantdocumentclick) {
            ...
            if (doc_gid != undefined) {
                var url = 'api/MstCAD/PostIndividualCheckList';
                lockUI();
