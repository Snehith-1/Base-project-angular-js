(function () {
    ...
    angular
        .module('angle')
        .controller('MstDisbIndividualFarmerDtlViewController', MstDisbIndividualFarmerDtlViewController);

    MstDisbIndividualFarmerDtlViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function MstDisbIndividualFarmerDtlViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstDisbIndividualFarmerDtlViewController';

        var farmercontact_gid = localStorage.getItem('farmercontact_gid');
        ...
        function activate() {         
            ...
            var url = 'api/MstCreditOpsApplication/GetDisbFarmerIndividualView';           
