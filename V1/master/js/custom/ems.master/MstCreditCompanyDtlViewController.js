(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditCompanyDtlViewController', MstCreditCompanyDtlViewController);

    MstCreditCompanyDtlViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstCreditCompanyDtlViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditCompanyDtlViewController';
        ...
        const lspagename = 'MstCreditCompanyDtlView';
        ...
        function activate() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetCreditObservationList'; //Called this list for Bureau Deatils also
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
