...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSBAManagementIndividualCodeCreateViewController', MstSBAManagementIndividualCodeCreateViewController);

    MstSBAManagementIndividualCodeCreateViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSBAManagementIndividualCodeCreateViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSBAManagementIndividualCodeCreateViewController';
        ...
        $scope.sam_code = searchObject.sam_code;
        var sam_code = $scope.sam_code;
        ...
        $scope.back = function () {
            //$state.go("app.MstSBAIndividualManagement");
