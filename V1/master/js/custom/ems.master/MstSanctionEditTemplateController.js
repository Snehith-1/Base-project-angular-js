(function () {
    ...
    angular
        .module('angle')
        .controller('MstSanctionEditTemplateController', MstSanctionEditTemplateController);

        MstSanctionEditTemplateController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route','$modal'];

    function MstSanctionEditTemplateController($rootScope, $scope, $state, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $modal) {

        $scope.title = 'MstSanctionEditTemplateController';
        var vm = this;
