(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditIndividualExistingBankEditCotroller', MstCreditIndividualExistingBankEditCotroller);

        MstCreditIndividualExistingBankEditCotroller.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCreditIndividualExistingBankEditCotroller($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditIndividualExistingBankEditCotroller';
        ...
        function activate() { 
            ...
            var url = 'api/MstAppCreditUnderWriting/EditExistingBankFacility';
        ...
        $scope.ExistingBankacctdtl_Back = function () {
            $location.url('app/MstCreditIndividualExistingBankAdd?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + $scope.lspage);
        }
        ...
        $scope.update_ExistingBankacctdtl = function () {
            ...
            var url = 'api/MstAppCreditUnderWriting/UpdateExistingBankFacility';
            lockUI();
