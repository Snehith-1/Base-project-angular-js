(function () {
    ...
    angular
        .module('angle')
        .controller('MstScannedDeferralHistory', MstScannedDeferralHistory);

    MstScannedDeferralHistory.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstScannedDeferralHistory($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstScannedDeferralHistory';
        ...
        var lsfromphysical = $location.search().lsfromphysical;  
        ...
        function activate() {
            ...
            var url = "";
            if(lsfromphysical=="N")
              url = 'api/MstScannedDocument/GetDeferralHistorySummary';
            else
             url = 'api/MstPhysicalDocument/GetDeferralHistorySummary';
