(function () {
    ...
    angular
        .module('angle')
        .controller('MstLoanSubProductController', MstLoanSubProductController);

        MstLoanSubProductController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstLoanSubProductController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstLoanSubProductController';
        $scope.lsoneapipage = $location.search().lsoneapipage;
        var lsoneapipage = $scope.lsoneapipage;
        activate();

        function activate() { 
            var url = 'api/MstApplication360/GetLoanSubProduct';
            lockUI();
        ...
        $scope.addloansubproduct = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstApplication360/LoanProductList';
                lockUI();
                SocketService.get(url).then(function (resp) {
                ...
                $scope.submit = function () {
                    ...
                    var url = 'api/MstApplication360/CreateLoanSubProduct';
                    lockUI();
        ...
        $scope.editloansubproduct = function (loansubproduct_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                SocketService.get(url).then(function (resp) {
                 ...
                 var url = 'api/MstApplication360/EditLoanSubProduct';
                ...
                $scope.update = function () {
                    ...
                    var url = 'api/MstApplication360/UpdateLoanSubProduct';
                    var params = {
        ...
        $scope.Status_update = function (loansubproduct_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.update_status = function () {
                    ...
                    var url = 'api/MstApplication360/InactiveLoanSubProduct';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
                ...
                var url = 'api/MstApplication360/LoanSubProductInactiveLogview';
                lockUI();
             ...
             var params = {
                loansubproduct_gid: loansubproduct_gid
                    ...
                    SweetAlert.swal({
                        ...
                        if (isConfirm) {
                            lockUI();
                            var url = 'api/MstApplication360/DeleteLoanSubProduct';
                            SocketService.getparams(url, params).then(function (resp) {
                                unlockUI();
                                if (resp.data.status == true) {
