(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADPendingIndividualDtlAddController', MstCADPendingIndividualDtlAddController);

    MstCADPendingIndividualDtlAddController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll', 'DownloaddocumentService','cmnfunctionService'];

        function MstCADPendingIndividualDtlAddController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll, DownloaddocumentService,cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADPendingIndividualDtlAddController';       
        activate();
