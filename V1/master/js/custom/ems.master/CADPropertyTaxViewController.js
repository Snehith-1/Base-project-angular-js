(function () {
    ...
    angular
        .module('angle')
        .controller('CADPropertyTaxViewController', CADPropertyTaxViewController);

    CADPropertyTaxViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADPropertyTaxViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADPropertyTaxViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADAPIVerifications/PropertyTaxViewDetails';
