(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditIndividualRepaymentAddController', MstCreditIndividualRepaymentAddController);

        MstCreditIndividualRepaymentAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function MstCreditIndividualRepaymentAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditIndividualRepaymentAddController';
       ...
       lockUI();
        ...
        $scope.creditrepayment_edit = function (creditrepaymentdtl_gid) {
            $location.url('app/MstCreditIndividualRepaymentEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&creditrepaymentdtl_gid=' + creditrepaymentdtl_gid + '&lspage=' + lspage);
        }
