...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationIndividualMakerTrashViewController', MstSAVerificationIndividualMakerTrashViewController);

    MstSAVerificationIndividualMakerTrashViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAVerificationIndividualMakerTrashViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationIndividualMakerTrashViewController';
        ...
        $scope.back = function () {
            ...
            if (lspage == 'IndividualPending') {
                $location.url('app/MstSAVerificationMakerIndividualDistractSummary');
            }
