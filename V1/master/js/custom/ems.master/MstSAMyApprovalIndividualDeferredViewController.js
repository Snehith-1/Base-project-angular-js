...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAMyApprovalIndividualDeferredViewController', MstSAMyApprovalIndividualDeferredViewController);

    MstSAMyApprovalIndividualDeferredViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAMyApprovalIndividualDeferredViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAMyApprovalIndividualDeferredViewController';
