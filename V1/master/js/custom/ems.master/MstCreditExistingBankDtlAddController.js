(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditExistingBankDtlAddController', MstCreditExistingBankDtlAddController);

    MstCreditExistingBankDtlAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce','cmnfunctionService'];

    function MstCreditExistingBankDtlAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditExistingBankDtlAddController';
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/MstCreditExistingBankDtlEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
