(function () {
    ...
    angular
        .module('angle')
        .controller('MstRMWaiverApprovalHistoryViewController', MstRMWaiverApprovalHistoryViewController);

    MstRMWaiverApprovalHistoryViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','DownloaddocumentService'];

    function MstRMWaiverApprovalHistoryViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstRMWaiverApprovalHistoryViewController';
