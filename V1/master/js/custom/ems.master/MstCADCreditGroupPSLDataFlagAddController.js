(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditGroupPSLDataFlagAddController', MstCADCreditGroupPSLDataFlagAddController);

    MstCADCreditGroupPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCADCreditGroupPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditGroupPSLDataFlagAddController';
        ...
        $scope.Editpsldataflag = function () {
            $location.url('app/MstCADCreditGroupPSLDataFlagEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
