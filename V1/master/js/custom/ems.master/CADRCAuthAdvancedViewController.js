(function () {
    ...
    angular
        .module('angle')
        .controller('CADRCAuthAdvancedViewController', CADRCAuthAdvancedViewController);

    CADRCAuthAdvancedViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADRCAuthAdvancedViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADRCAuthAdvancedViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADAPIVerifications/RCAuthAdvancedViewDetails';
