(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADPSLCSADataFlaggingAddController', MstCADPSLCSADataFlaggingAddController);

        MstCADPSLCSADataFlaggingAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCADPSLCSADataFlaggingAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADPSLCSADataFlaggingAddController';
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/MstCADPSLCSADataFlaggingEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=' + lspage);
        }
