(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingInstitutionViewController', MstSAOnboardingInstitutionViewController);

    MstSAOnboardingInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAOnboardingInstitutionViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
    /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingInstitutionViewController';
               ...
               SocketService.getparams(url, param).then(function (resp) {
                 //  $scope.cbosatype = resp.data.satype_gid;
                  ...
                  // $scope.cboDesignation = resp.data.designation_gid;
                   ...
                   $scope.txtreferred_by = resp.data.referred_by;
