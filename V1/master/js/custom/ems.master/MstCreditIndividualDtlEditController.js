(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditIndividualDtlEditController', MstCreditIndividualDtlEditController);

        MstCreditIndividualDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstCreditIndividualDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditIndividualDtlEditController';
        ...
        function activate() {
            ...
            SocketService.post(url, param).then(function (resp) {
             ...
             var url = 'api/MstAppCreditUnderWriting/GetIndividualTempClear';
             lockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIndividualMobileNoList';
           lockUI();
           SocketService.getparams(url, param).then(function (resp) {
               unlockUI();
           ...
           var url = 'api/MstAppCreditUnderWriting/GetIndividualEmailAddressList';
          lockUI();
          SocketService.getparams(url, param).then(function (resp) {
              unlockUI();
          ...
          var url = 'api/MstAppCreditUnderWriting/GetIndividualAddressList';
          lockUI();
          SocketService.getparams(url, param).then(function (resp) {
              unlockUI();
          ...
          var url = 'api/MstAppCreditUnderWriting/GetIndividualProofList';
          lockUI();
          SocketService.getparams(url, param).then(function (resp) {
              unlockUI();
          ...
          var url = 'api/MstAppCreditUnderWriting/GetIndividualDocList';
          lockUI();
          SocketService.getparams(url, param).then(function (resp) {
              unlockUI();
           ...
           var url = 'api/MstAppCreditUnderWriting/GetContactEquipmentHoldingList';
           SocketService.getparams(url, param).then(function (resp) {
               $scope.mstequipmentholding_list = resp.data.mstequipmentholding_list;
           });

           var url = 'api/MstAppCreditUnderWriting/GetContactLivestockList';
           SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/MstAppCreditUnderWriting/EditIndividual';
            ...
            var url = 'api/MstAppCreditUnderWriting/GetPANForm60List';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/EditPANAbsenceReasonList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstAppCreditUnderWriting/ContactPANAbsenceReasonList';
           lockUI();
           SocketService.getparams(url, param).then(function (resp) {
               unlockUI();
        ...
        $scope.pandtl_update = function () {
            ...
            var url = 'api/MstAppCreditUnderWriting/UpdatePANAbsenceReasons';
            lockUI();
    ...
    /*    $scope.PANAadhaarLink = function () {
        ...
        $scope.IndividualPANForm60DocumentUpload = function (val, val1, name) {
            ...
            if ($scope.uploadfrm != undefined) {
                var url = 'api/MstAppCreditUnderWriting/PANForm60DocumentUpload';
                lockUI();
        ...
        function panform60_templist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetPANForm60TempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.contactpanform60_list = resp.data.contactpanform60_list;
        ...
        $scope.IndividualPANForm60DocumentDelete = function (contact2panform60_gid) {
            ...
            lockUI();
            var url = 'api/MstAppCreditUnderWriting/PANForm60Delete';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.individualmobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_status == undefined) || ($scope.rdbwhatsapp_no == undefined) || ($scope.rdbwhatsapp_no == '') || ($scope.rdbprimary_status == '')) {
                ...
                var url = 'api/MstAppCreditUnderWriting/PostIndividualMobileNumber';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function mobileno_templist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIndividualMobileNoTempList';
           lockUI();
           SocketService.getparams(url, param).then(function (resp) {
           unlockUI();
                $scope.contactmobileno_list = resp.data.contactmobileno_list;
        ...
        $scope.individualmobileno_edit = function (contact2mobileno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditIndividualMobileNo';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateIndividualMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.individualmobileno_delete = function (contact2mobileno_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteIndividualMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.individualemail_add = function () {
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbemailprimary_status == undefined) || ($scope.rdbemailprimary_status == '')) {
                ...
                var url = 'api/MstAppCreditUnderWriting/PostIndividualEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function email_templist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIndividualEmailAddressTempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.contactemail_list = resp.data.contactemail_list;
        ...
        $scope.individualemail_edit = function (contact2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditIndividualEmailAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateIndividualEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.individualemail_delete = function (contact2email_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteIndividualEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.address_add = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/PostIndividualAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        function address_templist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIndividualAddressTempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.contactaddress_list = resp.data.contactaddress_list;
        ...
        $scope.address_edit = function (contact2address_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/EditIndividualAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.address_update = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/UpdateIndividualAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.address_delete = function (contact2address_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteIndividualAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
       ...
       $scope.idproofdocument_upload = function (val, val1, name) {
        ...
        function idproof_templist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIndividualProofTempList';
           lockUI();
           SocketService.getparams(url, param).then(function (resp) {
               unlockUI();
                $scope.contactidproof_list = resp.data.contactidproof_list;
        ...
        $scope.idproof_delete = function (contact2idproof_gid) {
            ...
            lockUI();
            var url = 'api/MstAppCreditUnderWriting/IndividualProofDelete';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
        ...
        $scope.individualdocument_add = function () {
            ...
            if ($scope.uploadfrm != undefined) {
                lockUI();
                var url = 'api/MstAppCreditUnderWriting/IndividualDocumentUpload';
        ...
        function individualdoc_templist() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetIndividualDocTempList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.uploadindividualdoc_list = resp.data.uploadindividualdoc_list;
        ...
        $scope.individualdocument_delete = function (contact2document_gid) {
            ...
            lockUI();
            var url = 'api/MstAppCreditUnderWriting/IndividualDocDelete';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.upload_list = resp.data.upload_list;
                if (resp.data.status == true) {
        ...
        $scope.update_individual = function () {
            ...
            if ($scope.rdburn_status == 'Yes' && ($scope.txt_urn == '' || $scope.txt_urn == undefined || $scope.txt_urn == null)) {
                ...
                var url = 'api/MstAppCreditUnderWriting/UpdateIndividual';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.addequipment_holding = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.equipment_submit = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/PostContactEquipmentHolding';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteequipment_holding = function (contact2equipment_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteContactEquipmentHolding';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.equipment_View = function (contact2equipment_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/GetContactEquipmentHoldingView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        function equipmentholding_list() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetEditContactEquipmentHoldingList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstequipmentholding_list = resp.data.mstequipmentholding_list;
        ...
        $scope.addlivestock_holding = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.livestock_submit = function () {
                    ...
                    var url = 'api/MstAppCreditUnderWriting/PostContactLivestock';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deletelivestock_holding = function (contact2livestock_gid) {
            ...
            var url = 'api/MstAppCreditUnderWriting/DeleteContactLivestock';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.livestock_View = function (contact2livestock_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstAppCreditUnderWriting/GetContactLivestockHoldingView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        function livestock_list() {
            ...
            var url = 'api/MstAppCreditUnderWriting/GetEditContactLivestockList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstlivestockholding_list = resp.data.mstlivestockholding_list;
