(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualDtlViewController', MstCADCreditIndividualDtlViewController);

    MstCADCreditIndividualDtlViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

        function MstCADCreditIndividualDtlViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualDtlViewController';
        ...
        const lspagename = 'MstCADCreditIndividualDtlView';
