(function () {
    ...
    angular
        .module('angle')
        .controller('MstPSLCSAGroupPSLDataFlagEditController', MstPSLCSAGroupPSLDataFlagEditController);

        MstPSLCSAGroupPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstPSLCSAGroupPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPSLCSAGroupPSLDataFlagEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstPSLCSAGroupPSLDataFlagAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
