...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationInstitutionCheckerTrashViewController', MstSAVerificationInstitutionCheckerTrashViewController);

    MstSAVerificationInstitutionCheckerTrashViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAVerificationInstitutionCheckerTrashViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationInstitutionCheckerTrashViewController';
        ...
        $scope.back = function () {
            ...
            if (lspage == 'InstitutePending') {
                $location.url('app/MstSAVerificationInstitutionCheckerDistractSummary');
            }
