(function () {
    ...
    angular
        .module('angle')
        .controller('MstSABussDevtIndividualDeferredSummaryController', MstSABussDevtIndividualDeferredSummaryController);

    MstSABussDevtIndividualDeferredSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSABussDevtIndividualDeferredSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSABussDevtIndividualDeferredSummaryController';
        ...
        $scope.view = function (sacontact_gid) {
            $location.url('app/MstSAOnboardingIndividualBDView?lssacontact_gid=' + sacontact_gid);
        }
        ...
        $scope.viewdeferred = function (sacontact_gid) {
            $location.url('app/MstSABussDevtIndividualDeferredView?hash=' + cmnfunctionService.encryptURL('lssacontact_gid=' + sacontact_gid));
        }
