(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADServicesDtlEditController', MstCADServicesDtlEditController);

        MstCADServicesDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCADServicesDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADServicesDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADApplication/ServicechargeEdit';
        ...
        $scope.update_ServiceCharges = function () {
            ...
            var url = 'api/MstCADApplication/ServicechargeUpdate';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                ...
                if (resp.data.status == true) {
                    ...
                    if (lspage == "StartCreditUnderwriting") {
                        ...
                        $location.url('app/MstCADProductChargesDtlEdit?application_gid=' + application_gid + '&lspage=' + lspage);
                    }
                    else {
