(function () {
    ...
    angular
        .module('angle')
        .controller('MstApplicationAssignmentSummaryController', MstApplicationAssignmentSummaryController);

    MstApplicationAssignmentSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstApplicationAssignmentSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstApplicationAssignmentSummaryController';
        lockUI();
        activate();
        function activate() {
            var url = 'api/MstApplicationAdd/GetAppPendingAssignmentSummary';
        ...
        $scope.applcreation_view = function (val) {
            $location.url('app/MstApplicationCreationView?application_gid=' + val + '&lstab=Pencreditmapping');
        }
