(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationInstPendingSummaryController', MstSAVerificationInstPendingSummaryController);

    MstSAVerificationInstPendingSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAVerificationInstPendingSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
    /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationInstPendingSummaryController';
        ...
        function activate() { 
            var url = 'api/MstSAOnboardingInstitution/GetSAVerfiyPendingSummary';
            lockUI();
        ...
        $scope.saonboardingverification = function (sacontactinstitution_gid) {
            ...
            $location.url('app/MstSAOnboardingInstitutionVerification?hash=' + cmnfunctionService.encryptURL('lssacontactinstitution_gid=' + sacontactinstitution_gid + '&lspage=InstitutePending'));
        }
    }
})();
