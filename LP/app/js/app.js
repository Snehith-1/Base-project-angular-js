...
(function() {
    ...
    function LoginFormController($rootScope, $scope, $state, $cookies, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        ...
        function activate() {
            var name = 'token';
            document.cookie = name + '=; Application=/; Expires=Thu, 01 Jan 2020 00:00:01 GMT;';
          ...
          vm.login = function () {
              ...
              if (vm.loginForm.$valid) {
                  ...
                  var url = 'api/Login/lawyerUserLogin';
                  lockUI();
                  SocketService.post(url, params).then(function (resp) {
                      if (resp.data.user_gid != "") {
                          $cookies.putObject('token', resp.data.token);
                          localStorage.setItem('lawyeruser_gid', resp.data.user_gid);
...
(function () {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider
         ...
         .state('app.documentCompliance', {
             url: '/documentCompliance',
             title: 'documentCompliance',
             templateUrl: helper.basepath('ems.lp/documentCompliance.html'),
             resolve: helper.resolveFor('oitozero.ngSweetAlert', 'ui.select', 'ngTable', 'ngDialog', 'datatables')
         })

             .state('app.documentComplianceView', {
                 url: '/documentComplianceView',
                 title: 'documentComplianceView',
                 templateUrl: helper.basepath('ems.lp/documentComplianceView.html'),
...
(function () {
    ...
    function invoiceCreatecontroller($rootScope, $scope, $state, $cookies, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, $route) {
        ...
        $scope.delete = function (tmpinvoice_documentgid) {
            var params = {
                tmpinvoice_documentgid: tmpinvoice_documentgid
            }
...
(function () {
    ...
    function invoiceViewcontroller($rootScope, $scope, $state, $cookies, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, $route) {
        ...
        function activate() {
            ...
            var params = {
                lawyerinvoice_gid: localStorage.getItem('lawyerinvoice_gid')
            }
