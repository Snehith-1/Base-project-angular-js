(function () {
    ...
    angular
        .module('angle')
        .controller('externalvisitReportCancelcontroller', externalvisitReportCancelcontroller);

        externalvisitReportCancelcontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', '$route', '$cookies', '$filter', 'ngTableParams', '$timeout'];

    function externalvisitReportCancelcontroller($rootScope, $scope, $state, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, $route, $cookies, $filter, ngTableParams, $timeout) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'externalvisitReportCancelcontroller';
        ...
        function activate() {
            ...
            SocketService.getparams(url, allocationdtl_gid).then(function (resp) {
                ...
                if (resp.data.requestedamount_byclient != "") {
                ...
                if (resp.data.disbursement_amount != "") {
                ...
                if (resp.data.totalloan_outstanding != "") {
                ...
                if (resp.data.total_disbursementamount != "") {
