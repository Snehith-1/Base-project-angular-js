...
{
    public class MdlMstHRLoanRequestCompleted : result
     {
       
        public List<hrloanrequestCompleted> hrloanrequestCompleted { get; set; }
        public List<hrloanrequestRejected> hrloanrequestRejected { get; set; }       
    ...
    public class hrloanrequestCompleted : result
    {
    ...
    public class hrloanrequestRejected : result
    {
