...
using System.Web;
/// <summary>
/// (It's used for Admin) Admin Model Class accessed by API methods from related DataAccess class and is returning relevant response to client.
/// </summary>
...
namespace ems.master.Models
{
    ...
    public class MdlCreditHistoryLog : result
    {
        ...
        public List<creditmanagerhistorylog_list> creditmanagerhistorylog_list { get; set; }
    ...
    public class creditmanagerhistorylog_list : result
    {
        public string application_gid { get; set; }
        public string rejected_by { get; set; }
        public string rejected_date { get; set; }
        ...
        public string approval_status { get; set; }
        public string creditmanagerrejectrevokereasonlog_gid { get; set; }
        public string creditmanagerrevokelog_gid { get; set; }
