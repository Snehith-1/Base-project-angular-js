...
/// <summary>
/// (It's used for CrimeCheckAPI) CrimeCheckAPI Model Class accessed by API methods from related DataAccess class and is returning relevant response to client.
/// </summary>
