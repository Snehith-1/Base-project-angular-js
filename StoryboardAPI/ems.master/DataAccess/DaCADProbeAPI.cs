...
/// <summary>
/// (It's used for CADProbeAPI) CADProbeAPI DataAccess Class accessed by API methods from related Controller class and is returning relevant response to client.
/// </summary>
/// <remarks>Written by Praveen Raj</remarks>

namespace ems.master.DataAccess
{
    public class DaCADProbeAPI
    {
        ...
        public MdlBaseDetailsResponse DaGetBaseDetails(string employee_gid, MdlBaseDetailsRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedetails where institution_gid='" + Values.institution_gid + "' and api_name='Base Details'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                response.Content = response.Content.Replace("'", "");

                msGetGid = objcmnfunctions.GetMasterGID("IPDT");
                msSQL = " insert into ocs_trn_tcadinstitutionprobedetails(" +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into ocs_trn_tcadinstitutionprobedetailslog(" +
        ...
        public void DaInstitutionProbeList(string institution_gid, MdlInstitutionProbe values)
        {
            msSQL = "  select institutionprobedetails_gid,api_name,apicall_status, date_format(created_date,'%d-%m-%Y %h:%i %p') as created_date" +
                    " from ocs_trn_tcadinstitutionprobedetails where institution_gid='" + institution_gid + "'";
        ...
        public MdlComprehensiveDetailsResponse DaGetComprehensiveDetails(string employee_gid, MdlComprehensiveDetailsRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedetails where institution_gid='" + Values.institution_gid + "' and api_name='Comprehensive Details'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public MdlDataStatusResponse DaGetDataStatus(string employee_gid, MdlDataStatusRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedetails where institution_gid='" + Values.institution_gid + "' and api_name='Data Status'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public MdlDocDetailsResponse DaGetArticleOfAssociationDoc(string employee_gid, MdlComprehensiveDetailsRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedocumentdetails where institution_gid='" + Values.institution_gid + "' and api_name='Article of Association'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msGetGid = objcmnfunctions.GetMasterGID("IPDD");
                msSQL = " insert into ocs_trn_tcadinstitutionprobedocumentdetails(" +
                ...
                {
                    msGetGidLog = objcmnfunctions.GetMasterGID("PDTL");
                    msSQL = " insert into ocs_trn_tcadinstitutionprobedocumentdetailslog(" +
        ...
        public void DaInstitutionProbeDocList(string institution_gid, MdlInstitutionProbeDoc values)
        {
            msSQL = " select institutionprobedocumentdetails_gid,api_name,probedocument_name,date_format(created_date,'%d-%m-%Y %h:%i %p') as created_date," +
                    " probedocument_path from ocs_trn_tcadinstitutionprobedocumentdetails " +
        ...
        public MdlDocDetailsResponse DaGetMemorandumOfAssociationDoc(string employee_gid, MdlProbeDocDetailsRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedocumentdetails where institution_gid='" + Values.institution_gid + "' and api_name='Certificate Of Incorporation'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public MdlDocDetailsResponse DaGetFormMGT7Doc(string employee_gid, MdlProbeDocDetailsRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedocumentdetails where institution_gid='" + Values.institution_gid + "' and api_name='MGT-7 Form'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public MdlDocDetailsResponse DaGetFormAOC4Doc(string employee_gid, MdlProbeDocDetailsRequest Values)
        {
            ...
            try
            {
                msSQL = "SELECT response FROM ocs_trn_tcadinstitutionprobedetails a where institution_gid='" + Values.institution_gid + "' and api_name='Comprehensive Details'";
                ...
                msSQL = "delete from ocs_trn_tcadinstitutionprobedocumentdetails where institution_gid='" + Values.institution_gid + "' and api_name='AOC-4 Form'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaInstitutionProbeLogList(string application_gid, MdlInstitutionProbe values)
        {
            msSQL = "  select institutionprobedetailslog_gid,api_name,apicall_status, date_format(created_date,'%d-%m-%Y %h:%i %p') as created_date" +
                    " from ocs_trn_tcadinstitutionprobedetailslog where application_gid='" + application_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaInstitutionProbeDocLogList(string application_gid, MdlInstitutionProbeDoc values)
        {
            msSQL = " select institutionprobedocumentdetailslog_gid,api_name,apicall_status,date_format(created_date,'%d-%m-%Y %h:%i %p') as created_date" +
                    " from ocs_trn_tcadinstitutionprobedocumentdetailslog " +
