...
/// <summary>
/// (It's used for pages in CC member and CC group master )CCMember DataAccess Class accessed by API methods from related Controller class and is returning relevant response to client.
/// </summary>
/// <remarks>Written by Sumala,Logapriya and Abilash</remarks>

namespace ems.master.DataAccess
{
    public class DaMstCCMemeber
    {
        ...
        public bool Dapostccgroup(string employee_gid, ccgroupname values)
        {
            ...
            msGetGid = objcmnfunctions.GetMasterGID("CCMR");
            msGetAPICode = objcmnfunctions.GetApiMasterGID("CCGN");
        ...
        public void DaGetccgroup(ccgroupname objccmember)
        {
            try
            {
                msSQL = " select ccgroupname_gid,api_code,ccgroup_code,ccgroup_name from ocs_mst_tccgroupname order by ccgroupname_gid desc ";
