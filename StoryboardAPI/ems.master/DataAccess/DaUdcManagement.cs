...
namespace ems.master.DataAccess
{
    public class DaUdcManagement
    {
        ...
        string msSQL, msGetGid, msGetUdcGid, msGetDocumentGid, lsapp_refno, lspath, lsmakersummary_flag, msGetAPICode;
        int mnResult;
        ...
        public void DaPostChequeDetail(string employee_gid, MdlCheque values)
        {
            ...
            msGetAPICode = objcmnfunctions.GetApiMasterGID("CHQM");
            msSQL = " insert into ocs_mst_tudcmanagement2cheque(" +
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update ocs_mst_tcheque2document set udcmanagement2cheque_gid ='" + msGetGid + "' where udcmanagement2cheque_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_mst_tudcmanagement(" +
                        " udcmanagement_gid," +
                        " api_code," +
                        " customer_gid," +
                        " customer_name," +
        ...
        public void DaGetChequeSummary(string employee_gid, MdlCheque values)
        {
            ...
            msSQL = " select udcmanagement2cheque_gid, cheque_no, stakeholder_name, mergedbankingentity_name ,cheque_type ,cts_enabled " +
                    " from ocs_mst_tudcmanagement2cheque" +
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " delete from ocs_mst_tcheque2document where udcmanagement2cheque_gid = '" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " insert into ocs_mst_tcheque2document( " +
                                    " cheque2document_gid," +
                                    " udcmanagement2cheque_gid," +
                                    " document_gid ," +
                                    " document_name ," +
        ...
        {
            msSQL = " select cheque2document_gid ,document_name,document_path from ocs_mst_tcheque2document " +
        ...
        {
            msSQL = "delete from ocs_mst_tcheque2document where cheque2document_gid='" + cheque2document_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaUpdateChequeDetail(string employee_gid, MdlCheque values)
        {
            msSQL = " select mergedbankingentity_gid,mergedbankingentity_name,special_condition," +
                    ...
                    " from ocs_mst_tudcmanagement2cheque where udcmanagement2cheque_gid='" + values.udcmanagement2cheque_gid + "'";
            ...
            try
            {
                msSQL = " update ocs_mst_tudcmanagement2cheque set " +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into ocs_mst_tudcmanagement2chequeupdatelog(" +
        ...
        public void DaChequeDetailsEdit(string udcmanagement2cheque_gid, MdlCheque values)
        {
            try
            {
                msSQL = " select stakeholder_gid, stakeholder_name, stakeholder_type,designation,accountholder_name,account_number,bank_name,cheque_no," +
                    ...
                    " from ocs_mst_tudcmanagement2cheque where udcmanagement2cheque_gid='" + udcmanagement2cheque_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        {
            msSQL = "delete from ocs_mst_tudcmanagement2cheque where udcmanagement2cheque_gid='" + udcmanagement2cheque_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaUdcDetailsEdit(string udcmanagement_gid, MdlUdcManagement values)
        {
            try
            {
                msSQL = " select customer_gid,customer_name" +
                    " from ocs_mst_tudcmanagement where udcmanagement_gid='" + udcmanagement_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void DaUpdateUdcDetail(string employee_gid, MdlUdcManagement values)
        {
            ...
            msSQL = "update ocs_mst_tudcmanagement2cheque set udcmanagement_gid ='" + values.udcmanagement_gid + "' where udcmanagement_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetUdcSummary(string employee_gid, string application_gid, MdlUdcManagement values)
        {
            ...
            msSQL = " select d.udcmanagement2cheque_gid,a.api_code,a.udcmanagement_gid, a.customer_name , a.sanctionrefno_name, a.udc_status, date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date," +
                    " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by," +
                    " d.cheque_no,d.stakeholder_name,d.cheque_type " +
                    " from ocs_mst_tudcmanagement a" +
                    " left join hrm_mst_temployee b on b.employee_gid=a.created_by " +
                    " left join adm_mst_tuser c on c.user_gid=b.user_gid" +
                    " left join ocs_mst_tudcmanagement2cheque d on d.udcmanagement_gid=a.udcmanagement_gid " +
        ...
        {
            msSQL = "select udcmanagement2cheque_gid from ocs_mst_tudcmanagement2cheque where udcmanagement_gid ='" + udcmanagement_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            msSQL = "delete from ocs_mst_tudcmanagement where udcmanagement_gid='" + udcmanagement_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaGetUdcTempClear(string employee_gid, result values)
        {
            ...
            msSQL = "delete from ocs_mst_tudcmanagement2cheque where udcmanagement_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetChequeMakerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name,f.sanction_refno, " +
                     ...
                     " where a.process_type = 'Accept' and e.menu_gid = 'CADMGTCMS' and " +
                     " e.maker_gid = '" + employee_gid + "' and e.maker_approvalflag = 'N' and (select approver_approvalflag from ocs_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'" +
        ...
        public void DaGetChequeFollowupMakerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name,g.sanction_refno, " +
                     ...
                     " concat(c.user_firstname, ' ', c.user_lastname, ' / ', c.user_code) as cadaccepted_by, " +
                     " date_format(a.processupdated_date, '%d-%m-%Y %h:%i %p') as cadaccepted_date, a.created_by,  " +
                     " a.creditgroup_gid,e.cadgroup_name,f.approval_status as followup_status,a.customer_urn,a.renewal_flag,a.enhancement_flag from ocs_trn_tcadapplication a " +
                     " left join hrm_mst_temployee b on b.employee_gid = a.processupdated_by " +
                     " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                     " left join ocs_trn_tprocesstype_assign e on e.application_gid = a.application_gid " +
                     " left join ocs_trn_tapplication2chequelist f on f.application_gid = a.application_gid " +
                     " left join ocs_trn_tapplication2sanction g on g.application_gid = a.application_gid " +
                     " where a.process_type = 'Accept' and e.approver_approvalflag = 'N' and " +
                     "  e.menu_gid = 'CADMGTCMS' and e.maker_gid = '" + employee_gid + "'  and e.maker_approvalflag = 'Y' " +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
            if (dt_datatable.Rows.Count != 0)
        ...
        public void DaGetChequeCheckerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, f.sanction_refno, " +
                     ...
                     " left join ocs_trn_tapplication2sanction f on f.application_gid = a.application_gid " +
                     " where a.process_type = 'Accept' and e.menu_gid = 'CADMGTCMS' and " +
                     " e.checker_gid = '" + employee_gid + "' and e.checker_approvalflag = 'N'and e.maker_approvalflag = 'Y'" +
                     " and (select approver_approvalflag from ocs_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'" +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
            if (dt_datatable.Rows.Count != 0)
        ...
        public void DaGetChequeFollowupCheckerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, g.sanction_refno, " +
                     ...
                     " left join ocs_trn_tapplication2sanction g on g.application_gid = a.application_gid " +
                     " where a.process_type = 'Accept' and e.approver_approvalflag = 'N' and " +
                     " e.menu_gid = 'CADMGTCMS' and e.checker_gid = '" + employee_gid + "' and e.checker_approvalflag = 'Y' and e.maker_approvalflag = 'Y'" +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
            if (dt_datatable.Rows.Count != 0)
        ...
        public void DaGetChequeApproverSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, f.sanction_refno," +
                     ...
                     " left join ocs_trn_tprocesstype_assign e on e.application_gid = a.application_gid " +
                     " left join ocs_trn_tapplication2sanction f on f.application_gid = a.application_gid " +
                     " where a.process_type = 'Accept' and e.approver_approvalflag = 'N' " +
                     " and e.checker_approvalflag = 'Y' and e.maker_approvalflag = 'Y' and e.menu_gid = 'CADMGTCMS' and e.approver_gid = '" + employee_gid + "'" +
                     " and (select approver_approvalflag from ocs_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'" +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
        ...
        public void DaGetChequeCompletedApprover(string employee_gid, MdlUdcManagement values)
        {
            msSQL =  " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, f.sanction_refno," +
                     ...
                     " concat(c.user_firstname, ' ', c.user_lastname, ' / ', c.user_code) as cadaccepted_by, " +
                     " date_format(a.processupdated_date, '%d-%m-%Y %h:%i %p') as cadaccepted_date, a.created_by, " +
                     " a.creditgroup_gid,e.cadgroup_name,e.approver_approveddate,a.customer_urn,a.renewal_flag,a.enhancement_flag from ocs_trn_tcadapplication a " +
                     " left join hrm_mst_temployee b on b.employee_gid = a.processupdated_by " +
                     " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                     " left join ocs_mst_tudcmanagement d on d.application_gid = a.application_gid " +
                     " left join ocs_trn_tprocesstype_assign e on e.application_gid = a.application_gid " +
                     " left join ocs_trn_tapplication2sanction f on f.application_gid = a.application_gid " +                     
                     " where a.process_type = 'Accept' and e.approver_approvalflag = 'Y' and " +
                     " e.menu_gid = 'CADMGTCMS' and e.approver_gid = '" + employee_gid + "'" +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
            if (dt_datatable.Rows.Count != 0)
        ...
        {
            msSQL = " select count(a.application_gid) as MakerPendingCount from ocs_trn_tprocesstype_assign a " +
                    " left join ocs_trn_tcadapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = 'CADMGTCMS' and " +
                    " a.maker_gid = '" + employee_gid + "' and a.maker_approvalflag = 'N'  " +
                    " and (select approver_approvalflag from ocs_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'";
            values.MakerPendingCount = objdbconn.GetExecuteScalar(msSQL);

            msSQL = " select count(a.application_gid) as MakerFollowUpCount from ocs_trn_tprocesstype_assign a " +
                    " left join ocs_trn_tcadapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = 'CADMGTCMS'" +
            ...
            msSQL = " select count(a.application_gid) as CheckerPendingCount from ocs_trn_tprocesstype_assign a " +
                    " left join ocs_trn_tcadapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = 'CADMGTCMS' and " +
                    " a.checker_gid = '" + employee_gid + "' and a.checker_approvalflag = 'N' and a.maker_approvalflag = 'Y' " +
                    " and (select approver_approvalflag from ocs_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'";
            values.CheckerPendingCount = objdbconn.GetExecuteScalar(msSQL);

            msSQL = " select count(a.application_gid) as CheckerFollowUpCount from ocs_trn_tprocesstype_assign a " +
                    " left join ocs_trn_tcadapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = 'CADMGTCMS' and " +
                    " a.checker_gid = '" + employee_gid + "' and a.checker_approvalflag = 'Y' and a.maker_approvalflag = 'Y' and a.approver_approvalflag = 'N'";
            values.CheckerFollowUpCount = objdbconn.GetExecuteScalar(msSQL);

            msSQL = " select count(a.application_gid) as ApproverPendingCount from ocs_trn_tprocesstype_assign a " +
                    " left join ocs_trn_tcadapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = 'CADMGTCMS' and " +
                    " a.approver_gid = '" + employee_gid + "' and a.approver_approvalflag = 'N'" +
                    " and a.checker_approvalflag = 'Y' and a.maker_approvalflag = 'Y' " +
                    " and (select approver_approvalflag from ocs_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'";
            values.ApproverPendingCount = objdbconn.GetExecuteScalar(msSQL);

            msSQL = " select count(a.application_gid) as CompletedCount from ocs_trn_tprocesstype_assign a " +
                    " left join ocs_trn_tcadapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = 'CADMGTCMS' and " +
        ...
        public void DaPostChequeMakerSubmit(string employee_gid, Mdlmakerchequedetails values)
        {
            msSQL = " select maker_gid from ocs_trn_tprocesstype_assign a " +
                    " where a.processtype_name = 'Accept' and a.menu_gid = 'CADMGTCMS' and a.application_gid = '" + values.application_gid + "'";
            ...
            if (values.maker_gid == values.checker_gid)
            {
                if (values.maker_gid == values.approver_gid)
                {
                    ...
                    msSQL = " insert into ocs_trn_tapplication2chequelist(" +
                    ...
                    if (mnResult != 0)
                    {
                        msSQL = " update ocs_trn_tprocesstype_assign set maker_approvalflag='Y', maker_approveddate= NOW(), checker_approvalflag ='Y', checker_approveddate = NOW()," +
        ...
        public void DaPostChequeCheckerSubmit(string employee_gid, Mdlcheckerchequedetails values)
        {
            ...
            {
                msSQL = " update ocs_trn_tapplication2chequelist set checkerapproved_by='" + employee_gid + "', " +
        ...
        {
            msSQL = " update ocs_trn_tapplication2chequelist set approved_by='" + employee_gid + "', " +
                        " approved_on = '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "', " +
                        " approval_status = 'Approved', " +
                        " approval_flag = 'Y' " +
                        " where application_gid='" + values.application_gid + "'";
        ...
        public void DaGetApprovalDetails(string application_gid, MdlChequeApprovalDetails values)
        {
            try
            {
                msSQL = " select application_gid,maker_name,checker_name,approver_name," +
                        ...
                        " from ocs_trn_tprocesstype_assign a where processtype_name = 'Accept' and menu_gid = 'CADMGTCMS' and application_gid='" + application_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
