    ...
    public class DaKyc
    {
        ...
        public DrivingLicenseResponse GetDrivingLicenseAuthenticationDtl(string employee_gid, DrivingLicenseModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycdlauthentication_gid from ocs_mst_tkycdlauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycdlauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_mst_tkycdlauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into ocs_mst_tkycdlauthentication(" +
        ...
        public VoterIDResponse GetVoterIDDetails(string employee_gid, VoterIDModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycepicauthentication_gid from ocs_mst_tkycepicauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycepicauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_mst_tkycepicauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into ocs_mst_tkycepicauthentication(" +
        ...
        public PassportDetailsResponse GetPassportDetails(string employee_gid, PassportModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycpassportauthentication_gid from ocs_mst_tkycpassportauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycpassportauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_mst_tkycpassportauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KEPA");
                msSQL = " insert into ocs_mst_tkycpassportauthentication(" +
        ...
        public GSTVerificationResponse GSTVerificationDetails(string employee_gid, GSTVerificationModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select gspinverification_gid from ocs_trn_tgspinverification where function_gid='" + Values.institution2branch_gid + "' and remarks='" + "Active" + "'";

                string gspinverification_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_trn_tgspinverification set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KGSP");
                msSQL = " insert into ocs_trn_tgspinverification(" +
                ...
                if (ObjGSTVerificationResponse.statusCode == 101)
                {
                    msSQL = "update ocs_mst_tinstitution2branch set verification_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    ObjGSTVerificationResponse.result.nba = null;
                    msSQL = "update ocs_mst_tinstitution2branch set verification_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
        ...
        public GSPGSTReturnFilingResponse GetGSPGSTReturnFiling(string employee_gid,GSTVerificationModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select gstreturnfilling_gid from ocs_trn_tgstreturnfilling where function_gid='" + Values.institution2branch_gid + "' and remarks='" + "Active" + "'";

                string gstreturnfilling_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_trn_tgstreturnfilling set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KPNA");
                msSQL = " insert into ocs_trn_tgstreturnfilling(" +
                ...
                if (ObjGSPGSTReturnFilingResponse.result.gstin == "" || ObjGSPGSTReturnFilingResponse.result.gstin == null)
                {
                    msSQL = "update ocs_mst_tinstitution2branch set returnfilling_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    msSQL = "update ocs_mst_tinstitution2branch set returnfilling_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
        ...
        public GSTAuthenticationResponse GetGSTDetailed(string employee_gid,GSTAuthenticationModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select gspinauthentication_gid from ocs_trn_tgspinauthentication where function_gid='" + Values.institution2branch_gid + "' and remarks='" + "Active" + "'";

                string gspinauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_trn_tgspinauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KGSP");
                msSQL = " insert into ocs_trn_tgspinauthentication(" +
                ...
                if (ObjGSTAuthenticationResponse.statusCode == 101)
                {
                    msSQL = "update ocs_mst_tinstitution2branch set authentication_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    ObjGSTAuthenticationResponse.result.nba = null;
                    msSQL = "update ocs_mst_tinstitution2branch set authentication_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
        ...
        public CINLLPResponse GetCompanyLLP_no(string employee_gid, CIN Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tcompanyllpno where companyllpno_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

              

                msSQL = " insert into ocs_trn_tcompanyllpno(" +
                        " companyllpno_gid," +
                        " function_gid," +
                        " application_gid," +
                        " cin_no ," +
        ...
        public McaSignatoriesResponse Getmcasignatories(string employee_gid,MCASignatories Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_mcasignatories where mcasignatories_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msGetGid = objcmnfunctions.GetMasterGID("KPNA");
                msSQL = " insert into ocs_trn_mcasignatories(" +
                        " mcasignatories_gid," +
                        " function_gid," +
                        " application_gid," +
                        " cin ," +
                ...
                if(ObjMcaSignatoriesResponse.result != null)
                {
                    ...
                    {
                        msSQL = " insert into ocs_trn_mcasignatorydetails(" +
                       " mcasignatories_gid," +
                       " date_of_appointment," +
                       " designation ," +
                       " dsc_expiry_date," +
        ...
        public FSSAIResponse GetFssaidetails(string employee_gid,Fssai Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tfssailicenseauthentication where fssailicenseauthentication_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                
                msSQL = " insert into ocs_trn_tfssailicenseauthentication(" +
        ...
        public FDAResponse GetFdadetails(string employee_gid,Fda Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tfdalicenseauthentication where fdalicenseauthentication_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_tfdalicenseauthentication(" +
        ...
        public IfscVerificationResponse GetIfscVerification(string employee_gid, IfscVerification Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycifscauthentication_gid from ocs_mst_tkycifscauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycifscauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_mst_tkycifscauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into ocs_mst_tkycifscauthentication(" +
        ...
        public BankAccVerificationResponse GetBankAccVerification(string employee_gid, BankAccVerification Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycbankaccverification_gid from ocs_mst_tkycbankaccverification where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycbankaccverification_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_mst_tkycbankaccverification set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into ocs_mst_tkycbankaccverification(" +
        ...
        public TANPResponse GetPostTANauthetication(string employee_gid,tan Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_ttandtl where tandtl_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_ttandtl(" +
                        " tandtl_gid," +
                        " function_gid," +
                        " application_gid," +
                        " tan ," +
        ...
        public iecdetailedPResponse PostIECDetailed(string employee_gid,iec_detailed Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tiecdtl where iecdtl_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msGetGid = objcmnfunctions.GetMasterGID("KPNA");
                msSQL = " insert into ocs_trn_tiecdtl(" +
                        " iecdtl_gid," +
                        " function_gid," +
                        " application_gid," +
                        " iec_no ," +
        ...
        public ShopAndEstablishmentResponse GetShopAndEstablishment(string employee_gid, ShopAndEstablishmentRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tshopandestablishment where shopandestablishment_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_tshopandestablishment(" +
        ...
        public PropertyTaxResponse GetPropertyTax(string employee_gid, PropertyTaxRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tpropertytax where propertytax_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_tpropertytax(" +
                        " propertytax_gid," +
                        " function_gid," +
                        " application_gid," +
                        " propertyNo ," +
        ...
        public VehicleRCAuthAdvancedResponse GetVehicleRCAuthAdvanced(string employee_gid, VehicleRCAuthAdvancedRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tvehiclercauthadvanced where vehiclercauthadvanced_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_tvehiclercauthadvanced(" +
        ...
        public VehicleRCSearchResponse GetVehicleRCSearch(string employee_gid, VehicleRCSearchRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tvehiclercsearch where vehiclercsearch_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_tvehiclercsearch(" +
                        " vehiclercsearch_gid," +
                        " function_gid," +
                        " application_gid," +
                        " engine_no ," +
        ...
        public LPGIDAuthenticationResponse GetLPGIDAuthentication(string employee_gid, LPGIDAuthenticationRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from ocs_trn_tlpgiddtl where ocs_trn_tlpgiddtl='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into ocs_trn_tlpgiddtl(" +
                        " lpgiddtl_gid," +
                        " function_gid," +
                        " application_gid," +
                        " lpg_id ," +
        ...
        public UdyamNumberResponse GetUdyamNumberDetails(string employee_gid, UdyamNumberModel Values)
        {
            UdyamNumberResponse ObjUdyamNumberResponse = new UdyamNumberResponse();
            try
            {
                ServicePointManager.SecurityProtocol = SecurityProtocolType.Ssl3 | SecurityProtocolType.Tls12 | SecurityProtocolType.Tls11 | SecurityProtocolType.Tls;

                Values.consent = "Y";
                Values.ispdfrequired = "N";
                var client = new RestClient(ConfigurationManager.AppSettings["kycapis2"].ToString() + "udyam/auth");
                var request = new RestRequest(Method.POST);
                request.AddHeader("content-type", "application/json");
                request.AddHeader("x-karza-key", ConfigurationManager.AppSettings["kycapiskey"].ToString());
                request.AddParameter("application/json", "{\"consent\":\"" + Values.consent + "\",\"udyamRegistrationNo\":\"" + Values.udyamreg_no + "\",\"isPDFRequired\":\"" + Values.ispdfrequired + "\"}", ParameterType.RequestBody);
                IRestResponse response = client.Execute(request);
                ObjUdyamNumberResponse = JsonConvert.DeserializeObject<UdyamNumberResponse>(response.Content);
                

                msSQL = "select kycudyamauthentication_gid from ocs_mst_tkycudyamauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycudyamauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update ocs_mst_tkycudyamauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                        " where kycudyamauthentication_gid='" + kycudyamauthentication_gid + "' ";

                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msGetGid = objcmnfunctions.GetMasterGID("KUMA");
                msSQL = " insert into ocs_mst_tkycudyamauthentication(" +
                        " kycudyamauthentication_gid," +
                        " function_gid," +
                        " udyamreg_no," +
                        " response," +
                        " validation_status," +
                        ...
                        "'" + employee_gid + "'," +
                        "'" + Values.udyamreg_no + "',";
                if (ObjUdyamNumberResponse.statusCode == 101)
                {
                    msSQL += "'" + response.Content.Replace("'", "") + "'," +
                             "'" + "Verified" + "',";
                }
                ...
                if (ObjUdyamNumberResponse.statusCode == 101)
                {
                    ObjUdyamNumberResponse.status = true;
                }
                else
                {
                    ObjUdyamNumberResponse.status = false;
                    ObjUdyamNumberResponse.message = ErrorResponseKyc.errorResponse + ObjUdyamNumberResponse.error;
                }
            ...
            {
                ObjUdyamNumberResponse.status = false;
                ObjUdyamNumberResponse.message = "Error Occurred in UDYAM Registration Validation";
            }
            return ObjUdyamNumberResponse;
        }
