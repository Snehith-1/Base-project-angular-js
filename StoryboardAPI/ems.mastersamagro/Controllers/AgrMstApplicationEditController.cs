...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This Controllers will provide access to edit datas from various stages in Application creation (General, Company, Individual, Overall limit, Product, charges, trade, Bureau & Done)
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Logapriya, Abilash.A, Premchander.K </remarks>

    [RoutePrefix("api/AgrMstApplicationEdit")]
    [Authorize]

    public class AgrMstApplicationEditController : ApiController
    {
        ...
        public HttpResponseMessage SubmitInstitutionDtlAdd(MdlMstInstitutionAdd values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaSubmitInstitutionDtlAdd(values, getsessionvalues.user_gid, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage SubmitIndividualDtlAdd(MdlMstContact values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaSubmitIndividualDtlAdd(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        [ActionName("GetWarehouseAddressDropdown")]
        [HttpGet]
        public HttpResponseMessage GetWarehouseAddressDropdown(string warehouse_gid)
        { 
            MdlWarehouseAddressList values = new MdlWarehouseAddressList();
            objDaAgrMstApplicationEdit.DaGetWarehouseAddressDropdown(warehouse_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetWarehouseDetail")]
        [HttpGet]
        public HttpResponseMessage GetWarehouseDetail()
        {
            MdlWarehousedtlList values = new MdlWarehousedtlList();
            objDaAgrMstApplicationEdit.DaGetWarehouseDetail(values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        // Supplier Details

        [ActionName("PostLoan2Supplierdtl")]
        [HttpPost]
        public HttpResponseMessage PostLoan2Supplierdtl(MdlSupplierdtl values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaPostLoan2Supplierdtl(getsessionvalues.employee_gid,values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
          
        [ActionName("GetLoan2Supplierdtl")]
        [HttpGet]
        public HttpResponseMessage GetLoan2Supplierdtl(string application_gid,string application2loan_gid, string tmp_status)
        {
            MdlSupplierdtlList values = new MdlSupplierdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetLoan2Supplierdtl(application_gid,application2loan_gid, getsessionvalues.employee_gid,values, tmp_status);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetLoan2SupplierGSTdtl")]
        [HttpGet]
        public HttpResponseMessage GetLoan2SupplierGSTdtl(string apploan2supplierdtl_gid)
        {
            MdlSupplierGSTdtlList values = new MdlSupplierGSTdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetLoan2SupplierGSTdtl(apploan2supplierdtl_gid,values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("DeleteSupplierDtl")]
        [HttpGet]
        public HttpResponseMessage DeleteSupplierDtl(string apploan2supplierdtl_gid)
        {
            result values = new result();
            objDaAgrMstApplicationEdit.DaDeleteSupplierDtl(apploan2supplierdtl_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
       
        [ActionName("PostLoan2SupplierPaymentdtl")]
        [HttpPost]
        public HttpResponseMessage PostLoan2SupplierPaymentdtl(MdlSupplierPaymentdtl values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaPostLoan2SupplierPaymentdtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetLoan2SupplierPaymentdtl")]
        [HttpGet]
        public HttpResponseMessage GetLoan2SupplierPaymentdtl(string application_gid,string application2loan_gid, string tmp_status)
        {
            MdlSupplierPaymentdtlList values = new MdlSupplierPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetLoan2SupplierPaymentdtl(application_gid,application2loan_gid, getsessionvalues.employee_gid, values, tmp_status);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("DeleteSupplierPaymentDtl")]
        [HttpGet]
        public HttpResponseMessage DeleteSupplierPaymentDtl(string apploan2supplierpayment_gid)
        {
            result values = new result();
            objDaAgrMstApplicationEdit.DaDeleteSupplierPaymentDtl(apploan2supplierpayment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlSupplierDropdowndtlList values = new MdlSupplierDropdowndtlList();
            objDaAgrMstApplicationEdit.DaGetSupplierNameDropdown(values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetSupplierNameDtlDropdown")]
        [HttpGet]
        public HttpResponseMessage GetSupplierNameDtlDropdown(string application_gid)
        {
            MdlSupplierdtl values = new MdlSupplierdtl();
            objDaAgrMstApplicationEdit.DaGetSupplierNameDtlDropdown(application_gid,values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetSupplierOnboardDtlDropdown")]
        [HttpGet]
        public HttpResponseMessage GetSupplierOnboardDtlDropdown(string application_gid)
        {
            MdlSupplierdtl values = new MdlSupplierdtl();
            objDaAgrMstApplicationEdit.DaGetSupplierOnboardDtlDropdown(application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        //    Payment Type - Customer(Repayment- Receipt)

        [ActionName("PostLoan2Repaymentdtl")]
        [HttpPost]
        public HttpResponseMessage PostLoan2Repaymentdtl(MdlPaymentdtl values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaPostLoan2Repaymentdtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetLoan2Repaymentdtl")]
        [HttpGet]
        public HttpResponseMessage GetLoan2Repaymentdtl(string application_gid,string application2loan_gid, string tmp_status)
        {
            MdlPaymentdtlList values = new MdlPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetLoan2Repaymentdtl(application_gid, application2loan_gid, getsessionvalues.employee_gid, values, tmp_status);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("DeleteLoan2Repaymentdtl")]
        [HttpGet]
        public HttpResponseMessage DeleteLoan2Repaymentdtl(string paymenttypecustomer_gid)
        {
            result values = new result();
            objDaAgrMstApplicationEdit.DaDeleteLoan2Repaymentdtl(paymenttypecustomer_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        //  STF Details - upload

        [ActionName("PostBankFundingUpload")]
        [HttpPost]
        public HttpResponseMessage PostBankFundingUpload()
        {
            HttpRequest httpRequest;
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            httpRequest = HttpContext.Current.Request;
            Agrupload_list documentname = new Agrupload_list();
            objDaAgrMstApplicationEdit.DaPostBankFundingUpload(httpRequest, documentname, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, documentname);
        }

        [ActionName("DeleteBankFundingUpload")]
        [HttpGet]
        public HttpResponseMessage DeleteBankFundingUpload(string bankfundingdataupload_gid)
        {
            result values = new result();
            objDaAgrMstApplicationEdit.DaDeleteBankFundingUpload(bankfundingdataupload_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetAppCommodityDtls")]
        [HttpGet]
        public HttpResponseMessage GetAppCommodityDtls(string application2product_gid)
        {
            MdlCommodityDtls values = new MdlCommodityDtls();
            objDaAgrMstApplicationEdit.DaGetAppCommodityDtls(application2product_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetAppCommodityGstList")]
        [HttpGet]
        public HttpResponseMessage GetAppCommodityGstList(string application2product_gid)
        {
            commoditygststatuslist values = new commoditygststatuslist();
            objDaAgrMstApplicationEdit.DaGetAppCommodityGstList(application2product_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetAppCommodityTradeProdctList")]
        [HttpGet]
        public HttpResponseMessage GetAppCommodityTradeProdctList(string application2product_gid)
        {
            commodityTradeProdctlist values = new commodityTradeProdctlist();
            objDaAgrMstApplicationEdit.DaGetAppCommodityTradeProdctList(application2product_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetAppCommodityCustomerpaymentList")]
        [HttpGet]
        public HttpResponseMessage GetAppCommodityCustomerpaymentList(string application2product_gid)
        {
            commodityTradeProdctlist values = new commodityTradeProdctlist();
            objDaAgrMstApplicationEdit.DaGetAppCommodityCustomerpaymentList(application2product_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetAppCommodityDocumentUploadList")]
        [HttpGet]
        public HttpResponseMessage GetAppCommodityDocumentUploadList(string application2product_gid)
        {
            commodityDocumentUploadlist values = new commodityDocumentUploadlist();
            objDaAgrMstApplicationEdit.DaGetAppCommodityDocumentUploadList(application2product_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetApprovedSupplierOnboardDropdown")]
        [HttpGet]
        public HttpResponseMessage GetApprovedSupplierOnboardDropdown()
        {
            MdlSupplierDropdowndtlList values = new MdlSupplierDropdowndtlList();
            objDaAgrMstApplicationEdit.DaGetApprovedSupplierOnboardDropdown(values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage postcollateraldocument()
        {
            ...
            httpRequest = HttpContext.Current.Request;
            Documentname documentname = new Documentname();
            objDaAgrMstApplicationEdit.Dapostcollateraldocument(httpRequest, documentname, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, documentname);
        }

        [ActionName("GetLoan2Repaymentvalue")]
        [HttpGet]
        public HttpResponseMessage GetLoan2Repaymentvalue(string application_gid)
        {
            MdlPaymentdtlList values = new MdlPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetLoan2Repaymentvalue(application_gid,  getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }


        [ActionName("GetSupplier2paymentvalue")]
        [HttpGet]
        public HttpResponseMessage GetSupplier2paymentvalue(string application_gid)
        {
            MdlPaymentdtlList values = new MdlPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetSupplier2paymentvalue(application_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }


        [ActionName("GetEditLoan2Repaymentvalue")]
        [HttpGet]
        public HttpResponseMessage GetEditLoan2Repaymentvalue(string application_gid, string application2loan_gid)
        {
            MdlPaymentdtlList values = new MdlPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetEditLoan2Repaymentvalue(application_gid, application2loan_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }


        [ActionName("GetEditSupplier2paymentvalue")]
        [HttpGet]
        public HttpResponseMessage GetEditSupplier2paymentvalue(string application_gid, string application2loan_gid)
        {
            MdlPaymentdtlList values = new MdlPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetEditSupplier2paymentvalue(application_gid, application2loan_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetSupplierpaymentdtls")]
        [HttpGet]
        public HttpResponseMessage GetSupplierpaymentdtls(string apploan2supplierdtl_gid)
        {
            MdlSupplierPaymentdtlList values = new MdlSupplierPaymentdtlList();
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaGetSupplierpaymentdtls(apploan2supplierdtl_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage UpdateGSTHeadOffice(MdlGSTHeadOffice values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaUpdateGSTHeadOffice(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        [ActionName("EditSupplierDetailsActive")]
        [HttpGet]
        public HttpResponseMessage EditSupplierDetailsActive(string apploan2supplierdtl_gid)
        {
            MdlSupplierdtl values = new MdlSupplierdtl();
            objDaAgrMstApplicationEdit.DaEditSupplierDetailsActive(apploan2supplierdtl_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        [ActionName("InactiveSupplierDetails")]
        [HttpPost]
        public HttpResponseMessage InactiveSupplierDetails(MdlSupplierdtl values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objDaAgrMstApplicationEdit.DaInactiveSupplierDetails(values, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        [ActionName("SupplierDetailsInactiveLogview")]
        [HttpGet]
        public HttpResponseMessage SupplierDetailsInactiveLogview(string apploan2supplierdtl_gid)
        {
            MdlSupplierdtl values = new MdlSupplierdtl();
            objDaAgrMstApplicationEdit.DaSupplierDetailsInactiveLogview(apploan2supplierdtl_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstApplicationAdd values = new MdlMstApplicationAdd();
            objDaAgrMstApplicationEdit.DaEditAppBasic(application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
