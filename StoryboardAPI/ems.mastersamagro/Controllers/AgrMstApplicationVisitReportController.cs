...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This Controllers will provide access to various functions in visit report (Visit updates, address, document upload & download events)
    /// </summary>
    /// <remarks>Written by Abilash.A, Premchander.K </remarks>

    [RoutePrefix("api/AgrMstApplicationVisitReport")]
    [Authorize]
    public class AgrMstApplicationVisitReportController : ApiController
    {
        DaAgrMstApplicationVisitReport objAgrMstApplicationAdd = new DaAgrMstApplicationVisitReport();
        ...
        public HttpResponseMessage getAddressTypeASC()
        {
            ...
            objAgrMstApplicationAdd.DaGetVisitedplace(values);
        ...
        //{
        //    MdlMstVisitPerson values = new MdlMstVisitPerson();
        //    objAgrMstApplicationAdd.GetInspectingOfficials(values);
        //    return Request.CreateResponse(HttpStatusCode.OK, values);
        //}
        ...
        public HttpResponseMessage PostPersonDetails(mstVisitpersondtl_list values)
        {
            ...
            objAgrMstApplicationAdd.DaPostPersonDetails(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostVisitContactNo(mstVisitpersoncontact_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostVisitContactNo(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostMobileNo(mstVisitpersonaddress_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostVisitAddress(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage VisitDocumentUpload()
        {
            ...
            objAgrMstApplicationAdd.DaPostVisitDocumentUpload(httpRequest, values, getsessionvalues.user_gid, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage VisitPhotoUpload()
        {
            ...
            objAgrMstApplicationAdd.DaPostVisitUploadPhoto(httpRequest, values, getsessionvalues.employee_gid, getsessionvalues.user_gid);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisittmpContactList()
        {
            ...
            objAgrMstApplicationAdd.DaGetVisittmpContactList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisitContactList(string applicationvisit2person_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            mstVisitpersondtl_list values = new mstVisitpersondtl_list();
            objAgrMstApplicationAdd.DaGetVisitContactList(getsessionvalues.employee_gid, applicationvisit2person_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetEditVisitContactList(string applicationvisit2person_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            mstVisitpersondtl_list values = new mstVisitpersondtl_list();
            objAgrMstApplicationAdd.DaGetEditVisitContactList(getsessionvalues.employee_gid, applicationvisit2person_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetLVisittmpPersondtlList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisittmpPersondtlList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisittmpAddressList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisittmpAddressList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetLVisitPersondtlList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisitPersondtlList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetEditVisitPersondtlList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetEditVisitPersondtlList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisitAddressList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisitAddressList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetEditVisitAddressList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetEditVisitAddressList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisittmpDocumentList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisittmpDocumentList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisitDocumentList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisitDocumentList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetEditVisitDocumentList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetEditVisitDocumentList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisittmpPhotosList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisittmpPhotoList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisitPhotosList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisitPhotoList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetEditVisitPhotosList(string applicationvisit_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetEditVisitPhotoList(getsessionvalues.employee_gid, applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpContactList(string applicationvisitperson2contact_gid)
        {
            ...
            objAgrMstApplicationAdd.DaDeleteVisittmpContactList(applicationvisitperson2contact_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmppersondtlList(string applicationvisit2person_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            mstVisitpersondtl_list values = new mstVisitpersondtl_list();
            objAgrMstApplicationAdd.DaDeleteVisittmppersondtlList(applicationvisit2person_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpAddressList(string applicationvisit2address_gid)
        {
            ...
            objAgrMstApplicationAdd.DaDeleteVisittmpAddressList(applicationvisit2address_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpDocumentList(string applicationvisit2document_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            UploadDocumentList values = new UploadDocumentList();
            objAgrMstApplicationAdd.DaDeleteVisittmpDocumentList(applicationvisit2document_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpPhotoList(string applicationvisit2photo_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            UploadphotoList values = new UploadphotoList();
            objAgrMstApplicationAdd.DaDeleteVisittmpPhotoList(applicationvisit2photo_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpContact()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            mstVisitpersoncontact_list values = new mstVisitpersoncontact_list();
            objAgrMstApplicationAdd.DaDeleteVisittmpContact(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmppersondtl()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            mstVisitpersondtl_list values = new mstVisitpersondtl_list();
            objAgrMstApplicationAdd.DaDeleteVisittmppersondtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpAddress()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            mstVisitpersonaddress_list values = new mstVisitpersonaddress_list();
            objAgrMstApplicationAdd.DaDeleteVisittmpAddress(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpDocument()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            UploadDocumentList values = new UploadDocumentList();
            objAgrMstApplicationAdd.DaDeleteVisittmpDocument(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteVisittmpPhoto()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            UploadphotoList values = new UploadphotoList();
            objAgrMstApplicationAdd.DaDeleteVisittmpPhoto(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostApplicationVisitReport(MdlMstVisitPerson values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostApplicationVisitReport(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostSubmitApplicationVisitReport(MdlMstVisitPerson values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostSubmitApplicationVisitReport(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            mstVisitpersonaddress_list values = new mstVisitpersonaddress_list();
            objAgrMstApplicationAdd.DaEditApplicationVisitaddress(applicationvisit2address_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            mstVisitpersondtl_list values = new mstVisitpersondtl_list();
            objAgrMstApplicationAdd.DaEditApplicationVisitpersondtl(applicationvisit2person_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostPersonDetailsUpdate(mstVisitpersondtl_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostPersonDetailsUpdate(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostPersonaddressUpdate(mstVisitpersonaddress_list values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostPersonaddressUpdate(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostSubmitApplicationVisitReportUpdate(MdlMstVisitPerson values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostSubmitApplicationVisitReportUpdate(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostUpdateApplicationVisitReportUpdate(MdlMstVisitPerson values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostUpdateApplicationVisitReportUpdate(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostSaveApplicationVisitReportUpdate(MdlMstVisitPerson values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objAgrMstApplicationAdd.DaPostSaveApplicationVisitReportUpdate(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisitReportList(string application_gid, string statusupdated_by)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaGetVisitReportList(application_gid, statusupdated_by, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstVisitPerson values = new MdlMstVisitPerson();
            objAgrMstApplicationAdd.DaEditApplicationVisitReport(applicationvisit_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetVisitReportDtls(string visitreport_gid)
        {
            ...
            objAgrMstApplicationAdd.DaGetVisitReportDtls(visitreport_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
    }
}