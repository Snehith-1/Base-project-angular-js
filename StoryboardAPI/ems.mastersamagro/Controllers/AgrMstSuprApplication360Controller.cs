...
namespace ems.mastersamagro.Controllers
{
    ...
    /// </summary>
    /// <remarks>Written by Abilash.A,  Premchandar.K</remarks>


    [RoutePrefix("api/AgrMstSuprApplication360")]
        [Authorize]

        public class AgrMstSuprApplication360Controller : ApiController
        {
        DaAgrMstSuprApplication360 objDaAgrMstApplication360 = new DaAgrMstSuprApplication360();
            ...
            [HttpGet]
            public HttpResponseMessage CompanyDocumentList()
            {
                MdlMstApplication360 values = new MdlMstApplication360();
                objDaAgrMstApplication360.DaCompanyDocumentList(values);
                return Request.CreateResponse(HttpStatusCode.OK, values);
            }
            ...
            [HttpGet]
            public HttpResponseMessage IndividualDocumentList()
            {
                MdlMstApplication360 objapplication360 = new MdlMstApplication360();
                objDaAgrMstApplication360.DaIndividualDocumentList(objapplication360);
                return Request.CreateResponse(HttpStatusCode.OK, objapplication360);
            }
            //Bsr Code
