...
namespace ems.mastersamagro.Controllers
{
    ...
    [RoutePrefix("api/AgrMstCreditMapping")]
    [Authorize]
    public class AgrMstCreditMappingController : ApiController
    {
        DaAgrMstCreditMapping objDaMstCreditMapping = new DaAgrMstCreditMapping();
