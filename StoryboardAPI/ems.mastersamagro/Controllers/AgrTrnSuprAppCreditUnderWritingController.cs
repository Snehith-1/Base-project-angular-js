...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This Controllers will provide access to add, edit, view datas in supplier credit stages.
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Logapriya, Abilash.A, Premchander.K </remarks>

    [RoutePrefix("api/AgrTrnSuprAppCreditUnderWriting")]
    [Authorize]

    public class AgrTrnSuprAppCreditUnderWritingController : ApiController
    {
        DaAgrTrnSuprAppCreditUnderWriting objAgrTrnAppCreditUnderWriting = new DaAgrTrnSuprAppCreditUnderWriting();
