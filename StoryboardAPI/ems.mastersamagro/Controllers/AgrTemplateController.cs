...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This controllers provide access to template and editor doc for contract flow in samagro
    /// </summary>
    /// <remarks>Written by Venkatesh </remarks>

    [RoutePrefix("api/AgrTemplate")]
    [Authorize]
    public class AgrTemplateController : ApiController
    {
        DaAgrTemplate objDaAccess = new DaAgrTemplate();
        ...
        {
            MdlTemplatelist1 objTemplateSummary = new MdlTemplatelist1();
