...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This Controllers will help to generate CAM document in buyer credit and pmg stages
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Premchander.K </remarks>


    [RoutePrefix("api/AgrTrnCAMGeneration")]
    [Authorize]
    public class AgrTrnCAMGenerationController : ApiController
    {
