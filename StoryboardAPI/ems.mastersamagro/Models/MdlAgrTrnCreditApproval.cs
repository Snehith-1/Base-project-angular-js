...
namespace ems.mastersamagro.Models
{
    ...
    /// <summary>
    /// This models will help to pull data's from back end and trigger approvals from credit risk approval stage 
    /// </summary>
    ...
    public class credtiApplicationCount : result
    {
        ...
        public string ccapproval_count { get; set; }
        public string autoapprovalappl_count { get; set; }
