...
namespace ems.mastersamagro.Models
{
    ...
    /// <summary>
    /// This Models will provide values to Export Credit Report.
    /// </summary>
    /// <remarks>Written by Abilash.A, Premchander.K </remarks>

    public class MdlAgrMstCreditAllocationReport : result
    {
    ...
    public class MstCreditExcelList
    {
        ...
        public string CustomerSupplier_Type { get; set; }

        public string Vertical { get; set; }
        public string Region { get; set; }
        public string Overall_Limit { get; set; }
        //public string Creditgroup { get; set; }
        public string ProductCreditgroup { get; set; }
