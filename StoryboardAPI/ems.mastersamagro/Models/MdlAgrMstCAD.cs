...
namespace ems.mastersamagro.Models
{
    ...
    /// <summary>
    /// This Models will store values for various functionalities in Post Tac Activity menu (Summaries, Process - Accept/reject/sendback cases contract, agreement and short closing functions)
    /// </summary>
    ...
    public class MdlMstCAD : result
    {
        ...
        public List<Contractupload_list> Contractupload_list { get; set; }
    ...
    public class MdlUpdateProcessType : result
    {
        ...
        public agrapploan2supplierdtl_gid[] lsapploan2supplierdtl_gid { get; set; }
    }

    public class agrapploan2supplierdtl_gid
    {
    ...
    public class cadapplicationlist : result
    {
        ...
        public string amendment_flag { get; set; }
        public string shortclosing_flag { get; set; }
        public string advancerejected_by { get; set; }
        public string advancerejected_date { get; set; }
        public string erp_id { get; set; }
        public string enhancement_status { get; set; }
        public string enhancement_flag { get; set; }
        public string buyeragreement_id { get; set; }
    }
    public class CadApplicationCount : result
    {
        ...
        public string advancerejected_count { get; set; }
    ...
    public class Contractupload_list
    {
        ...
        public string created_by { get; set; }
        public string application2sanction_gid { get; set; }
        public string contractdocumentupload_gid { get; set; }
    }
    ...
    public class cadsanctiondetails : result
    {
        ...
        public string contractlog_gid { get; set; }
        public string application_gid { get; set; }
        ...
        public string validityto_date { get; set; }
        public string lsapplication2sanction_gid { get; set; }
    ...
    public class MdlTemplatelist : result
    {
        public string template_content { get; set; }
        public string lspath { get; set; }
        public string lsname { get; set; }
    ...
    public class MdlCADtoCCLog : result
    {
        public string application_gid { get; set; }
        public string cadtocc_reason { get; set; }
        public List<cadtocclog_list> cadtocclog_list { get; set; }
    }
    ...
    public class cadtocclog_list : result
    {
        public string application_gid { get; set; }
        public string cadtocc_reason { get; set; }
        public string cadtocclog_gid { get; set; }
