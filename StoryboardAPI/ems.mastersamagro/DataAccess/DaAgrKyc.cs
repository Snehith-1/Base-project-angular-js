...
namespace vcidex_kyc.Function
{
    ...
    /// Driving License Authentication, VoterID, PassportDetail, KYC) in KYC - Buyer.
    /// </summary>
    /// <remarks>Written by Praveen </remarks>
    public class DaAgrKyc
    {
        ...
        public PanNumberResponse GetPanNumberDetails(string employee_gid, PanNumberModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycpanauthentication_gid from agr_mst_tkycpanauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycpanauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_mst_tkycpanauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                ...
                msSQL = " insert into agr_mst_tkycpanauthentication(" +
        ...
        public DrivingLicenseResponse GetDrivingLicenseAuthenticationDtl(string employee_gid, DrivingLicenseModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycdlauthentication_gid from agr_mst_tkycdlauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycdlauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_mst_tkycdlauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into agr_mst_tkycdlauthentication(" +
        ...
        public VoterIDResponse GetVoterIDDetails(string employee_gid, VoterIDModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycepicauthentication_gid from agr_mst_tkycepicauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycepicauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_mst_tkycepicauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into agr_mst_tkycepicauthentication(" +
        ...
        public PassportDetailsResponse GetPassportDetails(string employee_gid, PassportModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycpassportauthentication_gid from agr_mst_tkycpassportauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycpassportauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_mst_tkycpassportauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KEPA");
                msSQL = " insert into agr_mst_tkycpassportauthentication(" +
        ...
        public GSTSBPANDetailsResponse Getgstsbpandetails(string employee_gid, PanNumberModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycgstsbpan_gid from agr_mst_tkycgstsbpan where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycgstsbpan_gid = objdbconn.GetExecuteScalar(msSQL);
                string gstList = "";


                msSQL = " update agr_mst_tkycgstsbpan set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into agr_mst_tkycgstsbpan(" +
                        " kycgstsbpan_gid," +
                        " function_gid," +
                        " pan," +
                        " gstValues," +
        ...
        public GSTVerificationResponse GSTVerificationDetails(string employee_gid, GSTVerificationModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select gspinverification_gid from agr_trn_tgspinverification where function_gid='" + Values.institution2branch_gid + "' and remarks='" + "Active" + "'";

                string gspinverification_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_trn_tgspinverification set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KGSP");
                msSQL = " insert into agr_trn_tgspinverification(" +
                ...
                if (ObjGSTVerificationResponse.statusCode == 101)
                {
                    msSQL = "update agr_mst_tinstitution2branch set verification_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2branch set verification_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    ObjGSTVerificationResponse.result.nba = null;
                    msSQL = "update agr_mst_tinstitution2branch set verification_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);


                    msSQL = "update agr_mst_tbyronboardinstitution2branch set verification_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
        ...
        public GSPGSTReturnFilingResponse GetGSPGSTReturnFiling(string employee_gid, GSTVerificationModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select gstreturnfilling_gid from agr_trn_tgstreturnfilling where function_gid='" + Values.institution2branch_gid + "' and remarks='" + "Active" + "'";

                string gstreturnfilling_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_trn_tgstreturnfilling set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KPNA");
                msSQL = " insert into agr_trn_tgstreturnfilling(" +
                ...
                if (ObjGSPGSTReturnFilingResponse.result.gstin == "" || ObjGSPGSTReturnFilingResponse.result.gstin == null)
                {
                    msSQL = "update agr_mst_tinstitution2branch set returnfilling_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    msSQL = "update agr_mst_tinstitution2branch set returnfilling_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
        ...
        public GSTAuthenticationResponse GetGSTDetailed(string employee_gid, GSTAuthenticationModel Values)
        {
            ...
            try
            {
                ...
                msSQL = "select gspinauthentication_gid from agr_trn_tgspinauthentication where function_gid='" + Values.institution2branch_gid + "' and remarks='" + "Active" + "'";

                string gspinauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_trn_tgspinauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msGetGid = objcmnfunctions.GetMasterGID("KGSP");
                msSQL = " insert into agr_trn_tgspinauthentication(" +
                ...
                if (ObjGSTAuthenticationResponse.statusCode == 101)
                {
                    msSQL = "update agr_mst_tinstitution2branch set authentication_status='Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    ObjGSTAuthenticationResponse.result.nba = null;
                    msSQL = "update agr_mst_tinstitution2branch set authentication_status='Not Verified' where institution2branch_gid='" + Values.institution2branch_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public CINLLPResponse GetCompanyLLP_no(string employee_gid, CIN Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tcompanyllpno where companyllpno_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);



                msSQL = " insert into agr_trn_tcompanyllpno(" +
                        " companyllpno_gid," +
                        " function_gid," +
                        " application_gid," +
                        " cin_no ," +
        ...
        public McaSignatoriesResponse Getmcasignatories(string employee_gid, MCASignatories Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_mcasignatories where mcasignatories_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msGetGid = objcmnfunctions.GetMasterGID("KPNA");
                msSQL = " insert into agr_trn_mcasignatories(" +
                        " mcasignatories_gid," +
                        " function_gid," +
                        " application_gid," +
                        " cin ," +
                ...
                if (ObjMcaSignatoriesResponse.result != null)
                {
                    ...
                    {
                        msSQL = " insert into agr_trn_mcasignatorydetails(" +
                       " mcasignatories_gid," +
                       " date_of_appointment," +
                       " designation ," +
                       " dsc_expiry_date," +
        ...
        public FSSAIResponse GetFssaidetails(string employee_gid, Fssai Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tfssailicenseauthentication where fssailicenseauthentication_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);


                msSQL = " insert into agr_trn_tfssailicenseauthentication(" +
        ...
        public FDAResponse GetFdadetails(string employee_gid, Fda Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tfdalicenseauthentication where fdalicenseauthentication_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_tfdalicenseauthentication(" +
        ...
        public IfscVerificationResponse GetIfscVerification(string employee_gid, IfscVerification Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycifscauthentication_gid from agr_mst_tkycifscauthentication where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycifscauthentication_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_mst_tkycifscauthentication set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into agr_mst_tkycifscauthentication(" +
        ...
        public BankAccVerificationResponse GetBankAccVerification(string employee_gid, BankAccVerification Values)
        {
            ...
            try
            {
                ...
                msSQL = "select kycbankaccverification_gid from agr_mst_tkycbankaccverification where function_gid='" + employee_gid + "' and remarks='" + "Active" + "'";

                string kycbankaccverification_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update agr_mst_tkycbankaccverification set " +
                        " remarks='" + "Deleted" + "'," +
                        " updated_by='" + employee_gid + "'," +
                        " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                msSQL = " insert into agr_mst_tkycbankaccverification(" +
        ...
        public TANPResponse GetPostTANauthetication(string employee_gid, tan Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_ttandtl where tandtl_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_ttandtl(" +
                        " tandtl_gid," +
                        " function_gid," +
                        " application_gid," +
                        " tan ," +
        ...
        public iecdetailedPResponse PostIECDetailed(string employee_gid, iec_detailed Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tiecdtl where iecdtl_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msGetGid = objcmnfunctions.GetMasterGID("KPNA");
                msSQL = " insert into agr_trn_tiecdtl(" +
                        " iecdtl_gid," +
                        " function_gid," +
                        " application_gid," +
                        " iec_no ," +
        ...
        public ShopAndEstablishmentResponse GetShopAndEstablishment(string employee_gid, ShopAndEstablishmentRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tshopandestablishment where shopandestablishment_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_tshopandestablishment(" +
        ...
        public PropertyTaxResponse GetPropertyTax(string employee_gid, PropertyTaxRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tpropertytax where propertytax_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_tpropertytax(" +
                        " propertytax_gid," +
                        " function_gid," +
                        " application_gid," +
                        " propertyNo ," +
                ...
                else
                {
                    ...
                    ObjPropertyTaxResponse.message = ErrorResponseKyc.errorResponse + ObjPropertyTaxResponse.message;
                }
        ...
        public VehicleRCAuthAdvancedResponse GetVehicleRCAuthAdvanced(string employee_gid, VehicleRCAuthAdvancedRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tvehiclercauthadvanced where vehiclercauthadvanced_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_tvehiclercauthadvanced(" +
                ...
                else
                {
                    ...
                    ObjVehicleRCAuthAdvancedResponse.message = ErrorResponseKyc.errorResponse + ObjVehicleRCAuthAdvancedResponse.message;
                }
        ...
        public VehicleRCSearchResponse GetVehicleRCSearch(string employee_gid, VehicleRCSearchRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tvehiclercsearch where vehiclercsearch_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_tvehiclercsearch(" +
                        " vehiclercsearch_gid," +
                        " function_gid," +
                        " application_gid," +
                        " engine_no ," +
        ...
        public LPGIDAuthenticationResponse GetLPGIDAuthentication(string employee_gid, LPGIDAuthenticationRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tlpgiddtl where lpgiddtl_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_trn_tlpgiddtl(" +
                        " lpgiddtl_gid," +
                        " function_gid," +
                        " application_gid," +
                        " lpg_id ," +
