...
{
    /// <summary>
    /// This DataAccess will help to push and pull data's for original copy vetting
    /// </summary>
    /// <remarks>Written by Sherin Augusta.A, Premchandar.K </remarks>
    public class DaAgrTrnPhysicalDocument
    {
        ...
        string lstomembers, lsBccmail_id, lsccweb, lsto_mail, lsccdb, lscc2members, lsapplication_gid, lsrm_name, lsarn_number, lscustomer_name, lsquery_title, lsquery_description, lsqueryraised_by, lsquery_to, lsqueryraised_time, lsdocument_name;
        ...
        public void DaUpdatePhysicalApproval(result values, string lstype, string processtypeassign_gid, string user_gid)
        {
            ...
            if (lstype == "Maker")
            {
                ...
                values.message = "Original Copy Vetting submitted to Checker Successfully..!";
            }
            else if (lstype == "Checker")
            {
                ...
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                values.message = "Original Copy Vetting submitted to Approval Successfully..!";
            }
            else
            {
        ...
        //               " (select count(*) from agr_trn_tdeferralchecklist x where x.groupdocumentchecklist_gid = a.groupdocumentchecklist_gid and x.fromphysical_document='Y' LIMIT 1) as checklistcount, " +
        //               " (SELECT COUNT(*) FROM agr_trn_tphysicaldocument y " +
        ...
        //               " LEFT JOIN agr_trn_tdeferraltagdoc b on a.groupdocumentchecklist_gid = b.groupdocumentchecklist_gid " +
        ...
        //               " a.mstcovenant_type,a.application_gid, date_format(b.due_date,'%d-%m-%Y') as due_date, b.deferraltagdoc_gid, b.deferraltag_status, " +
        //               " date_format(b.created_date,'%d-%m-%Y %h:%i %p') as taggeddate, " +
        //               " (select count(*) from agr_trn_tdeferralchecklist x where x.groupdocumentchecklist_gid = a.groupcovdocumentchecklist_gid and x.fromphysical_document='Y' ) as checklistcount, " +
        //               " (SELECT COUNT(*) FROM agr_trn_tphysicaldocument y " +
        //               " WHERE y.groupdocumentchecklist_gid = a.groupcovdocumentchecklist_gid) as physical_documentcount, " +
        //               " (select physical_covenant_periods from agr_trn_tcovanantdocumentcheckdtls e " +
        ...
        public bool DaGetCADTrnPhysicalDocList(PhysicalDocTaggedDocumentList values, string credit_gid, string application_gid)
        {
            ...
            msSQL = " SELECT a.groupcovdocumentchecklist_gid, a.overall_docstatus ,a.physicaloverall_docstatus, mstdocumenttype_gid as documenttype_gid,mstdocumenttype_name as documenttype_code, " +
                       ...
                       " (SELECT COUNT(*) FROM agr_trn_tphysicaldocument y " +
                       " WHERE y.groupdocumentchecklist_gid = a.groupcovdocumentchecklist_gid) as physical_documentcount, " +
                       " CASE  WHEN physical_covenant_periods is null THEN  (select covenant_periods from agr_trn_tcovanantdocumentcheckdtls e " +
                       ...
                       " ELSE physical_covenant_periods END as 'covenant_periods', " +
                        " CASE  WHEN physical_buffer_days is null THEN  (select buffer_days from agr_trn_tcovanantdocumentcheckdtls e " +
                       " where e.groupcovdocumentchecklist_gid = a.groupcovdocumentchecklist_gid  group by a.groupcovdocumentchecklist_gid ) " +
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " insert into agr_trn_tphysicaldocument( " +
                        ...
                        if (mnResult == 1)
                        {
                            ...
                            {
                                msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus ='Pending Vetting'" +
                                      " where groupcovdocumentchecklist_gid='" + lsdocumentcheckdtl_gid + "'";
                                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                                msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus ='Pending Vetting'" +
                                        " where groupcovdocumentchecklist_gid='" + lsdocumentcheckdtl_gid + "'";
                                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                            }
                            else
                            {
                                msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='Pending Vetting'" +
                                  " where groupdocumentchecklist_gid='" + lsdocumentcheckdtl_gid + "'";
                                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                                msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Pending Vetting'" +
                                          " where groupdocumentchecklist_gid='" + lsdocumentcheckdtl_gid + "'";
                                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                            }
        ...
        {
            msSQL = " select physicaldocument_gid,groupdocumentchecklist_gid,file_name,file_path,documenttype_name,documenttype_code, physicaldocument_code, " +
                    " date_format(a.created_date,'%d-%m-%Y') as created_date,concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by " +
                    " from agr_trn_tphysicaldocument a" +
        ...
        {
            msSQL = " delete from agr_trn_tphysicaldocument where physicaldocument_gid='" + physicaldocument_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult == 1)
            {
                values.status = true;
        ...
        public void DaPostPhysicalDeferralTaggedDoc(deferraltagged values, string user_gid)
        {
            ...
            else
            {
                ...
                if (mnResult != 0)
                {
                    msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='Not Satisfied' " +
                            " where documentcheckdtl_gid='" + values.documentcheckdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Not Satisfied' " +
                            " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Not Satisfied' " +
        ...
        "'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')";
            ...
            //msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Deferral Tagged' " +
            //        " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
            //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            //msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Deferral Tagged' " +
            //       " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
            //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetPhysicalMStDeferraltag(string documentcheckdtl_gid, string lstype, Mstdeferraltag values)
        {
            ...
            if (lscovenant == "")
            {
                ...
                {
                    msSQL = " select documentseverity_gid,documentseverity_name,a.mstdocument_gid from  agr_trn_tgroupdocumentchecklist a " +
        ...
        public void DaPostAppcadPhysicalqueryadd(mdlcadquery values, string user_gid)
        {
            ...
            int query_no = 0;
            var lsquery_no = objdbconn.GetExecuteScalar("SELECT COUNT(*) FROM agr_trn_ttagquery WHERE groupdocumentchecklist_gid ='" + values.documentcheckdtl_gid + "' AND application_gid ='" + values.application_gid + "' AND  fromphysical_document = 'Y'  and query_status not in ('Pending','Cancelled')");
            if (lsquery_no == "")
            {
                query_no = 1;
            }
            ...
            if (mnResult == 1)
            {
                ...
                if (lscovenant != "")
                {
                    if (values.maker_flag != "Y")
                    {
                        ...
                        //msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='Query - Raised' " +
                        //  " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicalcopyquerystatus='Query - Raised' " +
                                " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                else
                {
                    if (values.maker_flag != "Y")
                    {
                        ...
                        //msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='Query - Raised' " +
                        //    " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupdocumentchecklist set physicalcopyquerystatus='Query - Raised' " +
                                " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaPostAppcadresponsequery(mdlcadquery values, string user_gid)
        {
            ...
            msSQL = " select  concat( g.user_firstname, ' ', g.user_lastname, ' / ', g.user_code) as raised_by,query_title,query_description,application_gid,date_format(a.query_responseddate,'%d-%m-%Y %h:%i %p') as query_responseddate from agr_trn_ttagquery a " +
                    "  left join adm_mst_tuser g on g.user_gid = a.created_by  " +
                    " where tagquery_gid='" + values.tagquery_gid + "'";
            objODBCDataReader = objdbconn.GetDataReader(msSQL);
            if (objODBCDataReader.HasRows == true)
            {
                ls_raised_by = objODBCDataReader["raised_by"].ToString();
                ls_query_responseddate = objODBCDataReader["query_responseddate"].ToString();
                ls_query_title = objODBCDataReader["query_title"].ToString();
                ls_query_description = objODBCDataReader["query_description"].ToString();
                ls_application_gid = objODBCDataReader["application_gid"].ToString();
            }
            objODBCDataReader.Close();
            ...
            if (mnResult == 1)
            {
                ...
                if (lscovenant != "")
                {
                    ...
                    //msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set overall_docstatus='Query - Closed' " +
                    //        " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    if (string.IsNullOrEmpty(tagquery_status))
                    {
                        //     msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='Query - Closed' " +
                        //" where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //     mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        //msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Query - Closed', physicalcopyquerystatus='Query - Closed' " +
                        //        " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set  physicalcopyquerystatus='Query - Closed' " +
                                " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                else
                {
                    ...
                    //msSQL = " update agr_trn_tgroupdocumentchecklist set overall_docstatus='Query - Closed' " +
                    //        " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    if (string.IsNullOrEmpty(tagquery_status))
                    {
                        //msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='Query - Closed' " +
                        //  " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        //msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Query - Closed', physicalcopyquerystatus='Query - Closed' " +
                        //        " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupdocumentchecklist set  physicalcopyquerystatus='Query - Closed' " +
                               " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetPhysicalAppcadQuerySummary(mslcadquerylist values, string documentcheckdtl_gid)
        {
            ...
            if (lscovenant != "")
            {
                msSQL = " select mstdocumenttype_name as documenttype_code,mstdocument_name as documenttype_name, date_format(physicaldocumentsubmission_date, '%d-%m-%Y') as documentsubmission_date  from agr_trn_tgroupcovenantdocumentchecklist " +
                  " where groupcovdocumentchecklist_gid='" + documentcheckdtl_gid + "'";
            }
            else
            {
                msSQL = " select mstdocumenttype_name as documenttype_code,mstdocument_name as documenttype_name, date_format(physicaldocumentsubmission_date, '%d-%m-%Y') as documentsubmission_date  from agr_trn_tgroupdocumentchecklist " +
                   " where groupdocumentchecklist_gid='" + documentcheckdtl_gid + "'";
            }
            objODBCDataReader = objdbconn.GetDataReader(msSQL);
            if (objODBCDataReader.HasRows == true)
            ...
            msSQL = " select tagquery_gid,document_gid,groupdocumentchecklist_gid, query_title,query_description,query_status,query_to,query_toname, " +
                    ...
                    " date_format(a.created_date, '%d-%m-%Y %h:%i %p') as query_raiseddate, document_name,  query_code " +
        ...
        public void DaPostPhysicalInitiateExtensionorwaiver(mdlinitiateextendwaiver values, string user_gid)
        {
            ...
            {
                msSQL = " select initiateextendorwaiver_gid  from agr_trn_tinitiateextendorwaiver a " +
            ...
            if (values.extendeddue_date != "" && Convert.ToDateTime(values.extendeddue_date).ToString("yyyy-MM-dd HH:mm:ss") != "0001-01-01 00:00:00")
            {
                ...
                if (lscovenant != "")
                {
                    msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physical_extendedduedate ='" + Convert.ToDateTime(values.extendeddue_date).ToString("yyyy-MM-dd") + "' " +
                            " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physical_extendedduedate ='" + Convert.ToDateTime(values.extendeddue_date).ToString("yyyy-MM-dd") + "' " +
                            " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    msSQL = " update agr_trn_tdocumentchecktls set physical_extendedduedate ='" + Convert.ToDateTime(values.extendeddue_date).ToString("yyyy-MM-dd") + "' " +
                            " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " update agr_trn_tgroupdocumentchecklist set physical_extendedduedate ='" + Convert.ToDateTime(values.extendeddue_date).ToString("yyyy-MM-dd") + "' " +
                            " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
            ...
            if (lscovenant1 != "")
            {
                msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='" + values.approval_status + " - " + values.activity_type + "' " +
                        " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='" + values.approval_status + " - " + values.activity_type + "' " +
                        " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            }
            else
            {
                msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='" + values.approval_status + " - " + values.activity_type + "' " +
                        " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='" + values.approval_status + " - " + values.activity_type + "' " +
                        " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            }
        ...
        //    msSQL = "select activity_type,groupdocumentchecklist_gid from agr_trn_tinitiateextendorwaiver where initiateextendorwaiver_gid='" + values.initiateextendorwaiver_gid + "'";
        //    objODBCDataReader = objdbconn.GetDataReader(msSQL);
        //    if (objODBCDataReader.HasRows == true)
        //    {
        ...
        //    {
        //        msSQL = " update agr_trn_textendorwaiverapproval set approval_remarks ='" + values.approval_remarks.Replace("'", "") + "'," +
        ...
        //            if (lscovenant != "")
        //            {
        //                msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='Approved - " + lsactivity_type + "' " +
        //                      " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

        //                msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Approved - " + lsactivity_type + "' " +
        //                        " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        //            }
        //            else
        //            {
        //                msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='Approved - " + lsactivity_type + "' " +
        //                  " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

        //                msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Approved - " + lsactivity_type + "' " +
        //                       " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        //            }
        ...
        //        if (lscovenant != "")
        //        {
        //            msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='" + values.approval_status + " - " + lsactivity_type + "'" +
        //                  " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

        //            msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='" + values.approval_status + " - " + lsactivity_type + "'" +
        //                    " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        //        }
        //        else
        //        {
        //            msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='" + values.approval_status + " - " + lsactivity_type + "'" +
        //              " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

        //            msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='" + values.approval_status + " - " + lsactivity_type + "'" +
        //                      " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
        //            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        //        }

        //        msSQL = " update agr_trn_tinitiateextendorwaiver set approval_status='" + values.approval_status + "' " +
        //                " where initiateextendorwaiver_gid='" + values.initiateextendorwaiver_gid + "'";
        //        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        //    }
        ...
        public void DaPostPhysicalCovenantPeriods(mdlscannedcovenantperiod values, string user_gid)
        {
            ...
            if (mnResult == 1)
            {
                msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physical_covenant_periods='" + values.covenant_periods + "'," +
                ...
                msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physical_covenant_periods='" + values.covenant_periods + "'," +
                    " physical_buffer_days = '" + values.buffer_days + "', " +
                     " physical_bufferday_updatedby='" + user_gid + "', " +
               " physical_covenantperiod_updatedby='" + user_gid + "'," +
               " physical_covenantperiod_updateddate='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'," +
        ...
        public void DaGetPhysicalCovenantPeriodsSummary(mdlscannedcovenantperiodlist values, string groupdocumentdtl_gid)
        {
            msSQL = " select a.covenantperioddtl_gid,a.groupdocumentdtl_gid, a.credit_gid, " +
                    " CASE WHEN a.physical_covenant_periods is null THEN (select covenant_periods from agr_trn_tcovanantdocumentcheckdtls e " +
                    ...
                    " CASE WHEN a.physical_buffer_days is null THEN (select buffer_days from agr_trn_tcovanantdocumentcheckdtls e " +
                    " where e.groupcovdocumentchecklist_gid = '" + groupdocumentdtl_gid + "'  group by e.groupcovdocumentchecklist_gid ) " +
        ...
        public void DaGetcancelPhysicalCovenantPeriod(mdlscannedcovenantperiod values, result objresult, string user_gid)
        {
            ...
            if (mnResult == 1)
            {
                msSQL = "select physical_covenant_periods from agr_trn_tcovenantperioddtl where groupdocumentdtl_gid='" + values.groupdocumentdtl_gid + "'";
                ...
                msSQL = "select physical_buffer_days from agr_trn_tcovenantperioddtl where groupdocumentdtl_gid='" + values.groupdocumentdtl_gid + "'";
                string lsbuffer_days = objdbconn.GetExecuteScalar(msSQL);
                if (lsbuffer_days != "")
                    values.previous_bufferdays = lsbuffer_days;

                msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physical_covenant_periods='" + values.previous_covenantperiods + "'," +
                ...
                " where groupcovdocumentchecklist_gid='" + values.groupdocumentdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physical_covenant_periods='" + values.previous_covenantperiods + "'," +
             " physical_buffer_days = '" + values.previous_bufferdays + "', " +
                    " physical_bufferday_updatedby='" + user_gid + "', " +
                    " physical_covenantperiod_updatedby='" + user_gid + "'," +
              " physical_covenantperiod_updateddate='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'," +
        ...
        public void DaupdatePhysicalAutomaticCompletion(string application_gid, string user_gid, result values)
        {
            ...
            if (overall_approvalstatus == "Approved")
            {
                msSQL = " select (select count(*) from agr_trn_tgroupdocumentchecklist where application_gid='" + application_gid + "' " +
                       ...
                       " (select COUNT(DISTINCT groupdocumentchecklist_gid) from agr_trn_tphysicaldocument A " +
        ...
        public void DaGetCADPhysicalDocFollowupSummary(physicalmakerapplicationlist values, string employee_gid)
        {
            msSQL = " (select a.application_gid,d.processtypeassign_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, " +
                    ...
                    " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                    " left join agr_trn_tprocesstype_assign d on d.application_gid = a.application_gid " +
                    " where a.process_type = 'Accept' and d.menu_gid = 'AGDMGTPYD'" +
                    " and a.docchecklist_approvalflag = 'Y' and d.maker_approvalflag='Y' and d.checker_approvalflag = 'Y' and d.completed_flag='N'  and d.approver_approvalflag='Y'" +
                    " order by d.created_date desc)";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<physicalmakerapplication>();
                ...
                if (httpRequest.Files.Count > 0)
                {
                    if (lscovenant_type == "Y")
                    {
                        msSQL = " select groupcovdocumentchecklist_gid as groupdocumentchecklist_gid,credit_gid,mstdocumenttype_gid,mstdocumenttype_name, " +
                               " mstdocument_name from agr_trn_tgroupcovenantdocumentchecklist " +
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        if (dt_datatable.Rows.Count != 0)
                        {
                            foreach (DataRow dt in dt_datatable.Rows)
                            {
                                ...
                                string msGetCode = objcmnfunctions.GetMasterGID("OCVC");
                                msGetGid = objcmnfunctions.GetMasterGID("PYDO");
                                msSQL = " insert into agr_trn_tphysicaldocument( " +
                                            " physicaldocument_gid," +
                                            " physicaldocument_code," +
        ...
        public void DaPostMultipleInitiateExtensionorwaiver(mdlmultipleinitiateextendwaiver values, string user_gid)
        {
            ...
            if (lsdocumentcheckdtl_gid != "")
            {
                ...
                if (values.covenant_type == "Y")
                {
                    msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='" + lsstatus + "' " +
                            " where groupcovdocumentchecklist_gid in (" + lsdocumentcheckdtl_gid + ")";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='" + lsstatus + "' " +
                            " where groupcovdocumentchecklist_gid in (" + lsdocumentcheckdtl_gid + ")";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                else
                {
                    msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='" + lsstatus + "' " +
                            " where groupdocumentchecklist_gid in (" + lsdocumentcheckdtl_gid + ")";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='" + lsstatus + "' " +
                            " where groupdocumentchecklist_gid in (" + lsdocumentcheckdtl_gid + ")";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
        ...
        public void DaPostPhysicalDocSent(string user_gid, Mdldocumentsend values)
        {
            try
            {
                ...
                if (mnResult == 1)
                {
                    if (values.covenant_type == "Y")
                    {
                        msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='" + values.document_status + "'" +
                                " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    else
                    {
                        msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='" + values.document_status + "'" +
                                " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                }
            ...
            if (mnResult == 1)
            {
                ...
                if (lscovenant != "")
                {
                    if (values.query_status == "Y")
                    {
                        ...
                        //msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Query - Raised', physicalcopyquerystatus='Query - Raised' " +
                        //        " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                else
                {
                    if (values.query_status == "Y")
                    {
                        ...
                        //msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Query - Raised', physicalcopyquerystatus='Query - Raised' " +
                        //        " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        //mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                if (values.query_status == "Y")
                {
                    ...
                    string lsquery_title = "", lsquery_description = "";
                    msSQL = " select  concat( g.user_firstname, ' ', g.user_lastname, ' / ', g.user_code) as raised_by, " +
                          ...
                          " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as raised_date from agr_trn_ttagquery a " +
                          "  left join adm_mst_tuser g on g.user_gid = a.created_by  " +
                          " where tagquery_gid='" + values.tagquery_gid + "'";
                    objODBCDataReader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDataReader.HasRows == true)
                    {
                        ls_raised_by = objODBCDataReader["raised_by"].ToString();
                        ls_raised_date = objODBCDataReader["raised_date"].ToString();
                        lsapplication_gid = objODBCDataReader["application_gid"].ToString();
                        lsquery_title = objODBCDataReader["query_title"].ToString();
                        lsquery_description = objODBCDataReader["query_description"].ToString();
                    }
                    ...
                    if (objODBCDataReader.HasRows == true)
                    {
                        ls_relationshipmanager_gid = objODBCDataReader["relationshipmanager_gid"].ToString();
                        ls_relationshipmanager_name = objODBCDataReader["relationshipmanager_name"].ToString();
                        ls_customerref_name = objODBCDataReader["customerref_name"].ToString();
                        ls_application_no = objODBCDataReader["application_no"].ToString();
                    }
                    objODBCDataReader.Close();

                    msSQL = " select groupcovdocumentchecklist_gid from agr_trn_tgroupcovenantdocumentchecklist " +
                      " where groupcovdocumentchecklist_gid ='" + values.documentcheckdtl_gid + "'";
                    string lscovenantlist = objdbconn.GetExecuteScalar(msSQL);
                    if (lscovenantlist != "")
                    {
                        msSQL = " select mstdocument_name as documenttype_name  from agr_trn_tgroupcovenantdocumentchecklist " +
                              " where groupcovdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        documenttype_name = objdbconn.GetExecuteScalar(msSQL);
                    }
                    else
                    {
                        msSQL = " select mstdocument_name as documenttype_name  from agr_trn_tgroupdocumentchecklist " +
                               " where groupdocumentchecklist_gid='" + values.documentcheckdtl_gid + "'";
                        documenttype_name = objdbconn.GetExecuteScalar(msSQL);
                    }


                    msSQL = " select  concat( g.user_firstname, ' ', g.user_lastname, ' / ', g.user_code) as raised_by,date_format(a.created_date,'%d-%m-%Y %h:%i %p') as raised_date from agr_trn_ttagquery a " +
                            "  left join adm_mst_tuser g on g.user_gid = a.created_by  " +
                            " where tagquery_gid='" + values.tagquery_gid + "'";
                    objODBCDataReader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDataReader.HasRows == true)
                    ...
                    msSQL = " select institution_gid from  agr_mst_tinstitution where stakeholder_type = 'Applicant' and application_gid = '" + lsapplication_gid + "'";
                    objODBCDataReader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDataReader.HasRows == true)
                    {
                        msSQL = " select company_name from  agr_mst_tinstitution where stakeholder_type = 'Applicant' and application_gid = '" + lsapplication_gid + "'";
                        lscompany_name = objdbconn.GetExecuteScalar(msSQL);
                    }
                    else
                    {
                        msSQL = " select concat(first_name,middle_name,last_name) from  agr_mst_tcontact where stakeholder_type = 'Applicant' and application_gid = '" + lsapplication_gid + "'";
                        lscompany_name = objdbconn.GetExecuteScalar(msSQL);
                    }
                    ...
                    msSQL = " select b.employee_emailid from agr_trn_tprocesstype_assign a " +
                    ...
                    msSQL = " select c.employee_emailid from agr_trn_tprocesstype_assign a " +
                            " left join hrm_mst_temployee c on c.employee_gid = a.checker_gid " +
                            " where application_gid = '" + lsapplication_gid + "' ";
                    cc1_mailid = objdbconn.GetExecuteScalar(msSQL);

                    msSQL = " select c.employee_emailid from agr_mst_tapplication a " +
                    ...
                    sub1 = "\"" + lscompany_name + "\"  \"" + ls_application_no + "\" – A query has been raised by PMG ";
                    ...
                    body1 = body1 + "<br />";
                    body1 = body1 + "&nbsp&nbsp Login " + ConfigurationManager.AppSettings["livedomain_url"].ToString() + " > Sam Agro > Customer info > Customer 360 > Process <br /> ";
                    body1 = body1 + "&nbsp&nbsp button in action (Associated to the customer name) > Deferral/Covenant > <br /> ";
                    body1 = body1 + "<br />";
                    body1 = body1 + "&nbsp&nbsp This is a system generated mail, do not reply. Reach out to PMG for queries.<br /> ";
                    body1 = body1 + "<br />";
        ...
        {
            msSQL = " delete from agr_trn_tphysicaldocument where groupdocumentchecklist_gid='" + tagquery_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult == 1)
                values.status = true;
            else
            ...
            foreach (var i in values.mdlapprovaldtl)
            {
                ...
                if (i.approval_status == "Approved")
                {
                    ...
                    else if (lsactivity_type == "Tag to Deferral")
                    {
                        ...
                        msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Deferral Accepted' " +
                                " where groupdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Deferral Accepted' " +
                               " where groupcovdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    //}
                ...
                else
                {
                    ...
                    if (lscovenant != "")
                    {
                        msSQL = " update agr_trn_tcovanantdocumentcheckdtls set physicaloverall_docstatus='" + i.approval_status + " - " + lsactivity_type + "'" +
                              " where groupcovdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='" + i.approval_status + " - " + lsactivity_type + "'" +
                                " where groupcovdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    else
                    {
                        msSQL = " update agr_trn_tdocumentchecktls set physicaloverall_docstatus='" + i.approval_status + " - " + lsactivity_type + "'" +
                          " where groupdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='" + i.approval_status + " - " + lsactivity_type + "'" +
                                  " where groupdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    ...
                    if (lsactivity_type == "Tag to Deferral")
                    {
                        ...
                        msSQL = " update agr_trn_tgroupdocumentchecklist set physicaloverall_docstatus='Deferral Rejected' " +
                                " where groupdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " update agr_trn_tgroupcovenantdocumentchecklist set physicaloverall_docstatus='Deferral Rejected' " +
                               " where groupcovdocumentchecklist_gid='" + i.documentcheckdtl_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                }
        ...
        public void DaOriginalcopyVettingDocExport(MdlCADExportConversation values)
        {
            ...
            var query_no = objdbconn.GetExecuteScalar("SELECT MAX(query_no) FROM agr_trn_ttagquery WHERE  application_gid ='" + values.application_gid + "' AND  fromphysical_document = 'Y' and query_status not in ('Pending','Cancelled')");
            ...
            if (dt_datatable.Rows.Count != 0)
            {
                ...
                try
                {
                    ...
                    var path = HttpContext.Current.Server.MapPath("../../../erpdocument" + "/" + lscompany_code + "/" + "SamAgro/PMG Original Copy vetting/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/");
                    values.attachment_path = HttpContext.Current.Server.MapPath("../../../erpdocument" + "/" + lscompany_code + "/" + "SamAgro/PMG Original Copy vetting/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + values.attachment_name);
                    values.attachment_cloudpath = lscompany_code + "/" + "SamAgro/PMG Original Copy vetting/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + values.attachment_name;
                    ...
                    workSheet.Cells["B1"].Value = "PMG Original Copy vetting -";
                    ...
                    workSheet.Cells["B8"].Value = "AC Approved date";
                    using (var range = workSheet.Cells["B8"])
                    {
                        range.Style.Font.Bold = true;
                    }
                    ...
                    {
                        workSheet.Cells["B1"].Value = "PMG Softcopy vetting -" + objODBCDataReader["customer_name"].ToString();
                    ...
                    excel.SaveAs(ms);
                    bool status;
                    status = objcmnstorage.UploadStream("erpdocument", lscompany_code + "/" + "SamAgro/PMG Original Copy vetting/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + values.attachment_name, ms);
                    ms.Close();
