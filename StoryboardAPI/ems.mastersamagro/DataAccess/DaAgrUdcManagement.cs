...
{
    /// <summary>
    /// This DataAccess provide access to buyer cheque management flow
    /// </summary>
    /// <remarks>Written by Premchandar.K </remarks>

    public class DaAgrUdcManagement
    {
        ...
        public void DaPostChequeDetail(string employee_gid, MdlCheque values)
        {
            ...
            msSQL = " insert into agr_mst_tudcmanagement2cheque(" +
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tcheque2document set udcmanagement2cheque_gid ='" + msGetGid + "' where udcmanagement2cheque_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = " insert into agr_mst_tudcmanagement(" +
                        " udcmanagement_gid," +
                        " customer_gid," +
                        " customer_name," +
                        " application_gid," +
        ...
        public void DaGetChequeSummary(string employee_gid, MdlCheque values)
        {
            ...
            msSQL = " select udcmanagement2cheque_gid, cheque_no, stakeholder_name, mergedbankingentity_name ,cheque_type ,cts_enabled " +
                    " from agr_mst_tudcmanagement2cheque" +
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " delete from agr_mst_tcheque2document where udcmanagement2cheque_gid = '" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = " insert into agr_mst_tcheque2document( " +
                                    " cheque2document_gid," +
                                    " udcmanagement2cheque_gid," +
                                    " document_gid ," +
                                    " document_name ," +
        ...
        {
            msSQL = " select cheque2document_gid ,document_name,document_path from agr_mst_tcheque2document " +
        ...
        {
            msSQL = "delete from agr_mst_tcheque2document where cheque2document_gid='" + cheque2document_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaUpdateChequeDetail(string employee_gid, MdlCheque values)
        {
            msSQL = " select mergedbankingentity_gid,mergedbankingentity_name,special_condition," +
                    ...
                    " from agr_mst_tudcmanagement2cheque where udcmanagement2cheque_gid='" + values.udcmanagement2cheque_gid + "'";
            ...
            try
            {
                msSQL = " update agr_mst_tudcmanagement2cheque set " +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into agr_mst_tudcmanagement2chequeupdatelog(" +
        ...
        public void DaChequeDetailsEdit(string udcmanagement2cheque_gid, MdlCheque values)
        {
            try
            {
                msSQL = " select stakeholder_gid, stakeholder_name, stakeholder_type,designation,accountholder_name,account_number,bank_name,cheque_no," +
                    ...
                    " from agr_mst_tudcmanagement2cheque where udcmanagement2cheque_gid='" + udcmanagement2cheque_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        {
            msSQL = "delete from agr_mst_tudcmanagement2cheque where udcmanagement2cheque_gid='" + udcmanagement2cheque_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaUdcDetailsEdit(string udcmanagement_gid, MdlUdcManagement values)
        {
            try
            {
                msSQL = " select customer_gid,customer_name" +
                    " from agr_mst_tudcmanagement where udcmanagement_gid='" + udcmanagement_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void DaUpdateUdcDetail(string employee_gid, MdlUdcManagement values)
        {
            ...
            msSQL = "update agr_mst_tudcmanagement2cheque set udcmanagement_gid ='" + values.udcmanagement_gid + "' where udcmanagement_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetUdcSummary(string employee_gid, string application_gid, MdlUdcManagement values)
        {
            ...
            msSQL = " select d.udcmanagement2cheque_gid,a.udcmanagement_gid, a.customer_name , a.sanctionrefno_name, a.udc_status, date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date," +
                    ...
                    " from agr_mst_tudcmanagement a" +
                    " left join hrm_mst_temployee b on b.employee_gid=a.created_by " +
                    " left join adm_mst_tuser c on c.user_gid=b.user_gid" +
                    " left join agr_mst_tudcmanagement2cheque d on d.udcmanagement_gid=a.udcmanagement_gid " +
        ...
        {
            msSQL = "select udcmanagement2cheque_gid from agr_mst_tudcmanagement2cheque where udcmanagement_gid ='" + udcmanagement_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            msSQL = "delete from agr_mst_tudcmanagement where udcmanagement_gid='" + udcmanagement_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaGetUdcTempClear(string employee_gid, result values)
        {
            ...
            msSQL = "delete from agr_mst_tudcmanagement2cheque where udcmanagement_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetChequeMakerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name,f.sanction_refno, " +
                     ...
                     " e.maker_gid = '" + employee_gid + "' and e.maker_approvalflag = 'N' and (select approver_approvalflag from agr_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'" +
        ...
        public void DaGetChequeFollowupMakerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name,g.sanction_refno, " +
                     ...
                     " concat(c.user_firstname, ' ', c.user_lastname, ' / ', c.user_code) as cadaccepted_by, " +
                     " date_format(a.processupdated_date, '%d-%m-%Y %h:%i %p') as cadaccepted_date, a.created_by,  " +
                     " a.creditgroup_gid,e.cadgroup_name,f.approval_status as followup_status,a.customer_urn from agr_mst_tapplication a " +
                     " left join hrm_mst_temployee b on b.employee_gid = a.processupdated_by " +
                     " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                     " left join agr_trn_tprocesstype_assign e on e.application_gid = a.application_gid " +
                     " left join agr_trn_tapplication2chequelist f on f.application_gid = a.application_gid " +
                     " left join agr_trn_tapplication2sanction g on g.application_gid = a.application_gid " +
        ...
        public void DaGetChequeCheckerSummary(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, f.sanction_refno, " +
                     ...
                     " and (select approver_approvalflag from agr_trn_tprocesstype_assign where menu_gid = 'CADMGTSAN' and application_gid = a.application_gid) = 'Y'" +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
            if (dt_datatable.Rows.Count != 0)
        ...
        public void DaGetChequeCompletedApprover(string employee_gid, MdlUdcManagement values)
        {
            msSQL = " select a.application_gid,a.application_no,a.customerref_name,a.customer_urn,a.creditgroup_name, f.sanction_refno," +
                     ...
                     " left join hrm_mst_temployee b on b.employee_gid = a.processupdated_by " +
                     " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                     " left join agr_mst_tudcmanagement d on d.application_gid = a.application_gid " +
                     " left join agr_trn_tprocesstype_assign e on e.application_gid = a.application_gid " +
                      " left join agr_trn_tapplication2sanction f on f.application_gid = a.application_gid " +
                     " where a.process_type = 'Accept' and e.approver_approvalflag = 'Y' and " +
                     " e.menu_gid = '" + getMenuClass.ChequeManagement + "' " +
                     " group by a.application_gid order by a.updated_date desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<cadapplicationlist>();
            if (dt_datatable.Rows.Count != 0)
        ...
        {
            msSQL = " select count(a.application_gid) as MakerPendingCount from agr_trn_tprocesstype_assign a " +
            ...
            msSQL = " select count(a.application_gid) as MakerFollowUpCount from agr_trn_tprocesstype_assign a " +
                    " left join agr_mst_tapplication b on a.application_gid = b.application_gid " +
            ...
            msSQL = " select count(a.application_gid) as CheckerPendingCount from agr_trn_tprocesstype_assign a " +
                    " left join agr_mst_tapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = '" + getMenuClass.ChequeManagement + "' and " +
            ...
            msSQL = " select count(a.application_gid) as CheckerFollowUpCount from agr_trn_tprocesstype_assign a " +
                    " left join agr_mst_tapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = '" + getMenuClass.ChequeManagement + "' and " +
            ...
            msSQL = " select count(a.application_gid) as ApproverPendingCount from agr_trn_tprocesstype_assign a " +
                    " left join agr_mst_tapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = '" + getMenuClass.ChequeManagement + "' and " +
            ...
            msSQL = " select count(a.application_gid) as CompletedCount from agr_trn_tprocesstype_assign a " +
                    " left join agr_mst_tapplication b on a.application_gid = b.application_gid " +
                    " where b.process_type = 'Accept' and a.menu_gid = '" + getMenuClass.ChequeManagement + "' and " +
        ...
        public void DaPostChequeMakerSubmit(string employee_gid, Mdlmakerchequedetails values)
        {
            ...
            msSQL = " insert into agr_trn_tapplication2chequelist(" +
        ...
        {
            msSQL = " update agr_trn_tapplication2chequelist set checkerapproved_by='" + employee_gid + "', " +
        ...
        {
            msSQL = " update agr_trn_tapplication2chequelist set approved_by='" + employee_gid + "', " +
        ...
        public void DaGetApprovalDetails(string application_gid, MdlChequeApprovalDetails values)
        {
            try
            {
                msSQL = " select application_gid,maker_name,checker_name,approver_name,maker_approveddate,checker_approveddate,approver_approveddate " +
                        " from agr_trn_tprocesstype_assign where processtype_name = 'Accept' and menu_gid = '" + getMenuClass.ChequeManagement + "' and application_gid='" + application_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
