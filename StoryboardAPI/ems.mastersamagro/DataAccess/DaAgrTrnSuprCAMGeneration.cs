...
{
    /// <summary>
    /// This DataAccess will help to generate CAM document in supplier credit and pmg stages
    /// </summary>
    /// <remarks>Written by Sherin Augusta </remarks>
    public class DaAgrTrnSuprCAMGeneration
    {
        ...
        public void DaGetCAMTemplate(string application_gid, MdlMstCAMGeneration values)
        {
            try
            {
                ...
                { //Address, PAN
                    msSQL = "select contact_gid,pan_no from agr_mst_tsuprcontact where application_gid='" + application_gid + "' and stakeholder_type in ('Applicant','Borrower')";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                    ...
                    msSQL = " select concat(addressline1,',', addressline2,',', taluka,',',city , ',',district,',',state ,'-'," +
                           " postal_code, ',', country)  as address from agr_mst_tsuprcontact2address where contact_gid='" + lsGID + "' and primary_status='Yes'";
                ...
                { //Address, PAN , CIN
                    msSQL = "select institution_gid,companypan_no,cin_no from agr_mst_tsuprinstitution where application_gid='" + application_gid + "' and stakeholder_type in ('Applicant','Borrower')";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                    ...
                    msSQL = " select concat(addressline1,',', addressline2,',', taluka,',',city , ',',district,',',state ,'-'," +
                           " postal_code, ',', country)  as address from agr_mst_tsuprinstitution2address where institution_gid='" + lsGID + "' and primary_status='Yes'";
                    lsaddress = objdbconn.GetExecuteScalar(msSQL);
                }
                ...
                msSQL = " select concat(first_name,' ' ,middle_name,' ',last_name) as individual_name,age,designation_name  from agr_mst_tsuprcontact" +
                    " where  application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select concat(contactpersonfirst_name,' ',contactpersonmiddle_name,' ' ,contactpersonlast_name) as contact_person," +
                    " c.email_address,b.mobile_no,designation_type from agr_mst_tsuprapplication a " +
                   " left join agr_mst_tsuprapplication2contactno b on a.application_gid=b.application_gid" +
                   " left join agr_mst_tsuprapplication2email c  on a.application_gid = c.application_gid  where a.application_gid='" + application_gid + "' and" +
                ...
                msSQL = " select  bank_name,facility_type,outstanding_amount,account_classification,fundedtypeindicator_name," +
                        " sanctioned_limit from agr_mst_tsuprcreditbankfacilitydtl where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = " select  bank_name,currentoutsatnding_amount,account_classification," +
                        " sanction_amount from agr_mst_tsuprcreditbankfacilitydtl where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                //supplier Info
                msSQL = " select supplier_name,relationship_vintage_year,purchase_amount,bankdebit_amount from agr_mst_tsuprcreditsupplier where " +
                ...
                string lsloanGID = objdbconn.GetExecuteScalar(" select quote(group_concat(application2loan_gid)) from agr_mst_tsuprapplication2loan where  " +
                ...
                else
                {
                    ...
                    msSQL = " select buyer_name, '' as relationship_vintage_year, '' as relationship_vintage_month from agr_mst_tsuprapplication2buyer where application2loan_gid in (" + lsloanGID + ") " +
                            " union " +
                ...
                msSQL = "select product_type from agr_mst_tsuprapplication2loan where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select product_type, tenureoverall_limit from agr_mst_tsuprapplication2loan where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select product_type, facilityoverall_limit from agr_mst_tsuprapplication2loan where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaPostWordGenerate(string employee_gid, MdlMstCAMGeneration values)
        {
            try
            {
                ...
                msSQL = " update agr_mst_tsuprapplication set cam_content='" + values.content.Replace("'", "''") + "'," +
        ...
        {
            msSQL = " select cam_content,document_path,document_name from agr_mst_tsuprapplication where application_gid='" + application_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
