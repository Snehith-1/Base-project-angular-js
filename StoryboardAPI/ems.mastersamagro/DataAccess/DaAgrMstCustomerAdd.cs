...
{
    /// <summary>
    /// This DataAccess will provide access to fetch data from Customer master in custopedia.
    /// </summary>
    /// <remarks>Written by Abilash.A</remarks>
    public class DaAgrMstCustomerAdd
    {
      ...
      string lsprimary_mobileno = objdbconn.GetExecuteScalar(msSQL);
        ...
        public bool DaPostUploadPhoto(HttpRequest httpRequest, UploadDocumentname objfilename, string employee_gid, string user_gid)
        {
           // UploadDocumentList objdocumentmodel = new UploadDocumentList();
            ...
            //path = ConfigurationManager.AppSettings["file_path"] + "/erp_documents" + "/" + lscompany_code + "/" + "SamAgro/photos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";
            path = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "SamAgro/photos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";
            {
            ...
            if ((FileExtension == ".jpg") || (FileExtension == ".jpeg") || (FileExtension == ".png") || (FileExtension == ".tif") || (FileExtension == ".tiff") || (FileExtension == ".jfif") || (FileExtension == ".gif"))
            {
                ...
                //lspath = "../../erp_documents" + "/" + lscompany_code + "/" + "SamAgro/photos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + msdocument_gid + FileExtension;
                ...
                bool status;
                status = objcmnstorage.UploadStream("erpdocument", lscompany_code + "/" + "SamAgro/photos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + msdocument_gid + FileExtension, ms);
                ms.Close();
                lspath = "erpdocument" + "/" + lscompany_code + "/" + "SamAgro/photos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";
        ...
        {
            msSQL = "select customer2usertype_gid from ocs_mst_tcustomer2mobileno where customer2usertype_gid='" + employee_gid + "' and primary_mobileno='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select customer2usertype_gid from ocs_mst_tcustomer2address where customer2usertype_gid='" + employee_gid + "' and primary_address='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
           ...
           if(lsuser_type== values.user_type)
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "select created_by from ocs_tmp_tphotoupload where created_by='" + employee_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if(objODBCDatareader.HasRows==true)
                {
                    msSQL = "update ocs_mst_tcustomer2userdtl set photo_name ='" + objODBCDatareader["photo_name"].ToString() + "',"+
                        " photo_path='"+ objODBCDatareader["photo_path"].ToString() + "' where customer2usertype_gid='" + msGetGid + "'";
                    objODBCDatareader.Close();
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                values.status = true;
        ...
        public void DaPostCustomerSubmit(string employee_gid, mdlcreatecustomer values)
        {
            ...
            msSQL = "select customer2usertype_gid from ocs_mst_tcustomer2address where customer2usertype_gid='" + lscustomer2userdtl_gid + "' and primary_address='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if(objODBCDatareader.HasRows==true)
            {
        ...
        public void DaGetAge(string dob,string employee_gid, Mdlmobile_no values)
        {
            ...
            catch 
            {
                ...
                {
                    values.status = false;
                    values.message = "Kindly Add Valid Date...";
                }
            }
        }
        ...
        public void DaGetCustomer2UserInfo(string customer2usertype_gid, string employee_gid, mdlcustomer2userdtl values)
        {
            ...
            if(objODBCDatareader.HasRows==true)
            {
                ...
                values.photo_path = HttpContext.Current.Server.MapPath(objODBCDatareader["photo_path"].ToString()); 
        ...
        {
            msSQL = "select customer2usertype_gid from ocs_mst_tcustomer2mobileno where (customer2usertype_gid='" + employee_gid + "' or customer2usertype_gid='" + values.customer2usertype_gid + "') and primary_mobileno='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select customer2usertype_gid from ocs_mst_tcustomer2address where (customer2usertype_gid='" + employee_gid + "' or customer2usertype_gid='" + values.customer2usertype_gid + "') and primary_address='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            if (mnResult != 0)
            {
                ...
                {
                    msSQL = "update ocs_mst_tcustomer2userdtl set photo_name ='" + objODBCDatareader["photo_name"].ToString() + "'," +
                        " photo_path='" + objODBCDatareader["photo_path"].ToString() + "' where customer2usertype_gid='" + values.customer2usertype_gid + "'";
                    objODBCDatareader.Close();
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                values.status = true;
        ...
        {
            msSQL = "select customer_urn from ocs_tmp_tcustomer where customer_urn='" + urn+"'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if(objODBCDatareader .HasRows ==true )
            {
                values.status = true;
        ...
        public void DaGetMyTeamCustomer(MdlCustomer objCustomer,string employee_gid)
        {
            try
            {
                ...
                msSQL = "( select a.customer_gid,a.vertical_code,a.customer_code,a.customer_urn,a.customername,a.contactperson,a.customer_type,  " +
                  ...
                  " from ocs_mst_tcustomer a " +
                  " left join hrm_mst_temployee b on a.created_by = b.employee_gid" +
                  " left join adm_mst_tuser c on b.user_gid = c.user_gid where relationship_manager in ("+ employee_gid + ") " +
                  "  order by a.customer_gid desc ) UNION (" +
                  " select a.tmpcustomer_gid as customer_gid,a.vertical_code,a.customer_code,a.customer_urn,a.customername,a.contactperson,d.customer_type, " +
                  " case when a.zonal_head = '' then 'NA' else a.zonal_name end as zonal_head," +
                  " case when a.business_head = '' then 'NA' else a.businesshead_name end as business_head, " +
