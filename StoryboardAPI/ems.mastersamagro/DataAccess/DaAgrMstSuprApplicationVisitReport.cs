...
{
    /// <summary>
    /// This DataAccess will provide access to various functions in supplier visit report (Visit updates, address, document upload & download events)
    /// </summary>
    /// <remarks>Written by Abilash.A, Premchander.K </remarks>
    public class DaAgrMstSuprApplicationVisitReport
    {
        ...
        {
            msSQL = "select primary_status from agr_mst_tsuprapplicationvisitperson2contactno  where primary_status='Yes' and applicationvisit2person_gid='" + employee_gid + "'";
            ...
            msSQL = "select applicationvisitperson2contact_gid,primary_status from agr_mst_tsuprapplicationvisitperson2contactno  where mobile_no='" + values.mobile_no + "' " +
            ...
            msSQL = " insert into agr_mst_tsuprapplicationvisitperson2contactno (" +
        ...
        public bool DaPostPersonDetails(string employee_gid, mstVisitpersondtl_list values)
        {
            ...
            msSQL = " insert into agr_mst_tsuprapplicationvisit2person (" +
                    " applicationvisit2person_gid," +
                    ...
                    "'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = "update agr_mst_tsuprapplicationvisitperson2contactno  set applicationvisit2person_gid= '" + msGetGid + "' where applicationvisit2person_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {

                values.status = true;
                values.message = "Visited Person Deltails Added Successfully";
                return true;
            }
            else
            {
        ...
        public bool DaPostVisitAddress(string employee_gid, mstVisitpersonaddress_list values)
        {
            ...
            msSQL = " insert into agr_mst_tsuprapplicationvisit2address (" +
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " insert into agr_mst_tsuprapplicationvisit2document( " +
                ...
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        if ((objcmnstorage.CheckIsValidfilename(FileExtension, project_flag) == false) || (objcmnstorage.CheckIsExecutable(bytes) == true))
                        {
                            ...
                            msSQL = " insert into agr_mst_tsuprapplicationvisit2photo ( " +
        ...
        {
            msSQL = "select applicationvisitperson2contact_gid,mobile_no,primary_status,whatsapp_mobileno from agr_mst_tsuprapplicationvisitperson2contactno  where " +
        ...
        {
            msSQL = "select applicationvisit2person_gid,clientrepresentative_name,clientrepresentative_designationgid,clientrepresentative_designationname,personal_mail,office_mail from agr_mst_tsuprapplicationvisit2person  where " +
        ...
        {
            msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,landmark,postal_code,city,taluk,district,state_name,country,latitude,longitude from agr_mst_tsuprapplicationvisit2address  where " +
              " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,landmark,postal_code,city,taluk,district,state_name,latitude,longitude,country from agr_mst_tsuprapplicationvisit2address  where " +
              " applicationvisit_gid='" + applicationvisit_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getmstVisitpersonaddress_list = new List<mstVisitpersonaddress_list>();
            if (dt_datatable.Rows.Count != 0)
        ...
        {
            msSQL = "select applicationvisit2document_gid,document_name,document_path,file_name  from agr_mst_tsuprapplicationvisit2document where " +
              " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select applicationvisit2photo_gid,visitphoto_name,visitphoto_path,file_name  from agr_mst_tsuprapplicationvisit2photo  where " +
              " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisitperson2contactno  where applicationvisitperson2contact_gid='" + applicationvisitperson2contact_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "select applicationvisitperson2contact_gid from agr_mst_tsuprapplicationvisitperson2contactno  where " +
                    " applicationvisit2person_gid='" + applicationvisit2person_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            if (dt_datatable.Rows.Count != 0)
            {
                foreach (DataRow dr_datarow in dt_datatable.Rows)
                {
                    msSQL = "delete from agr_mst_tsuprapplicationvisitperson2contactno  where applicationvisitperson2contact_gid='" + dr_datarow["applicationvisitperson2contact_gid"].ToString() + "'";
                    mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            dt_datatable.Dispose();
            msSQL = "delete from agr_mst_tsuprapplicationvisit2person  where applicationvisit2person_gid='" + applicationvisit2person_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisit2address  where applicationvisit2address_gid='" + applicationvisit2address_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisit2document where applicationvisit2document_gid='" + applicationvisit2document_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisit2photo  where applicationvisit2photo_gid='" + applicationvisit2photo_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisitperson2contactno  where applicationvisit2person_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "select applicationvisit2person_gid from agr_mst_tsuprapplicationvisit2person  where " +
                    " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            if (dt_datatable.Rows.Count != 0)
            {
                foreach (DataRow dr_datarow in dt_datatable.Rows)
                {
                    msSQL = "delete from agr_mst_tsuprapplicationvisitperson2contactno  where applicationvisit2person_gid='" + dr_datarow["applicationvisit2person_gid"].ToString() + "'";
                    mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            dt_datatable.Dispose();
            msSQL = "delete from agr_mst_tsuprapplicationvisit2person  where applicationvisit_gid ='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
                values.message = "Visited Person Details Deleted Successfully";
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisit2address  where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisit2document where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsuprapplicationvisit2photo  where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        public bool DaPostApplicationVisitReport(string employee_gid, string user_gid, MdlMstVisitPerson values)
        {
            ...
            {
                lsins_refno = "VSTSPBV" + DateTime.Now.ToString("yyyyMMdd");
            ...
            else
            {
                ...
                lsins_refno = "VSTSPCV" + DateTime.Now.ToString("yyyyMMdd");
            ...
            msSQL = " insert into agr_mst_tsuprapplicationvisitreport (" +
                    " applicationvisit_gid," +
                     " visitreport_id," +
                    " application_gid," +
            ...
            else
            {
                for (var i = 0; i < values.mstinspectingofficials.Count; i++)
                {
                    ...
                    msSQL = "Insert into agr_mst_tsuprapplicationvisit2inspectingofficial ( " +
            ...
            else
            {
                for (var i = 0; i < values.mdlvisitdone.Count; i++)
                {
                    ...
                    msSQL = "Insert into agr_mst_tsuprapplicationvisit2visitdone( " +
            ...
            msSQL = "update agr_mst_tsuprapplicationvisit2person  set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update agr_mst_tsuprapplicationvisit2address  set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update agr_mst_tsuprapplicationvisit2document set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update agr_mst_tsuprapplicationvisit2photo  set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaEditApplicationVisitaddress(string applicationvisit2address_gid, mstVisitpersonaddress_list values)
        {
            try
            {
                msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,latitude, longitude,landmark,postal_code,city,taluk,district,state_name,country from agr_mst_tsuprapplicationvisit2address  where " +
        ...
        public void DaEditApplicationVisitpersondtl(string applicationvisit2person_gid, mstVisitpersondtl_list values)
        {
            try
            {
                msSQL = "select applicationvisit2person_gid,clientrepresentative_name,clientrepresentative_designationgid,clientrepresentative_designationname," +
                       " personal_mail,office_mail from agr_mst_tsuprapplicationvisit2person  where " +
                       " applicationvisit2person_gid='" + applicationvisit2person_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public bool DaPostPersonDetailsUpdate(string employee_gid, mstVisitpersondtl_list values)
        {
            ...
            msSQL = " update agr_mst_tsuprapplicationvisit2person  set clientrepresentative_name='" + values.clientrepresentative_name + "'," +
            ...
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = "update agr_mst_tsuprapplicationvisitperson2contactno  set applicationvisit2person_gid= '" + values.applicationvisit2person_gid + "' where applicationvisit2person_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
                values.status = true;
        ...
        {
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = " update agr_mst_tsuprapplicationvisit2address  set addresstype_gid='" + values.addresstype_gid + "'," +
        ...
        {
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2person  where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2address  where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2document where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2photo  where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select date_format(applicationvisit_date,'%d-%m-%Y') as applicationvisit_date from agr_mst_tsuprapplicationvisitreport  where applicationvisit_gid='" + values.applicationvisit_gid + "'";
            ...
            msSQL = "update agr_mst_tsuprapplicationvisitreport  set " +
            ...
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = " delete from agr_mst_tsuprapplicationvisit2inspectingofficial  where applicationvisit_gid ='" + values.applicationvisit_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
            ...
            msSQL = " delete from agr_mst_tsuprapplicationvisit2visitdone where applicationvisit_gid ='" + values.applicationvisit_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
                for (var i = 0; i < values.mdlvisitdone.Count; i++)
            ...
            msSQL = "update agr_mst_tsuprapplicationvisit2person  set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update agr_mst_tsuprapplicationvisit2address  set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update agr_mst_tsuprapplicationvisit2document set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update agr_mst_tsuprapplicationvisit2photo  set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        {
            msSQL = "select visitreport_id, concat(c.user_firstname,' ',c.user_lastname,'/',c.user_code) as created_by,draft_flag, date_format(a.created_date,'%d-%m-%Y %H:%m:%s') as created_date, date_format(a.applicationvisit_date,'%d-%m-%Y') as applicationvisit_date,a.applicationvisit_gid  from agr_mst_tsuprapplicationvisitreport  a " +
        ...
        public void DaEditApplicationVisitReport(string applicationvisit_gid, MdlMstVisitPerson values)
        {
            try
            {
                msSQL = "select applicationvisit_gid,visitreport_id,date_format(applicationvisit_date,'%d-%m-%Y') as applicationvisit_date,clientkmp_activities," +
                    ...
                    " summary,draft_flag from agr_mst_tsuprapplicationvisitreport  where " +
                       " applicationvisit_gid='" + applicationvisit_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    ...
                    msSQL = " select inspectingofficials_gid,inspectingofficials_name,applicationvisit2inspectingofficial_gid from agr_mst_tsuprapplicationvisit2inspectingofficial  " +
                    ...
                    msSQL = " select visitdone_name,visitdone_gid,applicationvisit2visitdone_gid from agr_mst_tsuprapplicationvisit2visitdone " +
                 " where applicationvisit_gid='" + applicationvisit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2person  where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2address  where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2document where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from agr_mst_tsuprapplicationvisit2photo  where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
        ...
        public void DaGetVisitReportDtls(string visitreport_gid, MdlMstVisitPersonView values)
        {
            try
            {
               ...
               " from agr_mst_tsuprapplicationvisitreport  a " +
               " left join agr_mst_tsuprapplicationvisit2inspectingofficial  b on a.applicationvisit_gid = b.applicationvisit_gid" +
               " left join agr_mst_tsuprapplicationvisit2visitdone c on c.applicationvisit_gid = a.applicationvisit_gid " +
               " where a.applicationvisit_gid='" + visitreport_gid + "'";
                ...
                msSQL = "select applicationvisit2person_gid,clientrepresentative_name,clientrepresentative_designationname,personal_mail,office_mail from agr_mst_tsuprapplicationvisit2person  where " +
                ...
                msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,landmark,postal_code,city,taluk,district,state_gid,state_name,latitude,longitude,country from agr_mst_tsuprapplicationvisit2address  where " +
                        " applicationvisit_gid='" + visitreport_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getmstVisitpersonaddress_list = new List<mstVisitpersonaddress_list>();
                if (dt_datatable.Rows.Count != 0)
                ...
                msSQL = "select applicationvisit2document_gid,document_name,document_path,file_name,date_format(created_date,'%d-%m-%Y') as created_date  from agr_mst_tsuprapplicationvisit2document where " +
                        " applicationvisit_gid='" + visitreport_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getUploadDocumentList = new List<UploadDocumentList>();
                if (dt_datatable.Rows.Count != 0)
                ...
                msSQL = "select applicationvisit2photo_gid,visitphoto_name,visitphoto_path,file_name,date_format(created_date,'%d-%m-%Y') as created_date  from agr_mst_tsuprapplicationvisit2photo  where " +
                        " applicationvisit_gid='" + visitreport_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getUploadphotoList = new List<UploadphotoList>();
                if (dt_datatable.Rows.Count != 0)
