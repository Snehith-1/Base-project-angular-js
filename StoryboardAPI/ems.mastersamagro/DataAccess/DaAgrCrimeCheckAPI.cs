...
{
    /// <summary>
    /// This DataAccess provide access for various events ( 1. CrimeRecord for individual, company 
    /// TaggedCase , 2. CC CaseTagged for individual, Company) in CrimeCheck API - Buyer.
    /// </summary>
    /// <remarks>Written by Praveen </remarks>
    public class DaAgrCrimeCheckAPI
    {
        ...
        string page = "10";
         ...
         public MdlIndividualCrimeRecordResponse DaGetCrimeRecordsIndividual(string employee_gid, MdlIndividualCrimeRecordRequest values)
         {
             ...
             try
             {
                ...
                msSQL = "select crimechecksearchrecord_gid from agr_trn_tcrimechecksearchrecord where contact_gid='" + values.contact_gid + "' and created_by='" + employee_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == false)
                {

                    msGetGid = objcmnfunctions.GetMasterGID("CASR");
                    msSQL = " insert into agr_trn_tcrimechecksearchrecord(" +
        ...
        public MdlCompanyCrimeRecordResponse DaGetCrimeRecordsCompany(string employee_gid, MdlCompanyCrimeRecordRequest values)
        {
            ...
            try
            {
                ...
                msSQL = "select crimechecksearchrecord_gid from agr_trn_tcrimechecksearchrecord where institution_gid='" + values.institution_gid + "' and created_by='" + employee_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == false)
                {
        ...
        public MdlIndividualCrimeReportRequestResponse DaRequestCrimeReportIndividual(string employee_gid, MdlIndividualCrimeReportRequest values)
        {
            ...
            {               
                ...
                if(ObjMdlIndividualCrimeReportRequestResponse.Status == "OK")
                {
                    ...
                    msSQL = " insert into agr_mst_tcrimereportcontact( " +
                    ...
                    msSQL = "select crimecheckrtsearchrecord_gid from agr_trn_tcrimecheckrtsearchrecord where contact_gid='" + values.contact_gid + "' and created_by='" + employee_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == false)
                    {

                        msGetGid = objcmnfunctions.GetMasterGID("CCRS");
                        msSQL = " insert into agr_trn_tcrimecheckrtsearchrecord(" +
        ...
        public MdlCallbackResponse DaPostCallbackReportDetailsIndividual(MdlCallbackResponse values)
        {
            try
            {
                ...
                msSQL = "select crimereportcontact_gid from samunnati.agr_mst_tcrimereportcontact where request_id='" + ObjMdlIndividualCrimeReportResponse.requestId + "'"; 
                string lscrimereportcontact_gid = objdbconn.GetExecuteScalar(msSQL);

                msSQL = " update samunnati.agr_mst_tcrimereportcontact set " +        
        ...
        public MdlCompanyCrimeReportRequestResponse DaRequestCrimeReportCompany(string employee_gid, MdlCompanyCrimeReportRequest values)
        {
            ...
            try
            {
                ...
                msSQL = " select b.crimecheckcompanytype" +
                        " from agr_mst_tinstitution a left join ocs_mst_tcrimecheckcompanytypemapping b on a.companytype_name=b.samcompanytype where institution_gid='" + values.institution_gid + "'";
                ...
                if (ObjMdlCompanyCrimeReportRequestResponse.Status == "OK")
                {
                    ...
                    msSQL = " insert into agr_mst_tcrimereportinstitution( " +
                    ...
                    msSQL = "select crimecheckrtsearchrecord_gid from agr_trn_tcrimecheckrtsearchrecord where institution_gid='" + values.institution_gid + "' and created_by='" + employee_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == false)
                    {
        ...
        public void DaGetIndividualDetailsReport(string contact_gid, MdlIndividualCrimeReport values)
        {
            try
            {
                ...
                msSQL = " select addressline1, addressline2, city, taluka, district, state" +
                        " from agr_mst_tcontact2address where contact_gid='" + contact_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void DaGetIndividualReportList(MdlIndividualCrimeReportList values, string contact_gid)
        {
            try
            {
                msSQL = "select crimereportcontact_gid,contact_gid,request_id,request_time,report_mode,report_status,report_link " +
                    " from agr_mst_tcrimereportcontact where contact_gid='" + contact_gid + "'";
        ...
        public MdlCallbackResponse DaPostCallbackReportDetailsCompany(MdlCallbackResponse values)
        {
            try
            {
                ...
                msSQL = "select crimereportinstitution_gid from samunnati.agr_mst_tcrimereportinstitution where request_id='" + ObjMdlCompanyCrimeReportResponse.requestId + "'";
                string lscrimereportinstitution_gid = objdbconn.GetExecuteScalar(msSQL);

                

                msSQL = " update samunnati.agr_mst_tcrimereportinstitution set " +
                         " report_status='" + "Report obtained" + "'," +
                           " report_content='" + values.data.Replace("'", "") + "'," +
        ...
        public void DaGetCompanyReportList(MdlCompanyCrimeReportList values, string institution_gid)
        {
            try
            {
                msSQL = "select crimereportinstitution_gid,institution_gid,request_id,request_time,report_mode,report_status,report_link " +
                    " from agr_mst_tcrimereportinstitution where institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetCompanyDetailsReport(string institution_gid, MdlCompanyCrimeReport values)
        {
            try
            {
                ...
                msSQL = " select addressline1, addressline2, city, taluka, district, state" +
                        " from agr_mst_tinstitution2address where institution_gid='" + institution_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void DaGetCrimeRecordIndividualDetail(string contact_gid, MdlIndividualCrimeRecord values)
        {
            ...
            " contact2address_gid as address_gid from agr_mst_tcontact2address where contact_gid = '" + contact_gid + "'";
        ...
        public void DaGetCrimeRecordCompanyDetail(string institution_gid, MdlCompanyCrimeRecord values)
        {
            try
            {
                ...
                msSQL = " select concat(addressline1,',',addressline2) as address, " +
            " institution2address_gid as address_gid from agr_mst_tinstitution2address where institution_gid = '" + institution_gid + "'";
        ...
        public bool DaTagCaseIndividual(string employee_gid, MdlTagCaseIndividual values)
        {
            ...
            msSQL = " insert into agr_mst_tcrimecasetaggedcontact(" +
        ...
        public void DaGetTaggedCaseIndividualSummary(string contact_gid, MdlTagCaseIndividual values)
        {
            ...
            msSQL = " select crimecasetaggedcontact_gid,contact_gid,cin_number,case_type,case_status," +
                    ...
                    " from agr_mst_tcrimecasetaggedcontact a " +                  
        ...
        {
            msSQL = "delete from agr_mst_tcrimecasetaggedcontact where crimecasetaggedcontact_gid='" + crimecasetaggedcontact_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public bool DaTagCaseInstitution(string employee_gid, MdlTagCaseInstitution values)
        {
            ...
            msSQL = " insert into agr_mst_tcrimecasetaggedinstitution(" +
        ...
        public void DaGetTaggedCaseInstitutionSummary(string institution_gid, MdlTagCaseInstitution values)
        {
            ...
            msSQL = " select crimecasetaggedinstitution_gid,institution_gid,cin_number,case_type,case_status," +
                    " petitioner,petitioner_address,respondent,respondent_address,casetype_name,case_name," +
                    " court_type,district,state,year,gfc_updated_at,gfc_uniqueid,casedetails_link" +
                    " from agr_mst_tcrimecasetaggedinstitution a " +
        ...
        {
            msSQL = "delete from agr_mst_tcrimecasetaggedinstitution where crimecasetaggedinstitution_gid='" + crimecasetaggedinstitution_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaGetCCCaseTaggedIndividualSummary(string application_gid, MdlCCCaseTaggedIndividual values)
        {
            ...
            msSQL = " select contact_gid,first_name,middle_name,last_name,stakeholder_type," +
                    " (select distinct concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) from agr_mst_tcrimecasetaggedcontact a left join hrm_mst_temployee b on a.created_by = b.employee_gid left join adm_mst_tuser c on c.user_gid = b.user_gid where a.contact_gid = f.contact_gid) as tagged_by," +
                    " (select count(crimecasetaggedcontact_gid) from agr_mst_tcrimecasetaggedcontact a left join hrm_mst_temployee b on a.created_by = b.employee_gid left join adm_mst_tuser c on c.user_gid = b.user_gid where a.contact_gid = f.contact_gid) as no_of_cases" +
                    " from agr_mst_tcontact f " +
        ...
        public void DaGetCCCaseTaggedInstitutionSummary(string application_gid, MdlCCCaseTaggedInstitution values)
        {
            ...
            msSQL = " select institution_gid,company_name,stakeholder_type," +
                    " (select distinct concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) from agr_mst_tcrimecasetaggedinstitution a left join hrm_mst_temployee b on a.created_by = b.employee_gid left join adm_mst_tuser c on c.user_gid = b.user_gid where a.institution_gid = f.institution_gid) as tagged_by," +
                    " (select count(crimecasetaggedinstitution_gid) from agr_mst_tcrimecasetaggedinstitution a left join hrm_mst_temployee b on a.created_by = b.employee_gid left join adm_mst_tuser c on c.user_gid = b.user_gid where a.institution_gid = f.institution_gid) as no_of_cases" +
        ...
        public void DaGetCCReportInstitutionSummary(string application_gid, MdlCCReportInstitution values)
        {
            ...
            msSQL = " select institution_gid,company_name,stakeholder_type," +
                    " (select count(crimereportinstitution_gid) from agr_mst_tcrimereportinstitution a where a.institution_gid = f.institution_gid) as no_of_reports" +
                    " from agr_mst_tinstitution f " +
                    " where f.application_gid='" + application_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            for (int i = 0; i < getccreportinstitution_list.Count; i++)
            {
                msSQL = " select crimereportinstitution_gid,request_id,report_mode,report_link" +
                    " from agr_mst_tcrimereportinstitution a " +
        ...
        public void DaGetCCReportIndividualSummary(string application_gid, MdlCCReportIndividual values)
        {
            ...
            msSQL = " select contact_gid,first_name,middle_name,last_name,stakeholder_type," +
                    " (select count(crimereportcontact_gid) from agr_mst_tcrimereportcontact a where a.contact_gid = f.contact_gid) as no_of_reports" +
                    " from agr_mst_tcontact f " +
                    " where f.application_gid='" + application_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            for (int i = 0; i < getccreportindividual_list.Count; i++)
            {
                msSQL = " select crimereportcontact_gid,request_id,report_mode,report_link" +
                    " from agr_mst_tcrimereportcontact a " +
