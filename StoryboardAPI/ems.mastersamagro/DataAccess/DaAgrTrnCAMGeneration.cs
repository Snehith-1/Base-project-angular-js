...
{
    /// <summary>
    /// This DataAccess will help to generate CAM document in buyer credit and pmg stages
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Premchander.K </remarks>

    public class DaAgrTrnCAMGeneration
    {
        ...
        public void DaGetCAMTemplate(string application_gid, MdlMstCAMGeneration values)
        {
            try
            {
               ...
               msSQL = " select a.application_gid, application_no, customer_urn, customerref_name as customer_name, vertical_name,applicant_type, " +
                        ...
                        " left join agr_mst_tapplication2primaryvaluechain b on b.application_gid = a.application_gid " +
                        " left join agr_mst_tapplication2secondaryvaluechain c on c.application_gid = a.application_gid " +
                ...
                { //Address, PAN
                    msSQL = "select contact_gid,pan_no from agr_mst_tcontact where application_gid='" + application_gid + "' and stakeholder_type in ('Applicant','Borrower')";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                    ...
                    msSQL = " select concat(addressline1,',', addressline2,',', taluka,',',city , ',',district,',',state ,'-'," +
                           " postal_code, ',', country)  as address from agr_mst_tcontact2address where contact_gid='" + lsGID + "' and primary_status='Yes'";
                ...
                { //Address, PAN , CIN
                    msSQL = "select institution_gid,companypan_no,cin_no from agr_mst_tinstitution where application_gid='" + application_gid + "' and stakeholder_type in ('Applicant','Borrower')";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                    ...
                    msSQL = " select concat(addressline1,',', addressline2,',', taluka,',',city , ',',district,',',state ,'-'," +
                           " postal_code, ',', country)  as address from agr_mst_tinstitution2address where institution_gid='" + lsGID + "' and primary_status='Yes'";
                    lsaddress = objdbconn.GetExecuteScalar(msSQL);
                }
                ...
                //Individual Info
                    ...
                    msSQL = " select concat(first_name,' ' ,middle_name,' ',last_name) as individual_name,age,designation_name  from agr_mst_tcontact " +
                        " where  application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select concat(contactpersonfirst_name,' ',contactpersonmiddle_name,' ' ,contactpersonlast_name) as contact_person,"+
                    " c.email_address,b.mobile_no,designation_type from agr_mst_tapplication a " +
                   " left join agr_mst_tapplication2contactno b on a.application_gid=b.application_gid" +
                   " left join agr_mst_tapplication2email c  on a.application_gid = c.application_gid  where a.application_gid='" + application_gid + "' and" +
                ...
                msSQL= " select  bank_name,facility_type,outstanding_amount,account_classification,fundedtypeindicator_name,"+
                        " sanctioned_limit from agr_mst_tcreditbankfacilitydtl where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = " select  bank_name,currentoutsatnding_amount,account_classification,"+
                        " sanction_amount from agr_mst_tcreditrepaymentdtl where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                dt_datatable.Dispose();
                 ...
                 //supplier Info
                msSQL = " select supplier_name,relationship_vintage_year,purchase_amount,bankdebit_amount from agr_mst_tcreditsupplier where "+
                ...
                string lsloanGID = objdbconn.GetExecuteScalar(" select quote(group_concat(application2loan_gid)) from agr_mst_tapplication2loan where  " +
                ...
                else
                {
                    ...
                    msSQL = " select buyer_name, '' as relationship_vintage_year, '' as relationship_vintage_month from agr_mst_tapplication2buyer where application2loan_gid in (" + lsloanGID + ") "+
                            " union "+
                            " select buyer_name, relationship_vintage_year, relationship_vintage_month from agr_mst_tcreditbuyer " +
                ...
                msSQL = "select product_type from agr_mst_tapplication2loan where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select product_type, tenureoverall_limit from agr_mst_tapplication2loan where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select product_type, programoverall_limit from agr_mst_tapplication2loan where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                if (dt_datatable.Rows.Count != 0)
                {
                    foreach (DataRow dr_datarow in dt_datatable.Rows)
                    {
                        lsvalitidylimit += "<tr style='border-left: 1pt solid windowtext;'><td style='width: 9.8801 %;border-left: 1pt solid windowtext;border-top: 1pt solid windowtext;border-right: 1pt solid windowtext;border-bottom: 1pt solid windowtext;'>" + dr_datarow["product_type"].ToString() + " </td>" +
                           " <td style='width: 9.8801 %;border-left: 1pt solid windowtext;border-top: 1pt solid windowtext;border-right: 1pt solid windowtext;border-bottom: 1pt solid windowtext;'>" + dr_datarow["programoverall_limit"].ToString() + "" +
                           " </td>" +
                           " </tr>";
                    }
                }
        ...
        public void DaPostWordGenerate(string employee_gid,MdlMstCAMGeneration values)
        {
            try
            {
                ...
                path = HttpContext.Current.Server.MapPath("erpdocument" + "/" + lscompany_code + "/" + "SamAgro/CAMdocument/" + DateTime.Now.Year + "/" + DateTime.Now.Month);
                {
                ...
                lspath = HttpContext.Current.Server.MapPath("erpdocument" + "/" + lscompany_code + "/" + "SamAgro/CAMdocument/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/");
                objcmnfunctions.uploadFile(lspath, lsfile_gid);
                values.lsname = "CAM" + DateTime.Now.ToString("(dd-MM-yyyy HH-mm-ss)") + ".docx";

                values.lspath = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "SamAgro/CAMdocument/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" +lsfile_gid +"/"+ values.lsname;

                msSQL = " update agr_mst_tapplication set cam_content='" + values.content.Replace("'", "''") + "'," +
                    " document_path='"+ "erpdocument" + "/" + lscompany_code + "/" + "SamAgro/CAMdocument/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + lsfile_gid + "/" + values.lsname + "',"+
                ...
                //HTML File Creation
                string htmlFilePath = ConfigurationManager.AppSettings["file_path"]  +"/erpdocument" + "/" + lscompany_code + "/" + "SamAgro/CAMHTML/camfile.html";
                ...
                // Document
                string lscamfile = HttpContext.Current.Server.MapPath("erpdocument" + "/" + lscompany_code + "/" + "TmpFileSamAgro/Footer/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/"+ lsfile_gid + "/");
                {
                ...
                bool status;
                status = objcmnstorage.UploadStream("../../../erpdocument", lscompany_code + "/" + "SamAgro/CAMdocument/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + lsfile_gid + "/" + values.lsname, ms);
                ms.Close();
        ...
        public void DaGetApp2CAM(string application_gid, MdlMstCAMGeneration values)
        {
            msSQL = " select cam_content,document_path,document_name from agr_mst_tapplication  where application_gid='"+application_gid+"'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
