...
{
    /// <summary>
    /// This DataAccess provide access for various event (Genetic Code,Social And Trade Capital,
    /// Existing Bank Facility,Repayment Track, Lender Type List,Credit Account Classification List, 
    /// Credit Instalment Frequency List, Funded Type Indicator List, Credit Underwriting Facility Type List) in Credit Underwriting
    /// </summary>
    /// <remarks>Written by Premchander.K, Abilash, Sundar, Sherin </remarks>
    public class DaAgrTrnAppCreditUnderWriting
    {
        ...
        int columnNumber;
            ...
            string lstan_number, lsincometax_returnsstatus;
            ...
            public void DaGetSocialAndTradeCapital(string credit_gid, string applicant_type, MdlMstAppCreditUnderWriting values)
            {
                if (applicant_type == "Institution")
                {
                    msSQL = " SELECT date_format(a.created_date, '%d-%m-%Y %h:%i %p') as created_date, " +
                            ...
                            " concat(c.user_firstname, ' ', c.user_lastname, ' / ', c.user_code) as created_by, " +
                            " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                            " FROM agr_mst_tinstitution a left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                            " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                            " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                            " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
                ...
                if (applicant_type == "Individual")
                {
                    msSQL = " SELECT date_format(a.created_date, '%d-%m-%Y %h:%i %p') as created_date, " +
                            ...
                            " concat(c.user_firstname, ' ', c.user_lastname, ' / ', c.user_code) as created_by, " +
                            " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                            " FROM agr_mst_tcontact a left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                            " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                            " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                            " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
                ...
                if (applicant_type == "Group")
                {
                    msSQL = " SELECT date_format(a.created_date, '%d-%m-%Y %h:%i %p') as created_date, " +
                            ...
                            " concat(c.user_firstname, ' ', c.user_lastname, ' / ', c.user_code) as created_by, " +
                            " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                            " FROM agr_mst_tgroup a left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                            " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                            " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                            " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
            ...
            public void DaEditSocialAndTradeCapital(string credit_gid, string applicant_type, MdlMstAppCreditUnderWriting values)
            {
                try
                {
                    if (applicant_type == "Institution")
                    {
                        msSQL = " select social_capital, trade_capital, economical_flag from agr_mst_tinstitution where institution_gid='" + credit_gid + "'";
                        objODBCDatareader = objdbconn.GetDataReader(msSQL);
                        if (objODBCDatareader.HasRows == true)
                        {
                    ...
                    {
                        msSQL = " select social_capital, trade_capital,economical_flag from agr_mst_tcontact where contact_gid='" + credit_gid + "'";
                        objODBCDatareader = objdbconn.GetDataReader(msSQL);
                        if (objODBCDatareader.HasRows == true)
                        {
                            values.social_capital = objODBCDatareader["social_capital"].ToString();
                    ...
                    {
                        msSQL = " select social_capital, trade_capital, economical_flag from agr_mst_tgroup where group_gid='" + credit_gid + "'";
                        objODBCDatareader = objdbconn.GetDataReader(msSQL);
                        if (objODBCDatareader.HasRows == true)
                        {
                            values.social_capital = objODBCDatareader["social_capital"].ToString();
                ...
                try
                {
                    if (applicant_type == "Institution")
                    {
                        msSQL = " select startupasofloansanction_date, occupation_gid, occupation, lineofactivity_gid, lineofactivity, bsrcode_gid, clientdtl_gid, client_dtl, " +
                            ...
                            " from agr_mst_tinstitution where institution_gid='" + credit_gid + "'";
                        objODBCDatareader = objdbconn.GetDataReader(msSQL);
                        if (objODBCDatareader.HasRows == true)
                        {
                    ...
                    else if (applicant_type == "Individual")
                    {
                        msSQL = " select startupasofloansanction_date, occupation_gid, occupation, lineofactivity_gid, lineofactivity, bsrcode_gid, clientdtl_gid, client_dtl, " +
                           ...
                           " plantandmachineryinvestment, turnover_gid, turnover, msmeclassification_gid, msmeclassification, psltagging_flag," +
                           " date_format(loansanction_date, '%d-%m-%Y') loansanction_date, date_format(entityincorporation_date, '%d-%m-%Y') entityincorporation_date " +
                             " from agr_mst_tcontact where contact_gid='" + credit_gid + "'";
                        objODBCDatareader = objdbconn.GetDataReader(msSQL);
                        if (objODBCDatareader.HasRows == true)
                        {
                            values.startupasofloansanction_date = objODBCDatareader["startupasofloansanction_date"].ToString();
                    ...
                    else if (applicant_type == "Group")
                    {
                        ...
                        " plantandmachineryinvestment, turnover_gid, turnover, msmeclassification_gid, msmeclassification, psltagging_flag," +
                        " date_format(loansanction_date, '%d-%m-%Y') loansanction_date, date_format(entityincorporation_date, '%d-%m-%Y') entityincorporation_date " +
                        " from agr_mst_tgroup where group_gid='" + credit_gid + "'";
                        objODBCDatareader = objdbconn.GetDataReader(msSQL);
                        if (objODBCDatareader.HasRows == true)
                        {
                            values.startupasofloansanction_date = objODBCDatareader["startupasofloansanction_date"].ToString();
            ...
            public void DaPostExistingBankFacility(string employee_gid, MdlMstCUWExistingBankFacility values)
            {
                ...
                msSQL = " insert into agr_mst_tcreditbankfacilitydtl(" +
            ...
            public void DaGetExistingBankFacility(string credit_gid, string employee_gid, MdlMstCUWExistingBankFacility values)
            {
                msSQL = " select existingbankfacility_gid,credit_gid,application_gid,a.bank_gid,bank_name,date_format(facilitysanctioned_on, '%d-%m-%Y') as facilitysanctioned_on, " +
                        ...
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by, " +
                        " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                        " from agr_mst_tcreditbankfacilitydtl a " +
                        " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                        " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                        " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                        " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
            ...
            public void DaEditExistingBankFacility(string existingbankfacility_gid, MdlMstCUWExistingBankFacility values)
            {
                try
                {
                    msSQL = " select existingbankfacility_gid,credit_gid,application_gid,bank_gid,bank_name, date_format(facilitysanctioned_on, '%d-%m-%Y') as facilitysanctioned_on, " +
                       ...
                       " from agr_mst_tcreditbankfacilitydtl where existingbankfacility_gid='" + existingbankfacility_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaUpdateExistingBankFacility(string employee_gid, MdlMstCUWExistingBankFacility values)
            {
                msSQL = " select existingbankfacility_gid,credit_gid,application_gid,bank_gid,bank_name, date_format(facilitysanctioned_on, '%d-%m-%Y') as facilitysanctioned_on, " +
                       ...
                       " instalment_amount, outstanding_amount, date_format(record_date, '%d-%m-%Y') as record_date, overdue_amount, " +
                      " overdue_dpd, accountclassification_gid, account_classification, remarks, facilitytype_gid, facility_type" +
                      " from agr_mst_tcreditbankfacilitydtl where existingbankfacility_gid='" + values.existingbankfacility_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                ...
                msSQL = " update agr_mst_tcreditbankfacilitydtl set " +
            ...
            msSQL += " updated_by='" + employee_gid + "'," +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into agr_mst_tcreditbankfacilitydtlupdatelog(" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditbankfacilitydtl where existingbankfacility_gid='" + existingbankfacility_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    msSQL = "delete from agr_mst_tcreditbankfacilitydtlupdatelog where existingbankfacility_gid='" + existingbankfacility_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            msSQL = " insert into agr_mst_tcreditrepaymentdtl(" +
            ...
            public void DaGetRepaymentTrack(string credit_gid, string employee_gid, MdlMstCUWRepaymentTrack values)
            {
                msSQL = " select creditrepaymentdtl_gid,lendertype_gid,lender_type,ifsc_code,bank_name,nbfc_name, branch_name,facility_type, sanctionreference_id," +
                        ...
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by, " +
                        " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                        " from agr_mst_tcreditrepaymentdtl a " +
                        " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                        " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                        " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                        " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
            ...
            public void DaEditRepaymentTrack(string creditrepaymentdtl_gid, MdlMstCUWRepaymentTrack values)
            {
                try
                {
                    msSQL = " select creditrepaymentdtl_gid,lendertype_gid,lender_type,ifsc_code,bank_name,nbfc_name, branch_name,facility_type," +
                         ...
                         " from agr_mst_tcreditrepaymentdtl where creditrepaymentdtl_gid='" + creditrepaymentdtl_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaUpdateRepaymentTrack(string employee_gid, MdlMstCUWRepaymentTrack values)
            {
                msSQL = " select creditrepaymentdtl_gid,lendertype_gid,lender_type,ifsc_code,bank_name,nbfc_name, branch_name,facility_type," +
                         ...
                         " demanddue_date, oringinaltenure_year, sanctionreference_id, accountclassification_gid, oringinaltenure_month, oringinaltenure_days, " +
                         " balancetenure_year, balancetenure_month, balancetenure_days, account_classification, overdue_amount, numberofdays_overdue, remarks" +
                         " from agr_mst_tcreditrepaymentdtl where creditrepaymentdtl_gid='" + values.creditrepaymentdtl_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
            ...
            objODBCDatareader.Close();
            msSQL = " update agr_mst_tcreditrepaymentdtl set " +
            ...
            {
                msSQL += " branch_name='" + values.branch_name.Replace("'", "") + "',";

            }
            msSQL += " facility_type='" + values.facility_type + "'," +
            ...
            msSQL += " numberofdays_overdue='" + values.numberofdays_overdue + "'," +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into agr_mst_tcreditrepaymentdtlupdatelog(" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditrepaymentdtl where creditrepaymentdtl_gid='" + creditrepaymentdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    msSQL = "delete from agr_mst_tcreditrepaymentdtlupdatelog where creditrepaymentdtl_gid='" + creditrepaymentdtl_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            {
                msSQL = "select supplier_gid from agr_mst_tcreditsupplier where application_gid='" + values.application_gid + "' and supplier_gid='" + values.supplier_gid + "'";
                ...
                msSQL = " insert into agr_mst_tcreditsupplier(" +
                       " creditsupplier_gid," +
                       " credit_gid," +
                       " application_gid," +
                       " supplier_gid," +
                ...
                if (mnResult != 0)
                {
                    ...
                    msSQL = " select creditsupplier_gid,credit_gid,application_gid,supplier_gid,supplier_name,relationship_vintage_year,relationship_vintage_month," +
                         ...
                         " from agr_mst_tcreditsupplier where " +
            ...
            public void DaGetCreditSupplierList(string credit_gid, string employee_gid, MdlMstSupplier values)
            {
                msSQL = " select creditsupplier_gid,credit_gid,application_gid,supplier_gid,supplier_name,relationship_vintage_year,relationship_vintage_month," +
                         ...
                         " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by, " +
                         " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                         " from agr_mst_tcreditsupplier a " +
                         " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                         " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                         " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                         " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
            ...
            public void DaEditGetCreditSupplier(string creditsupplier_gid, MdlMstSupplier values)
            {
                try
                {
                    msSQL = " select creditsupplier_gid,credit_gid,application_gid,supplier_gid,supplier_name,relationship_vintage_year,relationship_vintage_month," +
                         ...
                         " from agr_mst_tcreditsupplier where creditsupplier_gid='" + creditsupplier_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaUpdateCreditSupplier(string employee_gid, MdlMstSupplier values)
            {
                msSQL = " select creditsupplier_gid,credit_gid,application_gid,supplier_gid,supplier_name,relationship_vintage_year,relationship_vintage_month," +
                        " format(purchase_amount,'en-IN') as purchase_amount,format(bankdebit_amount,'en-IN') as bankdebit_amount,relationship_supplier," +
                        " start_date,end_date " +
                        " from agr_mst_tcreditsupplier where creditsupplier_gid='" + values.creditsupplier_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                ...
                msSQL = " update agr_mst_tcreditsupplier set " +
                ...
                {//Date Updation
                    ...
                    {
                        msSQL = "update agr_mst_tcreditsupplier set start_date='" + Convert.ToDateTime(values.startdate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                            "where creditsupplier_gid='" + values.creditsupplier_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    ...
                    {
                        msSQL = "update agr_mst_tcreditsupplier set end_date='" + Convert.ToDateTime(values.enddate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                            "where creditsupplier_gid='" + values.creditsupplier_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    msGetGid = objcmnfunctions.GetMasterGID("CSUL");

                    msSQL = "Insert into agr_mst_tcreditsupplierupdatelog(" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditsupplier where creditsupplier_gid='" + creditsupplier_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    values.status = true;
                    ...
                    msSQL = " select creditsupplier_gid,credit_gid,application_gid,supplier_gid,supplier_name,relationship_vintage_year,relationship_vintage_month," +
                         " format(purchase_amount,'en-IN') as purchase_amount,format(bankdebit_amount,'en-IN')as bankdebit_amount,relationship_supplier," +
                         " date_format(start_date,'%d-%m-%Y') as start_date,date_format(end_date,'%d-%m-%Y') as end_date " +
                         " from agr_mst_tcreditsupplier where credit_gid='" + credit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    var getsupplier_list = new List<supplier_list>();
                    if (dt_datatable.Rows.Count != 0)
                    {
            ...
            {
                msSQL = "select buyer_gid from agr_mst_tcreditbuyer where application_gid='" + values.application_gid + "' and buyer_gid='" + values.buyer_gid + "'";
                ...
                msSQL = " insert into agr_mst_tcreditbuyer(" +
                       " creditbuyer_gid," +
                       " credit_gid," +
                       " application_gid," +
                       " buyer_gid ," +
                ...
                if (mnResult != 0)
                {
                    ...
                    msSQL = " select creditbuyer_gid,credit_gid,application_gid,buyer_gid,buyer_name,relationship_vintage_year,relationship_vintage_month," +
                         ...
                         " date_format(bankcredit_date,'%d-%m-%Y') as bankcredit_date from agr_mst_tcreditbuyer where " +
                         " credit_gid='" + values.credit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            public void DaEditGetCreditBuyer(string creditbuyer_gid, MdlMstCreditBuyer values)
            {
                try
                {
                    msSQL = " select creditbuyer_gid,credit_gid,application_gid,buyer_gid,buyer_name,relationship_vintage_year,relationship_vintage_month," +
                        " format(purchase_amount,'en-IN') as purchase_amount,format(buyer_limit,'en-IN')as buyer_limit,format(availed_limit,'en-IN')as availed_limit," +
                        " format(balance_limit,'en-IN')as balance_limit,top_buyer,bill_tenuredays,margin,bankcredit_value,source_deduction,relationship_borrower," +
                        " enduse_monitoring,start_date,end_date,bankcredit_date from agr_mst_tcreditbuyer where creditbuyer_gid='" + creditbuyer_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaUpdateCreditBuyer(string employee_gid, MdlMstCreditBuyer values)
            {
                ...
                msSQL = " select creditbuyer_gid,credit_gid,application_gid,buyer_gid,buyer_name,relationship_vintage_year,relationship_vintage_month," +
                        " format(purchase_amount,'en-IN') as purchase_amount,format(buyer_limit,'en-IN')as buyer_limit,format(availed_limit,'en-IN')as availed_limit," +
                        " format(balance_limit,'en-IN')as balance_limit,top_buyer,bill_tenuredays,margin,bankcredit_value,source_deduction,relationship_borrower," +
                        " enduse_monitoring,start_date,end_date,bankcredit_date from agr_mst_tcreditbuyer where creditbuyer_gid='" + values.creditbuyer_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                ...
                msSQL = " update agr_mst_tcreditbuyer set " +
                         " relationship_vintage_year='" + values.relationship_vintage_year + "'," +
                         " relationship_vintage_month='" + values.relationship_vintage_month + "'," +
                         " purchase_amount='" + values.purchase_amount.Replace(",", "") + "'," +
                ...
                if (mnResult == 1)
                {
                    ...
                    {
                        msSQL = "update agr_mst_tcreditbuyer set start_date='" + Convert.ToDateTime(values.startdate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                            "where creditbuyer_gid='" + values.creditbuyer_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    if (Convert.ToDateTime(values.enddate).ToString("yyyy-MM-dd HH:mm:ss") == "0001-01-01 00:00:00")
                    ...
                    {
                        msSQL = "update agr_mst_tcreditbuyer set end_date='" + Convert.ToDateTime(values.enddate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                            "where creditbuyer_gid='" + values.creditbuyer_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    ...
                    {
                        msSQL = "update agr_mst_tcreditbuyer set bankcredit_date='" + Convert.ToDateTime(values.bankcreditdate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                            "where creditbuyer_gid='" + values.creditbuyer_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    ...
                    msSQL = "Insert into agr_mst_tcreditbuyerupdatelog(" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditbuyer where creditbuyer_gid='" + creditbuyer_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    values.status = true;
            ...
            {
                msSQL = "select creditpolicy_gid from ocs_mst_tcreditbuyer where application_gid='" + values.application_gid + "'" +
                ...
                msSQL = " insert into agr_mst_tcreditobservation(" +
                ...
                if (mnResult != 0)
                {
                    ...
                    msSQL = " select creditobservation_gid,credit_gid,application_gid,creditpolicy_gid,credit_policy,complied_status,observation " +
                             "  from agr_mst_tcreditobservation where " +
                             " credit_gid='" + values.credit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            public void DaGetCreditObservationList(string credit_gid, string employee_gid, MdlMstCreditObservation values)
            {
                msSQL = " select creditobservation_gid,credit_gid,application_gid,creditpolicy_gid,credit_policy,complied_status,observation, " +
                        ...
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by, " +
                        " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                        " from agr_mst_tcreditobservation a" +
                        " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                        " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                        " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                        " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
            ...
            public void DaEditGetCreditObservation(string creditobservation_gid, MdlMstCreditObservation values)
            {
                ...
                {
                    msSQL = " select creditobservation_gid,credit_gid,application_gid,creditpolicy_gid,credit_policy,complied_status,observation " +
                             "  from agr_mst_tcreditobservation where creditobservation_gid='" + creditobservation_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaUpdateCreditObservation(string employee_gid, MdlMstCreditObservation values)
            {
                ...
                msSQL = "select creditobservation_gid,credit_gid,application_gid,creditpolicy_gid,credit_policy,complied_status,observation" +
                    " from agr_mst_tcreditobservation where creditobservation_gid='" + values.creditobservation_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    lscredit_gid = objODBCDatareader["credit_gid"].ToString();
                ...
                msSQL = " update agr_mst_tcreditobservation set " +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = "Insert into agr_mst_tcreditobservationupdatelog(" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditobservation where creditobservation_gid='" + creditobservation_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    values.status = true;
            ...
            public bool DaPostCreditBank(string employee_gid, MdlCreditBankAcc values)
            {
                ...
                msSQL = " insert into agr_mst_tcreditbankdtl(" +
                        " creditbankdtl_gid," +
                        " credit_gid," +
                        " application_gid," +
                        " bank_name," +
                ...
                if (mnResult != 0)
                {
                    msSQL = "update agr_mst_tcreditbankdtl2cheque set creditbankdtl_gid='" + msGetGid + "' where creditbankdtl_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " select creditbankdtl_gid,bank_name,branch_name,ifsc_code,bankaccount_number from " +
                              " agr_mst_tcreditbankdtl where credit_gid='" + values.credit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                try
                {
                    if (httpRequest.Files.Count > 0)
                    {
                        ...
                        msGetGid = objcmnfunctions.GetMasterGID("CRCQ");
                            msSQL = " insert into agr_mst_tcreditbankdtl2cheque( " +
                            ...
                            msSQL = " select creditbankdtl2cheque_gid,creditbankdtl_gid,chequeleaf_name,chequeleaf_path,document_title from " +
                                " agr_mst_tcreditbankdtl2cheque where creditbankdtl_gid='" + employee_gid + "' or  creditbankdtl_gid='" + lscreditbankdtl_gid + "'";
                            dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            {
                msSQL = "delete from agr_mst_tcreditbankdtl2cheque where creditbankdtl2cheque_gid='" + creditbankdtl2cheque_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    values.status = true;
                    ...
                    msSQL = " select creditbankdtl2cheque_gid,creditbankdtl_gid,chequeleaf_name,chequeleaf_path,document_title from " +
                             " agr_mst_tcreditbankdtl2cheque where creditbankdtl_gid='" + employee_gid + "' or creditbankdtl_gid='" + credit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    var getdocumentdtlList = new List<credituploaddocument_list>();
                    if (dt_datatable.Rows.Count != 0)
                    {
            ...
            public void DaGetCrediBankAccList(string credit_gid, string employee_gid, MdlCreditBankAcc values)
            {
                msSQL = "select creditbankdtl_gid,credit_gid,application_gid,bank_name,branch_name,bank_address,micr_code,ifsc_code,bankaccount_name," +
                     ...
                     " from agr_mst_tcreditbankdtl where credit_gid='" + credit_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getcreditbankacc_list = new List<creditbankacc_list>();
                if (dt_datatable.Rows.Count != 0)
                {
            ...
            public void DaGetCreditOperationsView(string credit_gid, string applicant_type, MdlMstAppCreditUnderWriting values)
            {
                if (applicant_type == "Institution")
                {
                    msSQL = " select company_name,stakeholder_type,urn_status, urn from agr_mst_tinstitution where institution_gid='" + credit_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                ...
                {
                    msSQL = " select first_name,stakeholder_type,urn_status, urn from agr_mst_tcontact where contact_gid='" + credit_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                ...
                {
                    msSQL = " select group_name,group_type,groupurn_status, group_urn from agr_mst_tgroup where group_gid='" + credit_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaGetCreditBuyerTextData(string creditbuyer_gid, MdlMstCreditBuyer values)
            {
                msSQL = " select creditbuyer_gid,credit_gid,application_gid,relationship_borrower, enduse_monitoring " +
                        " from agr_mst_tcreditbuyer where creditbuyer_gid='" + creditbuyer_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    values.creditbuyer_gid = objODBCDatareader["creditbuyer_gid"].ToString();
            ...
            public void DaGetCreditBankDocumentUpload(string creditbankdtl_gid, credituploaddocument values)
            {
                msSQL = " select creditbankdtl2cheque_gid,creditbankdtl_gid,chequeleaf_name,chequeleaf_path,document_title, " +
                    ...
                    " from agr_mst_tcreditbankdtl2cheque a left join hrm_mst_temployee b on a.created_by=b.employee_gid" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditbankdtl2cheque where creditbankdtl_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                values.status = true;
            }
            ...
            public void DaEditGetCreditBankAccDtl(string creditbankdtl_gid, MdlCreditBankAcc values)
            {
                try
                {
                    msSQL = "select creditbankdtl_gid,credit_gid,application_gid,bank_name,branch_name,bank_address,micr_code,ifsc_code,bankaccount_name," +
                    " bankaccounttype_gid,bankaccounttype_name,bankaccount_number,confirmbankaccountnumber,joinaccount_status,joinaccount_name," +
                    " chequebook_status,accountopen_date from agr_mst_tcreditbankdtl where creditbankdtl_gid='" + creditbankdtl_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                    ...
                    msSQL = " select creditbankdtl2cheque_gid,creditbankdtl_gid,chequeleaf_name,chequeleaf_path,document_title from " +
                                " agr_mst_tcreditbankdtl2cheque where  creditbankdtl_gid='" + creditbankdtl_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    var getdocumentdtlList = new List<credituploaddocument_list>();
                    if (dt_datatable.Rows.Count != 0)
                    {
            ...
            public void UpdateCreditBankAccDtl(string employee_gid, MdlCreditBankAcc values)
            {
                ...
                msSQL = " select creditbankdtl_gid,credit_gid,application_gid,bank_name,branch_name,bank_address,micr_code,ifsc_code,bankaccount_name," +
                    " bankaccounttype_gid,bankaccounttype_name,bankaccount_number,confirmbankaccountnumber,joinaccount_status,joinaccount_name," +
                    " chequebook_status,accountopen_date from agr_mst_tcreditbankdtl where creditbankdtl_gid='" + values.creditbankdtl_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    lsbank_name = objODBCDatareader["bank_name"].ToString();
                ...
                msSQL = " update agr_mst_tcreditbankdtl set " +
                         " bank_name='" + values.bank_name + "'," +
                ...
                {//Date Updation
                    ...
                    {
                        msSQL = "update agr_mst_tcreditbankdtl set accountopen_date='" + Convert.ToDateTime(values.accountopendate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                            "where creditbankdtl_gid='" + values.creditbankdtl_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    msSQL = "update agr_mst_tcreditbankdtl2cheque set creditbankdtl_gid='" + values.creditbankdtl_gid + "' where creditbankdtl_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msGetGid = objcmnfunctions.GetMasterGID("CBDU");

                    msSQL = " insert into agr_mst_tcreditbankdtllog(" +
            ...
            {
                msSQL = "delete from agr_mst_tcreditbankdtl where creditbankdtl_gid='" + creditbankdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                msSQL = "delete from  agr_mst_tcreditbankdtl2cheque where creditbankdtl_gid='" + creditbankdtl_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    values.status = true;
                    ...
                    msSQL = " select creditbankdtl_gid,bank_name,branch_name,ifsc_code,bankaccount_number from " +
                               " agr_mst_tcreditbankdtl where credit_gid='" + credit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    var getcreditbankacc_list = new List<creditbankacc_list>();
                    if (dt_datatable.Rows.Count != 0)
                    {
            ...
            public void DaInstitutionEditDocumentTmpList(string institution_gid, string employee_gid, institutionuploaddocument values)
            {
                msSQL = " select institution2documentupload_gid,institution_gid,document_name,document_path,document_title,document_id, documenttype_name " +
                    " from agr_mst_tinstitution2documentupload where institution_gid='" + employee_gid + "' or institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            public void DaInstitutionEditDocumentDelete(string institution2documentupload_gid, institutionuploaddocument objfilename, string employee_gid)
            {
                ...
                if (mnResult == 1)
                {
                    ...
                    {
                        msSQL = " select count(*) as documentcount from agr_trn_tdocumentchecktls " +
            ...
            public void DaInstitutionAddressList(string institution_gid, MdlMstAddressDetails values)
            {
                msSQL = "  select institution2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, landmark," +
                        " postal_code,latitude,longitude from agr_mst_tinstitution2address where institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            public void DaInstitutionDocumentList(string institution_gid, institutionuploaddocument values)
            {
                msSQL = " select institution2documentupload_gid,institution_gid,document_name,document_path,document_title,document_id," +
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as uploaded_by, documenttype_name, " +
            ...
            string lsuistakeholder_type = objdbconn.GetExecuteScalar(msSQL);
            ...
            msSQL = " select application_gid, application_no, company_name, date_incorporation, businessstart_date,companypan_no, year_business, month_business, cin_no," +
                         ...
                         " assessmentagency_name, assessmentagencyrating_gid, assessmentagencyrating_name, ratingas_on, amlcategory_gid, amlcategory_name,businesscategory_gid, " +
                         " businesscategory_name, contactperson_firstname, contactperson_middlename, contactperson_lastname, designation_gid, designation, " +
                         " lastyear_turnover, escrow, start_date, end_date, urn_status, urn, tan_number, incometax_returnsstatus " +
                ...
                if (objODBCDatareader.HasRows == true)
                {
                    ...
                    lsincometax_returnsstatus = objODBCDatareader["incometax_returnsstatus"].ToString();
            }
                objODBCDatareader.Close();
                try
                {
                        ...
                        if (mnResult != 0)
                        {
                            ...
                            if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                            {
                                ...
                                Thread t = new Thread(new ThreadStart(() =>
                                {
                                    ...
                                    msSQL = " select stakeholder_type from agr_mst_tinstitution where institution_gid = '" + values.institution_gid + "'";
                                    lsstakeholder_type = objdbconn.GetExecuteScalar(msSQL);

                                    if(lsstakeholder_type == "Applicant")
                                    {
                                        //Updating Overall Company Details
                                        List<string> existingString = new List<string> { lsofficialemail_address, lsofficial_telephoneno, lscompanypan_no, lscompanytype_name, lstan_number, lsincometax_returnsstatus, lslastyear_turnover };
                                        List<string> updatedString = new List<string> { values.official_mailid, values.official_telephoneno, values.companypan_no, values.companytype_name, values.tan_number, values.incometax_returnsstatus, values.lastyear_turnover };

                                        if (!(existingString.SequenceEqual(updatedString)))
                                        {
                                            objFnSamAgroHBAPIContract.UpdateContractInstitutionHBAPI(values.institution_gid);
                                        }

                                        //Calling if newly added addresses are there.

                                        objFnSamAgroHBAPIContract.UpdateContractInstitutionAddressAddHBAPI(values.institution_gid);
            ...
            {
                msSQL = "  select institution2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, landmark," +
                        " postal_code,latitude,longitude from agr_mst_tinstitution2address where institution_gid='" + institution_gid + "' or institution_gid='" + employee_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getmstaddress_list = new List<mstaddress_list>();
                if (dt_datatable.Rows.Count != 0)
                {
            ...
            {
                msSQL = "select institution_gid from agr_mst_tinstitution2branch where gst_no='" + values.gst_no + "' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "')";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    objODBCDatareader.Close();
            ...
            public void DaEditInstitutionGST(string institution2branch_gid, MdlMstGST values)
            {
                try
                {
                    msSQL = "select gst_state, gst_no, institution_gid, institution2branch_gid, gst_registered , headoffice_status" +
                    ...
                    if (objODBCDatareader.HasRows == true)
                    {
                        ...
                        values.headoffice_status = objODBCDatareader["headoffice_status"].ToString();
                    }
                    values.status = true;
                    values.message = "success";
                    objODBCDatareader.Close();
            ...
            objODBCDatareader.Close();
                try
                {
                    ...
                    if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                    {
                        ...
                        {
                            HttpContext.Current = ctx;
                            objFnSamAgroHBAPIContract.UpdateContractInstitutionAddressHBAPI(values.institution2address_gid);
                        }));
            ...
            public void DaGetIntitutionTempClear(string employee_gid, result values)
            {
                ...
                msSQL = "delete from agr_trn_ttandtl where function_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            public void DaDeleteIndividualMobileNo(string contact2mobileno_gid, MdlContactMobileNo values)
            {
                ...
                if (mnResult != 0)
                {
                    msSQL = "delete from agr_mst_tcontact2mobilenoupdatelog where contact2mobileno_gid='" + contact2mobileno_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            public void DaGetIndividualAddressTempList(string contact_gid, string employee_gid, MdlContactAddress values)
            {
                msSQL = " select contact2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country," +
                        " postal_code,latitude,longitude  from agr_mst_tcontact2address where contact_gid='" + employee_gid + "' or contact_gid = '" + contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            {
                msSQL = " select contact2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country," +
                        " postal_code,latitude, longitude from agr_mst_tcontact2address where contact_gid='" + contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getcontactaddress_list = new List<contactaddress_list>();
                if (dt_datatable.Rows.Count != 0)
                {
            ...
            {
                msSQL = "select contact2idproof_gid,idproof_name,idproof_no,document_name, document_path,idproof_dob,file_no from agr_mst_tcontact2idproof where " +
                  " contact_gid='" + employee_gid + "' or contact_gid = '" + contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            public void DaDeleteAppMobileNo(string application2contact_gid, MdlMstMobileNo values)
            {
                ...
                if (mnResult != 0)
                {
                    msSQL = "delete from agr_mst_tapplication2contactnoupdatelog where application2contact_gid='" + application2contact_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            {
                msSQL = "select email_address,application2email_gid,primary_emailaddress, application_gid from agr_mst_tapplication2email where " +
                  " application_gid='" + employee_gid + "' or application_gid = '" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getmstemailaddress_list = new List<mstemailaddress_list>();
                if (dt_datatable.Rows.Count != 0)
            ...
            public void DaDeleteAppEmailAddress(string application2email_gid, MdlMstEmailAddress values)
            {
                ...
                if (mnResult != 0)
                {
                    msSQL = "delete from agr_mst_tapplication2emailupdatelog where application2email_gid='" + application2email_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            public void DaDeleteAppGeneticCode(string application2geneticcode_gid, MdlMstGeneticCode values, string employee_gid)
            {
                ...
                if (mnResult != 0)
                {
                    msSQL = "delete from agr_mst_tapplication2geneticcodeupdatelog where application2geneticcode_gid='" + application2geneticcode_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            public void DaEditAppBasicDetail(string application_gid, MdlMstApplicationAdd values)
            {
                try
                {
                    msSQL = " select application_gid,customer_urn,customerref_name as customer_name,vertical_gid,vertical_name,verticaltaggs_gid,verticaltaggs_name," +
                            ...
                            " program_gid,program_name,product_gid,product_name,variety_gid,variety_name,sector_name,category_name,botanical_name,alternative_name from agr_mst_tapplication where application_gid='" + application_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                        values.application_gid = objODBCDatareader["application_gid"].ToString();
            ...
            {
                msSQL = " select application_gid from agr_trn_tAppcreditapproval where application_gid='" + values.application_gid + "' and hierary_level<>'0'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    objODBCDatareader.Close();
                ...
                msSQL = "select count(application2geneticcode_gid) from agr_mst_tapplication2geneticcode where application_gid='" + employee_gid + "' or application_gid='" + values.application_gid + "'";
                ...
                if (lsmastercount == lsgeneticcount)
                {
                    ...
                    msSQL = " select application_gid,customer_urn,customerref_name as customer_name,vertical_gid,vertical_name,verticaltaggs_gid,verticaltaggs_name," +
                                 ...
                                 " vernacular_language,contactpersonfirst_name,contactpersonmiddle_name,contactpersonlast_name,designation_gid,designation_type,landline_no,creditgroup_gid,creditgroup_name, " +
                                 " program_gid,program_name,product_gid,product_name,variety_gid,variety_name,sector_name,category_name, botanical_name, alternative_name from agr_mst_tapplication " +
                    ...
                    try
                    {
                        ...
                        if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                        {
                            ...
                            Thread t = new Thread(new ThreadStart(() =>
                            {
                                ...
                                //Updating Overall Company Details
                                List<string> existingString = new List<string> { lscustomer_name, lssa_name };
                                List<string> updatedString = new List<string> { values.customer_name, values.sa_name };

                                if (!(existingString.SequenceEqual(updatedString)))
                                {
                                    objFnSamAgroHBAPIContract.UpdateContractBasicDetailsHBAPI(values.application_gid);
                                }
            ...
            public void DaUpdateGroupDtl(string employee_gid, MdlMstGroup values)
            {
                ...
                msSQL = " select group_name,date_format(date_of_formation,'%d-%m-%Y') as date_of_formation,group_type,groupmember_count,groupurn_status,group_urn,group_status" +
                           " from agr_mst_tgroup where group_gid='" + values.group_gid + "'";
                ...
                DaAgrMstScannedDocument objvalues = new DaAgrMstScannedDocument();
                    ...
                    msSQL = " insert into agr_mst_tgroupupdatelog(" +
                         " groupupdatelog_gid," +
                         " group_gid," +
                         " application_gid," +
                         " group_name," +
            ...
            public void DaServicechargeEdit(string application2servicecharge_gid, MdlProductCharges values, string employee_gid)
            {
                try
                {
                    msSQL = " select application2servicecharge_gid,application_gid,processing_fee,processing_collectiontype,doc_charges,doccharge_collectiontype," +
                            ...
                            " from agr_mst_tapplicationservicecharge where application2servicecharge_gid ='" + application2servicecharge_gid + "'";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
            ...
            public void DaServicechargeUpdate(string employee_gid, MdlProductCharges values)
            {
                ...
                msSQL = " select application2servicecharge_gid,application_gid,processing_fee,processing_collectiontype,doc_charges,doccharge_collectiontype," +
                              " fieldvisit_charges,fieldvisit_charges_collectiontype,adhoc_fee,adhoc_collectiontype,life_insurance,lifeinsurance_collectiontype," +
                              " acct_insurance,total_collect,total_deduct,product_type,producttype_gid,acctinsurance_collectiontype " +
                              " from agr_mst_tapplicationservicecharge where application2servicecharge_gid ='" + values.application2servicecharge_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    lsapplication_gid = objODBCDatareader["application_gid"].ToString();
                ...
                try
                {
                    msSQL = " update agr_mst_tapplicationservicecharge set " +
                    ...
                    msSQL = " select generatelsa_gid from agr_trn_tgeneratelsa a " +
                       " left join agr_trn_tprocesstype_assign b on b.application_gid = a.application_gid " +
                    ...
                    if (generatelsa_gid != "")
                    {
                        msSQL = " update agr_trn_tlsafeescharge set " +
                           " processing_fee='" + values.processing_fee.Replace(",", "") + "'," +
                           " processing_collectiontype='" + values.processing_collectiontype + "'," +
                           " doc_charges='" + values.doc_charges.Replace(",", "") + "'," +
                           " doccharge_collectiontype='" + values.doccharge_collectiontype + "'," +
                    ...
                    if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                    {
                        ...
                        Thread t = new Thread(new ThreadStart(() =>
                        {
                            HttpContext.Current = ctx;
                                ...
                                if (!(existingString.SequenceEqual(updatedString)))
                                {
                                    objFnSamAgroHBAPIContract.UpdateContractChargesHBAPI(values.application2servicecharge_gid);
                                }
            ...
            {
                msSQL = "update agr_mst_tapplication set ccsubmit_flag='Y', approval_status='Submitted to CC',ccsubmitted_by='" + employee_gid + "'," +
                ...
                try
                {
                    if (httpRequest.Files.Count > 0)
                    {
                        ...
                        msGetGid = objcmnfunctions.GetMasterGID("A2MD");
                            msSQL = " insert into agr_mst_tapplication2camdoc( " +
                            ...
                            msSQL = " select application2camdoc_gid,application_gid,document_name,document_path,document_title from " +
                                " agr_mst_tapplication2camdoc where application_gid='" + lsapplication_gid + "'";
                            dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            {
                msSQL = "delete from agr_mst_tapplication2camdoc where application2camdoc_gid='" + application2camdoc_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    msSQL = " select application2camdoc_gid,application_gid,document_name,document_path,document_title from " +
                               " agr_mst_tapplication2camdoc where application_gid='" + application_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    var getcamdocument_list = new List<camdocument_list>();
                    if (dt_datatable.Rows.Count != 0)
                    {
            ...
            public void DaImportExcelBankStatement(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                objcmnfunctions.uploadFile(lspath, lsfile_gid);
                    ...
                    foreach (DataRow row in dt.Rows)
                    {
                        ...
                        msSQL = " insert into agr_mst_tbankstatementanalysis(" +
            ...
            public void DaGetBankStatementList(string credit_gid, string application_gid, string employee_gid, MdlMstCUWBankStatement values)
            {
                msSQL = " select bankstatementanalysis_gid, credit_gid, application_gid, month, year, total_debits, total_credits, accttransfer_debits, accttransfer_credits," +
                        ...
                        " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date, " +
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by " +
                        " from agr_mst_tbankstatementanalysis a " +
                        " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                        " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
            ...
            public void DaImportProfitLoss(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                objcmnfunctions.uploadFile(lspath, lsfile_gid);
                    ...
                    msSQL = "select application_gid from agr_trn_tfsaupload where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                        " and template_name='" + template_name + "'";
                    string lsGID = objdbconn.GetExecuteScalar(msSQL);
                    if (lsGID == null || lsGID == "")
                    {
                        msGetGid = objcmnfunctions.GetMasterGID("FSAU");
                        msSQL = " insert into agr_trn_tfsaupload(" +
                           " fasupload_gid," +
                           " application_gid," +
                           " credit_gid," +
                           " template_name," +
                    ...
                    {
                        msSQL = "delete from agr_trn_tfsaupload where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                        " and template_name='" + template_name + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                        if (mnResult != 0)
                        {
                            msSQL = "delete from agr_trn_tcreditprofitloss where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                       " and template_name='" + template_name + "'";
                            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    foreach (DataColumn column in dt.Columns)
                    {
                        ...
                        else
                        {
                            ...
                            msSQL = " insert into agr_trn_tcreditprofitloss(" +
            ...
            public void DaGetProfitLoss(string application_gid, string credit_gid, string template_name, MdlMstProfitLoss values)
            {
                msSQL = "select audited,domestic_sales,export_sales,totalgross_sales,excise_duty,otheroperating_income,other_income,net_sales,increasenet_sales, " +
                    ...
                    " current_tax,deferred_tax,pat,net_profitloss,amount,rate,retained_profit,template_name,application_gid,credit_gid,allfiguresin_inr from agr_trn_tcreditprofitloss " +
            ...
            public void DaImportExcelBalanceSheetTemplate1(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                if ((!System.IO.Directory.Exists(lsfilePath)))
                    ...
                    else
                    {
                        ...
                        if (mnResult != 0)
                        {
                            msSQL = "delete from agr_trn_tcreditbalancesheet where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                    ...
                    foreach (DataColumn column in dt.Columns)
                    {
                        ...
                        else
                        {
                            ...
                            msSQL = " insert into agr_trn_tcreditbalancesheet(" +
            ...
            public void DaGetBalanceSheetTemplate1List(string credit_gid, string application_gid, string template_type, string employee_gid, MdlMstCUWBalancesheettemplate1 values)
            {
                msSQL = " select creditbalancesheet_gid, credit_gid, application_gid, template_type, allfiguresin_inr, audit_type, applicant_bank, other_banks, billpurchased_disc, wcb_total," +
                        ...
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by " +
                        " from agr_trn_tcreditbalancesheet a " +
                        " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                        " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
            ...
            public void DaImportExcelSummaryTemplate1(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                objcmnfunctions.uploadFile(lspath, lsfile_gid);
                    ...
                    else
                    {
                        ...
                        if (mnResult != 0)
                        {
                            msSQL = "delete from agr_trn_tsummarytemplate1 where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                                    " and template_name='" + template_name + "'";
                            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    foreach (DataColumn column in dt.Columns)
                    {
                        ...
                        else
                        {
                            ...
                            msSQL = " insert into agr_trn_tsummarytemplate1(" +
            ...
            public void DaGetSummaryTemplate1View(string credit_gid, string application_gid, string template_name, MdlSummaryTemplate1View values)
            {
                ...
                try
                {
                    msSQL = " select date, audit_type, net_sales, other_income, total_revenue, growth_in_revenues, ebitda, ebitda_margin, depreciation," +
                            ...
                            " from agr_trn_tsummarytemplate1" +
                            " where application_gid='" + application_gid + "'" +
                            " and credit_gid='" + credit_gid + "' and template_name='" + template_name + "'";
            ...
            public void DaImportExcelBalanceSheetTemplate2(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                ms.Close();
                    ...
                    else
                    {
                        ...
                        if (mnResult != 0)
                        {
                            msSQL = "delete from agr_trn_tcreditbalancesheet2 where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                       " and template_type='" + lstemplate_type + "'";
                            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    foreach (DataColumn column in dt.Columns)
                    {
                        ...
                        else
                        {
                            ...
                            msSQL = " insert into agr_trn_tcreditbalancesheet2(" +
            ...
            public void DaGetBalanceSheetTemplate2List(string credit_gid, string application_gid, string template_type, string employee_gid, MdlMstCUWBalancesheettemplate2 values)
            {
                msSQL = " select creditbalancesheet2_gid, credit_gid, application_gid, template_type, allfiguresin_inr, audit_type,demand_deposits, term_deposits, " +
                        ...
                        " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date, " +
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by " +
                        " from agr_trn_tcreditbalancesheet2 a " +
                        " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                        " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                        " where credit_gid = '" + credit_gid + "' and a.application_gid='" + application_gid + "' and template_type='" + template_type + "'";
            ...
            public void DaImportProfitLossTemp2(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                objcmnfunctions.uploadFile(lspath, lsfile_gid);
                    ...
                    else
                    {
                        ...
                        if (mnResult != 0)
                        {
                            msSQL = "delete from agr_trn_tcreditprofitlosstemp2 where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                       " and template_name='" + template_name + "'";
                            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    foreach (DataColumn column in dt.Columns)
                    {
                        ...
                        else
                        {
                            ...
                            msSQL = " insert into agr_trn_tcreditprofitlosstemp2(" +
            ...
            public void DaImportExcelSummaryTemplate2(HttpRequest httpRequest, string employee_gid, result objResult)
            {
                ...
                objcmnfunctions.uploadFile(lspath, lsfile_gid);
                    ...
                    else
                    {
                        ...
                        if (mnResult != 0)
                        {
                            msSQL = "delete from agr_trn_tsummarytemplate2 where application_gid='" + application_gid + "' and credit_gid='" + credit_gid + "'" +
                                    " and template_name='" + template_name + "'";
                            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    foreach (DataColumn column in dt.Columns)
                    {
                        ...
                        else
                        {
                            ...
                            msSQL = " insert into agr_trn_tsummarytemplate2(" +
            ...
            public void DaGetSummaryTemplate2View(string credit_gid, string application_gid, string template_name, MdlSummaryTemplate2View values)
            {
                ...
                try
                {
                    msSQL = " select date, audit_type, interest_earned, other_income, total_income, growth_in_income, interest_expenses, operating_expenses, provision_and_contingencies," +
                            ...
                            " from agr_trn_tsummarytemplate2" +
                            " where application_gid='" + application_gid + "'" +
                            " and credit_gid='" + credit_gid + "' and template_name='" + template_name + "'";
            ...
            {
                msSQL = "select remarks from agr_mst_tapplication  where application_gid ='" + application_gid + "'";
                ...
                msSQL = " select approval_gid, approval_name, approval_status, hierary_level, case when hierary_level = 0 then 'creditManager' " +
                        ...
                        " when hierary_level = 3 then 'CreditHead'  end as approver from agr_trn_tAppcreditapproval  where application_gid ='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
            ...
            public void DaGetProfitLossTemp2List(string application_gid, string credit_gid, string template_name, MdlMstProfitLosstemp2 values)
            {
                msSQL = " select credirprofitlosstemp2_gid, audited, interest_income, incomeon_investments, interest_others, income_others, " +
                        ...
                        " template_name, application_gid, credit_gid from agr_trn_tcreditprofitlosstemp2 " +
                        " where application_gid='" + application_gid + "'" +
                        " and credit_gid='" + credit_gid + "' and template_name='" + template_name + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void Dagetoldnewapplication(string onboard_gid, string product_gid, string program_gid,MdlMstGetoldnewapplicationid values)
        {
            try
            {
               
                //msSQL = " select application_gid  from agr_mst_tbyronboard  where application_gid='" + onboard_gid + "' ";
                //objODBCDatareader = objdbconn.GetDataReader(msSQL);
                //if (objODBCDatareader.HasRows == true)
                //{
                    //lsapplication_gid1 = objODBCDatareader["application_gid"].ToString();

                    msSQL = " select  a.buyeronboard_gid, a.application_gid,b.product_type, a.created_date,b.application2loan_gid,c.application_no from agr_mst_tonboardinitiatedtl a " +
                  " left join agr_mst_tapplication2loan b on b.application_gid = a.application_gid " +
                   " left join agr_mst_tapplication c on c.application_gid = a.application_gid " +
                  " where a.buyeronboard_gid='" + onboard_gid + "'and  b.producttype_gid ='"+ product_gid + "' and b.productsubtype_gid='"+ program_gid + "'   <> b.application2loan_gid and c.approval_status not like'%Rejected%'  group by a.application_gid order by c.created_date desc limit 1 ";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                        values.newapplication_gid = objODBCDatareader["application_gid"].ToString();
                        values.newapplication2loan_gid = objODBCDatareader["application2loan_gid"].ToString();
                    //values.newapplication2loan_gid = objODBCDatareader["application2loan_gid"].ToString();
                    values.newapplicationno = objODBCDatareader["application_no"].ToString();
                       values.newproduct_type = objODBCDatareader["product_type"].ToString();                   
                   
                   }
                    msSQL = " select  a.buyeronboard_gid, a.application_gid, a.created_date,b.application2loan_gid,b.product_type,c.application_no from agr_mst_tonboardinitiatedtl a " +
                         " left join agr_mst_tapplication2loan b on b.application_gid = a.application_gid " +
                         " left join agr_mst_tapplication c on c.application_gid = a.application_gid " +
                         " where a.buyeronboard_gid='" + onboard_gid + "'and  b.producttype_gid ='" + product_gid + "' and b.productsubtype_gid='" + program_gid + "'   <> b.application2loan_gid and c.approval_status not like'%Rejected%'  group by a.application_gid order by created_date desc limit 1,1 ";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                        values.oldapplication_gid = objODBCDatareader["application_gid"].ToString();
                        values.oldapplication2loan_gid = objODBCDatareader["application2loan_gid"].ToString();
                        values.oldapplicationno = objODBCDatareader["application_no"].ToString();
                         values.oldproduct_type = objODBCDatareader["product_type"].ToString();
        ...
        public void Dagetproductvariety(MdlMstGetoldnewapplicationid values, string newapplication2loan_gid, string oldapplication2loan_gid)
        {
            try
            {
                msSQL = "  select  application2loan_gid,product_type,productsub_type,CASE WHEN (source_type not in" +
                    " (select source_type from agr_mst_tapplication2loan where application2loan_gid='" + oldapplication2loan_gid + "' or  application_gid='')) " +
                 " THEN 'Y' else 'N'  END AS 'source_flag', " +
               " CASE WHEN(collateralobservation_summary not in " +
         " (select collateralobservation_summary from agr_mst_tapplication2loan where application2loan_gid= '" + oldapplication2loan_gid + "' or application_gid = '')) " +
            " THEN 'Y' else 'N'  END AS 'observation_flag' from agr_mst_tapplication2loan where application2loan_gid = '" + newapplication2loan_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    values.Mdlsource_typeflag = objODBCDatareader["source_flag"].ToString();
                    values.Mdlcollateralobservation_summaryflag = objODBCDatareader["observation_flag"].ToString();
                ...
                values.message = "success";
                objODBCDatareader.Close();
                //msSQL = "select source_type from agr_mst_tapplication2loan where application2loan_gid='" + newapplication2loan_gid + "' and source_type not in (select source_type from agr_mst_tapplication2loan where application2loan_gid='" + oldapplication2loan_gid + "')";
                ...
                //}
                //msSQL = "select collateralobservation_summary from agr_mst_tapplication2loan where application2loan_gid='" + newapplication2loan_gid + "' and collateralobservation_summary not in (select collateralobservation_summary from agr_mst_tapplication2loan where application2loan_gid='" + oldapplication2loan_gid + "')";
                ...
                //    foreach (DataRow dr_datarow in dt_datatable.Rows)
                //    {
                //        values.Mdlcollateralobservation_summaryflag = "Y";
        ...
        public void DaGetLoanProgramValueChain(string oldapplication2loan_gid, MdlMstProductChargesView values, string newapplication2loan_gid)
        {
            try
            {
                msSQL = " select program, primaryvaluechain_name, secondaryvaluechain_name,product_gid,product_name, " +
                        ...
                        " from agr_mst_tapplication2loan where application2loan_gid='" + newapplication2loan_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                ...
                //        " from agr_mst_tapplication2product where application2loan_gid='" + newapplication2loan_gid + "'";
                //           msSQL = " select application2product_gid, product_gid, product_name, variety_gid, variety_name, sector_name, category_name, hsn_code, " +
                //           " CASE WHEN(a.product_name not in (select product_name from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = '')) " +
                //            " THEN 'Y' " +
                //            " else 'N' " +
                //       " END AS 'product_flag' " +
                // " , botanical_name,alternative_name,unitpricevalue_commodity,natureformstate_commodity,qualityof_commodity, " +
                // " quantity,uom_gid,uom_name, headingdesc_product,typeofsupply_naturename,sectorclassification_name " +
                //" from agr_mst_tapplication2product a  where application2loan_gid = '" + newapplication2loan_gid + "' ";
                msSQL = " select application2product_gid, product_gid, product_name, variety_gid, variety_name, sector_name, category_name, hsn_code," +
                    " CASE WHEN(a.product_name not in (select product_name from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = ''))THEN 'Y' " +
                    "else 'N' END AS 'product_flag'  ,CASE WHEN(a.variety_name not in (select variety_name from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = ''))THEN 'Y' else 'N' " +
                    "  END AS 'variety_flag', botanical_name,alternative_name,unitpricevalue_commodity,natureformstate_commodity,qualityof_commodity, quantity,uom_gid,uom_name, headingdesc_product,typeofsupply_naturename,sectorclassification_name," +
                    " CASE WHEN(a.sectorclassification_name not in (select sectorclassification_name from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = ''))THEN 'Y' WHEN(a.unitpricevalue_commodity not in (select unitpricevalue_commodity from agr_mst_tapplication2product " +
                    "where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = ''))THEN 'Y'  WHEN(a.natureformstate_commodity not in (select natureformstate_commodity from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = '')) THEN 'Y' " +
                    " WHEN(a.qualityof_commodity not in (select qualityof_commodity from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = ''))THEN 'Y'  WHEN(a.quantity not in (select quantity from agr_mst_tapplication2product" +
                    " where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = '')) THEN 'Y'   WHEN(a.uom_name not in (select uom_name from agr_mst_tapplication2product where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = '')) THEN 'Y'   else 'N' END AS 'sector_flag'  from agr_mst_tapplication2product a " +
                    " where application2loan_gid = '" + newapplication2loan_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                if (dt_datatable.Rows.Count != 0)
                {
                    foreach (DataRow dr_datarow in dt_datatable.Rows)
                    {
                        getmstproductdtl_list.Add(new mstproductdtl_list
                        {
                            ...
                            product_flag = dr_datarow["product_flag"].ToString(),
                            variety_flag = dr_datarow["variety_flag"].ToString(),
                            sector_flag = dr_datarow["sector_flag"].ToString()
                        });
                    }
        ...
        public void DaGetLoan2Supplierdtl(string newapplication2loan_gid, string employee_gid, MdlSupplierdtlList values, string tmp_status, string oldapplication2loan_gid, string application_gid)
        {
            msSQL = " select apploan2supplierdtl_gid,application2loan_gid,application_gid, supplier_gid, a.supplier_name,supplier_address,supplier_emailid, " +
                    " supplier_phoneno, supplier_gstno, supplier_pandtl, milestone_applicable,milestonepaymenttype_gid,milestonepaymenttype_name,supplier_vintage, supplier_margin, " +
                   " CASE WHEN(a.supplier_name not in (select supplier_name from agr_mst_tapploan2supplierdtl where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = '')) " +
                    " THEN 'Y' else 'N'  END AS 'product_flag' " +
            ...
            if (tmp_status == "true")
                ...
                msSQL += " where a.application_gid='" + application_gid + "' and (a.application2loan_gid = '" + employee_gid + "' or a.application2loan_gid = '" + newapplication2loan_gid + "') order by apploan2supplierdtl_gid asc";
            else
                msSQL += " where a.application2loan_gid = '" + newapplication2loan_gid + "' order by apploan2supplierdtl_gid asc";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetLoan2SupplierPaymentdtl(string newapplication2loan_gid, string application_gid, string oldapplication2loan_gid, string employee_gid, MdlSupplierPaymentdtlList values, string tmp_status)
        {
            msSQL = " select apploan2supplierpayment_gid,application_gid,application2loan_gid, commodity_gid, commodity_name, " +
                    ...
                    " CASE WHEN(a.commodity_name not in (select commodity_name from agr_mst_tapploan2supplierpayment where application2loan_gid = '" + oldapplication2loan_gid + "' or application2loan_gid = '')) " +
              " THEN 'Y' else 'N'  END AS 'product_flag' " +
            ...
            if (tmp_status == "true")
                ...
                msSQL += " where  a.application_gid='" + application_gid + "' and (a.application2loan_gid = '" + employee_gid + "' or a.application2loan_gid = '" + newapplication2loan_gid + "') order by apploan2supplierpayment_gid asc";
            else
                msSQL += " where a.application2loan_gid = '" + newapplication2loan_gid + "' order by apploan2supplierpayment_gid asc";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void Dagetproductprogramgid(string application_gid, MdlMstGetoldnewapplicationid values)
        {
            try
            {

                msSQL = " select product_gid,program_gid from agr_mst_tonboardinitiatedtl where application_gid='" + application_gid + "' ";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void Dagetproductapplicationloangid(string application2loan_gid,MdlMstGetoldnewapplicationid values, string application_gid)
        {
            try
            {

                msSQL = " select date_format(created_date,'%Y-%m-%d %T') as created_date  from agr_mst_tapplication2loan where application2loan_gid='" + application2loan_gid + "' ";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                ...
                msSQL = " select application2loan_gid  from agr_mst_tapplication2loan where application2loan_gid !='" + application2loan_gid + "' " +
                    " and created_date ='" + values.created_date + "' order by application2loan_gid desc limit 1 ";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    values.newapplication2loan_gid = objODBCDatareader["application2loan_gid"].ToString();
                ...
                msSQL = " select application2loan_gid,date_format(facilityrequested_date, '%d-%m-%Y') as facilityrequested_date, product_type,limit_product, " +
                       ...
                       " case when application2loan_gid = '" + application2loan_gid + "' then 'Y'  else 'N' end as highlight_flag " +
                       " from agr_mst_tapplication2loan " +
                       " where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getmstloansummary_list = new List<mstLoan_list1>();
                if (dt_datatable.Rows.Count != 0)
                {
                    foreach (DataRow dr_datarow in dt_datatable.Rows)
                    {
                        getmstloansummary_list.Add(new mstLoan_list1
                        {
                            ...
                            highlight_flag = (dr_datarow["highlight_flag"].ToString())
        ...
        public void Dagetrenewalamendmentflag(string application_gid, MdlMstGetoldnewapplicationid values)
        {
            try
            {

                msSQL = " select amendment_flag,renewal_flag from agr_mst_tapplication where application_gid='" + application_gid + "' ";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        //public void Dagetcollateraldetailflag(string newapplication2loan_gid, string application_gid, string oldapplication2loan_gid, MdlMstGetoldnewapplicationid values)
        //{
        //    try
        //    {
        ...
        //               " where application_gid='" + newapplication2loan_gid + "' and loan_type ='Secured'";
        //        dt_datatable = objdbconn.GetDataTable(msSQL);
        //        var getmstcollateral_list = new List<mstcollateral_list1>();
        //        if (dt_datatable.Rows.Count != 0)
        //        {
        //            foreach (DataRow dr_datarow in dt_datatable.Rows)
        //            {
        //                getmstcollateral_list.Add(new mstcollateral_list1
        //                {
        //                    application2loan_gid = (dr_datarow["application2loan_gid"].ToString()),
