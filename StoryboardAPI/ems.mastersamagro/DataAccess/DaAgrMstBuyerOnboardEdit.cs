...
{
    /// <summary>
    /// This DataAccess will provide access to edit single and multiple datas in Buyer Onboard stage.  (Includes editing of onboarded buyer general, company & individual info)
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Premchander.K </remarks>
    public class DaAgrMstBuyerOnboardEdit
    {
        ...
        string lsincometax_returnsstatus;
        ...
        public bool DaSubmitInstitutionDtlEdit(MdlMstBuyerOnboardInstitutionAdd values, string employee_gid)
        {
            ...
            msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2address where (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "') and primary_status='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2email where (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "') and primary_status='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            if (values.Gstflag == "Yes")
            {
                ...
                msSQL = "select institution2branch_gid from agr_mst_tbyronboardinstitution2branch where institution_gid='" + employee_gid + "' and headoffice_status ='Yes' ";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            //msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2bankdtl where institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "' and primary_status='Yes'";
            //objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            //msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2bankdtl where institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "'";
            //objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select stakeholder_type from agr_mst_tbyronboardcontact where application_gid='" + values.application_gid + "' and stakeholder_type in ('Borrower','Applicant')";
            ...
            msSQL = "select stakeholder_type from agr_mst_tbyronboard2institution where application_gid='" + values.application_gid + "' and stakeholder_type in ('Borrower','Applicant')";
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tbyronboardinstitution2ratingdetail set institution_gid='" + msGetGid + "', application_gid ='" + values.application_gid + "' where institution_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaIndividualSubmit(string employee_gid, MdlMstBuyerOnboardContact values)
        {
            ...
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2email where contact_gid='" + employee_gid + "' and primary_status='Yes' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            objODBCDatareader.Close();
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2address where contact_gid='" + employee_gid + "' and primary_status='Yes' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tbyronboardcontact2bankdtl set contact_gid='" + msGetGid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                {
                    msSQL = "update agr_mst_tbyronboard set applicant_type ='Individual' where application_gid='" + values.application_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaInstitutionDetailsEdit(string institution_gid, MdlMstBuyerOnboardInstitutionAdd values)
        {
            try
            {
                msSQL = " select application_gid, application_no, company_name, date_incorporation, businessstart_date, companypan_no, year_business, month_business, cin_no," +
                   " official_telephoneno, officialemail_address, companytype_gid, companytype_name, stakeholder_type, stakeholdertype_gid, assessmentagency_gid, msme_registration, lglentity_id, lei_renewaldate, kin,  " +
                   ...
                   " businesscategory_name, contactperson_firstname, contactperson_middlename, contactperson_lastname, designation_gid, designation, stakeholder_type," +
        ...
        {
            msSQL = "select institution2branch_gid,gst_state,gst_no, gst_registered,authentication_status,returnfilling_status,verification_status , headoffice_status from agr_mst_tbyronboardinstitution2branch where institution_gid='" + institution_gid + "'or institution_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select email_address,institution2email_gid,primary_status from agr_mst_tbyronboardinstitution2email where institution_gid='" + institution_gid + "'or institution_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaInstitutionAddressList(string institution_gid, string employee_gid, MdlMstBuyerOnboardAddressDetails values)
        {
            msSQL = "  select institution2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, latitude, longitude, landmark," +
                    " postal_code from agr_mst_tbyronboardinstitution2address where institution_gid='" + institution_gid + "'or institution_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaInstitutionDocumentList(string institution_gid, string employee_gid, institutionBuyerOnboarduploaddocument values)
        {
            msSQL = " select institution2documentupload_gid,institution_gid,document_name,document_path,document_title,document_id," +
                    ...
                    " from agr_mst_tbyronboardinstitution2documentupload a" +
        ...
        public bool DaUpdateInstitutionDtl(MdlMstInstitutionAdd values, string employee_gid)
        {
            ...
            msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2mobileno where institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2email where institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select institution_gid from agr_mst_tbyronboardinstitution2address where institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select institution_gid  from agr_mst_tbyronboardinstitution2email where primary_status='Yes' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "'  )";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            objODBCDatareader.Close();
            msSQL = "select institution_gid  from agr_mst_tbyronboardinstitution2address where primary_status='Yes' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "')";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            if (values.Gstflag == "Yes")
            {
                msSQL = "select institution2branch_gid from agr_mst_tbyronboardinstitution2branch where (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "') and headoffice_status ='Yes' ";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select application_gid from agr_mst_tbyronboard2institution where institution_gid='" + values.institution_gid + "'";
            ...
            if (values.stakeholder_type == "Borrower" || values.stakeholder_type == "Applicant")
            {
                ...
                msSQL = "select stakeholder_type from agr_mst_tbyronboard2institution where application_gid='" + values.application_gid + "' and" +
            ...
            msSQL = " select application_gid, application_no, company_name, date_incorporation, businessstart_date,companypan_no, year_business, month_business, cin_no,incometax_returnsstatus," +
                     ...
                     " assessmentagency_name, assessmentagencyrating_gid, assessmentagencyrating_name, ratingas_on, amlcategory_gid, amlcategory_name,businesscategory_gid,lglentity_id, " +
                     " businesscategory_name, contactperson_firstname, contactperson_middlename, contactperson_lastname, designation_gid, designation, msme_registration,lei_renewaldate,kin, " +
                     " lastyear_turnover, escrow, start_date, end_date, urn_status, urn, tan_number  " +
                     " from agr_mst_tbyronboard2institution where institution_gid='" + values.institution_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
            ...
            try
            {
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into agr_mst_tbyronboard2institutionupdateLOG(" +
                    ...
                    msSQL = "update agr_mst_tbyronboardinstitution2branch set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2mobileno set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2email set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2address set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2licensedtl set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2ratingdetail set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2bankdtl set institution_gid='" + values.institution_gid + "', application_gid ='" + values.application_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    ...
                    msSQL = "select companydocument_gid, institution2documentupload_gid from agr_mst_tbyronboardinstitution2documentupload where institution_gid='" + employee_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt in dt_datatable.Rows)
                    {
                    ...
                    msSQL = "update agr_mst_tbyronboardinstitution2documentupload set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = "update agr_mst_tbyronboardinstitution2form60documentupload set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    msSQL = "select mobile_no from agr_mst_tbyronboardinstitution2mobileno where institution_gid='" + values.institution_gid + "' and primary_status='yes'";
                    string lsmobileno = objdbconn.GetExecuteScalar(msSQL);

                    msSQL = "select email_address from agr_mst_tbyronboardinstitution2email where institution_gid='" + values.institution_gid + "' and primary_status='yes'";
                    lsemail_address = objdbconn.GetExecuteScalar(msSQL);
                    if (values.stakeholder_type == "Borrower" || values.stakeholder_type == "Applicant")
                    {
                        msSQL = "update agr_mst_tbyronboard set applicant_type ='Institution' where application_gid='" + values.application_gid + "'";
                    ...
                    if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                    {
                        ...
                        Thread t = new Thread(new ThreadStart(() =>
                        {
                            ...
                            //List<string> existingString = new List<string> { lsofficial_mailid, lsofficial_telephoneno, lscompany_name, lscompanypan_no, lscompanytype_name, lstan_number, lsincometax_returnsstatus, lslastyear_turnover };
                            //List<string> updatedString = new List<string> { values.official_mailid, values.official_telephoneno, values.company_name, values.companypan_no, values.companytype_name, values.tan_number, values.incometax_returnsstatus, values.lastyear_turnover };

                            //if (!(existingString.SequenceEqual(updatedString)))
                            //{
                                objFnSamAgroHBAPIConnEdit.UpdateBuyerInstitutionHBAPI(values.institution_gid);
                            //}
                            ...
                            {
                                objFnSamAgroHBAPIConnEdit.UpdateBuyerInstitutionContactBasicHBAPI(values.institution_gid);
                            }
                            ...
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerInstitutionContactAddHBAPI(mobilenogid_list, emailgid_list, values.institution_gid);
        ...
        public void DaGetIndividualAddressTempList(string contact_gid, string employee_gid, MdlBuyerOnboardContactAddress values)
        {
            msSQL = " select contact2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, latitude, longitude," +
                    " postal_code from agr_mst_tbyronboardcontact2address where contact_gid='" + employee_gid + "' or contact_gid = '" + contact_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = " select contact2document_gid,document_name,document_title,document_path from agr_mst_tbyronboardcontact2document " +
        ...
        public void DaContactPANAbsenceReasonList(string contact_gid, string employee_gid, MdlBuyerOnboardPANAbsenceReason objMdlPANAbsenceReason)
        {
            try
            {
                msSQL = " SELECT panabsencereason" +
                   " from agr_mst_tbyronboardcontact2panabsencereason where contact_gid = '" + contact_gid + "' or contact_gid = '" + employee_gid + "'";
        ...
        public void DaUpdateIndividual(string employee_gid, MdlMstBuyerOnboardContact values)
        {
            ...
            //msSQL = "select contact_gid from agr_mst_tbyronboardcontact2bankdtl where contact_gid='" + employee_gid + "' or contact_gid='" + values.contact_gid + "' and primary_status='Yes'";
            //objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            //msSQL = "select contact_gid from agr_mst_tbyronboardcontact2bankdtl where contact_gid='" + employee_gid + "' or contact_gid='" + values.contact_gid + "'";
            //objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2mobileno where (contact_gid='" + employee_gid + "' or contact_gid='" + values.contact_gid + "')  and primary_status='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2email where (contact_gid='" + employee_gid + "' or contact_gid='" + values.contact_gid + "') and primary_status='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            objODBCDatareader.Close();
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2address where (contact_gid='" + employee_gid + "' or contact_gid='" + values.contact_gid + "') and primary_status='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select pan_status from agr_mst_tbyronboardcontact where contact_gid='" + values.contact_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (values.pan_status == "Customer Submitting PAN")
            {
                ...
                msSQL = "delete from agr_mst_tbyronboardcontact2panabsencereason where contact_gid='" + values.contact_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            msSQL = " select application_gid,pan_status,pan_no,aadhar_no,first_name,middle_name,last_name,individual_dob,age,gender_gid,gender_name,designation_gid,designation_name," +
                        ...
                        " group_gid, group_name, profile, urn_status, urn, fathernominee_status, mothernominee_status, spousenominee_status, othernominee_status," +
                        " relationshiptype, nomineefirst_name, nominee_middlename, nominee_lastname, nominee_dob, nominee_age, totallandinacres, cultivatedland" +
                        " from agr_mst_tbyronboardcontact where contact_gid='" + values.contact_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            if (mnResult != 0)
            {
                if (values.pan_status == "Customer Submitting Form 60")
                {
                    ...
                    msSQL = " select panabsencereason from agr_mst_tbyronboardcontact2panabsencereason" +
                           " where contact_gid='" + values.contact_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    if (dt_datatable.Rows.Count != 0)
                    {
                    ...
                    else
                    {
                        ...
                        for (var i = 0; i < values.BuyerOnboardcontactpanabsencereason_list.Count; i++)
                        {
                            ...
                            if (matchCount2 == 0)
                            {
                                msSQL = "delete from agr_mst_tbyronboardcontact2panabsencereason where panabsencereason='" + values.BuyerOnboardcontactpanabsencereason_list[i].panabsencereason + "' and contact_gid = '" + values.contact_gid + "'";
                                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                            }
                            matchCount2 = 0;
                        }
                ...
                msSQL = " insert into agr_mst_tbyronboardcontactupdatelog(" +
              ...
              "'" + lspep_status + "',";
                ...
                msSQL = " select contact2mobileno_gid" +
                        " from agr_mst_tbyronboardcontact2mobileno" +
                ...
                msSQL = " select contact2email_gid" +
                        " from agr_mst_tbyronboardcontact2email" +
                        " where contact_gid='" + employee_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var emailgid_list = new List<string>();
                if (dt_datatable.Rows.Count != 0)
                ...
                //Updates
                msSQL = "update agr_mst_tbyronboardcontact2mobileno set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "update agr_mst_tbyronboardcontact2email set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "update agr_mst_tbyronboardcontact2address set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "update agr_mst_tbyronboardcontact2idproof set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "update agr_mst_tbyronboardcontact2panform60 set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "update agr_mst_tbyronboardcontact2panabsencereason set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                msSQL = "select individualdocument_gid, contact2document_gid from agr_mst_tbyronboardcontact2document where contact_gid='" + employee_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                foreach (DataRow dt in dt_datatable.Rows)
                {
                    string lscovenant_type = "", lsdocumenttype_gid = "", lsdocumenttype_name = "", lscompanydocument_name = "";
                ...
                msSQL = "update agr_mst_tbyronboardcontact2document set contact_gid ='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "select mobile_no from agr_mst_tbyronboardcontact2mobileno where contact_gid='" + values.contact_gid + "' and primary_status='yes'";
                string lsmobileno = objdbconn.GetExecuteScalar(msSQL);

                msSQL = "select email_address from agr_mst_tbyronboardcontact2email where contact_gid='" + values.contact_gid + "' and primary_status='yes'";
                lsemail_address = objdbconn.GetExecuteScalar(msSQL);
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        if (!(existingString.SequenceEqual(updatedString)))
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualHBAPI(values.contact_gid);
                        }
                        ...
                        if (!(existingContactValues.SequenceEqual(updatedContactValues)))
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualContactBasicHBAPI(values.contact_gid);
                        }


                        //Calling if newly added address are there.

                        objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualAddressAddHBAPI(values.contact_gid);


                        //Calling to update contacts not updated in ERP

                        objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualContactAddHBAPI(mobilenogid_list, emailgid_list, values.contact_gid);
        ...
        public void DaGetAppProductTempList(string application_gid, string employee_gid, MdlMstBuyerOnboardProductDetailList values)
        {
            msSQL = " select application2product_gid,product_gid,product_name,variety_gid,variety_name,sector_name,category_name,hsn_code, " +
                    " botanical_name,alternative_name from agr_mst_tbyronboard2product " +
        ...
        public void DaEditAppBasicDetail(string application_gid, MdlMstBuyerOnboardApplicationAdd values)
        {
            try
            {
                msSQL = " select application_gid,customer_urn,customerref_name as customer_name,vertical_gid,vertical_name,verticaltaggs_gid,verticaltaggs_name," +
                        ...
                        " botanical_name,alternative_name,onboarding_status,buyersuppliertype_gid,buyersuppliertype_name from agr_mst_tbyronboard where application_gid='" + application_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    values.application_gid = objODBCDatareader["application_gid"].ToString();
        ...
        public void DaUpdateAppBasicDetail(string employee_gid, MdlMstBuyerOnboardApplicationAdd values)
        {
            ...
            msSQL = "select count(*) from agr_mst_tbyronboard2geneticcode where application_gid='" + employee_gid + "' or application_gid='" + values.application_gid + "'";
            string lsgeneticcount = objdbconn.GetExecuteScalar(msSQL);
            if (lsmastercount == lsgeneticcount)
            {
                msSQL = "select application_gid from agr_mst_tbyronboard2contactno where (application_gid='" + employee_gid + "' or application_gid='" + values.application_gid + "')" +
                ...
                msSQL = "select application_gid from agr_mst_tbyronboard2email where (application_gid='" + employee_gid + "' or application_gid='" + values.application_gid + "')" +
                ...
                msSQL = " select application_gid,customer_urn,customerref_name as customer_name,vertical_gid,vertical_name,verticaltaggs_gid,verticaltaggs_name," +
                             ...
                             " category_name, botanical_name, alternative_name, buyersuppliertype_gid, buyersuppliertype_name from agr_mst_tbyronboard " +
                ...
                try
                {
                    ...
                    msSQL = "select status,application_no from agr_mst_tbyronboard where application_gid='" + values.application_gid + "' ";
                    objODBCDatareader = objdbconn.GetDataReader(msSQL);
                    if (objODBCDatareader.HasRows == true)
                    {
                        ...
                        {
                            msSQL = "select application_no from agr_mst_tbyronboard where application_gid='" + values.application_gid + "' ";
                    ...
                    if (mnResult == 1)
                    {
                        ...
                        // msSQL = "Insert into agr_mst_tbyronboardbasicdetailsupdatelog(" +
                        ...
                        msSQL = "update agr_mst_tbyronboard2contactno set application_gid ='" + values.application_gid + "' where application_gid='" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = "update agr_mst_tbyronboard2email set application_gid ='" + values.application_gid + "' where application_gid='" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = "update agr_mst_tbyronboard2geneticcode set application_gid ='" + values.application_gid + "' where application_gid='" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                        msSQL = "update agr_mst_tbyronboard2product set application_gid ='" + values.application_gid + "' where application_gid='" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                        ...
                        if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                        {
                            ...
                            Thread t = new Thread(new ThreadStart(() =>
                            {
                                ...
                                if (!(existingString.SequenceEqual(updatedString)))
                                {
                                    objFnSamAgroHBAPIConnEdit.UpdateBuyerGeneralHBAPI(values.application_gid);
                                }
                                ...
                                if (!(existingContactValues.SequenceEqual(updatedContactValues)))
                                {
                                    objFnSamAgroHBAPIConnEdit.UpdateBuyerGeneralContactBasicHBAPI(values.application_gid);
                                }

                                //Calling to update contacts not updated in ERP

                                objFnSamAgroHBAPIConnEdit.UpdateBuyerGeneralContactAddHBAPI(mobilenogid_list, emailgid_list, values.application_gid);
        ...
        public bool DaSaveInstitutionEditDtl(MdlMstBuyerOnboardInstitutionAdd values, string employee_gid)
        {
            ...
            if (mnResult == 1)
            {
                ...
                msSQL = "update agr_mst_tbyronboardinstitution2bankdtl set institution_gid='" + values.institution_gid + "' where institution_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                msSQL = "update agr_mst_tbyronboardinstitution2ratingdetail set institution_gid='" + values.institution_gid + "', application_gid ='" + values.application_gid + "' where institution_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaSaveIndividualEditDtl(MdlMstBuyerOnboardContact values, string employee_gid)
        {
            ...
            msSQL = "select application_gid from agr_mst_tbyronboardcontact where contact_gid='" + values.contact_gid + "'";
            values.application_gid = objdbconn.GetExecuteScalar(msSQL);
            if (values.stakeholder_type == "Borrower" || values.stakeholder_type == "Applicant")
            {
                msSQL = "select stakeholder_type from agr_mst_tbyronboardcontact where application_gid='" + values.application_gid + "' and stakeholder_type in ('Borrower','Applicant')" +
            ...
            if (values.pan_status == "Customer Submitting PAN")
            {
                msSQL = "delete from agr_mst_tbyronboardcontact2panform60 where contact_gid='" + values.contact_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaSubmitIndividualEditDtl(string employee_gid, MdlMstBuyerOnboardContact values)
        {
            ...
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2email where  primary_status='Yes' and ( contact_gid='" + employee_gid + "' or  contact_gid='" + values.contact_gid + "')";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            objODBCDatareader.Close();
            msSQL = "select contact_gid from agr_mst_tbyronboardcontact2address where primary_status='Yes' and ( contact_gid='" + employee_gid + "' or  contact_gid='" + values.contact_gid + "')";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tbyronboardcontact2bankdtl set contact_gid='" + values.contact_gid + "' where contact_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            try
            {
                ...
                if (mnResult == 1)
                {
                    ...
                    if (values.stakeholder_type == "Borrower" || values.stakeholder_type == "Applicant")
                    {
                        ...
                        msSQL = "update agr_mst_tbyronboard2institution set mobile_no='" + lsmobile_no + "'," +
                         " email_address='" + lsemail_address + "' where institution_gid='" + values.institution_gid + "' ";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
        ...
        public void DaDeleteIndividualAddress(string contact2address_gid, MdlBuyerOnboardContactAddress values)
        {
            ...
            if (mnResult != 0)
            {
                msSQL = "delete from agr_mst_tbyronboardcontact2addressupdatelog where contact2address_gid='" + contact2address_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        {
            msSQL = " select email_address,application2email_gid,primary_emailaddress, application_gid from agr_mst_tbyronboard2email where " +
            ...
            msSQL = "select application2email_gid from agr_mst_tbyronboard2email where primary_emailaddress = 'Yes' and  (application2email_gid='" + values.application2email_gid + "')";
            ...
            try
            {
                msSQL = " update agr_mst_tbyronboard2email set " +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = "Insert into agr_mst_tbyronboard2emailupdatelog(" +
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerGeneralContactHBAPI(values.application2email_gid, UpdateContactHBAPIFrom.Email);
                        }
        ...
        {
            msSQL = " select mobile_no,application2contact_gid,primary_mobileno,whatsapp_mobileno, application_gid from agr_mst_tbyronboard2contactno where " +
            ...
            msSQL = "select application2contact_gid from agr_mst_tbyronboard2contactno where primary_mobileno='Yes' and  (application2contact_gid='" + values.application2contact_gid + "')";
            string application2contact_gid = objdbconn.GetExecuteScalar(msSQL);
            if (application2contact_gid != (values.application2contact_gid))
            {


                msSQL = "select primary_mobileno from agr_mst_tbyronboard2contactno where primary_mobileno='Yes' and (application_gid='" + employee_gid + "' or application_gid='" + values.application_gid + "')";
                string primary_mobileno = objdbconn.GetExecuteScalar(msSQL);
                if (primary_mobileno == (values.primary_mobileno))
                {
                    values.status = false;
            ...
            try
            {
                msSQL = " update agr_mst_tbyronboard2contactno set " +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = "Insert into agr_mst_tbyronboard2contactnoupdatelog(" +
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerGeneralContactHBAPI(values.application2contact_gid, UpdateContactHBAPIFrom.MobileNo);
                        }
        ...
        {
            msSQL = " select mobile_no,institution2mobileno_gid,primary_status,whatsapp_no, institution_gid from agr_mst_tbyronboardinstitution2mobileno where " +
            ...
            msSQL = "select institution2mobileno_gid from agr_mst_tbyronboardinstitution2mobileno where primary_status='Yes' and  (institution2mobileno_gid='" + values.institution2mobileno_gid + "')";
            string institution2mobileno = objdbconn.GetExecuteScalar(msSQL);
            if (institution2mobileno != (values.institution2mobileno_gid))
            {
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        if (lsmobile_no != values.mobile_no)
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerInstitutionContactHBAPI(values.institution2mobileno_gid, UpdateContactHBAPIFrom.MobileNo);
                        }
        ...
        {
            msSQL = " select email_address,institution2email_gid,primary_status, institution_gid from agr_mst_tbyronboardinstitution2email where " +
            ...
            msSQL = "select institution2email_gid from agr_mst_tbyronboardinstitution2email where primary_status='Yes' and  (institution2email_gid='" + values.institution2email_gid + "')";
            ...
            if (institution2email_gid != (values.institution2email_gid))
            {
                ...
                {
                    values.status = false;
                    values.message = "Already Primary Mail Added";
                    return false;
                }
            }
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        if (lsemail_address != values.email_address)
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerInstitutionContactHBAPI(values.institution2email_gid, UpdateContactHBAPIFrom.Email);
                        }
        ...
        public bool DaUpdateInstitutionAddressDetail(string employee_gid, MdlMstBuyerOnboardAddressDetails values)
        {
            ...
            msSQL = "select institution2address_gid from agr_mst_tbyronboardinstitution2address where primary_status='Yes' and  (institution2address_gid='" + values.institution2address_gid + "')";
            ...
            try
            {
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerInstitutionAddressHBAPI(values.institution2address_gid);
                        }
        ...
        {
            msSQL = " select mobile_no,contact2mobileno_gid,primary_status,whatsapp_no, contact_gid from agr_mst_tbyronboardcontact2mobileno where " +
            ...
            msSQL = "select contact2mobileno_gid from agr_mst_tbyronboardcontact2mobileno where primary_status='Yes' and  (contact2mobileno_gid='" + values.contact2mobileno_gid + "')";
            ...
            try
            {
                msSQL = " update agr_mst_tbyronboardcontact2mobileno set " +
                         " mobile_no='" + values.mobile_no + "'," +
                         " primary_status='" + values.primary_status + "'," +
                         " whatsapp_no='" + values.whatsapp_no + "'," +
                         " updated_by='" + employee_gid + "'," +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = "Insert into agr_mst_tbyronboardcontact2mobilenoupdatelog(" +
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        if (lsmobile_no != values.mobile_no)
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualContactHBAPI(values.contact2mobileno_gid, UpdateContactHBAPIFrom.MobileNo);
                        }
        ...
        {
            msSQL = " select email_address,contact2email_gid,primary_status, contact_gid from agr_mst_tbyronboardcontact2email where " +
            ...
            msSQL = "select contact2email_gid from agr_mst_tbyronboardcontact2email where primary_status='Yes' and  (contact2email_gid='" + values.contact2email_gid + "')";
            ...
            try
            {
                msSQL = " update agr_mst_tbyronboardcontact2email set " +
                         " email_address='" + values.email_address + "'," +
                         " primary_status='" + values.primary_status + "'," +
                         " updated_by='" + employee_gid + "'," +
                         " updated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = "Insert into agr_mst_tbyronboardcontact2emailupdatelog(" +
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        if (lsemail_address != values.email_address)
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualContactHBAPI(values.contact2email_gid, UpdateContactHBAPIFrom.Email);
                        }
        ...
        public void DaEditIndividualAddress(string contact2address_gid, MdlBuyerOnboardContactAddress values)
        {
            try
            {
                msSQL = "select addresstype_gid, addresstype_name, addressline1, addressline2, landmark, taluka, primary_status, postal_code, city," +
                    ...
                    " from agr_mst_tbyronboardcontact2address where contact2address_gid='" + contact2address_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public bool DaUpdateIndividualAddress(string employee_gid, MdlBuyerOnboardContactAddress values)
        {
            ...
            msSQL = "select addresstype_gid, addresstype_name, addressline1, addressline2, landmark, taluka, primary_status, postal_code, city," +
        " district, state, country, latitude, longitude, contact_gid, contact2address_gid " +
        " from agr_mst_tbyronboardcontact2address where contact2address_gid='" + values.contact2address_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
                lsaddress_typegid = objODBCDatareader["addresstype_gid"].ToString();
            ...
            msSQL = "select contact2address_gid from agr_mst_tbyronboardcontact2address where primary_status='Yes' and  (contact2address_gid='" + values.contact2address_gid + "')";
            ...
            try
            {
                ...
                if (mnResult == 1)
                {
                    ...
                    msSQL = " insert into agr_mst_tbyronboardcontact2addressupdatelog(" +
                ...
                if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                {
                    ...
                    Thread t = new Thread(new ThreadStart(() =>
                    {
                        ...
                        if (!(existingStringList.SequenceEqual(updatedStringList)))
                        {
                            objFnSamAgroHBAPIConnEdit.UpdateBuyerIndividualAddressHBAPI(values.contact2address_gid);
                        }
        ...
        public void DaPostByrRaiseQuery(mdlraisequery values, string user_gid, string employee_gid)
        {
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tbyronboard set  query_status ='Query Raised' " +
                           " where application_gid='" + values.application_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaGetByrQuerySummary(mdlraisequery values, string application_gid)
        {
            msSQL = " select onboardquery_gid,query_title,query_status,query_description,close_remarks, " +
                     " concat(b.user_firstname, ' ', b.user_lastname, ' / ', b.user_code) as created_by,date_format(a.created_date, '%d-%m-%Y %h:%i %p') as created_date from agr_mst_tonboardquery a" +
                     " left join adm_mst_tuser b on b.user_gid = a.created_by " +
                     " where a.byronboard_gid='" + application_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetUpdateByrQueryStatus(mdlraisequery values, string user_gid)
        {
            ...
            if (mnResult != 0)
            {
                msSQL = " select onboardquery_gid from agr_mst_tonboardquery where byronboard_gid ='" + values.application_gid + "'" +
                ...
                {
                    msSQL = "update agr_mst_tbyronboard set  query_status ='Closed' " +
                           " where application_gid='" + values.application_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                }
                objODBCDatareader.Close();
        ...
        public void DaGetRaiseQuerydesc(mdlraisequery values, string onboardquery_gid)
        {
        ...
        public void DaGetOpenQueryStatus(mdlraisequery values, string application_gid)
        {

            msSQL = " select onboardquery_gid from agr_mst_tonboardquery where byronboard_gid ='" + application_gid + "'" +
                    " and query_status ='Open'";
