...
{
    public class DaLglTrnDNTrackerCBO
    {
        ...
        int mnResult;
        public bool DaGetCBOPendingList(string employee_gid, MdlDNpendingList values)
        {
            msSQL = " (select max(od_days) as max_od_days,urn,acknowledgement_status,a.Customer_name,GurantorCustomerId,Guarantor_Name,Vertical,DN_status" +
                    " from lgl_trn_tmisdata a where Vertical='CBO' and natureof_credit_amount >= 5000 " +
                    ...
                    " Vertical='CBO' and natureof_credit_amount >= 5000 and " +
        ...
        public bool DaGetCBOGeneratedList(string employee_gid, MdlDNGeneratedList values)
        {
        ...
        public bool DaGetCBOSkippedList(string employee_gid, MdlDNSkippedList values)
        {
            msSQL = " select max(od_days) as max_od_days,a.urn,Customer_name,GurantorCustomerId,Guarantor_Name,Vertical," +
                    ...
                    " left join lgl_tmp_tmisdata b on a.urn = b.urn where  Vertical='CBO' " +
        ...
        public bool DaGetCBOExclusionList(string employee_gid, MdlDNexclusionList values)
        {
            msSQL = "select account_no,count(urn),max(od_days) as max_od_days,urn,acknowledgement_status," +
                      " a.Customer_name,GurantorCustomerId,Guarantor_Name,Vertical,DN_status,date_format(a.exclusion_updateddate, '%d-%m-%Y') as excluded_date," +
        ...
        public bool DaGetCBOLegalSRList(MdlDNlegalsrList values, string employee_gid)
        {
            ...
            msSQL = " select a.customer_gid, a.templegalsr_gid,d.email,d.mobileno,a.auth_status,a.approval_status," +
                    ...
                    " where a.created_by='" + employee_gid + "' and Vertical='CBO'" +
        ...
        public bool DaGetCBO_Count(string employee_gid, count_dtl values)
        {
            ...
            msSQL = "select count(distinct a.urn) from lgl_trn_tmisdata a" +
                      " left join hrm_mst_temployee b on a.exclusion_updatedby = b.employee_gid" +
                      " left join adm_mst_tuser c on b.user_gid = c.user_gid where  Vertical='CBO'" +
