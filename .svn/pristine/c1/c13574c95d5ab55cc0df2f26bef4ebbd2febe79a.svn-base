(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualExistingBankAddController', MstCADCreditIndividualExistingBankAddController);

        MstCADCreditIndividualExistingBankAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function MstCADCreditIndividualExistingBankAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualExistingBankAddController';
    ...
    $scope.Overduedpd = function () {
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/MstCADCreditIndividualExistingBankEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
        //KYC API
