(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadPhysicalDocStatusController', MstCadPhysicalDocStatusController);

    MstCadPhysicalDocStatusController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstCadPhysicalDocStatusController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadPhysicalDocStatusController';
        ...
        function activate() {
            ...
            if (lspage == "CadPhysicalCompleted" || lspage != "RMDocChecklist") {
