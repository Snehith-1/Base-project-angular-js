(function () {
    ...
    angular
        .module('angle')
        .controller('AgrSuprGSTAuthenticationViewController', AgrSuprGSTAuthenticationViewController);

        AgrSuprGSTAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrSuprGSTAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrSuprGSTAuthenticationViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/GSTAuthenticationViewDetails';
