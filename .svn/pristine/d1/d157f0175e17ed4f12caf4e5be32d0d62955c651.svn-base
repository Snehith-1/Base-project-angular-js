(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupRepaymentEditController', MstCreditGroupRepaymentEditController);

        MstCreditGroupRepaymentEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCreditGroupRepaymentEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupRepaymentEditController';
        ...
        $scope.repaymentdtl_Back = function () {
            $location.url('app/MstCreditGroupRepaymentAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + $scope.lspage);
        }
