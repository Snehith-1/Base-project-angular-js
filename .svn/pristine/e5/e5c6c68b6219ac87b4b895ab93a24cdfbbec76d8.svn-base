(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualBankStatementAnalysisAddController', AgrTrnCreditIndividualBankStatementAnalysisAddController);

        AgrTrnCreditIndividualBankStatementAnalysisAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce', '$resource','DownloaddocumentService','cmnfunctionService'];

    function AgrTrnCreditIndividualBankStatementAnalysisAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, $resource,DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualBankStatementAnalysisAddController';
