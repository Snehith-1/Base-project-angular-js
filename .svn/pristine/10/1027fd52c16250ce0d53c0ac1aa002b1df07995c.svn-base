(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstApplCreationGradingToolViewController', AgrMstApplCreationGradingToolViewController);

    AgrMstApplCreationGradingToolViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function AgrMstApplCreationGradingToolViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstApplCreationGradingToolViewController';
