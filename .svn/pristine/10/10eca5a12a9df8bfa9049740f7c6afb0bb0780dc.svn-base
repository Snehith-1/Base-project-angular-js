(function () {
    ...
    angular
        .module('angle')
        .controller('BaseDetailsViewController', BaseDetailsViewController);

    BaseDetailsViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function BaseDetailsViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'BaseDetailsViewController';        
        ...
        function activate() {
            ...
            var url = 'api/ProbeAPI/BaseDetailsView';
