...
namespace ems.mastersamagro.Models
{
    ...
    /// <summary>
    /// This Models will store values for various excel reports in Samagro
    /// </summary>
    /// <remarks>Written by Abilash.A, Kalaiarasan Premchandar.K </remarks>

    public class MdlAgrMstApplicationReport : result
    {
        ...
        public List<MstWarehouseSummaryList> MstWarehouseSummaryList { get; set; }      
        public List<MstOtherCreditorSummaryList> MstOtherCreditorSummaryList { get; set; }
    ...
    public class ExportExcelReturnData : result
    {
        public string lscloudpath { get; set; }
        public string lsname { get; set; }
        public string lspath { get; set; }
    ...
    public class MstWarehouseSummaryList
    {
    ...
    public class MstOtherCreditorSummaryList
    {             
