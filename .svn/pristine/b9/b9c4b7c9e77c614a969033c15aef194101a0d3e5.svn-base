(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstByrOnboardApprovalEditcontroller', AgrMstByrOnboardApprovalEditcontroller);

    AgrMstByrOnboardApprovalEditcontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstByrOnboardApprovalEditcontroller($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstByrOnboardApprovalEditcontroller';
        ...
        function activate() {
            ...
            var lsedit = searchObject.lsedit;
            $scope.lsedit = searchObject.lsedit;
        ...
        $scope.GetBuyergeneral = function () {
            ...
            SocketService.get(url).then(function (resp) {
                $scope.buyertype_list = resp.data.BuyerSupplierType_List;
            });
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/GetGeneralInfoEdit';
            ...
            unlockUI();
            lockUI();
            var url = 'api/AgrMstBuyerOnboardEdit/GetIndividualSummaryEdit';
            SocketService.getparams(url, param).then(function (resp) {
                if (resp.data.status == true) {
                    ...
                    if ($scope.individual_list != null) {
                        ...
                        var getpendingapplicant = $scope.individual_list.find(function (v) { return v.contact_status === "Completed" });
                        if ((getapplicant && getapplicant.contact_gid) && (getpendingapplicant && getpendingapplicant.contact_gid)) {
            ...
            lockUI();
            var url = 'api/AgrMstBuyerOnboardEdit/GetInstitutionSummaryEdit';
            SocketService.getparams(url, param).then(function (resp) {
                if (resp.data.status == true) {
                    unlockUI();
                    ...
                    if ($scope.institution_list != null) {
                        ...
                        var getpendingapplicant = $scope.institution_list.find(function (v) { return v.institution_status === "Completed" });
                        if ((getapplicant && getapplicant.institution_gid) && (getpendingapplicant && getpendingapplicant.institution_gid)) {
                            $scope.showapprovalsubmitbtn = true;
                        }
                    }
                }
        ...
        $scope.GetBuyerindividual = function () {
            ...
            var url = 'api/AgrMstBuyerOnboard/GetCompanyList';
            ...
            if ($scope.editmdtab == true) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PANAbsenceReasonList';
                SocketService.get(url).then(function (resp) {
        ...
        $scope.productgendtl_add = function () {
            if (($scope.cboproduct_name == undefined) || ($scope.cboproduct_name == '') || ($scope.cboproduct_name == null) ||
               ($scope.cbovariety_name == undefined) || ($scope.cbovariety_name == undefined) || ($scope.cbovariety_name == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostProductDetailAdd';
                lockUI();
        ...
        function productdetaillist() {
            ...
            var url = 'api/AgrMstBuyerOnboard/GetProductDetailList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.product_delete = function (application2product_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteProductDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.generalmobileno_add = function () {
            if (($scope.txtgeneralmobileno == undefined) || ($scope.txtgeneralmobileno == '') || ($scope.rdbprimarymobile_no == undefined) || ($scope.rdbprimarywhatsapp_no == undefined) || ($scope.rdbprimarymobile_no == '') || ($scope.rdbprimarywhatsapp_no == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostMobileNo';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function generalmobilenolist() {
            ...
            var url = 'api/AgrMstBuyerOnboard/GetAppMobileNoList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.generalmobileno_delete = function (application2contact_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.add_generalmaildetails = function () {
            if (($scope.txtgeneralmail_id == undefined) || ($scope.txtgeneralmail_id == '') || ($scope.rdbgeneralmaildetails == undefined) || ($scope.rdbgeneralmaildetails == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function generalmail_list() {
            var url = 'api/AgrMstBuyerOnboard/GetAppEmailAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.generalmail_delete = function (application2email_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addgeneticcode = function () {
            if (($scope.cboGeneticCode == undefined) || ($scope.rdbStatus == undefined) || ($scope.txtgenetic_remarks == undefined) || ($scope.cboGeneticCode == null) || ($scope.rdbStatus == null) || ($scope.txtgenetic_remarks == null) || ($scope.cboGeneticCode == '') || ($scope.rdbStatus == '') || ($scope.txtgenetic_remarks == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostGeneticCode';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.geneticcode_delete = function (application2geneticcode_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteGenetic';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Submitgeneraldetails = function () {
            ...
            if (($scope.cboVernacularLanguage == undefined) || ($scope.cboVernacularLanguage == '') || ($scope.cboVernacularLanguage == null)) {
                ...
                if ($scope.cbosa_idname != undefined || $scope.cbosa_idname != null) {
                    ...
                    var getassociatemastername = $scope.associatemaster_list.find(function (v) { return v.associatemaster_gid === $scope.cbosa_idname });
                ...
                if ($scope.buyertypeadd != undefined || $scope.buyertypeadd != null) {
                    lsbuyersuppliertype_gid = $scope.buyertypeadd.buyersuppliertype_gid;
                    lsbuyersuppliertype_name = $scope.buyertypeadd.buyersuppliertype_name;
                }
                var params = {
                ...
                var url = 'api/AgrMstBuyerOnboard/SubmitGeneralDtl';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function GeneralInfo_list() {
            var url = 'api/AgrMstBuyerOnboard/GetGeneralInfo';
            SocketService.get(url).then(function (resp) {
                $scope.lblapplication_no = resp.data.application_no;
                $scope.lblcustomer_name = resp.data.customer_name;
                $scope.lblvertical_name = resp.data.vertical_name;
        ...
        $scope.getPANbasedGST = function (institution_gid) {
            if ($scope.txtpan_number.length == 10) {
                ...
                if ($scope.institutiongst_list != null) {
                    ...
                    var url = 'api/AgrMstBuyerOnboard/DeleteGSTInstitution';
                    lockUI();
                ...
                SocketService.post(url, params).then(function (resp) {
                    ...
                    if (resp.data.statusCode == 101) {
                        ...
                        var url = 'api/AgrMstBuyerOnboard/PostInstitutionGSTList';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
                ...
                if ($scope.cboStakeholdertype.user_type != "") { 
                    ...
                    var url = 'api/AgrMstBuyerOnboard/GetOnboardValidatePANAadhar';
                    SocketService.post(url, params).then(function (resp) {
        ...
        function creditbankacc_list() {
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionBankAccDtl';
            SocketService.get(url).then(function (resp) {
                   ...
                   ($scope.cboAccountType == undefined) || ($scope.cboAccountType == '') || ($scope.rdbJoint_Account == undefined) || ($scope.rdbJoint_Account == '') ||
                        ...
                        if ($scope.rdbJoint_Account == 'Yes') {
                            ...
                            if (($scope.txtjointacctholder_name == undefined) || ($scope.txtjointacctholder_name == '')) {
                                ...
                                var url = 'api/AgrMstBuyerOnboard/UpdateInstitutionBankAccDtl';
                                lockUI();
                                SocketService.post(url, params).then(function (resp) {
                                    unlockUI();
                                    if (resp.data.status == true) {
                   ...
                   ($scope.cboAccountType == undefined) || ($scope.cboAccountType == '') || ($scope.rdbJoint_Account == undefined) || ($scope.rdbJoint_Account == '') ||
                        ...
                        if ($scope.rdbJoint_Account == 'Yes') {
                            ...
                            if (($scope.txtjointacctholder_name == undefined) || ($scope.txtjointacctholder_name == '')) {
                                ...
                                var url = 'api/AgrMstBuyerOnboard/UpdateIndividualBankAccDtl';
                                lockUI();
                                SocketService.post(url, params).then(function (resp) {
                                    unlockUI();
                                    if (resp.data.status == true) {
        ...
        function license_list() {
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionLicenseList';
            SocketService.get(url).then(function (resp) {
        ...
        function institutiongstlist() {
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionGSTList';
            SocketService.get(url).then(function (resp) {
        ...
        function institutionmobilenolist() {
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionMobileNoList';
            SocketService.get(url).then(function (resp) {
        ...
        function institutionmail_list() {
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionEmailAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        function institutionaddress_list() {
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.institutiongst_add = function () {
            if (($scope.rdbgstregistered == undefined) || ($scope.rdbgstregistered == '') || ($scope.txtgst_state == undefined) || ($scope.txtgst_state == '') || ($scope.txtgst_number == undefined) || ($scope.txtgst_number == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostInstitutionGST';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutiongst_delete = function (institution2branch_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteInstitutionGST';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.verify_gstverification = function (gst_no, institution2branch_gid) {
            ...
            var url = 'api/AgrKyc/GSTVerification';
            SocketService.post(url, params).then(function (resp) {
        ...
        $scope.gstaddressview = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrMstAPIVerifications/GSTVerificationViewDetails';
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        function institutionratinglist() {
            ...
            var url = 'api/AgrMstBuyerOnboard/GetInstitutionRatingList';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.ratingdtl_add = function () {
            ...
            var url = 'api/AgrMstBuyerOnboard/PostRatingdtl';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.ratingdtl_delete = function (institution2ratingdetail_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteRatingDtl';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.institutionmobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimarymobile_no == undefined) || ($scope.rdbprimarywhatsapp_no == undefined) || ($scope.rdbprimarymobile_no == '') || ($scope.rdbprimarywhatsapp_no == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostInstitutionMobileNo';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionmobileno_delete = function (institution2mobileno_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteInstitutionMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.add_institutiomaildetails = function () {
            if (($scope.txtinstitutionmail_address == undefined) || ($scope.txtinstitutionmail_address == '') || ($scope.rdbinstitutiomaildetails == undefined) || ($scope.rdbinstitutiomaildetails == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostInstitutionEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionmail_delete = function (institution2email_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteInstitutionEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addinstitutionaddress = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.institutionaddressSubmit = function () {
                    ...
                    var url = 'api/AgrMstBuyerOnboard/PostInstitutionAddressDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteinstitution_address = function (institution2address_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteInstitutionAddressDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.institutionlicenseadd = function () {
            ...
            if (($scope.cboLicenseType == '') || ($scope.cboLicenseType == undefined) || ($scope.txtnumber == '') || ($scope.txtnumber == undefined) || ($scope.txtissue_date == '') || ($scope.txtissue_date == undefined) || ($scope.txtexpiry_date == '') || ($scope.txtexpiry_date == undefined)) {
                ...
                var url = 'api/AgrMstBuyerOnboard/PostInstitutionLicenseDetail';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionlicense_delete = function (institution2licensedtl_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteInstitutionLicenseDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.InstitutionDocumentUpload = function (val, val1, name) {
            if (($scope.txtdocument_id == null) || ($scope.txtdocument_id == '') || ($scope.txtdocument_id == undefined) || ($scope.cbocompanydocumentname == null) || ($scope.cbocompanydocumentname == '') || ($scope.cbocompanydocumentname == undefined)) {
                ...
                if ($scope.uploadfrm != undefined) {
                    lockUI();
                    var url = 'api/AgrMstBuyerOnboard/InstitutionDocumentUpload';
        ...
        $scope.institutiondocument_delete = function (institution2documentupload_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/InstitutionDocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.institutionupload_list = resp.data.BuyerOnboardinstitutionupload_list;
                if (resp.data.status == true) {
        ...
        $scope.headoffice_confirm = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                $scope.headoffice_submit = function () {
                    ...
                    lockUI();
                    var url = 'api/AgrMstBuyerOnboard/UpdateGSTHeadOffice';
                    SocketService.post(url, params).then(function (resp) {
                        if (resp.data.status == true) {
                            unlockUI();
                            Notify.alert(resp.data.message, {
            ...
            ($scope.cboAccountType == undefined) || ($scope.cboAccountType == '') || ($scope.rdbJoint_Account == undefined) || ($scope.rdbJoint_Account == '') ||
                ...
                if ($scope.rdbJoint_Account == 'Yes') {
                    ...
                    if (($scope.txtjointacctholder_name == undefined) || ($scope.txtjointacctholder_name == '')) {
                        ...
                        var url = 'api/AgrMstBuyerOnboard/PostInstitutionBank';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        //    var url = 'api/AgrMstBuyerOnboard/Institution2bankTmpList';
        //    SocketService.getparams(url, params).then(function (resp) {
        //        $scope.creditbankacc_list = resp.data.BuyerOnboardinstitution2bankacc_list;
        ...
        $scope.creditbankacctdtl_delete = function (institution2bankdtl_gid, institution_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteinstitutionBankAcc';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
                    $scope.creditbankacc_list = resp.data.BuyerOnboardinstitution2bankacc_list;
        ...
        $scope.indbankacctdtl_delete = function (contact2bankdtl_gid, contact_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/DeleteIndividualBankAcc';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
            ...
            ($scope.cboAccountType == undefined) || ($scope.cboAccountType == '') || ($scope.rdbJoint_Account == undefined) || ($scope.rdbJoint_Account == '') ||
                ...
                if ($scope.rdbJoint_Account == 'Yes') {
                    ...
                    if (($scope.txtjointacctholder_name == undefined) || ($scope.txtjointacctholder_name == '')) {
                        ...
                        var url = 'api/AgrMstBuyerOnboard/PostIndividualBank';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        function indbankacc_list() {
            var url = 'api/AgrMstBuyerOnboard/GetIndividualBankAccDtl';
            SocketService.get(url).then(function (resp) {
                $scope.creditbankacc_list = resp.data.BuyerOnboardIndividual2bankacc_list;
        ...
        //$scope.indeditbankacctdtl_delete = function (institution2bankdtl_gid, institution_gid) {
        //    var params = {
        //        institution2bankdtl_gid: institution2bankdtl_gid,
        //        institution_gid: institution_gid
        //    }
        ...
        $scope.submit_institution = function () {
            ...
            if ($scope.cboStakeholdertype == null || $scope.cboStakeholdertype == '' || $scope.cboStakeholdertype == undefined) {
                ...
                var url = 'api/AgrMstBuyerOnboardEdit/SubmitInstitutionDtlEdit';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.save_institution = function () {
            ...
            if ($scope.cboStakeholdertype == null || $scope.cboStakeholdertype == '' || $scope.cboStakeholdertype == undefined) {
                ...
                var url = 'api/AgrMstBuyerOnboardEdit/SaveInstitutionDtl';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.change_pan = function (cbopanstatus) {
            if ($scope.cbopanstatus == 'Customer Submitting PAN') {
                ...
                var url = 'api/AgrMstBuyerOnboard/GetPANForm60List';
                SocketService.get(url).then(function (resp) {
        ...
        $scope.pandtl_submit = function () {
            ...
            var url = 'api/AgrMstBuyerOnboard/PostPANAbsenceReasons';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.IndividualPANForm60DocumentUpload = function (val, val1, name) {
            ...
            $scope.uploadfrm = frm;
            if ($scope.uploadfrm != undefined) {
                var url = 'api/AgrMstBuyerOnboard/PANForm60DocumentUpload';
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    $("#file").val('');
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.IndividualPANForm60DocumentDelete = function (contact2panform60_gid) {
            ...
            lockUI();
            var url = 'api/AgrMstBuyerOnboard/PANForm60Delete';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.mobileno_add = function () {
            ...
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_no == undefined) || ($scope.rdbwhatsapp_no == undefined) || ($scope.rdbwhatsapp_no == '') || ($scope.rdbprimary_no == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/MobileNumberAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
                    ...
                    var url = 'api/AgrMstBuyerOnboard/GetMobileNoList';
                    SocketService.get(url).then(function (resp) {
        ...
        $scope.mobileno_delete = function (contact2mobileno_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/MobileNoDelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.email_add = function () {
            ...
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbprimary_email == undefined) || ($scope.rdbprimary_email == '')) {
                ...
                var url = 'api/AgrMstBuyerOnboard/EmailAddressAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
                    ...
                    var url = 'api/AgrMstBuyerOnboard/GetEmailAddressList';
                    SocketService.get(url).then(function (resp) {
        ...
        $scope.emailaddress_delete = function (contact2email_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/EmailAddressDelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.idproofdocument_upload = function (val, val1, name) {
            ...
            if (($scope.cboIndividualProof == null) || ($scope.cboIndividualProof == '') || ($scope.cboIndividualProof == undefined) || ($scope.txtidproof_no == null) || ($scope.txtidproof_no == '') || ($scope.txtidproof_no == undefined)) {
                ...
                $scope.uploadfrm = frm;
                if ($scope.uploadfrm != undefined) {
                    var url = 'api/AgrMstBuyerOnboard/IndividualProofDocumentUpload';
                    SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                        $("#file").val('');
                        unlockUI();
                        if (resp.data.status == true) {
                        ...
                        var url = 'api/AgrMstBuyerOnboard/GetIndividualProofList';
                        SocketService.get(url).then(function (resp) {
        ...
        $scope.idproof_delete = function (contact2idproof_gid) {
            ...
            lockUI();
            var url = 'api/AgrMstBuyerOnboard/IndividualProofDelete';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        function individualaddress_list() {
            var url = 'api/AgrMstBuyerOnboard/GetAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.address_add = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/AgrMstBuyerOnboard/AddressAdd';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.address_delete = function (contact2address_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/AddressDelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.individualdocument_upload = function (val, val1, name) {
            ...
            if (($scope.cboIndividualDocument == null) || ($scope.cboIndividualDocument == '') || ($scope.cboIndividualDocument == undefined)) {
                ...
                $scope.uploadfrm = frm;
                if ($scope.uploadfrm != undefined) {
                    var url = 'api/AgrMstBuyerOnboard/IndividualDocumentUpload';
                    SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                        $("#fileIndividuaDocument").val('');
                        ...
                        var url = 'api/AgrMstBuyerOnboard/GetIndividualDocList';
                        SocketService.get(url).then(function (resp) {
        ...
        $scope.individualdocument_delete = function (contact2document_gid) {
            ...
            lockUI();
            var url = 'api/AgrMstBuyerOnboard/IndividualDocDelete';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.upload_list = resp.data.upload_list;
                if (resp.data.status == true) {
            ...
            if ($scope.txtpan_no.length == 10) {
                ...
                if ($scope.cboStakeholdertype.user_type != "") {
                    ...
                    SocketService.post(url, params).then(function (resp) {
                        ...
                        if (resp.data.status == true) {
                            if (resp.data.panoraadhar == "PAN")
                                $scope.AlreadyaddedIndividualpanaadhar = true;
                            else {
                                $scope.AlreadyaddedIndividualpanaadhar = false;
                            }
                        }
        ...
        $scope.AadharValidation = function () {
        ...
        $scope.individual_save = function () {
            ...
            if ($scope.cboPropertyOwner != undefined || $scope.cboPropertyOwner != null) {
                lspropertyin_gid = $scope.cboPropertyOwner.propertyin_gid;
                lspropertyin_name = $scope.cboPropertyOwner.propertyin_name;
            }
            ...
            if (lsstakeholdertype_gid == '' || lsstakeholdertype_gid == undefined || lsstakeholdertype_gid == null) {
                ...
                var params = {
                    ...
                    father_firstname: $scope.txtfirst_name,
                ...
                var url = 'api/AgrMstBuyerOnboardEdit/IndividualSave';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.individual_submit = function () {
            ...
            $scope.rdbfathernominee_status == undefined && $scope.rdbmothernominee_status == undefined && $scope.rdbspousenominee_status == undefined && $scope.rdbothernominee_status == undefined) {
                ...
                var url = 'api/AgrMstBuyerOnboardEdit/IndividualSubmit';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
                        ...
                        $location.url('app/AgrMstByrOnboardApprovalEdit?hash=' + cmnfunctionService.encryptURL('application_gid=' + $scope.application_gid));
                        overallgeneralsummary();
                        $scope.cbopanstatus = '';
                        $scope.txtpan_no = '';
                        $scope.txtaadhar_no = '';
        ...
        $scope.back = function () {
            ...
            if ($scope.lsedit == "OnPending") {
                $state.go('app.AgrMstCustomerApprovalSummary');
            }
            else if ($scope.lsedit == "OnCompleted") {
                $state.go('app.AgrMstOnboardingApprovalCompleted');
            }
        }
        ...
        $scope.Submittoapproval = function () {
            ...
            var url = 'api/AgrMstBuyerOnboard/GetOnboardSubmitApproval';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    unlockUI();
        ...
        $scope.Editgeneral = function (application_gid, application_status, product_gid, variety_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/EditAppBasicDetail';
            unlockUI();
            SocketService.getparams(url, param).then(function (resp) {
                ...
                $scope.cbovertical = resp.data.vertical_gid;
                $scope.buyertypeadd = resp.data.buyersuppliertype_gid;
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/GetAppMobileNoTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstmobileno_list = resp.data.mstBuyerOnboardmobileno_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/GetAppEmailAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstemailaddress_list = resp.data.mstBuyerOnboardemailaddress_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/GetAppGeneticCodeTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstgeneticcode_list = resp.data.mstBuyerOnboardgeneticcode_list;
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/GetAppProductTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstproduct_list = resp.data.mstBuyerOnboardproduct_list;
            });
            ...
            $scope.mobileno_edit = function (application2contact_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/EditAppMobileNo';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_mobileno = function () {
                        ...
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateAppMobileNo';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.emailaddress_edit = function (application2email_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/EditAppEmailAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_emailaddress = function () {
                        ...
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateAppEmailAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.basicdetail_update = function () {
                ...
                if (($scope.cboVernacularLanguage == undefined) || ($scope.cboVernacularLanguage == '') || ($scope.cboVernacularLanguage == null)) {
                    ...
                    if ($scope.buyertypeadd != undefined || $scope.buyertypeadd != null) {
                        lsbuyersuppliertype_gid = $scope.buyertypeadd;
                        var getbuyersuppliertype_name = $scope.buyertype_list.find(function (v) { return v.buyersuppliertype_gid === $scope.buyertypeadd });
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/UpdateAppBasicDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.Editindividual = function (contact_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/EditIndividual';
            ...
            SocketService.getparams(url, param).then(function (resp) {
                ...
                $scope.stakeholdertype_name = resp.data.stakeholdertype_name;
                ...
                $scope.cboPropertyOwner = resp.data.propertyholder_gid;
            ...
            var url = 'api/AgrMstBuyerOnboard/Individual2bankTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.creditbankacc_list = resp.data.BuyerOnboardIndividual2bankacc_list;
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/GetPANForm60List';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactpanform60_list = resp.data.BuyerOnboardcontactpanform60_list;
            });
            var param = {
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/EditPANAbsenceReasonList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.panabsencereason_list = resp.data.BuyerOnboardpanabsencereason_list;
                for (var i = 0; i < $scope.panabsencereason_list.length; i++) {
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/ContactPANAbsenceReasonList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/GetIndividualMobileNoTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactmobileno_list = resp.data.BuyerOnboardcontactmobileno_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/GetIndividualEmailAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactemail_list = resp.data.BuyerOnboardcontactemail_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/GetIndividualAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactaddress_list = resp.data.BuyerOnboardcontactaddress_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/GetIndividualProofTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.contactidproof_list = resp.data.contactBuyerOnboardidproof_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/GetIndividualDocTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.uploadindividualdoc_list = resp.data.uploadBuyerOnboardindividualdoc_list;
            });
            ...
            $scope.individualmobileno_edit = function (contact2mobileno_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/EditIndividualMobileNo';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_mobileno = function () {
                        ...
                        if ($scope.txteditmobile_no.length < 10) {
                            Notify.alert('Enter 10 Digit Mobile Number', 'warning');
                        }
                        ...
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateIndividualMobileNo';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.individualemail_edit = function (contact2email_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/EditIndividualEmailAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.txteditemail_address = resp.data.email_address;
                        $scope.rdbeditprimary_status = resp.data.primary_status;
                    });
                    ...
                    $scope.update_emailaddress = function () {
                        ...
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateIndividualEmailAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.individualemail_delete = function (contact2email_gid) {
                ...
                var url = 'api/AgrMstBuyerOnboard/DeleteIndividualEmailAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
            ...
            $scope.address_edit = function (contact2address_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/EditIndividualAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.address_update = function () {
                        ...
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateIndividualAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.address_delete = function (contact2address_gid) {
                ...
                var url = 'api/AgrMstBuyerOnboardEdit/DeleteIndividualAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
            ...
            $scope.update_individual = function () {
                ...
                if ($scope.cboStakeholderType == null || $scope.cboStakeholderType == '' || $scope.cboStakeholderType == undefined) {
                    ...
                    //if ($scope.cboPropertyOwner != undefined || $scope.cboPropertyOwner != null) {
                    //    lspropertyin_gid = $scope.cboPropertyOwner;
                    //    var getpropertyin = $scope.propertyin_list.find(function (v) { return v.propertyin_gid === $scope.cboPropertyOwner });
                    //    if (getpropertyin != null && getpropertyin != "")
                    //        lspropertyin_name = getpropertyin.propertyin_name;
                    //}

                    if ($scope.cboInstitution != undefined || $scope.cboInstitution != null) {
                        var institutionname_gid = $scope.cboInstitution;
                        var getinstitutionname = $scope.institutionlist.find(function (v) { return v.institution_gid === $scope.cboInstitution });
                        if (getinstitutionname != null && getinstitutionname != "")
                        institutionname = getinstitutionname.institution_name;
                    }
                    ...
                    var params = {
                        ...
                        propertyholder_gid: $scope.cboPropertyOwner,
                        propertyholder_name: lspropertyin_name,
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/UpdateIndividual';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
            ...
            $scope.individualedit_save = function () {
                ...
                if ($scope.cboStakeholderType == null || $scope.cboStakeholderType == '' || $scope.cboStakeholderType == undefined) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/SaveIndividualEditDtl';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
            ...
            $scope.individualedit_submit = function () {
                ...
                if ($scope.cboInstitution == '') {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/SubmitIndividualEditDtl';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
            ...
            $scope.IndividualPANDocumentUploadEdit = function (val, val1, name) {
                ...
                if ($scope.uploadfrm != undefined) {
                    ...
                    SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                        ...
                        var url = 'api/AgrMstBuyerOnboard/GetEditPANForm60List';
                        SocketService.getparams(url, param).then(function (resp) {
                            $scope.contactpanform60_list = resp.data.BuyerOnboardcontactpanform60_list;
                        });
                ...
                if (($scope.cboIndividualDocument == null) || ($scope.cboIndividualDocument == '') || ($scope.cboIndividualDocument == undefined)) {
                    ...
                    if ($scope.uploadfrm != undefined) {
                        ...
                        SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                            ...
                            var url = 'api/AgrMstBuyerOnboard/GetIndividualDocListEdit';
                            SocketService.getparams(url, param).then(function (resp) {
                                $scope.uploadindividualdoc_list = resp.data.uploadBuyerOnboardindividualdoc_list;
                            });
        ...
        $scope.Editinstitution = function (institution_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionDetailsEdit';
            ...
            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionGSTList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.institutiongst_list = resp.data.mstBuyerOnboardgst_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionMobileNoList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.institutionmobileno_list = resp.data.mstBuyerOnboardmobileno_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionEmailAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.institutionemailaddress_list = resp.data.mstBuyerOnboardemailaddress_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.institutionaddress_list = resp.data.mstBuyerOnboardaddress_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionLicenseList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.institutionlicense_list = resp.data.mstBuyerOnboardlicense_list;
            });

            var url = 'api/AgrMstBuyerOnboardEdit/InstitutionDocumentList';
            SocketService.getparams(url, params).then(function (resp) {
            ...
            function companydocument_list() {
                ...
                var url = 'api/AgrMstBuyerOnboard/Getcompanyeditdocumentlist';
                SocketService.getparams(url, param).then(function (resp) {
                    $scope.institutionupload_list = resp.data.BuyerOnboardinstitutionupload_list;
                });
            }
            ...
            $scope.headoffice_confirm = function (institution2branch_gid, validateinstitution_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    $scope.headoffice_submit = function () {
                        ...
                        lockUI();
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateGSTHeadOffice';
                        SocketService.post(url, params).then(function (resp) {
                            if (resp.data.status == true) {
                                unlockUI();
                                Notify.alert(resp.data.message, {
            ...
            $scope.edit_gstdetails = function (institution2branch_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/EditInstitutionGST';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_gst = function () {
                        ...
                        var url = 'api/AgrMstBuyerOnboardEdit/UpdateInstitutionGST';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrMstBuyerOnboardEdit/EditInstitutionMobileNo';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/UpdateInstitutionMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
             ...
             $scope.institutionemailaddress_edit = function (institution2email_gid) {
                 ...
                 function ModalInstanceCtrl($scope, $modalInstance) {
                     ...
                     var url = 'api/AgrMstBuyerOnboardEdit/EditInstitutionEmailAddress';
                     SocketService.getparams(url, params).then(function (resp) {
                         $scope.txteditemail_address = resp.data.email_address;
                     ...
                     $scope.update_emailaddress = function () {
                         ...
                         var url = 'api/AgrMstBuyerOnboardEdit/UpdateInstitutionEmailAddress';
                         lockUI();
                         SocketService.post(url, params).then(function (resp) {
                             unlockUI();
                             if (resp.data.status == true) {
             ...
             $scope.editinstitution_address = function (institution2address_gid) {
                 ...
                 function ModalInstanceCtrl($scope, $modalInstance) {
                     ...
                     var url = 'api/AgrMstBuyerOnboardEdit/EditInstitutionAddressDetail';
                     SocketService.getparams(url, params).then(function (resp) {
                     ...
                     $scope.update_address = function () {
                         ...
                         var url = 'api/AgrMstBuyerOnboardEdit/UpdateInstitutionAddressDetail';
                         lockUI();
                         SocketService.post(url, params).then(function (resp) {
                             unlockUI();
                             if (resp.data.status == true) {
            ...
            $scope.submit_editinstitution = function () {
                ...
                if ($scope.cboeditStakeholdertype == null || $scope.cboeditStakeholdertype == '' || $scope.cboeditStakeholdertype == undefined) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/SubmitInstitutionEditDtl';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
            ...
            $scope.update_institution = function () {
                ...
                if ($scope.cboeditStakeholdertype == null || $scope.cboeditStakeholdertype == '' || $scope.cboeditStakeholdertype == undefined) {
                    ...
                    if ($scope.cboeditinstDesignation != undefined || $scope.cboeditinstDesignation != null) {
                        lsdesignation_gid = $scope.cboeditinstDesignation;
                        var getdesginationname = $scope.designation_list.find(function (v) { return v.designation_gid === $scope.cboeditinstDesignation });
                        if (getdesginationname != null && getdesginationname != "")
                            lsdesignation_type = getdesginationname.designation_type;
                    }
                    ...
                    if ($scope.cboeditStakeholdertype != undefined || $scope.cboeditStakeholdertype != null) {
                        lsstakeholdertype_gid = $scope.cboeditStakeholdertype;
                        var getStakeholderType = $scope.usertype_list.find(function (v) { return v.usertype_gid === $scope.cboeditStakeholdertype });
                        if (getStakeholderType != null && getStakeholderType != "")
                            lsstakeholdertype_name = getStakeholderType.user_type;
                    }
                    ...
                    if ($scope.cboeditCompanytype != undefined || $scope.cboeditCompanytype != null) {
                        lscompanytype_gid = $scope.cboeditCompanytype;
                        var getcboCompanytype = $scope.companytype_list.find(function (v) { return v.companytype_gid === $scope.cboeditCompanytype });
                        if (getcboCompanytype != null && getcboCompanytype != "")
                            lscompanytype_name = getcboCompanytype.companytype_name;
                    }
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/UpdateInstitutionDtl';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
            ...
            $scope.save_editinstitution = function () {
                ...
                if ($scope.cboeditStakeholdertype == null || $scope.cboeditStakeholdertype == '' || $scope.cboeditStakeholdertype == undefined) {
                    ...
                    var url = 'api/AgrMstBuyerOnboardEdit/SaveInstitutionEditDtl';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.DeleteInstitution = function (institution_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/Deleteinstitution';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Deleteindividual = function (contact_gid) {
            ...
            var url = 'api/AgrMstBuyerOnboard/Deleteindividual';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
