(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingPendingwithRMIndividualSummaryController', MstSAOnboardingPendingwithRMIndividualSummaryController);

    MstSAOnboardingPendingwithRMIndividualSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAOnboardingPendingwithRMIndividualSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingPendingwithRMIndividualSummaryController';
        ...
        function activate() {
            ...
            var url = 'api/MstSAOnboardingBussDevtVerification/GetPendingwithRMIndividualSummary';
        ...
        $scope.bd_verificationCAD = function () {
        ...
        $scope.bd_verificationdeferred = function () {
            $state.go('app.MstSABussDevtInstitutuonDeferredSummary');
        }
        ...
        $scope.rmtaggedemployee = function (sacontact_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.taggedsubmit = function () {
                    ...
                    var url = 'api/MstSAOnboardingBussDevtVerification/IndividualPendingRMTaggedUpdate';
                    lockUI();
