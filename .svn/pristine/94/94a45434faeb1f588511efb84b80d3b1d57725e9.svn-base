(function () {
    ...
    angular
        .module('angle')
        .controller('MstSBAIndividualManagementController', MstSBAIndividualManagementController);

    MstSBAIndividualManagementController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSBAIndividualManagementController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSBAIndividualManagementController';
        ...
        function activate() {
            var params = {
                ...
                samagro_code: sam_code
            }
            var url = 'api/MstSAOnboardingIndividual/GetIndividualActivityWebSummary';
            lockUI();
        ...
        $scope.management_view = function () {
            $location.url('app/MstSBAManagementIndividualCodeCreateView?hash=' + cmnfunctionService.encryptURL('lssacontact_gid=' + sacontact_gid + '&samfin_code=' + samfin_code + '&sam_code=' + sam_code ));
        }
        ...
        $scope.institution_completed = function () {
            $state.go('app.MstSBAManagement');///app.MstSAOnboardingCodeApprovalInsSummary
        }
        ...
        $scope.back = function () {
            ...
            $state.go("app.MstSBAIndividualActivityManagement");
        }
    }
})();
