(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadGroupViewController', MstCadGroupViewController);

    MstCadGroupViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstCadGroupViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadGroupViewController';
        ...
        const lspagename = 'MstCadGroupView';
        ...
        function activate() {
            ...
            lockUI();
            var url = 'api/MstCADApplication/GetCadGroupView';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.txtgroup_name = resp.data.group_name;
            ...
            lockUI();
            var url = 'api/MstCADApplication/GetCadGroupAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            lockUI();
            var url = 'api/MstCADApplication/GetCadGroupBankList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            lockUI();
            var url = 'api/MstCADApplication/GetCadGroupDocumentList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
