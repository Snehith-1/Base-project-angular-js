 (function () {
            ...
            angular
                .module('angle')
                .controller('AgrCadConsolidatedSanctionReportController', AgrCadConsolidatedSanctionReportController);

            AgrCadConsolidatedSanctionReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

            function AgrCadConsolidatedSanctionReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
                /* jshint validthis:true */
                var vm = this;
                vm.title = 'AgrCadConsolidatedSanctionReportController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstApplicationReport/GetConsolidatedSanctionReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
