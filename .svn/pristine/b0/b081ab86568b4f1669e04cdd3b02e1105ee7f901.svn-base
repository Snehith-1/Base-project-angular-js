...
/// <summary>
///(It's used for Buyer Master in Samfin)Buyer Model Class accessed by API methods from related DataAccess class and is returning relevant response to client.
/// </summary>
