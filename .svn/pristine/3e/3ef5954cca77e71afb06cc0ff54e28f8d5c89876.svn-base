(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualExistingBankEditCotroller', AgrTrnCreditIndividualExistingBankEditCotroller);

        AgrTrnCreditIndividualExistingBankEditCotroller.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrTrnCreditIndividualExistingBankEditCotroller($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualExistingBankEditCotroller';
        ...
        function activate() { 
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/EditExistingBankFacility';
        ...
        $scope.update_ExistingBankacctdtl = function () {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/UpdateExistingBankFacility';
            lockUI();
