(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditGroupExistingBankAddController', MstCADCreditGroupExistingBankAddController);

        MstCADCreditGroupExistingBankAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function MstCADCreditGroupExistingBankAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditGroupExistingBankAddController';
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/MstCADCreditGroupExistingBankEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
