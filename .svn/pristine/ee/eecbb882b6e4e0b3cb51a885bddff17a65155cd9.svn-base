(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditRepaymentDtlAddController', AgrTrnSuprCreditRepaymentDtlAddController);

    AgrTrnSuprCreditRepaymentDtlAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce','cmnfunctionService'];

    function AgrTrnSuprCreditRepaymentDtlAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditRepaymentDtlAddController';
        ...
        $scope.creditrepayment_edit = function (creditrepaymentdtl_gid) {
            $location.url('app/AgrTrnSuprCreditRepaymentDtlEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&creditrepaymentdtl_gid=' + creditrepaymentdtl_gid + '&lspage=' + lspage);
        }
