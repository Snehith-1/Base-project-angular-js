...
namespace ems.hrm.DataAccess
{
    public class hrClass
    {
        ...
        public bool openingbalance(string employee_gid)
        {
            ...
            {
                lsdate = Convert.ToDateTime(objODBCDatareader["attendance_startdate"]);
                lsenddate = Convert.ToDateTime(objODBCDatareader["attendance_enddate"]);
            }
                    ...
                    if (lsaccrual == "Y")
                    {
                        if (lscarry == "N")
                        {
                            ...
                            if (objODBCDatareader.HasRows == true)
                            {
                                    ...
                                    lscarry = objODBCDatareader["leavecarry_count"].ToString();
                        ...
                        if (lscarry == "N")
                        {
                         ...
                         " and leavetype_gid='" + lsleavetype_gid + "' and year='" + leave_year + "' and month = '" + leave_month + "'";
                            ...
                            if (objODBCDatareader.HasRows == true)
                            {
                                    ...
                                    lscarry = objODBCDatareader["total_leavecount"].ToString();
                                if (lscarry != null || lscarry !="")
                                {
                                    lsavailable_leave = Convert.ToDouble(lscarry) - leave_taken;
                                    objODBCDatareader.Close();
