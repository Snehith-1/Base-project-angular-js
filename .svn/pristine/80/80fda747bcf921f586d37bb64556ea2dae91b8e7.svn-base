(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationPendingIndividualViewController', MstSAVerificationPendingIndividualViewController);

    MstSAVerificationPendingIndividualViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAVerificationPendingIndividualViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationPendingIndividualViewController';
        ...
        function activate() {
            ...
            SocketService.getparams(url, param).then(function (resp) {
               ...
               // var maskaadhar=aadhar.replace(/(\d{4})(\d{4})(\d{4})/, 'XXXX-XXXX-$3');
        ...
        $scope.back = function () {
            $state.go('app.MstSAVerificationIndividualMappingPending');
        }
