(function () {
    ...
    angular
        .module('angle')
        .controller('AgrSuprPropertyTaxViewController', AgrSuprPropertyTaxViewController);

    AgrSuprPropertyTaxViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrSuprPropertyTaxViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrSuprPropertyTaxViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/PropertyTaxViewDetails';
