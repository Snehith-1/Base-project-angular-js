(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditGroupPSLDataFlagEditController', MstCADCreditGroupPSLDataFlagEditController);

    MstCADCreditGroupPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADCreditGroupPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditGroupPSLDataFlagEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstCADCreditGroupPSLDataFlagAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=CADAcceptanceCustomers');
        }
