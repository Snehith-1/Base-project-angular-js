(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditIndividualPSLDataFlagAddController', MstCreditIndividualPSLDataFlagAddController);

    MstCreditIndividualPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstCreditIndividualPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditIndividualPSLDataFlagAddController';
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/MstCreditIndividualPSLDataFlagEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage);
        }
        //KYC API
