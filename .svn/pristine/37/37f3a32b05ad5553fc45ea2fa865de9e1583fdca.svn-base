(function () {
    ...
    angular
        .module('angle')
        .controller('CADBaseDetailsViewController', CADBaseDetailsViewController);

    CADBaseDetailsViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADBaseDetailsViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADBaseDetailsViewController';        
        ...
        function activate() {
            ...
            var url = 'api/CADProbeAPI/BaseDetailsView';
