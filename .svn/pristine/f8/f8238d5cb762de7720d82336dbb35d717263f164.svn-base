(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBussDevtVerificationIndividualSummaryController', MstSAOnboardingBussDevtVerificationIndividualSummaryController);

    MstSAOnboardingBussDevtVerificationIndividualSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstSAOnboardingBussDevtVerificationIndividualSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBussDevtVerificationIndividualSummaryController';
        var lspage = 'Individual'
        activate();
        
        function activate() {
            var url = 'api/MstSAOnboardingBussDevtVerification/GetOnboardSummary';
            lockUI();
            SocketService.get(url).then(function (resp) {
                $scope.saOnboardSummary_list = resp.data.saOnboardSummary_list;
                unlockUI();
            });
            var url = 'api/MstSAOnboardingBussDevtVerification/GetBDVerificationCounts';
            SocketService.get(url).then(function (resp) {
                unlockUI()
        ...
        $scope.bd_verificationindividualdeferred = function () {
