(function () {
    ...
    angular
        .module('angle')
        .controller('MstGeneralTabController', MstGeneralTabController);

    MstGeneralTabController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstGeneralTabController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstGeneralTabController';
        lockUI();
        activate();
        function activate() {
        ...
        if (lstab == 'add') {
            ...
            var url = 'api/MstApplicationAdd/GetDropDown';
              ...
              SocketService.get(url).then(function (resp) {
                ...
                var url = 'api/MstApplicationAdd/GetTempApp';
                SocketService.get(url).then(function (resp) {
                ...
                var url = 'api/MstApplicationAdd/GetGroupSummary';
                SocketService.get(url).then(function (resp) {
                    unlockUI();
                ...
                var url = 'api/MstApplicationAdd/GetAddHypothecation';
                
                SocketService.get(url).then(function (resp) {
                    unlockUI();
                    $scope.security_type = resp.data.security_type;
                    $scope.security_value = resp.data.security_value;
                    if ($scope.security_value != 'undefined') {
                        $scope.security_value = resp.data.security_value;
                        $scope.lblamountseperator = (parseInt($scope.security_value.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
        ...
        $scope.generalmobileno_add = function () {
            if (($scope.txtgeneralmobileno == undefined) || ($scope.txtgeneralmobileno == '') || ($scope.rdbprimarymobile_no == undefined) || ($scope.rdbprimarywhatsapp_no == undefined) || ($scope.rdbprimarymobile_no == '') || ($scope.rdbprimarywhatsapp_no == '') ) {
                ...
                var params = {
                 ...
                 var url = 'api/MstApplicationAdd/PostMobileNo';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function generalmobilenolist() {
            ...
            var url = 'api/MstApplicationAdd/GetAppMobileNoList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.generalmobileno_delete = function (application2contact_gid) {
            ...
            var url = 'api/MstApplicationAdd/DeleteMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.add_generalmaildetails = function () {
            if (($scope.txtgeneralmail_id == undefined) || ($scope.txtgeneralmail_id == '') || ($scope.rdbgeneralmaildetails == undefined) || ($scope.rdbgeneralmaildetails == '')) {
               ...
               var params = {
                ...
                var url = 'api/MstApplicationAdd/PostEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function generalmail_list() {
            var url = 'api/MstApplicationAdd/GetAppEmailAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.generalmail_delete = function (application2email_gid) {
            ...
            var url = 'api/MstApplicationAdd/DeleteEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addgeneticcode = function () {
            if (($scope.cboGeneticCode == undefined) || ($scope.rdbStatus == undefined) || ($scope.txtgenetic_remarks == undefined) || ($scope.cboGeneticCode == null) || ($scope.rdbStatus == null) || ($scope.txtgenetic_remarks == null) || ($scope.cboGeneticCode == '') || ($scope.rdbStatus == '') || ($scope.txtgenetic_remarks == '')) {
               ...
               var params = {
                  ...
                  var url = 'api/MstApplicationAdd/PostGeneticCode';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.geneticcode_delete = function (application2geneticcode_gid) {
            ...
            var url = 'api/MstApplicationAdd/DeleteGenetic';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        /*    if ($scope.cboVernacularLanguage != undefined || $scope.cboVernacularLanguage != null) {
            ...
            if ($scope.cbovariety_name != undefined || $scope.cbovariety_name != null) {
             ...
             var url = 'api/MstApplicationAdd/SaveGeneralDtl';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
                ...
                $location.url('app/MstApplicationGeneralAdd?lstab=add');
            });
        ...
        $scope.Submitgeneraldetails=function()
        {
            ...
            var url = 'api/MstApplicationAdd/SubmitGeneralDtl';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.DeleteGeneral=function(application_gid)
        {
            ...
            var url = 'api/MstApplicationAdd/DeleteGeneral';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        {
            $location.url('app/MstApplcreationBasicdtlEdit?lsapplication_gid=' + application_gid + '&lstab=add&lsstatus=' + application_status + '&product_gid=' + product_gid + '&variety_gid=' + variety_gid);
        }
        $scope.Editindividual = function (application_gid, contact_gid) {
            $location.url('app/MstApplcreationIndividualdtlEdit?application_gid=' + application_gid + '&lscontact_gid=' + contact_gid + '&lstab=add');
             }
        $scope.Editinstitution = function (application_gid, institution_gid) {
            $location.url('app/MstApplcreationInstitutiondtlEdit?application_gid=' + application_gid + '&lsinstitution_gid=' + institution_gid + '&lstab=add');
        }
        ...
        $scope.DeleteInstitution = function (institution_gid) {
            ...
            var url = 'api/MstApplicationAdd/Deleteinstitution';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Delete_Group = function (group_gid) {
            ...
            var url = 'api/MstApplicationAdd/DeleteGroup';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Editsocialtrade = function (application_gid) {
            $location.url('app/MstApplcreationSocialTradeEdit?lsapplication_gid=' + application_gid + '&lstab=add');
              }
        ...
        $scope.Editgroup = function (group_gid) {
            $location.url('app/MstApplcreationGroupdtlEdit?lsgroup_gid=' + group_gid + '&lstab=add');
        }

        $scope.edit_cicupload = function () {
            $location.url('app/MstApplcreationInstitutiondtlEdit?lsinstitution_gid=' + institution_gid + '&lstab=add');
        ...
        $scope.importIndividual = function (application_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {                             
                ...
                $scope.application_gid = application_gid;
                    ...
                    var url = 'api/MstApplicationView/GetIndividualImportLog';
                    SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.uploadExcelIndividual = function () {
                    ...
                    if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                        ...
                        var url = 'api/MstApplicationAdd/ImportExcelIndividual';
                        lockUI();
                        SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.importInstitution = function (application_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstApplicationView/GetInstitutionImportLog';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.uploadExcelInstitution = function () {
                    ...
                    if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                        ...
                        var url = 'api/MstApplicationAdd/ImportExcelInstitution';
                        lockUI();
                        SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
        ...
        $scope.importGroup = function (application_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstApplicationView/GetGroupImportLog';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.uploadExcelGroup = function () {
                    ...
                    if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                        ...
                        var url = 'api/MstApplicationAdd/ImportExcelGroup';
                        lockUI();
                        SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
         ...
         $scope.productdtl_add = function () {
             if (($scope.cboproduct_name == undefined) || ($scope.cboproduct_name == '') || ($scope.cboproduct_name == null) ||
                ($scope.cbovariety_name == undefined) || ($scope.cbovariety_name == undefined) || ($scope.cbovariety_name == '')) {
                 ...
                 var url = 'api/MstApplicationAdd/PostProductDetailAdd';
                 lockUI();
                 SocketService.post(url, params).then(function (resp) {
                     unlockUI();
                     if (resp.data.status == true) {
         ...
         function productdetaillist() {
             ...
             var url = 'api/MstApplicationAdd/GetProductDetailList';
             SocketService.get(url).then(function (resp) {
