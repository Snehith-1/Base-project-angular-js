(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstProductDescVisitReportEditController', AgrMstProductDescVisitReportEditController);
    AgrMstProductDescVisitReportEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstProductDescVisitReportEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstProductDescVisitReportEditController';
        ...
        $scope.Back = function () {
            $location.url('app/AgrProductDescVisitReportAdd?application_gid=' + application_gid + '&lstab=' + lstab);
        }
