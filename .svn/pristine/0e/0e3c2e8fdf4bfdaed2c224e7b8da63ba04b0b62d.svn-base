(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADPSLCSADataFlaggingEditController', MstCADPSLCSADataFlaggingEditController);

        MstCADPSLCSADataFlaggingEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADPSLCSADataFlaggingEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADPSLCSADataFlaggingEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstCADPSLCSADataFlaggingAdd?application_gid=' + application_gid + '&credit_gid=' + institution_gid + '&lspage=' + lspage);
        }
