...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingInstitutionCodecreationController', MstSAOnboardingInstitutionCodecreationController);

    MstSAOnboardingInstitutionCodecreationController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAOnboardingInstitutionCodecreationController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingInstitutionCodecreationController';
        ...
        function activate() {
            ...
            var url = 'api/MstSAOnboardingInstitution/SamcodesAutoGenerate';
        ...
        $scope.submit_code = function () {
            ...
            else if ($scope.txtsamagro == undefined || $scope.txtsamagro == null || $scope.txtsamagro == "")
            {
                ...
                var url = 'api/MstSAOnboardingBussDevtVerification/InstitutionSamCodesupdate';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    ...
                    if (resp.data.status == true) {
                        ...
                        $state.go('app.MstSBACodeCreationSummary');
                    }
        ...
        $scope.back = function () {
            ...
            if (lspage == 'InstitutePending') {
                $location.url('app/MstSBACodeCreationSummary');
            }
