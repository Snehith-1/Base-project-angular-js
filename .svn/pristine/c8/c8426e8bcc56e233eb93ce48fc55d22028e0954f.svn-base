...
{
    /// <summary>
    /// This DataAccess will provide access to add single and multiple datas in Supplier Onboard stage.  (Includes overall summary adding of onboarded buyer general, company & individual info & initiate, approve & reject records)
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Premchander.K </remarks>

    public class DaAgrMstSupplierOnboard
    {
        ...
        string lsemployee_name, lsapplication_gid, lsapp_refno, lscreatedby_name;
        ...
        string lsbranch_name, lsbank_address, lsmicr_code, lsbankaccount_name, lsbankaccounttype_gid, lsbankaccounttype_name, lsbankaccount_number, lsconfirmbankaccountnumber, lsjoinaccount_status, lsjoinaccount_name, lschequebook_status, lsaccountopen_date, lsbank_name, lsifsc_code;

        string lscreated_by, lscreated_date, lsapproved_date, lsapproved_by, lsrm_gid;
        ...
        string lsapplication_no, lscustomerref_name, lsrm_mail;
        ...
        public void DaGetOnboardApplicationGeneralInfo(string application_gid, MdlMstOnboardApplicationView values)
        {
            try
            {
                msSQL = " select a.application_gid, a.application_no, customer_urn, customerref_name as customer_name, vertical_name, verticaltaggs_name,a.cccompleted_flag, " +
                        ...
                        " a.vertical_name,a.buyersuppliertype_name,a.customer_name from agr_mst_tsupronboard a" +
                        " left join agr_mst_tsupronboard2institution d on d.application_gid = a.application_gid " +
                        " left join agr_mst_tsupronboardcontact e on e.application_gid = a.application_gid " +
                ...
                msSQL = " select application_gid from agr_mst_tsupronboard2institution " +
                ...
                {
                    msSQL = " select application_gid from agr_mst_tsupronboardcontact " +
                            " where application_gid='" + application_gid + "' and (stakeholder_type='Applicant' or stakeholder_type='Borrower')";
                ...
                msSQL = "select mobile_no from agr_mst_tsupronboard2contactno where application_gid='" + application_gid + "' and primary_mobileno = 'Yes'";
                values.primary_mobileno = objdbconn.GetExecuteScalar(msSQL);

                msSQL = "select email_address from agr_mst_tsupronboard2email where application_gid='" + application_gid + "' and primary_emailaddress = 'Yes'";
                ...
                msSQL = " select geneticcode_name, genetic_status, genetic_remarks, application_gid, geneticcode_gid " +
                       " from agr_mst_tsupronboard2geneticcode " +
                ...
                msSQL = " select application2product_gid,product_gid,product_name,variety_gid,variety_name,sector_name,category_name,hsn_code, " +
                         " botanical_name,alternative_name from agr_mst_tsupronboard2product where application_gid='" + application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetOnboardIndividualInfo(string application_gid, MdlMstOnboardIndividual values)
        {
            msSQL = " select a.contact_gid, a.application_gid, concat_ws(' ', first_name, last_name, middle_name) as individual_name, " +
                        ...
                        "concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by,stakeholder_type from agr_mst_tsupronboardcontact a" +
                        " left join hrm_mst_temployee b on b.employee_gid = a.created_by" +
        ...
        public void DaGetOnboardInstitutionInfo(string application_gid, MdlMstOnboardInstitution values)
        {
            msSQL = " select a.institution_gid, a.application_gid, cin_no, companytype_name, " +
                        ...
                        " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by,stakeholder_type" +
                        " from agr_mst_tsupronboard2institution a" +
                        " left join hrm_mst_temployee b on b.employee_gid = a.created_by" +
                        " left join adm_mst_tuser c on b.user_gid = c.user_gid" +
                        " where application_gid = '" + application_gid + "'";
        ...
        public void DaGetOnboardInstitutionView(string institution_gid, MdlMstInstitutionDtlView values)
        {
            try
            {
                msSQL = " select institution_gid, application_gid, company_name, companypan_no, date_format(date_incorporation, '%d-%m-%Y') as date_incorporation, " +
                        ...
                        " incometax_returnsstatus,revenue,profit,fixed_assets,sundrydebt_adv from agr_mst_tsupronboard2institution " +
                ...
                msSQL = "select institution2branch_gid,gst_state,gst_no, gst_registered,headoffice_status from agr_mst_tsupronboardinstitution2branch where institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "  select institution2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, landmark," +
                    " postal_code, city,latitude,longitude  from agr_mst_tsupronboardinstitution2address where institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = " select institution2form60documentupload_gid,form60document_name,form60document_path from agr_mst_tsupronboardinstitution2form60documentupload " +
                               " where institution_gid ='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = " select institution2documentupload_gid,institution_gid,document_name,document_path,document_title,document_id from agr_mst_tsupronboardinstitution2documentupload " +
                        " where institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetGurantorIndividualView(string contact_gid, MdlMstIndividualDtlView values)
        {
            try
            {
                msSQL = " select contact_gid, application_gid, concat_ws(' ', first_name, last_name, middle_name) as individual_name, stakeholder_type," +
                        ...
                        " from agr_mst_tsupronboardcontact " +
              ...
              " from agr_mst_tsupronboardcontact2panabsencereason where contact_gid='" + contact_gid + "'";
                ...
                msSQL = " select contact2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country," +
                   " postal_code, landmark, city, latitude, longitude from agr_mst_tsupronboardcontact2address where contact_gid='" + contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                ...
                msSQL = "select mobile_no from agr_mst_tsupronboardcontact2mobileno where contact_gid='" + contact_gid + "' and primary_status = 'Yes'";
                values.primaryindividual_mobileno = objdbconn.GetExecuteScalar(msSQL);

                msSQL = "select email_address from agr_mst_tsupronboardcontact2email where contact_gid='" + contact_gid + "' and primary_status = 'Yes'";
                ...
                msSQL = "select contact2idproof_gid,idproof_name,idproof_no,document_name, document_path from agr_mst_tsupronboardcontact2idproof where " +
                ...
                if (dt_datatable.Rows.Count != 0)
                {
                    foreach (DataRow dr_datarow in dt_datatable.Rows)
                    {
                        getcontactidproof_list.Add(new contactidproof_list
                        {
                            ...
                            document_path = objcmnstorage.EncryptData((dr_datarow["document_name"].ToString())),
                        });
                ...
                dt_datatable.Dispose();
                msSQL = " select document_title,document_name,document_path from agr_mst_tsupronboardcontact2document " +
                                " where contact_gid='" + contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetSupplierApprovalPendingSummary(string employee_gid, MdlMstOnboardApplicationlist values)
        {
            msSQL = " select application_gid,application_no,customerref_name as customer_name,customer_urn,vertical_name,onboard_approvalstatus,status, query_status, " +
                    " applicant_type,a.createdby_name as createdby_name, sourced_by, " +
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date,date_format(a.approval_submitteddate,'%d-%m-%Y %h:%i %p') as submittedto_approval " +
                    " from agr_mst_tsupronboard a " +
        ...
        {
            msSQL = " select (select count(*) from agr_mst_tsupronboard where created_by = '" + employee_gid + "' " +
                    " and onboard_approvalstatus = '" + OnboardAppStatus.Pending + "') as BuyerApprovalPending, " +
                    " (select count(*) from agr_mst_tsupronboard where created_by = '" + employee_gid + "' and onboard_approvalstatus = '" + OnboardAppStatus.Approved + "') as BuyerApproved, " +
        ...
        {
            msSQL = " select (select count(*) from agr_mst_tsupronboard where status='Completed' " +
                     " and onboard_approvalstatus = '" + OnboardAppStatus.Pending + "') as BuyerApprovalPending, " +
                     " (select count(*) from agr_mst_tsupronboard where status='Completed' and onboard_approvalstatus = '" + OnboardAppStatus.Pending + "') as SupplierApprovalPending ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
                values.BuyerApprovalPending = objODBCDatareader["BuyerApprovalPending"].ToString();
        ...
        public void DaGetRejectedCountDetail(string FromRM, string employee_gid, MdlOnboardApprovalCountdtl values)
        {
            if (FromRM == "Y")
            {
                msSQL = " select (select count(*) from agr_mst_tsupronboard where created_by = '" + employee_gid + "' and onboard_approvalstatus = '" + OnboardAppStatus.Rejected + "') as BuyerRejected, " +
            ...
            {
                msSQL = " select (select count(*) from agr_mst_tsupronboard where onboard_approvalstatus = '" + OnboardAppStatus.Rejected + "') as BuyerRejected, " +
        ...
        public void DaGetBuyerOnboardingApprovalPending(string employee_gid, MdlMstOnboardApplicationlist values)
        {
            msSQL = " select application_gid,application_no,customerref_name as customer_name,customer_urn,vertical_name,onboard_approvalstatus,status," +
                    ...
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date,date_format(a.approval_submitteddate,'%d-%m-%Y %h:%i %p') as submittedto_approval " +
                    " from agr_mst_tsupronboard a " +
                    " where a.status='Completed' and onboard_approvalstatus='" + OnboardAppStatus.Pending + "' order by application_gid desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getapplicationadd_list = new List<onboardapplicationdtl>();
            if (dt_datatable.Rows.Count != 0)
            {
        ...
        public void DaGetSupplierOnboardApprovedSummary(string employee_gid, MdlMstOnboardApplicationlist values)
        {
            msSQL = " select application_gid,application_no,customerref_name as customer_name,customer_urn,vertical_name,onboard_approvalstatus,status," +
                    " applicant_type,a.createdby_name as createdby_name,onboard_approvedbyname,date_format(a.onboard_approveddate,'%d-%m-%Y %h:%i %p') as onboard_approveddate, " +
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date,date_format(a.approval_submitteddate,'%d-%m-%Y %h:%i %p') as submittedto_approval, initiated_by, date_format(a.initiated_date,'%d-%m-%Y %h:%i %p') as initiated_date " +
                    " from agr_mst_tsupronboard a " +
                    " where a.created_by='" + employee_gid + "' " +
                    " and onboard_approvalstatus='" + OnboardAppStatus.Approved + "' order by application_gid desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaPostSupplierOnboardApproval(string employee_gid, MdlOnboardApproval values)
        {
            msSQL = " select institution_gid from agr_mst_tsupronboard2institution a " +
            ...
            {
                msSQL = " select contact_gid from agr_mst_tsupronboardcontact a " +
                        " where stakeholder_type = 'Applicant' and a.application_gid = '" + values.application_gid + "'";
                objODBCDatareader1 = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader1.HasRows == true)
                {
            ...
            {
                msSQL = " update agr_mst_tsupronboard set onboard_approvalstatus='" + OnboardAppStatus.Approved + "', " +
                ...
                if (mnResult == 1)
                {
                    string msGETRef = objcmnfunctions.GetMasterGID("SURG");
                    msGETRef = msGETRef.Replace("SURG", "");
                    lsapp_refno = $"{msGETRef:00000}";
                    lsapp_refno = "1" + lsapp_refno;
                    msSQL = "update agr_mst_tsupronboard set application_no='" + lsapp_refno + "' where application_gid = '" + values.application_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    //Virtual Account Details
                    //string msGETVirtualRef = objcmnfunctions.GetMasterGID("SVAN");
                    //msGETVirtualRef = msGETVirtualRef.Replace("SVAN", "");
                    //string lsapp_virtualno = $"{msGETVirtualRef:000000}";
                    //lsapp_virtualno = "SAMAG" + lsapp_virtualno;

                    //msSQL = " update agr_mst_tsupronboard set application_no='" + lsapp_refno + "', " +
                    ...
                    if (ConfigurationManager.AppSettings["sysSamagroHyperbrdigeAPIEnable"].ToString() == "Yes")
                    {
                        ...
                        Thread t = new Thread(new ThreadStart(() =>
                        {
                            ...
                            {
                                objFnSamAgroHBAPIConn.PostSupplierInstitutionHBAPI(values.application_gid, lsapprovalperson_name);
                            }
                            else if (!String.IsNullOrEmpty(lscontact_gid))
                            {
                                objFnSamAgroHBAPIConn.PostSupplierContactHBAPI(values.application_gid, lsapprovalperson_name);
                            }
                ...
                {
                    values.status = true;
                    values.message = "Supplier Onboarding Approved Successfully!";
                    ...
                    sub = " Supplier Onboard Application Approval ";
                    body = body + "<br />";
                    body = body + " &nbsp&nbsp Dear Sir/Madam,<br />";
                    body = body + "<br />";
                    body = body + "&nbsp&nbsp The below Supplier has been approved. Below are the details:<br />";
                    body = body + "<br />";
                    body = body + "&nbsp&nbsp <b>Supplier name:</b> " + HttpUtility.HtmlEncode(lscustomerref_name )+ "<br />";
                    body = body + "<br />";
                    //body = body + "&nbsp&nbsp <b>Supplier id:</b> " + lsapplication_no + "<br />";
                    //body = body + "<br />";
                    body = body + "&nbsp&nbsp <b>Approved by:</b> " + HttpUtility.HtmlEncode(lsapproved_by )+ "<br />";
                    body = body + "<br />";
                    body = body + "&nbsp&nbsp <b>Approved date:</b> " + lsapproved_date + "<br />";
                    body = body + "<br />";
                    ...
                    bool customer_mail_status = objCusotmerMail.DaonboardedSupplierMail(values.application_gid, lsapproved_date, lsto_mail, lscreatedby_name, lscustomerref_name, lsapplication_no);
            ...
            {
                msSQL = " update agr_mst_tsupronboard set onboard_approvalstatus='" + OnboardAppStatus.Rejected + "', " +
                        " onboard_approvalremarks='" + values.approval_remarks.Replace("'", "") + "'," +
                        " onboard_approvedby='" + employee_gid + "'," +
                        " onboard_approvedbyname='" + lsapprovalperson_name + "'," +
                        " onboard_approveddate='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'" +
                ...
                {
                    values.status = true;
                    values.message = "Supplier Onboarding Rejected Successfully!";
                    ...
                    body = body + " &nbsp&nbsp Dear Sir/Madam,<br />";
                    body = body + "<br />";
                    body = body + "&nbsp&nbsp The below Supplier has been rejected. Below are the details:<br />";
                    body = body + "<br />";
                    body = body + "&nbsp&nbsp <b>Supplier name:</b> " + HttpUtility.HtmlEncode(lscustomerref_name)+ "<br />";
                    body = body + "<br />";
                    //body = body + "&nbsp&nbsp <b>Supplier id:</b> " + lsapplication_no + "<br />";
        ...
        public void DaPostInitiateSupplierApplication(string employee_gid, MdlOnboardApproval values)
        {

            msSQL = " select a.created_by as rm_gid, concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by from agr_mst_tsupronboard a" +
              " left join hrm_mst_temployee b on b.employee_gid = a.created_by " +
                  " left join adm_mst_tuser c on c.user_gid = b.user_gid" +
          " where a.application_gid = '" + values.application_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = " insert into agr_mst_tsuprapplication (application_gid, application_no, customer_urn, customer_name, entity_gid, " +
                       ...
                       " validityoveralllimit_year, validityoveralllimit_month, validityoveralllimit_days, " +
                       " calculationoveralllimit_validity, principalfrequency_name, principalfrequency_gid, " +
                       ...
                       " select application_gid, '', customer_urn, customer_name, entity_gid," +
                       " entity_name, vertical_gid, vertical_name, verticaltaggs_gid, verticaltaggs_name, constitution_gid, constitution_name," +
                       " businessunit_gid, businessunit_name, sa_status, sa_id, sa_name, baselocation_gid, baselocation_name," +
                       ...
                       " pslupdated_by, pslcompleteremarks, sanction_approvalflag," +
                       " scheduled_by, scheduled_date, cccompleted_by, onboarding_status " +
                       " from agr_mst_tsupronboard where application_gid = '" + values.application_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL); 
            if (mnResult == 1)
            {
                ...
                msSQL = " update agr_mst_tsupronboard set initiated_date='" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "', " +
                ...
                msSQL = " select contact_gid from agr_mst_tsupronboardcontact where application_gid= '" + values.application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                foreach (DataRow dt in dt_datatable.Rows)
                {
                    string msGetInidividualGID = objcmnfunctions.GetMasterGID("CTCT");

                    msSQL = " insert into agr_mst_tsuprcontact (contact_gid,application_gid,application_no,pan_status,pan_no,aadhar_no," +
                    ...
                    "client_dtl,economical_flag,psltagging_flag,credit_status)" +
                        "select contact_gid, application_gid, application_no, pan_status, pan_no, " +
                            ...
                            " economical_flag, psltagging_flag, credit_status from agr_mst_tsupronboardcontact  " +
                            " where contact_gid= '" + dt["contact_gid"].ToString() + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);


                    msSQL = " select contact2email_gid from agr_mst_tsupronboardcontact2email where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {
                        

                        msSQL = " insert into agr_mst_tsuprcontact2email  select contact2email_gid, contact_gid, " +
                                " email_address, primary_status, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardcontact2email where contact2email_gid= '" + dt1["contact2email_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2panform60_gid from agr_mst_tsupronboardcontact2panform60 where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {
                        

                        msSQL = " insert into agr_mst_tsuprcontact2panform60  select contact2panform60_gid, contact_gid, " +
                                " document_name, document_path, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardcontact2panform60  where contact2panform60_gid= '" + dt1["contact2panform60_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2bankdtl_gid from agr_mst_tsupronboardcontact2bankdtl " +
                    ...
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {
                        ...
                        msSQL = " insert into agr_mst_tsuprcontact2bankdtl select contact2bankdtl_gid, contact2bankdtl_gid, application_gid," +
                                ...
                                " from agr_mst_tsupronboardcontact2bankdtl where contact2bankdtl_gid= '" + dt1["contact2bankdtl_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2mobileno_gid from agr_mst_tsupronboardcontact2mobileno  where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {
                       

                        msSQL = " insert into agr_mst_tsuprcontact2mobileno  select contact2mobileno_gid, contact_gid, " +
                                " mobile_no, primary_status, whatsapp_no, landline_no, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardcontact2mobileno where contact2mobileno_gid= '" + dt1["contact2mobileno_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2idproof_gid from agr_mst_tsupronboardcontact2idproof  where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprcontact2idproof  select contact2idproof_gid, contact_gid, " +
                                ...
                                " from agr_mst_tsupronboardcontact2idproof  where contact2idproof_gid= '" + dt1["contact2idproof_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2address_gid from agr_mst_tsupronboardcontact2address  where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprcontact2address  select contact2address_gid, contact_gid, " +
                                ...
                                " from agr_mst_tsupronboardcontact2address  where contact2address_gid= '" + dt1["contact2address_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2panabsencereason_gid from agr_mst_tsupronboardcontact2panabsencereason where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {
                      

                        msSQL = " insert into agr_mst_tsuprcontact2panabsencereason select contact2panabsencereason_gid, contact_gid, " +
                                " panabsencereason, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardcontact2panabsencereason where contact2panabsencereason_gid= '" + dt1["contact2panabsencereason_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select contact2document_gid from agr_mst_tsupronboardcontact2document where contact_gid ='" + dt["contact_gid"].ToString() + "'";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {
                        string msGetOnboardGID = objcmnfunctions.GetMasterGID("C2DO");

                        msSQL = " insert into agr_mst_tsuprcontact2document select contact2document_gid, contact_gid, " +
                                ...
                                " covenantperiod_updatedby, covenantperiod_updateddate " +
                                " from agr_mst_tsupronboardcontact2document where contact2document_gid= '" + dt1["contact2document_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();
                ...
                msSQL = " select institution_gid from agr_mst_tsupronboard2institution where application_gid= '" + values.application_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                foreach (DataRow dt in dt_datatable.Rows)
                {

                    msSQL = " insert into agr_mst_tsuprinstitution (institution_gid,application_gid,application_no,company_name,date_incorporation," +
                   ...
                   " sundrydebt_adv,fixed_assets,profit,revenue,incometax_returnsstatus, msme_registration,lei_renewaldate,kin,lglentity_id) " +
                       " select institution_gid, application_gid,  application_no,company_name,date_incorporation, " +
                             "form60document_name,form60document_path,companypan_no,year_business,month_business,cin_no,official_telephoneno," +
                   " officialemail_address,companytype_gid,companytype_name,stakeholder_type,stakeholdertype_gid,assessmentagency_gid," +
                   " assessmentagency_name,assessmentagencyrating_gid,assessmentagencyrating_name,ratingas_on,amlcategory_gid,amlcategory_name," +
                   " businesscategory_gid,businesscategory_name,contactperson_firstname,contactperson_middlename,contactperson_lastname," +
                   ...
                   " entityincorporation_date,hq_metropolitancity,clientdtl_gid,client_dtl,psltagging_flag,credit_status,tan_number," +
                   " sundrydebt_adv,fixed_assets,profit,revenue,incometax_returnsstatus, msme_registration,lei_renewaldate,kin,lglentity_id " +
                   "from agr_mst_tsupronboard2institution " +
                            " where institution_gid= '" + dt["institution_gid"].ToString() + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                    msSQL = " select institution2address_gid from agr_mst_tsuprinstitution2address  " +
                          " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution  select institution2address_gid, institution_gid, " +
                                ...
                                " from agr_mst_tsuprinstitution2address  where institution2address_gid= '" + dt1["institution2address_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2branch_gid from agr_mst_tsupronboardinstitution2branch " +
                        " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2branch  select institution2address_gid, institution_gid, " +
                                ...
                                " from agr_mst_tsupronboardinstitution2branch   where institution2branch_gid= '" + dt1["institution2branch_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2mobileno_gid from agr_mst_tsupronboardinstitution2mobileno " +
                          " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2mobileno  select institution2mobileno_gid, institution_gid, " +
                                " mobile_no, primary_status, whatsapp_no, landline_no, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardinstitution2mobileno   where institution2mobileno_gid= '" + dt1["institution2mobileno_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2email_gid from agr_mst_tsupronboardinstitution2email " +
                       " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2email  select institution2email_gid, institution_gid, " +
                                " email_address, primary_status, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardinstitution2email  where institution2email_gid= '" + dt1["institution2email_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2ratingdetail_gid from agr_mst_tsupronboardinstitution2ratingdetail " +
                    " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2ratingdetail select institution2ratingdetail_gid, institution_gid, application_gid," +
                                ...
                                " from agr_mst_tsupronboardinstitution2ratingdetail where institution2ratingdetail_gid= '" + dt1["institution2ratingdetail_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2bankdtl_gid from agr_mst_tsupronboardinstitution2bankdtl  " +
                         " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2bankdtl  select institution2bankdtl_gid, institution_gid, application_gid," +
                                " bankaccount_number, ifsc_code, bank_name, branch_name, micr_code, accountholder_name, accounttype_gid, accounttype_name, " +
                                " joint_account, jointaccountholder_name, chequebookfacility_available, accountopen_date, created_by, created_date, " +
                                " updated_by, updated_date, bank_address, bankaccount_name, bankaccounttype_gid, bankaccounttype_name, confirmbankaccountnumber, " +
                                " joinaccount_status, joinaccount_name, chequebook_status, disbursement_accountstatus, primary_status " +
                                " from agr_mst_tsupronboardinstitution2bankdtl  where institution2bankdtl_gid= '" + dt1["institution2bankdtl_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2licensedtl_gid from agr_mst_tsupronboardinstitution2licensedtl " +
                          " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2licensedtl select institution2licensedtl_gid, institution_gid, " +
                                " licensetype_gid, licensetype_name, license_no, issue_date, expiry_date, created_by, created_date, updated_date, updated_by " +
                                " from agr_mst_tsupronboardinstitution2licensedtl where institution2licensedtl_gid= '" + dt1["institution2licensedtl_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();

                    msSQL = " select institution2documentupload_gid from agr_mst_tsupronboardinstitution2documentupload " +
                        " where institution_gid in ('" + dt["institution_gid"].ToString() + "')";
                    dt_datatable1 = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt1 in dt_datatable1.Rows)
                    {

                        msSQL = " insert into agr_mst_tsuprinstitution2documentupload select institution2documentupload_gid, institution_gid, " +
                                ...
                                " from agr_mst_tsupronboardinstitution2documentupload where institution2documentupload_gid= '" + dt1["institution2documentupload_gid"].ToString() + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    }
                    dt_datatable1.Dispose();
                ...
                if (mnResult == 1)
                {
                    msSQL = " select individualdocument_gid, contact2document_gid, contact_gid from agr_mst_tsuprcontact2document  where contact_gid in " +
                            " (select contact_gid from agr_mst_tsupronboardcontact where application_gid='" + values.application_gid + "')";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt in dt_datatable.Rows)
                    {
                    ...
                    msSQL = " select contact_gid from agr_mst_tsuprcontact2document  where contact_gid in " +
                            " (select contact_gid from agr_mst_tsupronboardcontact where application_gid='" + values.application_gid + "') group by contact_gid";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt in dt_datatable.Rows)
                    {
                        DaAgrMstSuprScannedDocument objvalues1 = new DaAgrMstSuprScannedDocument();
                ...
                if (mnResult == 1)
                {
                    msSQL = " select companydocument_gid, institution2documentupload_gid, institution_gid from agr_mst_tsupronboardinstitution2documentupload  where institution_gid in " +
                           " (select institution_gid from agr_mst_tsupronboard2institution where application_gid='" + values.application_gid + "')";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt in dt_datatable.Rows)
                    {
                        string lscovenant_type = "", lsdocumenttype_gid = "", lsdocumenttype_name = "", lscompanydocument_name = "";
                    ...
                    msSQL = " select institution_gid from agr_mst_tsupronboardinstitution2documentupload  where institution_gid in " +
                            " (select institution_gid from agr_mst_tsupronboard2institution where application_gid='" + values.application_gid + "') group by institution_gid";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
                    foreach (DataRow dt in dt_datatable.Rows)
                    {
                ...
                values.status = true;
                values.message = "Supplier Onboarding Initiated Successfully!";
            }
            else
            {
                values.status = true;
        ...
        {
            msSQL = " select application2product_gid,product_gid,product_name,variety_gid,variety_name,sector_name,category_name,hsn_code, " +
                    " botanical_name,alternative_name from agr_mst_tsupronboard2product where application_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "delete from agr_mst_tsupronboard2product where application2product_gid='" + application2product_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
                ...
                values.status = true;
                msSQL = " select application2product_gid,product_gid,product_name,variety_gid,variety_name,sector_name,category_name,hsn_code," +
                        " botanical_name,alternative_name " +
                        " from agr_mst_tsupronboard2product where application_gid='" + employee_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getmstproduct_list = new List<mstBuyerOnboardproduct_list>();
                if (dt_datatable.Rows.Count != 0)
                {
        ...
        {
            msSQL = "select primary_mobileno from agr_mst_tsupronboard2contactno where primary_mobileno='Yes' and (application_gid='" + employee_gid + "' or" +
            ...
            msSQL = "select application2contact_gid from agr_mst_tsupronboard2contactno where mobile_no='" + values.mobile_no + "' " +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboard2contactno where application2contact_gid='" + application2contact_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        {
            msSQL = "select primary_emailaddress from agr_mst_tsupronboard2email where primary_emailaddress='Yes' and (application_gid='" + employee_gid + "' or" +
               " application_gid='" + values.application_gid + "') ";
            ...
            msSQL = "select application2email_gid from agr_mst_tsupronboard2email where email_address='" + values.email_address + "' and (application_gid='" + employee_gid + "' or" +
               " application_gid='" + values.application_gid + "') ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsupronboard2email where application2email_gid='" + application2email_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaPostGeneticCode(string employee_gid, MdlMstBuyerOnboardGeneticCode values)
        {
            ...
            msSQL = "select geneticcode_gid from agr_mst_tsupronboard2geneticcode where application_gid='" + employee_gid + "' and geneticcode_gid='" + values.geneticcode_gid + "'";
        ...
        public void DaSubmitGeneralDtl(MdlMstBuyerOnboardApplicationAdd values, string employee_gid)
        {
            ...
            msSQL = "select count(*) from agr_mst_tsupronboard2geneticcode where application_gid='" + employee_gid + "' or application_gid='" + lsapplication_gid + "'";
            string lsgeneticcount = objdbconn.GetExecuteScalar(msSQL);
            if (lsmastercount == lsgeneticcount)
            {

                msSQL = "select application_gid from agr_mst_tsupronboard2contactno where (application_gid='" + employee_gid + "' or application_gid='" + lsapplication_gid + "') and primary_mobileno='Yes'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                ...
                msSQL = "select application_gid from agr_mst_tsupronboard2email where (application_gid='" + employee_gid + "' or application_gid='" + lsapplication_gid + "') and primary_emailaddress='Yes'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == false)
                {
                    objODBCDatareader.Close();
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tsupronboard2product set application_gid ='" + msGetGid + "' where application_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                msSQL = "update agr_mst_tsupronboard2contactno set application_gid='" + msGetGid + "' where application_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                if (mnResult != 0)
                {
                    msSQL = "update agr_mst_tsupronboard2email set application_gid='" + msGetGid + "' where application_gid='" + employee_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                    if (mnResult != 0)
                    {
                        msSQL = "update agr_mst_tsupronboard2geneticcode set application_gid='" + msGetGid + "' where application_gid='" + employee_gid + "'";
                        mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                        if (mnResult != 0)
                        {
        ...
        public bool DaPostInstitutionGST(string employee_gid, MdlMstBuyerOnboardGST values)
        {
            ...
            msSQL = "select institution_gid from agr_mst_tsupronboardinstitution2branch where gst_no='" + values.gst_no + "' and institution_gid='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
                objODBCDatareader.Close();
        ...
        {
            msSQL = " select institution2branch_gid,gst_state,gst_no, gst_registered,authentication_status,returnfilling_status,verification_status, headoffice_status from agr_mst_tsupronboardinstitution2branch where institution_gid='" + employee_gid + "' ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2branch where institution2branch_gid='" + institution2branch_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
                msSQL = "delete from agr_mst_tsupronboardinstitution2branchupdatelog where institution2branch_gid='" + institution2branch_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public bool DaPostInstitutionMobileNo(string employee_gid, MdlMstBuyerOnboardMobileNo values)
        {
            ...
            msSQL = "select institution2mobileno_gid from agr_mst_tsupronboardinstitution2mobileno where mobile_no='" + values.mobile_no + "' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "')";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows)
            {
                objODBCDatareader.Close();
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2mobileno where institution2mobileno_gid='" + institution2mobileno_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
                msSQL = "delete from agr_mst_tsupronboardinstitution2mobilenoupdatelog where institution2mobileno_gid='" + institution2mobileno_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public bool DaPostInstitutionEmailAddress(string employee_gid, MdlMstBuyerOnboardEmailAddress values)
        {
            ...
            msSQL = "select institution2email_gid from agr_mst_tsupronboardinstitution2email where email_address='" + values.email_address + "' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "')";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows)
            {
                objODBCDatareader.Close();
        ...
        {
            msSQL = " select email_address,institution2email_gid,primary_status from agr_mst_tsupronboardinstitution2email where institution_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getmstemailaddress_list = new List<mstBuyerOnboardemailaddress_list>();
            if (dt_datatable.Rows.Count != 0)
            {
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2email where institution2email_gid='" + institution2email_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
                msSQL = "delete from agr_mst_tsupronboardinstitution2emailupdatelog where institution2email_gid='" + institution2email_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public bool DaPostInstitutionAddressDetail(string employee_gid, string user_gid, MdlMstBuyerOnboardAddressDetails values)
        {
            ...
            //msSQL = "select institution2address_gid from agr_mst_tsupronboardinstitution2address where addresstype_name='" + values.address_type + "' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "')";
            //objODBCDatareader = objdbconn.GetDataReader(msSQL);
            //if (objODBCDatareader.HasRows)
            //{
            //    objODBCDatareader.Close();
        ...
        public void DaGetInstitutionAddressList(string employee_gid, MdlMstBuyerOnboardAddressDetails values)
        {
            msSQL = "  select institution2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, landmark, latitude, longitude," +
                    " postal_code from agr_mst_tsupronboardinstitution2address where institution_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2address where institution2address_gid='" + institution2address_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
                msSQL = "delete from agr_mst_tsupronboardinstitution2addressupdatelog where institution2address_gid='" + institution2address_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaEditInstitutionLicenseDetail(string institution2licensedtl_gid, MdlMstBuyerOnboardLicenseDetails values)
        {
            ...
            {
                //msSQL = " select institution2licensedtl_gid,licensetype_gid,licensetype_name,license_no,date_format(issue_date,'%d-%m-%Y') as issue_date," +
                //   " date_format(expiry_date,'%d-%m-%Y') as expiry_date, date_format(expiry_date,'%Y-%m-%d') as expiry_dateedit,date_format(issue_date,'%Y-%m-%d') as issue_dateedit,institution_gid from agr_mst_tsupronboardinstitution2licensedtl" +
                //   " where institution2licensedtl_gid='" + institution2licensedtl_gid + "'";

                msSQL = " select institution2licensedtl_gid,licensetype_gid,licensetype_name,license_no, date_format(issue_date,'%d-%m-%Y') as issue_date," +
                  " date_format(expiry_date,'%d-%m-%Y') as expiry_date, institution_gid from agr_mst_tsupronboardinstitution2licensedtl" +
                  " where institution2licensedtl_gid='" + institution2licensedtl_gid + "'";
        ...
        public void DaUpdateInstitutionLicenseDetail(string employee_gid, MdlMstBuyerOnboardLicenseDetails values)
        {
            ...
            try
            {
                msSQL = " update agr_mst_tsupronboardinstitution2licensedtl set " +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2licensedtl where institution2licensedtl_gid='" + institution2licensedtl_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " insert into agr_mst_tsupronboardinstitution2documentupload( " +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2documentupload where institution2documentupload_gid='" + institution2documentupload_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        {
            msSQL = "select institution2branch_gid from agr_mst_tsupronboardinstitution2branch where institution_gid='" + employee_gid + "' or institution_gid='" + institution_gid + "'";
        ...
        public void DaGetInstitutionRatingList(string institution_gid, string employee_gid, string tmp_status, MdlBuyerOnboardRatingList values)
        {
            msSQL = " select institution2ratingdetail_gid,application_gid, institution_gid,creditrating_agencygid,creditrating_agencyname," +
                    ...
                    " from agr_mst_tsupronboardinstitution2ratingdetail a ";
            if (tmp_status == "true")
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2ratingdetail where institution2ratingdetail_gid='" + institution2ratingdetail_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public bool DaPostInstitutionBank(string employee_gid, MdlBuyerOnboardInstitution2BankAcc values)
        {
            ...
            msSQL = "select primary_status from agr_mst_tsupronboardinstitution2bankdtl where primary_status='Yes' and (institution_gid='" + employee_gid + "' or institution_gid='" + values.institution_gid + "')";
            string lsprimary_status = objdbconn.GetExecuteScalar(msSQL);
            if (lsprimary_status == (values.primary_status))
            {
                values.status = false;
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = " select institution2bankdtl_gid,bank_name,branch_name,ifsc_code,bankaccount_number from " +
                          " agr_mst_tsupronboardinstitution2bankdtl where institution_gid='" + values.institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetInstitutionBankAccDtl(string employee_gid, MdlBuyerOnboardInstitution2BankAcc values)
        {
            msSQL = " select institution2bankdtl_gid,institution_gid,bank_name,branch_name,ifsc_code,bankaccount_number, primary_status," +
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date, primary_status," +
                    ...
                    " from agr_mst_tsupronboardinstitution2bankdtl a " +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardinstitution2bankdtl where institution2bankdtl_gid='" + institution2bankdtl_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = " select institution2bankdtl_gid,bank_name,branch_name,ifsc_code,bankaccount_number from " +
                           " agr_mst_tsupronboardinstitution2bankdtl where institution_gid='" + institution_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getcreditbankacc_list = new List<BuyerOnboardinstitution2bankacc_list>();
                if (dt_datatable.Rows.Count != 0)
                {
        ...
        public void DaEditGetCreditBankAccDtl(string institution2bankdtl_gid, MdlBuyerOnboardInstitution2BankAcc values)
        {
            try
            {
                ...
                " chequebook_status,accountopen_date from agr_mst_tsupronboardinstitution2bankdtl where institution2bankdtl_gid='" + institution2bankdtl_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void DaUpdateInstitutionBankAccDtl(string employee_gid, MdlBuyerOnboardInstitution2BankAcc values)
        {
            ...
            msSQL = " select institution2bankdtl_gid,institution_gid,application_gid,bank_name,branch_name,bank_address,micr_code,ifsc_code,bankaccount_name," +
                " bankaccounttype_gid,bankaccounttype_name,bankaccount_number,confirmbankaccountnumber,joinaccount_status,joinaccount_name," +
                " chequebook_status,accountopen_date from agr_mst_tsupronboardinstitution2bankdtl where institution2bankdtl_gid='" + values.institution2bankdtl_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
            ...
            msSQL = " update agr_mst_tsupronboardinstitution2bankdtl set " +
            ...
            {//Date Updation
                ...
                //else
                //{
                //    msSQL = "update agr_mst_tsupronboardinstitution2bankdtl set accountopen_date='" + Convert.ToDateTime(values.accountopendate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                //        "where institution2bankdtl_gid='" + values.institution2bankdtl_gid + "' ";
                //    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                //}
                ...
                msSQL = " insert into agr_mst_tsupronboardinstitution2bankdtlupdatelog(" +
        ...
        public bool DaSubmitInstitutionDtl(MdlMstBuyerOnboardInstitutionAdd values, string employee_gid)
        {
            ...
            msSQL = "select stakeholder_type from agr_mst_tsupronboardcontact where application_gid='" + lsapplication_gid + "' and stakeholder_type in ('Borrower','Applicant')";
            ...
            msSQL = "select stakeholder_type from agr_mst_tsupronboard2institution where application_gid='" + lsapplication_gid + "' and stakeholder_type in ('Borrower','Applicant')";
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = "update agr_mst_tsupronboardinstitution2ratingdetail set institution_gid='" + msGetGid + "', application_gid ='" + lsapplication_gid + "' where institution_gid='" + employee_gid + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                ...
                {
                    msSQL = "update agr_mst_tsupronboard set applicant_type ='Institution' where application_gid='" + lsapplication_gid + "'";
                    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " insert into agr_mst_tsupronboardcontact2panform60(" +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardcontact2panform60 where contact2panform60_gid='" + contact2panform60_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " insert into agr_mst_tsupronboardcontact2idproof(" +
                                " contact2idproof_gid," +
                                " contact_gid," +
                                " idproof_name," +
                                " idproof_no," +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardcontact2idproof where contact2idproof_gid='" + contact2idproof_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        msSQL = " insert into agr_mst_tsupronboardcontact2document( " +
        ...
        {
            msSQL = " select contact2document_gid,document_name,document_path,document_title from agr_mst_tsupronboardcontact2document " +
                                 " where contact_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardcontact2document where contact2document_gid='" + contact2document_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult == 1)
            {
        ...
        public bool DaMobileNumberAdd(string employee_gid, MdlBuyerOnboardContactMobileNo values)
        {
            ...
            //msSQL = "select mobile_no from agr_mst_tsupronboardcontact2mobileno where mobile_no='" + values.mobile_no + "' and contact_gid='" + employee_gid + "'";
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardcontact2mobileno where contact2mobileno_gid='" + contact2mobileno_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public bool DaEmailAddressAdd(string employee_gid, MdlBuyerOnboardContactEmail values)
        {
            ...
            //msSQL = "select email_address from agr_mst_tsupronboardcontact2email where email_address='" + values.email_address + "' and contact_gid='" + employee_gid + "'";
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardcontact2email where contact2email_gid='" + contact2email_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public bool DaAddressAdd(string employee_gid, MdlBuyerOnboardContactAddress values)
        {
            ...
            //msSQL = "select contact2address_gid from agr_mst_tsupronboardcontact2address where addresstype_name='" + values.addresstype_name + "' and " +
            //    " contact_gid='" + employee_gid + "' ";
            //objODBCDatareader = objdbconn.GetDataReader(msSQL);
            //if (objODBCDatareader.HasRows)
            //{
        ...
        public void DaGetAddressList(string employee_gid, MdlBuyerOnboardContactAddress values)
        {
            msSQL = " select contact2address_gid,addresstype_name,primary_status, addressline1, addressline2, taluka, district, state, country, latitude, longitude," +
                    " postal_code from agr_mst_tsupronboardcontact2address where contact_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaIndividualSubmit(string employee_gid, MdlMstBuyerOnboardContact values)
        {
            ...
            msSQL = "select stakeholder_type from agr_mst_tsupronboardinstitution where application_gid='" + lsapplication_gid + "' and stakeholder_type in ('Borrower','Applicant')";
            lsstakeholder_type = objdbconn.GetExecuteScalar(msSQL);
            ...
            msSQL = "select contact_gid from agr_mst_tsupronboardcontact2email where contact_gid='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            objODBCDatareader.Close();
            msSQL = "select contact_gid from agr_mst_tsupronboardcontact2address where contact_gid='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
        ...
        public void DasuprronboardTmpClear(string employee_gid, MdlMstBuyerOnboardApplicationAdd values)
        {
            msSQL = "delete from agr_mst_tsupronboard2product where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "delete from agr_mst_tsupronboard2contactno where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "delete from agr_mst_tsupronboard2email where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "delete from agr_mst_tsupronboard2geneticcode where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "delete from agr_mst_tsupronboard where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "delete from agr_mst_tsupronboardinstitution2branch where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardinstitution2ratingdetail  where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardinstitution2mobileno where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardinstitution2documentupload where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardinstitution2licensedtl where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboard2institution  where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2mobileno  where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2idproof  where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2address  where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2document where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact where application_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardinstitution2address where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2email where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2panabsencereason where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2panform60 where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardinstitution2email where institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " delete from agr_mst_tsupronboardcontact2bankdtl where contact_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "delete from agr_mst_tsupronboardinstitution2bankdtl where  institution_gid ='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            values.status = true;
        }

        public void DaGetSupplierOnboardSubmitApproval(string application_gid, result values)
        {
            ...
            if (mnResult != 0)
            {
                ...
                body = body + " &nbsp&nbsp Dear Sir/Madam,<br />";
                body = body + "<br />";
                body = body + "&nbsp&nbsp The below Supplier has been created by an employee. Please review and approve. Below are the details:<br />";
                body = body + "<br />";
                body = body + "&nbsp&nbsp <b>Supplier name:</b> " + HttpUtility.HtmlEncode(lscustomerref_name )+ "<br />";
                body = body + "<br />";
        ...
        public void DaGetonboardTempClear(string employee_gid, MdlMstBuyerOnboardApplicationAdd values)
        {
        ...
        {
            msSQL = " SELECT company_name, institution_gid from agr_mst_tsupronboard2institution where application_gid='" + application_gid + "' order by institution_gid desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select institution2branch_gid,gst_state,gst_no, gst_registered from agr_mst_tsupronboardinstitution2branch where institution_gid='" + institution_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getmstgst_list = new List<mstgst_list>();
            if (dt_datatable.Rows.Count != 0)
            {
        ...
        public void DaGetsuprInstitutionRatingList(string institution_gid, string employee_gid, MdlRatingList values)
        {
            msSQL = " select institution2ratingdetail_gid,application_gid, institution_gid,creditrating_agencygid,creditrating_agencyname," +
                    " creditrating_gid,creditrating_name,date_format(a.assessed_on,'%d-%m-%Y') as assessed_on,creditrating_link, " +
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date " +
        ...
        public void DaGetsuprPANForm60List(string contact_gid, MdlContactPANForm60 values)
        {
            msSQL = "select contact2panform60_gid,document_name, document_path from agr_mst_tsupronboardcontact2panform60 where " +
              " contact_gid='" + contact_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = " Delete from agr_mst_tsupronboard2institution where institution_gid='" + institution_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        {
            msSQL = "Delete from agr_mst_tsupronboardcontact where contact_gid='" + contact_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public bool DaPostIndividualBank(string employee_gid, MdlBuyerOnboardIndividual2BankAcc values)
        {
            ...
            msSQL = "select primary_status from agr_mst_tsupronboardcontact2bankdtl where primary_status='Yes' and (contact_gid='" + employee_gid + "' or contact_gid='" + values.contact_gid + "')";
            string lsprimary_status = objdbconn.GetExecuteScalar(msSQL);
            if (lsprimary_status == (values.primary_status))
            {
                values.status = false;
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = " select contact2bankdtl_gid,bank_name,branch_name,ifsc_code,bankaccount_number from " +
                          " agr_mst_tsupronboardcontact2bankdtl where contact_gid='" + values.contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetIndividualBankAccDtl(string employee_gid, MdlBuyerOnboardIndividual2BankAcc values)
        {
            msSQL = " select contact2bankdtl_gid,contact_gid,bank_name,branch_name,ifsc_code,bankaccount_number,primary_status, " +
                    ...
                    " concat(c.user_firstname,' ',c.user_lastname,' / ',c.user_code) as created_by, " +
                    " concat(e.user_firstname, ' ', e.user_lastname, ' / ', e.user_code) as updated_by " +
                    " from agr_mst_tsupronboardcontact2bankdtl a " +
                    " left join hrm_mst_temployee b on a.created_by = b.employee_gid " +
                    " left join adm_mst_tuser c on c.user_gid = b.user_gid " +
                    " left join hrm_mst_temployee d on a.updated_by = d.employee_gid " +
                    " left join adm_mst_tuser e on e.user_gid = d.user_gid " +
        ...
        {
            msSQL = "delete from agr_mst_tsupronboardcontact2bankdtl where contact2bankdtl_gid='" + contact2bankdtl_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            if (mnResult != 0)
            {
                ...
                msSQL = " select contact2bankdtl_gid,bank_name,branch_name,ifsc_code,bankaccount_number from " +
                           " agr_mst_tsupronboardcontact2bankdtl where contact_gid='" + contact_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getcreditbankacc_list = new List<BuyerOnboardIndividual2bankacc_list>();
                if (dt_datatable.Rows.Count != 0)
                {
        ...
        public void DaEditGetIndividualBankAccDtl(string contact2bankdtl_gid, MdlBuyerOnboardIndividual2BankAcc values)
        {
            try
            {
                ...
                " bankaccounttype_gid,bankaccounttype_name,bankaccount_number,confirmbankaccountnumber,joinaccount_status,joinaccount_name," +
                " chequebook_status,accountopen_date from agr_mst_tsupronboardcontact2bankdtl where contact2bankdtl_gid='" + contact2bankdtl_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public void DaUpdateIndividualBankAccDtl(string employee_gid, MdlBuyerOnboardIndividual2BankAcc values)
        {
            ...
            msSQL = " select contact2bankdtl_gid,contact_gid,application_gid,bank_name,branch_name,bank_address,micr_code,ifsc_code,bankaccount_name," +
                " bankaccounttype_gid,bankaccounttype_name,bankaccount_number,confirmbankaccountnumber,joinaccount_status,joinaccount_name," +
                " chequebook_status,accountopen_date from agr_mst_tsupronboardcontact2bankdtl where contact2bankdtl_gid='" + values.contact2bankdtl_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
                lsbank_name = objODBCDatareader["bank_name"].ToString();
            ...
            msSQL = " update agr_mst_tsupronboardcontact2bankdtl set " +
                     " bank_name='" + values.bank_name + "'," +
                     " branch_name='" + values.branch_name.Replace("'", "") + "'," +
                     " bank_address='" + values.bank_address.Replace("'", "") + "'," +
                     " micr_code='" + values.micr_code + "'," +
            ...
            {//Date Updation
                ...
                //else
                //{
                //    msSQL = "update agr_mst_tsupronboardcontact2bankdtl set accountopen_date='" + Convert.ToDateTime(values.accountopendate).AddDays(1).ToString("yyyy-MM-dd 00:00:00") + "'" +
                //        "where contact2bankdtl_gid='" + values.contact2bankdtl_gid + "' ";
                //    mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                //}
                ...
                msSQL = " insert into agr_mst_tsupronboardcontact2bankdtlupdatelog(" +
        ...
        public void DaGetSuprInstitutionBankAccDtl(string institution_gid, string employee_gid, MdlInstitution2BankAcc values)
        {
            msSQL = " select institution2bankdtl_gid,institution_gid,bank_name,branch_name,ifsc_code,bankaccount_number, primary_status, " +
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date, " +
                    " date_format(a.updated_date, '%d-%m-%Y %h:%i %p') as updated_date, " +
        ...
        public void DaGetSuprIndividualBankAccDtl(string contact_gid, string employee_gid, Mdlindividual2bankacc values)
        {
            msSQL = " select contact2bankdtl_gid,contact_gid,bank_name,branch_name,ifsc_code,bankaccount_number, primary_status," +
                    " date_format(a.created_date,'%d-%m-%Y %h:%i %p') as created_date, " +
                    " date_format(a.updated_date, '%d-%m-%Y %h:%i %p') as updated_date, " +
        ...
        public void DaGeSupronboardInitiateDetail(string supplieronboard_gid, MdlonboardInitiateDetail values)
        {
            msSQL = " select application_no,virtualaccount_number,customerref_name from agr_mst_tsupronboard " +
                    " where application_gid='" + supplieronboard_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
                values.supplier_id = objODBCDatareader["application_no"].ToString();
                //values.virtualaccount_number = objODBCDatareader["virtualaccount_number"].ToString();
                values.supplier_name = objODBCDatareader["customerref_name"].ToString();
            }
            objODBCDatareader.Close();

            msSQL = " select application_no,approval_status, a.product_name, a.program_name,initiated_remarks, " +
                    ...
                    " where a.buyeronboard_gid ='" + supplieronboard_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaGetSuprValidateProductProgram(string loanproduct_gid, string supplieronboard_gid, MdlMstApplication360 values)
        {
            msSQL = "  SELECT  loansubproduct_gid,loansubproduct_name  " +
                    ...
                    "  left join agr_mst_tsuprapplication b on a.application_gid = b.application_gid " +
                    " where a.supplieronboard_gid = '" + supplieronboard_gid + "'  and  b.process_type is null) ) " +
                    ...
                    " where a.supplieronboard_gid = '" + supplieronboard_gid + "'  and approval_status in ('Rejected By Business','CC Rejected','Rejected By Credit') ))" +
        ...
        public void DaGetOnboardLgltagstatusLog(string onboard_gid, MdlOboardlglstatus values)
        {
            msSQL = " select lgltag_status," +
                    ...
                    " left join hrm_mst_temployee b on b.employee_gid=a.created_by " +
                    " left join adm_mst_tuser c on c.user_gid=b.user_gid" +
                    " where a.supronboard_gid='" + onboard_gid + "' order by onboardlgltagstatuslog_gid desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaPostOnboardTranferRM(string employee_gid, MdlRmtransferdtl values)
        {
            ...
            msSQL = " select created_by, createdby_name from agr_mst_tsupronboard where application_gid='" + values.onboard_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
        ...
        public void DaGetOnboardTranferRMLog(string onboard_gid, MdlRmtransferlist values)
        {
            msSQL = " select transferfrom_employeename,transferto_employeename,a.transfer_remarks," +
                    ...
                    " left join hrm_mst_temployee b on b.employee_gid=a.created_by " +
                    " left join adm_mst_tuser c on c.user_gid=b.user_gid" +
                    " where a.supronboard_gid='" + onboard_gid + "' order by onboardrmtransferlog_gid desc ";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        //   {
        //    msSQL = " select created_by from agr_mst_tsupronboard2institution where ";
        ...
        //     if (lspan == "")
        //     {
        //  msSQL = " select created_by from agr_mst_tsupronboardcontact where";
        //     if (values.stakeholder_type == "Applicant")
        //      {
        ...
        //          {
        //  msSQL = " select application_gid from agr_mst_tsupronboardcontact where ";
        //           if (values.stakeholder_type == "Applicant")
        //          {
        ...
        //if (lsapplication_gid != "")
        //{
        //    msSQL = " select customerref_name from agr_mst_tsupronboard where application_gid='" + lsapplication_gid + "'";
        //    values.customername = objdbconn.GetExecuteScalar(msSQL);
        //    values.status = true;
        //}
        // }
        ...
        public void DaGetOnboardValidatePANAadhar(MdlonboardValidatedtl values)
        {
            ...
            msSQL = " select (select count(b.application_gid) from agr_mst_tsupronboard b " +
                            " left join agr_mst_tsupronboard2institution a on b.application_gid = a.application_gid " +
                            " where companypan_no ='" + values.pan_no + "' and stakeholder_type='Applicant' and (b.onboard_approvalstatus = 'R' ) ) + " +
                            " (select count(b.application_gid) from agr_mst_tsupronboard a " +
                            " left join agr_mst_tsupronboardcontact b on b.application_gid = a.application_gid " +
            ...
            if (Convert.ToInt32(values.lsrejectcount) == 1)
            {
                ...
                if (Convert.ToInt32(values.lstotalpancount) == 0)
                {
                    ...
                    msSQL = " select (select count(b.application_gid) from agr_mst_tsupronboard b " +
                            ...
                            " (select count(a.application_gid) from agr_mst_tsupronboard a " +
                            " left join agr_mst_tsupronboardcontact b on b.application_gid = a.application_gid " +
                    ...
                    else
                    {
                        ...
                        {
                            msSQL = " select  institution_gid from  agr_mst_tsupronboard2institution where companypan_no ='" + values.pan_no + "' and stakeholder_type='Applicant' and  application_gid ='" + values.onboard_gid + "' and institution_gid ='" + values.institution_gid + "'";
                        ...
                        else if (!string.IsNullOrEmpty(values.contact_gid))
                        {
                            ...
                            msSQL = " select  contact_gid from  agr_mst_tsupronboardcontact where pan_no ='" + values.pan_no + "' and stakeholder_type='Applicant' and  application_gid ='" + values.onboard_gid + "'and contact_gid = '" + values.contact_gid + "' ";
            ...
            else if (values.onboard_gid != "" || values.onboard_gid != null)
            {
                ...
                if ((Convert.ToInt32(values.lspancount) == 1))
                {
                    ...
                    if ((Convert.ToInt32(values.lsnonapplicantpancount)) == 0)
                    {
                        ...
                        if (!string.IsNullOrEmpty(values.institution_gid))
                        {
                            msSQL = " select  institution_gid from  agr_mst_tsupronboard2institution where companypan_no ='" + values.pan_no + "' and stakeholder_type in ('Guarantor','Member') and  application_gid ='" + values.onboard_gid + "' and institution_gid ='" + values.institution_gid + "'";
                            string lsinstitution_gid = objdbconn.GetExecuteScalar(msSQL);
                        ...
                        else if (!string.IsNullOrEmpty(values.contact_gid))
                        {
                            ...
                            msSQL = " select  contact_gid from  agr_mst_tsupronboardcontact where pan_no ='" + values.pan_no + "' and stakeholder_type in ('Guarantor','Member') and  application_gid ='" + values.onboard_gid + "'and contact_gid = '" + values.contact_gid + "' ";
                            string lscontact_gid = objdbconn.GetExecuteScalar(msSQL);
