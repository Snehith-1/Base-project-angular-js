(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSentbackcctoCreditHistoryController', AgrMstSentbackcctoCreditHistoryController);

    AgrMstSentbackcctoCreditHistoryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrMstSentbackcctoCreditHistoryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSentbackcctoCreditHistoryController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnCreditApproval/GetAppcreditApprovallogSummary';
            SocketService.getparams(url, param).then(function (resp) {
