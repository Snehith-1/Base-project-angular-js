...
{
    public class DaMstCreditAllocationReport
    {
        ...
        //CreditSummary
        public void DaMstCreditSummary(MstCreditAllocationReport objMstCreditSummary)
        {
            msSQL = " select a.application_gid, a.application_no,a.customerref_name as customer_name,a.vertical_name, a.region,a.applicant_type, " +
                    ...
                    " left join ocs_trn_tAppcreditapproval h on (a.application_gid = h.application_gid and h.hierary_level = '3') " +
        ...
        public void DaExportMstCreditReport(MstCreditAllocationReport objMstCreditAllocationReport)
        {
            msSQL = " select a.application_gid, a.application_no, a.customerref_name as customer_name,a.vertical_name, a.region,a.applicant_type, " +
                    "a.creditgroup_name,date_format(a.creditassigned_date, '%d-%m-%Y %h:%i %p') as 'creditassigned_date' , " +
                    " concat(g.user_firstname, ' ', g.user_lastname, ' / ', g.user_code) as creditassigned_by,a.remarks," +
            ...
            if (dt_datatable.Rows.Count != 0)
            {
                ...
                foreach (DataRow dr_datarow in dt_datatable.Rows)
                {
                    ...
                    objGetMstCreditSummary.Add(new MstCreditExcelList
                    {
                        ...
                        Creditgroup = dr_datarow["creditgroup_name"].ToString(),
                        ...
                        CM_Reject_Remark = objdbconn.GetExecuteScalar("select approval_remarks from ocs_trn_tAppcreditapproval where application_gid = '" + dr_datarow["application_gid"].ToString() + "'"),
                        RCM_Approved_Reject_Remark = objdbconn.GetExecuteScalar("select approval_remarks from ocs_trn_tAppcreditapproval where application_gid = '" + dr_datarow["application_gid"].ToString() + "' and hierary_level = '1'"),
                        NCM_Approved_Reject_Remark = objdbconn.GetExecuteScalar("select approval_remarks from ocs_trn_tAppcreditapproval where application_gid = '" + dr_datarow["application_gid"].ToString() + "' and hierary_level = '2'"),
                        CH_Approved_Reject_Remark = objdbconn.GetExecuteScalar("select approval_remarks from ocs_trn_tAppcreditapproval where application_gid = '" + dr_datarow["application_gid"].ToString() + "' and hierary_level = '3'"),
            ...
            try
            {
                ...
                var path = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "Master/Credit Allocation Report/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";
                objMstCreditAllocationReport.lscloudpath =  lscompany_code + "/" + "Master/Credit Allocation Report/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + objMstCreditAllocationReport.lsname;
                objMstCreditAllocationReport.lspath = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "Master/Credit Allocation Report/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + objMstCreditAllocationReport.lsname;
