(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstGeneralTabController', AgrMstGeneralTabController);

    AgrMstGeneralTabController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrMstGeneralTabController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstGeneralTabController';
        lockUI();
        activate();
        function activate() {
        ...
        if (lstab == 'add') {
            ...
            var url = 'api/AgrMstApplicationAdd/GetDropDown';
              ...
              SocketService.get(url).then(function (resp) {
                ...
                var url = 'api/AgrMstApplicationAdd/GetTempApp';
                SocketService.get(url).then(function (resp) {
                ...
                var url = 'api/AgrMstApplicationAdd/GetInstitutionSummary';
                SocketService.get(url).then(function (resp) {
                    unlockUI();
                ...
                var url = 'api/AgrMstApplicationAdd/GetAppSocialTradeSummary';
                SocketService.get(url).then(function (resp) {
                    unlockUI();
                ...
                var url = 'api/AgrMstApplicationAdd/GetAddHypothecation';
        ...
        $scope.generalmobileno_add = function () {
            if (($scope.txtgeneralmobileno == undefined) || ($scope.txtgeneralmobileno == '') || ($scope.rdbprimarymobile_no == undefined) || ($scope.rdbprimarywhatsapp_no == undefined) || ($scope.rdbprimarymobile_no == '') || ($scope.rdbprimarywhatsapp_no == '')) {
                ...
                var params = {
                 ...
                 var url = 'api/AgrMstApplicationAdd/PostMobileNo';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function generalmobilenolist() {
            ...
            var url = 'api/AgrMstApplicationAdd/GetAppMobileNoList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.generalmobileno_delete = function (application2contact_gid) {
            ...
            var url = 'api/AgrMstApplicationAdd/DeleteMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.add_generalmaildetails = function () {
            if (($scope.txtgeneralmail_id == undefined) || ($scope.txtgeneralmail_id == '') || ($scope.rdbgeneralmaildetails == undefined) || ($scope.rdbgeneralmaildetails == '')) {
               ...
               var params = {
                ...
                var url = 'api/AgrMstApplicationAdd/PostEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function generalmail_list() {
            var url = 'api/AgrMstApplicationAdd/GetAppEmailAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.generalmail_delete = function (application2email_gid) {
            ...
            var url = 'api/AgrMstApplicationAdd/DeleteEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addgeneticcode = function () {
            if (($scope.cboGeneticCode == undefined) || ($scope.rdbStatus == undefined) || ($scope.txtgenetic_remarks == undefined) || ($scope.cboGeneticCode == null) || ($scope.rdbStatus == null) || ($scope.txtgenetic_remarks == null) || ($scope.cboGeneticCode == '') || ($scope.rdbStatus == '') || ($scope.txtgenetic_remarks == '')) {
               ...
               var params = {
                  ...
                  var url = 'api/AgrMstApplicationAdd/PostGeneticCode';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.geneticcode_delete = function (application2geneticcode_gid) {
            ...
            var url = 'api/AgrMstApplicationAdd/DeleteGenetic';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        /*    if ($scope.cboVernacularLanguage != undefined || $scope.cboVernacularLanguage != null) {
            ...
            SocketService.post(url, params).then(function (resp) {
                ...
                $location.url('app/AgrMstApplicationGeneralAdd?lstab=add');
            });
        ...
        $scope.DeleteGeneral=function(application_gid)
        {
            ...
            var url = 'api/AgrMstApplicationAdd/DeleteGeneral';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        {
            $location.url('app/AgrMstApplcreationBasicdtlEdit?lsapplication_gid=' + application_gid + '&lstab=add&lsstatus=' + application_status + '&product_gid=' + product_gid + '&variety_gid=' + variety_gid);
        }
        $scope.Editindividual = function (contact_gid) {
            $location.url('app/AgrMstApplcreationIndividualdtlEdit?lscontact_gid=' + contact_gid + '&lstab=add');
             }
        $scope.Editinstitution = function (institution_gid) {
            $location.url('app/AgrMstApplcreationInstitutiondtlEdit?lsinstitution_gid=' + institution_gid + '&lstab=add');
        }
        ...
        $scope.Editsocialtrade = function (application_gid) {
            $location.url('app/AgrMstApplcreationSocialTradeEdit?lsapplication_gid=' + application_gid + '&lstab=add');
              }
        ...
        $scope.Editgroup = function (group_gid) {
            $location.url('app/AgrMstApplcreationGroupdtlEdit?lsgroup_gid=' + group_gid + '&lstab=add');
        }
        ...
        $scope.importGroup = function (application_gid) {
         ...
         function productdetaillist() {
             ...
             var url = 'api/AgrMstApplicationAdd/GetProductDetailList';
             SocketService.get(url).then(function (resp) {
