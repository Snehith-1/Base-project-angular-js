(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupExistingBankAddController', MstCreditGroupExistingBankAddController);

        MstCreditGroupExistingBankAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function MstCreditGroupExistingBankAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupExistingBankAddController';
        ...
        $scope.creditexistingbank_edit = function (existingbankfacility_gid) {
            $location.url('app/MstCreditGroupExistingBankEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&existingbankfacility_gid=' + existingbankfacility_gid + '&lspage=' + lspage);
        }
