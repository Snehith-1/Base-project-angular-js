(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditBuyerDtlEditController', MstCreditBuyerDtlEditController);

        MstCreditBuyerDtlEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCreditBuyerDtlEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditBuyerDtlEditController';
        ...
        function activate() { 
            ...
            var url = 'api/MstAppCreditUnderWriting/EditGetCreditBuyer';
        ...
        $scope.buyerdtl_Back = function () {
            $location.url('app/MstCreditBuyerDtlAdd?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=' + $scope.lspage);
        }
        ...
        $scope.update_buyerdtl = function () {
            ...
            ($scope.txtBankCreditValue == undefined) || ($scope.rdbDeductionat_Source == undefined) || ($scope.txtrelationship_borrower == undefined) || ($scope.txtEndUse_Monitoring == undefined))
           {
             ...
             var url = 'api/MstAppCreditUnderWriting/UpdateCreditBuyer';
            lockUI();
