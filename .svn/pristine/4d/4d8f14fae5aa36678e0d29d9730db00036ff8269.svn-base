...
{
    public class MdlMstHRLoanApprovalsApproved : result
     {
        public string drm_remarks { get; set; }
        public string fh_remarks { get; set; }
        public string request_gid { get; set; }
        public List<Approvedrequestsummary> Approvedrequestsummary { get; set; }
        public List<ApprovedApprovalsummary> ApprovedApprovalsummary { get; set; }
    ...
    public class ApprovedApprovalsummary : result
    {
        public string request_gid { get; set; }
        ...
        public class Approvedrequestsummary : result
    {
