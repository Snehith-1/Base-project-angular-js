(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditPSLDataFlaggingEditController', MstCADCreditPSLDataFlaggingEditController);

    MstCADCreditPSLDataFlaggingEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADCreditPSLDataFlaggingEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditPSLDataFlaggingEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstCADCreditPSLDataFlaggingAdd?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=CADAcceptanceCustomers');
        }
