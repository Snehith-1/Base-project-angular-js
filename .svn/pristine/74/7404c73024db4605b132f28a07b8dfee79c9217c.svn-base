(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprVisitReportAddController', AgrMstSuprVisitReportAddController);

    AgrMstSuprVisitReportAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstSuprVisitReportAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprVisitReportAddController';
        ...
        $scope.editapplicationvisitreport = function (val) {
            ...
            $location.url('app/AgrMstSuprVisitReportEdit?visitreport_gid=' + val + '&application_gid=' + application_gid);

        }

        $scope.viewapplicationvisitreport = function (val) {
            $location.url('app/AgrMstSuprVisitReportView?visitreport_gid=' + val + '&application_gid=' + application_gid);
