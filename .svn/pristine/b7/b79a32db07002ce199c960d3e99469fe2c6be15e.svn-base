(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCADIndividualDtlAddController', AgrMstSuprCADIndividualDtlAddController);

    AgrMstSuprCADIndividualDtlAddController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstSuprCADIndividualDtlAddController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll, DownloaddocumentService, cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCADIndividualDtlAddController';
        activate();
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/GetGroupList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.grouplist = resp.data.grouplist;
            });
            var url = 'api/AgrMstSuprApplicationAdd/GetCompanyList';
            SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/PANAbsenceReasonList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.PANAadhaarLink = function () {
            if ($scope.txtpan_no.length == 10) {
                ...
                var url = 'api/AgrSuprKyc/PANAadhaarLink';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.mobileno_add = function () {
            ...
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_no == undefined) || ($scope.rdbwhatsapp_no == undefined) || ($scope.rdbwhatsapp_no == '') || ($scope.rdbprimary_no == '')) {
                ...
                var url = 'api/AgrMstSuprApplicationAdd/MobileNumberAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    ...
                    var url = 'api/AgrMstSuprApplicationAdd/GetMobileNoList';
                    SocketService.get(url).then(function (resp) {
        ...
        $scope.mobileno_delete = function (contact2mobileno_gid) {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/MobileNoDelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.email_add = function () {
            ...
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbprimary_email == undefined) || ($scope.rdbprimary_email == '')) {
                ...
                var url = 'api/AgrMstSuprApplicationAdd/EmailAddressAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
                    ...
                    var url = 'api/AgrMstSuprApplicationAdd/GetEmailAddressList';
                    SocketService.get(url).then(function (resp) {
        ...
        $scope.emailaddress_delete = function (contact2email_gid) {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/EmailAddressDelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
            ...
            if (($scope.cboIndividualProof == null) || ($scope.cboIndividualProof == '') || ($scope.cboIndividualProof == undefined) || ($scope.txtidproof_no == null) || ($scope.txtidproof_no == '') || ($scope.txtidproof_no == undefined)) {
                ...
                if ($scope.uploadfrm != undefined) {
                    ...
                    SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                        ...
                        var url = 'api/AgrMstSuprApplicationAdd/GetIndividualProofList';
                        SocketService.get(url).then(function (resp) {
        ...
        function individualaddress_list() {
            var url = 'api/AgrMstSuprApplicationAdd/GetAddressList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.address_add = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/AgrMstSuprApplicationAdd/AddressAdd';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.address_delete = function (contact2address_gid) {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/AddressDelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.individualdocument_upload = function (val, val1, name) {
            ...
            if (($scope.cboIndividualDocument == null) || ($scope.cboIndividualDocument == '') || ($scope.cboIndividualDocument == undefined)) {
                ...
                $scope.uploadfrm = frm;
                if ($scope.uploadfrm != undefined) {
                    var url = 'api/AgrMstSuprApplicationAdd/IndividualDocumentUpload';
                    SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                        $("#fileIndividuaDocument").val('');
                        ...
                        var url = 'api/AgrMstSuprApplicationAdd/GetIndividualDocList';
                        SocketService.get(url).then(function (resp) {
        ...
        $scope.individualdocument_delete = function (contact2document_gid) {
            ...
            lockUI();
            var url = 'api/AgrMstSuprApplicationAdd/IndividualDocDelete';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.upload_list = resp.data.upload_list;
                if (resp.data.status == true) {
        ...
        $scope.individual_save = function () {
            ...
            if ($scope.rdburn_status == 'Yes' && ($scope.txt_urn == '' || $scope.txt_urn == undefined || $scope.txt_urn == null)) {
                ...
                var url = 'api/AgrMstSuprApplicationEdit/SaveIndividualDtlAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.individual_submit = function () {
            ...
            if ($scope.rdburn_status == 'Yes' && ($scope.txt_urn == '' || $scope.txt_urn == undefined || $scope.txt_urn == null)) {
                ...
                var url = 'api/AgrMstSuprApplicationEdit/SubmitIndividualDtlAdd';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.pandtl_submit = function () {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/PostPANAbsenceReasons';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
