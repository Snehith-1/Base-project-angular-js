...
/// <summary>
/// (It's used for ApplicationVisitReport) ApplicationVisitReport DataAccess Class accessed by API methods from related Controller class and is returning relevant response to client.
/// </summary>
/// <remarks>Written by Sumala,Logapriya and Abilash</remarks>

namespace ems.master.DataAccess
{
    public class DaMstApplicationVisitReport
    {
        ...
        //public void GetInspectingOfficials(MdlMstVisitPerson values)
        //{
        //    try
        //    {
        ...
        //                {
        //                    inspectingofficials_gid = (dr_datarow["employee_gid"].ToString()),
        //                    inspectingofficials_name = (dr_datarow["employee_name"].ToString())
        //                });
        //            }
        ...
        {
            msSQL = "select primary_status from ocs_mst_tapplicationvisitperson2contactno where primary_status='Yes' and applicationvisit2person_gid='" + employee_gid + "'";
            ...
            msSQL = "select applicationvisitperson2contact_gid,primary_status from ocs_mst_tapplicationvisitperson2contactno where mobile_no='" + values.mobile_no + "' " +
            ...
            msSQL = " insert into ocs_mst_tapplicationvisitperson2contactno(" +
        ...
        public bool DaPostPersonDetails(string employee_gid, mstVisitpersondtl_list values)
        {
            ...
            msSQL = " insert into ocs_mst_tapplicationvisit2person(" +
                    " applicationvisit2person_gid," +
                    ...
                    "'" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = "update ocs_mst_tapplicationvisitperson2contactno set applicationvisit2person_gid= '" + msGetGid + "' where applicationvisit2person_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        public bool DaPostVisitAddress(string employee_gid, mstVisitpersonaddress_list values)
        {
            ...
            msSQL = " insert into ocs_mst_tapplicationvisit2address(" +
        ...
        public void DaPostVisitDocumentUpload(HttpRequest httpRequest, UploadDocumentList objfilename, string user_gid,string employee_gid)
        {
            ...
            path = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "Master/VisitDocumentUpload/" + DateTime.Now.Year + "/" + DateTime.Now.Month;
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        bool status;
                        status = objcmnstorage.UploadStream("erpdocument", lscompany_code + "/" + "CST/VisitDocumentUpload/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + msdocument_gid + FileExtension, ms);
                        ms.Close();
                        lspath = "erpdocument" + "/" + lscompany_code + "/" + "CST/VisitDocumentUpload/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";

               
                        msGetGid = objcmnfunctions.GetMasterGID("VR2D");
                        msSQL = " insert into ocs_mst_tapplicationvisit2document( " +
        ...
        public bool DaPostVisitUploadPhoto(HttpRequest httpRequest, UploadphotoList objfilename, string employee_gid, string user_gid)
        {
            ...
            path = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "Master/Visitphotos/" + DateTime.Now.Year + "/" + DateTime.Now.Month;
            if ((!System.IO.Directory.Exists(path)))
                System.IO.Directory.CreateDirectory(path);
                ...
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        if ((FileExtension == ".jpg") || (FileExtension == ".jpeg") || (FileExtension == ".png") || (FileExtension == ".tif") || (FileExtension == ".tiff") || (FileExtension == ".jfif") || (FileExtension == ".gif"))
                        {
                            ...
                            bool status;
                            status = objcmnstorage.UploadStream("erpdocument", lscompany_code + "/" + "CST/Visitphotos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + msdocument_gid + FileExtension, ms);
                            ms.Close();
                            lspath = "erpdocument" + "/" + lscompany_code + "/" + "CST/Visitphotos/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";

                            msGetGid = objcmnfunctions.GetMasterGID("VR2P");

                            msSQL = " insert into ocs_mst_tapplicationvisit2photo( " +
        ...
        {
            msSQL = "select applicationvisitperson2contact_gid,mobile_no,primary_status,whatsapp_mobileno from ocs_mst_tapplicationvisitperson2contactno where " +
        ...
        {
            msSQL = "select applicationvisit2person_gid,clientrepresentative_name,clientrepresentative_designationgid,clientrepresentative_designationname,personal_mail,office_mail from ocs_mst_tapplicationvisit2person where " +
        ...
        {
            msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,landmark,postal_code,city,taluk,district,state_name,country,latitude,longitude from ocs_mst_tapplicationvisit2address where " +
              " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,landmark,postal_code,city,taluk,district,state_name,latitude,longitude,country from ocs_mst_tapplicationvisit2address where " +
              " applicationvisit_gid='" + applicationvisit_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            var getmstVisitpersonaddress_list = new List<mstVisitpersonaddress_list>();
            if (dt_datatable.Rows.Count != 0)
        ...
        {
            msSQL = "select applicationvisit2document_gid,document_name,document_path,file_name  from ocs_mst_tapplicationvisit2document where " +
              " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select applicationvisit2photo_gid,visitphoto_name,visitphoto_path,file_name  from ocs_mst_tapplicationvisit2photo where " +
              " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisitperson2contactno where applicationvisitperson2contact_gid='" + applicationvisitperson2contact_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "select applicationvisitperson2contact_gid from ocs_mst_tapplicationvisitperson2contactno where " +
                    " applicationvisit2person_gid='" + applicationvisit2person_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);         
            if (dt_datatable.Rows.Count != 0)
            {
                foreach (DataRow dr_datarow in dt_datatable.Rows)
                {
                    msSQL = "delete from ocs_mst_tapplicationvisitperson2contactno where applicationvisitperson2contact_gid='" + dr_datarow["applicationvisitperson2contact_gid"].ToString() + "'";
                    mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);                
            ...
            dt_datatable.Dispose();
            msSQL = "delete from ocs_mst_tapplicationvisit2person where applicationvisit2person_gid='" + applicationvisit2person_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisit2address where applicationvisit2address_gid='" + applicationvisit2address_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisit2document where applicationvisit2document_gid='" + applicationvisit2document_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisit2photo where applicationvisit2photo_gid='" + applicationvisit2photo_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisitperson2contactno where applicationvisit2person_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "select applicationvisit2person_gid from ocs_mst_tapplicationvisit2person where " +
                    " applicationvisit_gid='" + employee_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
            if (dt_datatable.Rows.Count != 0)
            {
                foreach (DataRow dr_datarow in dt_datatable.Rows)
                {
                    msSQL = "delete from ocs_mst_tapplicationvisitperson2contactno where applicationvisit2person_gid='" + dr_datarow["applicationvisit2person_gid"].ToString() + "'";
                    mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            ...
            dt_datatable.Dispose();
            msSQL = "delete from ocs_mst_tapplicationvisit2person where applicationvisit_gid ='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
                values.message = "Visit Person Details Deleted Successfully";
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisit2address where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisit2document where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        {
            msSQL = "delete from ocs_mst_tapplicationvisit2photo where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
        ...
        public bool DaPostApplicationVisitReport (string employee_gid,string user_gid, MdlMstVisitPerson values)
        {
            ...
            {
                lsins_refno = "VISITAPPBV" + DateTime.Now.ToString("yyyyMMdd");
                string msGETRef1 = objcmnfunctions.GetMasterGID("VIRM");
                msGETRef1 = msGETRef1.Replace("VIRM", "");
                lsins_refno = lsins_refno + msGETRef1;
            }
            else
            {

                lsins_refno = "VISITAPPCV" + DateTime.Now.ToString("yyyyMMdd");
                string msGETRef1 = objcmnfunctions.GetMasterGID("VICM");
                msGETRef1 = msGETRef1.Replace("VICM", "");
                lsins_refno = lsins_refno + msGETRef1;
            }

            msGetGid = objcmnfunctions.GetMasterGID("APVR");
            msSQL = " insert into ocs_mst_tapplicationvisitreport(" +
                    " applicationvisit_gid," +
                    " visitreport_id," +
                    " application_gid," +
            ...
            else
            {
                for (var i = 0; i < values.mstinspectingofficials.Count; i++)
                {
                    ...
                    msSQL = "Insert into ocs_mst_tapplicationvisit2inspectingofficial( " +
            ...
            else
            {
                for (var i = 0; i < values.mdlvisitdone.Count; i++)
                {
                    ...
                    msSQL = "Insert into ocs_mst_tapplicationvisit2visitdone( " +
            ...
            msSQL = "update ocs_mst_tapplicationvisit2person set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update ocs_mst_tapplicationvisit2address set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update ocs_mst_tapplicationvisit2document set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update ocs_mst_tapplicationvisit2photo set applicationvisit_gid ='" + msGetGid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public void DaEditApplicationVisitaddress(string applicationvisit2address_gid, mstVisitpersonaddress_list values)
        {
            try
            {
                msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,latitude, longitude,landmark,postal_code,city,taluk,district,state_name,country from ocs_mst_tapplicationvisit2address where " +
        ...
        public void DaEditApplicationVisitpersondtl(string applicationvisit2person_gid, mstVisitpersondtl_list values)
        {
            try
            {
                msSQL = "select applicationvisit2person_gid,clientrepresentative_name,clientrepresentative_designationgid,clientrepresentative_designationname," +
                       " personal_mail,office_mail from ocs_mst_tapplicationvisit2person where " +
                       " applicationvisit2person_gid='" + applicationvisit2person_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
        ...
        public bool DaPostPersonDetailsUpdate(string employee_gid, mstVisitpersondtl_list values)
        {
            ...
            msSQL = " update ocs_mst_tapplicationvisit2person set clientrepresentative_name='" + values.clientrepresentative_name + "'," +
             ...
             mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = "update ocs_mst_tapplicationvisitperson2contactno set applicationvisit2person_gid= '" + values.applicationvisit2person_gid + "' where applicationvisit2person_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
                values.status = true;
        ...
        {
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = " update ocs_mst_tapplicationvisit2address set addresstype_gid='" + values.addresstype_gid + "'," +
        ...
        {
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2person where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2address where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2document where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2photo where applicationvisit_gid ='" + employee_gid + "' or applicationvisit_gid='" + values.applicationvisit_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select date_format(applicationvisit_date,'%d-%m-%Y') as applicationvisit_date from ocs_mst_tapplicationvisitreport where applicationvisit_gid='" + values.applicationvisit_gid + "'";
            ...
            msSQL = "update ocs_mst_tapplicationvisitreport set " +
           ...
           if (values.applicationvisit_date == null)
            ...
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = " delete from ocs_mst_tapplicationvisit2inspectingofficial where applicationvisit_gid ='" + values.applicationvisit_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
            ...
            msSQL = " delete from ocs_mst_tapplicationvisit2visitdone where applicationvisit_gid ='" + values.applicationvisit_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnresult != 0)
            {
                for (var i = 0; i < values.mdlvisitdone.Count; i++)
            ...
            msSQL = "update ocs_mst_tapplicationvisit2person set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update ocs_mst_tapplicationvisit2address set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update ocs_mst_tapplicationvisit2document set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = "update ocs_mst_tapplicationvisit2photo set applicationvisit_gid ='" + values.applicationvisit_gid + "' where applicationvisit_gid='" + employee_gid + "'";
            mnresult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        {
            msSQL = " select concat(c.user_firstname,' ',c.user_lastname,'/',c.user_code) as created_by,draft_flag,visitreport_id, " +
                    " date_format(a.created_date,'%d-%m-%Y %H:%m:%s') as created_date, date_format(a.applicationvisit_date,'%d-%m-%Y') as applicationvisit_date,a.applicationvisit_gid  from ocs_mst_tapplicationvisitreport a " +
        ...
        public void DaEditApplicationVisitReport(string applicationvisit_gid, MdlMstVisitPerson values)
        {
            try
            {
                msSQL = "select applicationvisit_gid,visitreport_id,date_format(applicationvisit_date,'%d-%m-%Y') as applicationvisit_date,clientkmp_activities," +
                    ...
                    " summary,draft_flag from ocs_mst_tapplicationvisitreport where " +
                       " applicationvisit_gid='" + applicationvisit_gid + "'";
                objODBCDatareader = objdbconn.GetDataReader(msSQL);
                if (objODBCDatareader.HasRows == true)
                {
                    ...
                    msSQL = " select inspectingofficials_gid,inspectingofficials_name,applicationvisit2inspectingofficial_gid from ocs_mst_tapplicationvisit2inspectingofficial " +
                    ...
                    msSQL = " select visitdone_name,visitdone_gid,applicationvisit2visitdone_gid from ocs_mst_tapplicationvisit2visitdone " +
                 " where applicationvisit_gid='" + applicationvisit_gid + "'";
                    dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        {
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2person where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2address where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2document where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
            ...
            msSQL = "select applicationvisit_gid from ocs_mst_tapplicationvisit2photo where applicationvisit_gid ='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == false)
            {
                objODBCDatareader.Close();
        ...
        public void DaGetVisitReportDtls(string visitreport_gid, MdlMstVisitPersonView values)
        {
            try
            {
               ...
               " where a.applicationvisit_gid='" + visitreport_gid + "'";
                ...
                msSQL = "select applicationvisit2address_gid,addresstype_gid,addresstype_name,primary_status,address_line1,address_line2,landmark,postal_code,city,taluk,district,state_gid,state_name,latitude,longitude,country from ocs_mst_tapplicationvisit2address where " +
                        " applicationvisit_gid='" + visitreport_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getmstVisitpersonaddress_list = new List<mstVisitpersonaddress_list>();
                if (dt_datatable.Rows.Count != 0)
                ...
                msSQL = "select applicationvisit2document_gid,document_name,document_path,file_name,date_format(created_date,'%d-%m-%Y') as created_date  from ocs_mst_tapplicationvisit2document where " +
                        " applicationvisit_gid='" + visitreport_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getUploadDocumentList = new List<UploadDocumentList>();
                if (dt_datatable.Rows.Count != 0)
                ...
                msSQL = "select applicationvisit2photo_gid,visitphoto_name,visitphoto_path,file_name,date_format(created_date,'%d-%m-%Y') as created_date  from ocs_mst_tapplicationvisit2photo where " +
                        " applicationvisit_gid='" + visitreport_gid + "'";
                dt_datatable = objdbconn.GetDataTable(msSQL);
                var getUploadphotoList = new List<UploadphotoList>();
                if (dt_datatable.Rows.Count != 0)
