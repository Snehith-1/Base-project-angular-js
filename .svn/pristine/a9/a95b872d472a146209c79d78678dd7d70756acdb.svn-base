...
namespace ems.mastersamagro.Controllers
{
    ...
    [RoutePrefix("api/AgrKycView")]
    [Authorize]

    public class AgrKycViewController : ApiController
    {
        ...
        public HttpResponseMessage DrivingLicenseViewDetails(string kycdlauthentication_gid)
        {
            ...
            msSQL = " select CAST(response as char) as response" +
                       " from agr_mst_tkycdlauthentication where kycdlauthentication_gid='" + kycdlauthentication_gid + "'";
        ...
        public HttpResponseMessage VoterIDViewDetails(string kycepicauthentication_gid)
        {
            ...
            msSQL = " select CAST(response as char) as response" +
                       " from agr_mst_tkycepicauthentication where kycepicauthentication_gid='" + kycepicauthentication_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
        ...
        public HttpResponseMessage PassportViewDetails(string kycpassportauthentication_gid)
        {
            ...
            msSQL = " select CAST(response as char) as response" +
                       " from agr_mst_tkycpassportauthentication where kycpassportauthentication_gid='" + kycpassportauthentication_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
        ...
        public HttpResponseMessage GSTSBPANViewDetails(string kycgstsbpan_gid)
        {
            ...
            msSQL = " select CAST(response as char) as response" +
                       " from agr_mst_tkycgstsbpan where kycgstsbpan_gid='" + kycgstsbpan_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
        ...
        public HttpResponseMessage IFSCViewDetails(string kycifscauthentication_gid)
        {
            ...
            msSQL = " select CAST(response as char) as response" +
                       " from agr_mst_tkycifscauthentication where kycifscauthentication_gid='" + kycifscauthentication_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
        ...
        public HttpResponseMessage BankAccViewDetails(string kycbankaccverification_gid)
        {
            ...
            msSQL = " select CAST(response as char) as response" +
                       " from agr_mst_tkycbankaccverification where kycbankaccverification_gid='" + kycbankaccverification_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
