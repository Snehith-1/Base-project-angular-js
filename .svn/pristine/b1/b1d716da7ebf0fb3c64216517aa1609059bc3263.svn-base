...
/// <summary>
/// (It's used for Kyc) Kyc Model Class accessed by API methods from related DataAccess class and is returning relevant response to client.
/// </summary>
...
namespace vcidex_kyc.Models
{
    ...
    public class PanNumberResponse : MdlKyc
    {
    ...
    public class PanVerificationResponse : MdlKyc
    {
    ...
    public class DrivingLicenseResponse : MdlKyc
    {
    ...
    public class VoterIDResponse : MdlKyc
    {
    ...
    public class PassportDetailsResponse : MdlKyc
    {
    ...
    public class GSTSBPANDetailsResponse : MdlKyc
    {
        public string requestId { get; set; }
    ...
    public class GSTVerificationResponse : MdlKyc
    {
        public string requestId { get; set; }
    ...
    public class GSPGSTReturnFilingResponse : MdlKyc
    {
        public string requestId { get; set; }
    ...
    public class GSTAuthenticationResponse : MdlKyc
    {
        public string requestId { get; set; }
    ...
    public class CompanyLLPResponse : MdlKyc
    {
    ...
    public class McaSignatoriesResponse : MdlKyc
    {
    ...
    public class UamResponse : MdlKyc
    {
    ...
    public class FSSAIResponse : MdlKyc
    {
    ...
    public class FDAResponse : MdlKyc
    {
        [JsonProperty("status-code")]
        public string statuscode { get; set; }
        public string request_id { get; set; }
    ...
    public class EBAResponse : MdlKyc
    {
    ...
    public class TelephoneAuthenticationResponse : MdlKyc
    {
    ...
    public class BankAccVerificationResponse : MdlKyc
    {
        [JsonProperty("status-code")]
        public string statusCode { get; set; }
    ...
    public class ITRVOCRResponse : MdlKyc
    {
        public string request_id { get; set; }
    ...
    public class ChequeOCRResponse : MdlKyc
    {
        public int statusCode { get; set; }
        public string requestId { get; set; }
    ...
    public class PanAadhaarLinkResponse : MdlKyc
    {
    ...
    public class IfscVerificationResponse : MdlKyc
    {
        [JsonProperty("status-code")]
        public string statusCode { get; set; }
    ...
    public class CINLLPResponse : MdlKyc
    {
    ...
    public class TANPResponse : MdlKyc
    {
    ...
    public class iecdetailedPResponse : MdlKyc
    {
    ...
    public class ShopAndEstablishmentResponse : MdlKyc
    {
    ...
    public class PropertyTaxResponse : MdlKyc
    {
    ...
    public class VehicleRCAuthAdvancedResponse : MdlKyc
    {
    ...
    public class VehicleRCSearchResponse : MdlKyc
    {
    ...
    public class LPGIDAuthenticationResponse : MdlKyc
    {
    ...
    public class UdyamNumberModel : Common
    {
        public string udyamreg_no { get; set; }
        public string ispdfrequired { get; set; }
    }

    public class UdyamNumberResponse : MdlKyc
    {
