(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstApplicationSocialTradeCapitalEdit', AgrMstApplicationSocialTradeCapitalEdit);

    AgrMstApplicationSocialTradeCapitalEdit.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrMstApplicationSocialTradeCapitalEdit($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstApplicationSocialTradeCapitalEdit';
        lockUI();
        activate();
        ...
        $scope.save_socialtradecapital = function () {
            ...
            var url = 'api/AgrMstApplicationEdit/SocialAndTradeCapitalSubmit';
            lockUI();
