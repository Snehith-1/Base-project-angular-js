...
/// <summary>
/// (It's used for Business Approval in Samfin)ApplicationApproval Controller Class containing API methods for accessing the related DataAccess class and returning relevant response to client. 
/// </summary>
/// <remarks>Written by Sumala,Logapriya and Abilash </remarks>
namespace ems.master.Controllers
{
    [RoutePrefix("api/MstApplicationApproval")]
    [Authorize]
    public class MstApplicationApprovalController : ApiController
    {
        DaMstApplicationApproval objMstApplicationapproval = new DaMstApplicationApproval();
