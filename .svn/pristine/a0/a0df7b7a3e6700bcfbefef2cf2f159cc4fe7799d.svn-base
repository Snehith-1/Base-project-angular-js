(function () {
    ...
    angular
        .module('angle')
        .controller('MstApplCreationGradingToolViewController', MstApplCreationGradingToolViewController);

        MstApplCreationGradingToolViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function MstApplCreationGradingToolViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstApplCreationGradingToolViewController';
        ...
        function activate() {
            ...
            var url =  'api/MstApplicationView/GetGradingView';
