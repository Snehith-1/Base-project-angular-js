(function () {
    ...
    angular
        .module('angle')
        .controller('MstCustomerView', MstCustomerView);

    MstCustomerView.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route'];

    function MstCustomerView($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCustomerView';
        activate();
        ...
        function activate() {
            ...
            var url = 'api/MstCustomerAdd/GetViewCustomer2UserDtl';
        ...
        $scope.viewuserdtl = function (customer2usertype_gid) {
            ...
            $location.url('app/MstCustomer2userView?lsredirect=view');
        }
    }
})();
