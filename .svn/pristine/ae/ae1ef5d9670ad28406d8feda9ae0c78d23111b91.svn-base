(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstUDCMakerAddController', AgrMstUDCMakerAddController);

    AgrMstUDCMakerAddController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams', '$anchorScroll','cmnfunctionService'];

    function AgrMstUDCMakerAddController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, $anchorScroll,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstUDCMakerAddController';
        ...
        function activate() {
            ...
            var url = 'api/AgrUdcManagement/GetUdcTempClear';
            SocketService.get(url).then(function (resp) {
            });

            var url = 'api/AgrUdcManagement/GetCustomers';
            lockUI();
            SocketService.get(url).then(function (resp) {
            ...
            var url = 'api/AgrUdcManagement/GetStakeholders';
            SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/AgrUdcManagement/GetDropDownUdc';
            lockUI();
            SocketService.get(url).then(function (resp) {
        ...
        $scope.add_cheque = function () {
            ...
            var url = 'api/AgrUdcManagement/PostChequeDetail';
        ...
        function cheque_list() {
            var url = 'api/AgrUdcManagement/GetChequeSummary';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.delete_cheque = function (udcmanagement2cheque_gid) {
            ...
            var url = 'api/AgrUdcManagement/DeleteChequeDetail';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
        ...
        $scope.viewCheque = function (udcmanagement2cheque_gid) {
            $location.url('app/AgrMstUDCMakerView?lsudcmanagement_gid=' + $scope.udcmanagement_gid + '&lstab=add');
        }
        ...
        function chequedocument_list() {
            var url = 'api/AgrUdcManagement/GetChequeDocumentList';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.delete_document = function (cheque2document_gid) {
            ...
            var url = 'api/AgrUdcManagement/ChequeDocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
