(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprOnboardApprovalEditcontroller', AgrMstSuprOnboardApprovalEditcontroller);

    AgrMstSuprOnboardApprovalEditcontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstSuprOnboardApprovalEditcontroller($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprOnboardApprovalEditcontroller';
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.update_Bankacctdtl = function () {
                    if (($scope.txtIFSC_Code == undefined) || ($scope.txtIFSC_Code == '') || ($scope.txtbankacct_no == undefined) || ($scope.txtbankacct_no == '') || ($scope.txtBank_Address == undefined) || ($scope.txtBank_Address == '') ||
                        ($scope.txtconfirmbankacct_no == undefined) || ($scope.txtconfirmbankacct_no == '') || ($scope.txtacctholder_name == undefined) || ($scope.txtacctholder_name == '') ||
                        ($scope.cboAccountType == undefined) || ($scope.cboAccountType == '') || ($scope.rdbJoint_Account == undefined) || ($scope.rdbJoint_Account == '') ||
                        ($scope.rdbCheque_Book == undefined) || ($scope.rdbCheque_Book == '') || ($scope.rdbprimarystatus == undefined) || ($scope.rdbprimarystatus == '') || ($scope.txtBank_Address == undefined) || ($scope.txtBank_Address == '') || ($scope.txtBranch_Name == undefined) || ($scope.txtBranch_Name == '')) {
                        Notify.alert('Enter All Mandatory Fields', 'warning');
                    }
        ...
        $scope.AadharIndividualValidation = function (contact_gid) {
            var getStakeholderType = ""; 
            if ($scope.stakeholdertype_name != undefined && $scope.stakeholdertype_name != "") {
                getStakeholderType = $scope.stakeholdertype_name;
            }
            else {
                var getStakeholderType = $scope.cboindStakeholderType.user_type
            }
            if (getStakeholderType != null && getStakeholderType != "") {
                $scope.AlreadyaddedIndividualpanaadhar = false;
                lockUI();
        ...
        $scope.Editgeneral = function (application_gid, application_status, product_gid, variety_gid) {
            ...
            $scope.mobileno_edit = function (application2contact_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditAppMobileNo';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_mobileno = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateAppMobileNo';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.emailaddress_edit = function (application2email_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditAppEmailAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_emailaddress = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateAppEmailAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        $scope.Editindividual = function (contact_gid) {
            ...
            $scope.individualmobileno_edit = function (contact2mobileno_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditIndividualMobileNo';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_mobileno = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateIndividualMobileNo';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.individualemail_edit = function (contact2email_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditIndividualEmailAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.txteditemail_address = resp.data.email_address;
                        $scope.rdbeditprimary_status = resp.data.primary_status;
                    });
                    ...
                    $scope.update_emailaddress = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateIndividualEmailAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.individualemail_delete = function (contact2email_gid) {
                ...
                var url = 'api/AgrMstSupplierOnboard/DeleteIndividualEmailAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
            ...
            $scope.address_edit = function (contact2address_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditIndividualAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.address_update = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateIndividualAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        $scope.Editinstitution = function (institution_gid) {
            ...
            $scope.institutionmobileno_edit = function (institution2mobileno_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditInstitutionMobileNo';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_mobileno = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateInstitutionMobileNo';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.institutionemailaddress_edit = function (institution2email_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditInstitutionEmailAddress';
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.txteditemail_address = resp.data.email_address;
                    ...
                    $scope.update_emailaddress = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateInstitutionEmailAddress';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
            ...
            $scope.editinstitution_address = function (institution2address_gid) {
                ...
                function ModalInstanceCtrl($scope, $modalInstance) {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/EditInstitutionAddressDetail';
                    SocketService.getparams(url, params).then(function (resp) {
                    ...
                    $scope.update_address = function () {
                        ...
                        var url = 'api/AgrMstSupplierOnboardEdit/UpdateInstitutionAddressDetail';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
