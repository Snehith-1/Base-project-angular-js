    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper) {
        ...
        $stateProvider
         ...
         .state('app.caseAllocation', {
            ...
            .state('app.externalvisitReportGenerate',
             {
                 url: '/externalvisitReportGenerate',
                 title: 'externalvisitReportGenerate',
                 templateUrl: helper.basepath('ems.ep/externalvisitReportGenerate.html'),
                 resolve: helper.resolveFor('oitozero.ngSweetAlert', 'ui.select', 'ngTable', 'ngDialog', 'datatables', 'textAngular', 'localytics.directives')
     
             })

             .state('app.externalvisitReportdetailView',
             {
                 url: '/externalvisitReportdetailView',
                 title: 'externalvisitReportdetailView',
                 templateUrl: helper.basepath('ems.ep/externalvisitReportdetailView.html'),
                 resolve: helper.resolveFor('oitozero.ngSweetAlert', 'ui.select', 'ngTable', 'ngDialog', 'datatables', 'localytics.directives')
     
             })

             .state('app.externalvisitReportCancel',
             {
                 url: '/externalvisitReportCancel',
                 title: 'externalvisitReportCancel',
                 templateUrl: helper.basepath('ems.ep/externalvisitReportCancel.html'),
