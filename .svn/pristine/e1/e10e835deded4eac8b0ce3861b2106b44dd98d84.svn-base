...
{
    /// <summary>
    /// This DataAccess provide access for various Single and Mutliple events (Get InstitutionDetails, 
    ///  Probe - Institution & Individual, Comprehensive, FormMGT7, FormAOC4, Article Of Association) in Buyer ProbeAPI.
    /// </summary>
    /// <remarks>Written by Praveen </remarks>
    public class DaAgrProbeAPI
    {
        ...
        public MdlBaseDetailsResponse DaGetBaseDetails(string employee_gid, MdlBaseDetailsRequest Values)
        {
            ...
            {               
                ...
                msSQL = "delete from agr_trn_tinstitutionprobedetails where institution_gid='" + Values.institution_gid + "' and api_name='Base Details'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

                response.Content = response.Content.Replace("'", "");

                msGetGid = objcmnfunctions.GetMasterGID("IPDT");
                msSQL = " insert into agr_trn_tinstitutionprobedetails(" +
               ...
               msSQL += "'" + employee_gid + "'," +
                ...
                if(mnResult == 1)
                {
                    ...
                    msSQL = " insert into agr_trn_tinstitutionprobedetailslog(" +
        ...
        public void DaInstitutionProbeList(string institution_gid, MdlInstitutionProbe values)
        {
            ...
            //        " from agr_trn_tinstitutionprobedetails where institution_gid='" + institution_gid + "'";
        ...
        public MdlComprehensiveDetailsResponse DaGetComprehensiveDetails(string employee_gid, MdlComprehensiveDetailsRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tinstitutionprobedetails where institution_gid='" + Values.institution_gid + "' and api_name='Comprehensive Details'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public MdlDataStatusResponse DaGetDataStatus(string employee_gid, MdlDataStatusRequest Values)
        {
            ...
            try
            {
                ...
                msSQL = "delete from agr_trn_tinstitutionprobedetails where institution_gid='" + Values.institution_gid + "' and api_name='Data Status'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
        ...
        public MdlDocDetailsResponse DaGetFormAOC4Doc(string employee_gid, MdlProbeDocDetailsRequest Values)
        {
            ...
            try
            {
                msSQL = "SELECT response FROM agr_trn_tinstitutionprobedetails a where institution_gid='" + Values.institution_gid + "' and api_name='Comprehensive Details'";
        ...
        public void DaInstitutionProbeLogList(string application_gid, MdlInstitutionProbe values)
        {
            msSQL = "  select institutionprobedetailslog_gid,api_name,apicall_status, date_format(created_date,'%d-%m-%Y %h:%i %p') as created_date" +
                    " from agr_trn_tinstitutionprobedetailslog where application_gid='" + application_gid + "'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
