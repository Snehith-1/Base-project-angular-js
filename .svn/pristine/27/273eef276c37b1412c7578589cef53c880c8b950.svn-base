...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationInstitutionDeferredViewController', MstSAVerificationInstitutionDeferredViewController);

    MstSAVerificationInstitutionDeferredViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAVerificationInstitutionDeferredViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationInstitutionDeferredViewController';
        ...
        $scope.back = function () {
            $state.go("app.MstSAVerificationInstitutionDeferredSummary");
        }
        ...
        $scope.uploaddownloadall = function (val1, val2) {
