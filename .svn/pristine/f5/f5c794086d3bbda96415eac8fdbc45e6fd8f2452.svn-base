(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCcCommitteeInstitutionViewController', AgrMstSuprCcCommitteeInstitutionViewController);

    AgrMstSuprCcCommitteeInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', 'DownloaddocumentService'];

    function AgrMstSuprCcCommitteeInstitutionViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCcCommitteeInstitutionViewController';
