(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditIndividualBureauEditController', AgrTrnSuprCreditIndividualBureauEditController);

    AgrTrnSuprCreditIndividualBureauEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnSuprCreditIndividualBureauEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        ...
        $scope.generateDetails = function () {
            ...
            if (bureauname_name == 'TransUnion') {
                ...
                var url = 'api/AgrSuprBureauAPI/GetTransUnionConsumerCreditInfo';
                lockUI();
                ...
                $scope.html_content = '';
                var url = 'api/AgrSuprBureauAPI/GetHighmarkCreditInfo';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.update_CICUploads = function () {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/UpdateCICUploadIndividual';
            lockUI();
