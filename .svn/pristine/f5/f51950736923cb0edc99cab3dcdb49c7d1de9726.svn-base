(function () {
    ...
    angular
        .module('angle')
        .controller('MstBuyer2CreditStatusView', MstBuyer2CreditStatusView);

    MstBuyer2CreditStatusView.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function MstBuyer2CreditStatusView($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstBuyer2CreditStatusView';
