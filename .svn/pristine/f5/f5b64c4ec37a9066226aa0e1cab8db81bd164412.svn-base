(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationAssignedIndividualViewController', MstSAVerificationAssignedIndividualViewController);

    MstSAVerificationAssignedIndividualViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstSAVerificationAssignedIndividualViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationAssignedIndividualViewController';
        ...
        $scope.back = function () {
            $state.go('app.MstSAVerificationIndividualPending');
        }
