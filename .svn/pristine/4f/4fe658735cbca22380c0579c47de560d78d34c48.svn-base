(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditInstitutionBureauEditController', MstCADCreditInstitutionBureauEditController);

    MstCADCreditInstitutionBureauEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstCADCreditInstitutionBureauEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditInstitutionBureauEditController';
        ...
        $scope.CICUploads_Back = function () {
            $location.url('app/MstCADCreditInstitutionDtlAdd?application_gid=' + $scope.application_gid + '&institution_gid=' + $scope.institution_gid + '&lspage=CADAcceptanceCustomers');               
        }
        ...
        $scope.update_CICUploads = function () {
            ...
            var url = 'api/MstCADCreditAction/UpdateCICUploadInstitution';
            lockUI();
