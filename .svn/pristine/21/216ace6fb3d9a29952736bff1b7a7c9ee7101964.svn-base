(function () {
    ...
    angular
        .module('angle')
        .controller('CADComprehensiveDetailsViewController', CADComprehensiveDetailsViewController);

    CADComprehensiveDetailsViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADComprehensiveDetailsViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADComprehensiveDetailsViewController';        
        ...
        function activate() {
            ...
            var url = 'api/CADProbeAPI/ComprehensiveDetailsView';
