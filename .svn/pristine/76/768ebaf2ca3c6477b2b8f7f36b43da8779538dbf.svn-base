(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualPSLDataFlagEditController', MstCADCreditIndividualPSLDataFlagEditController);

    MstCADCreditIndividualPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADCreditIndividualPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualPSLDataFlagEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstCADCreditIndividualPSLDataFlagAdd?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=CADAcceptanceCustomers');
        }
        ...
        $scope.update_psldata = function () {
            ...
            ($scope.cboTurnover == undefined) || ($scope.cboMSMEClassification == undefined) || ($scope.txtDateofEntity == undefined) || ($scope.rdbmetropolitan == undefined) || ($scope.cboClientDetails == undefined)
                ...
                var url = 'api/MstCADCreditAction/PSLDataFlaggingUpdate';
                lockUI();
