(function () {
    ...
    angular
        .module('angle')
        .controller('CADGSPGSTINAuthenticationViewController', CADGSPGSTINAuthenticationViewController);

    CADGSPGSTINAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADGSPGSTINAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADGSPGSTINAuthenticationViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADAPIVerifications/GSTVerificationViewDetails';
