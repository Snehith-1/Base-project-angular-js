(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADPSLCSAGroupPSLDataFlagEditController', MstCADPSLCSAGroupPSLDataFlagEditController);

        MstCADPSLCSAGroupPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADPSLCSAGroupPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADPSLCSAGroupPSLDataFlagEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstCADPSLCSAGroupPSLDataFlagAdd?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
