(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprApplSubmittedtoCCSummaryController', AgrMstSuprApplSubmittedtoCCSummaryController);

    AgrMstSuprApplSubmittedtoCCSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrMstSuprApplSubmittedtoCCSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprApplSubmittedtoCCSummaryController';
        lockUI();
        activate();
        function activate() {
            var url = 'api/AgrMstSuprApplicationAdd/GetApplSubmittedToCCSummary';
        ...
        $scope.applcreation_view = function (val) {
            $location.url('app/AgrMstSuprApplicationCreationView?application_gid=' + val + '&lstab=ApplSubmittedToCC');
        }
