 (function () {
            ...
            angular
                .module('angle')
                .controller('MstCadConsolidatedSanctionReportController', MstCadConsolidatedSanctionReportController);

            MstCadConsolidatedSanctionReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

            function MstCadConsolidatedSanctionReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
                /* jshint validthis:true */
                var vm = this;
                vm.title = 'MstCadConsolidatedSanctionReportController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationReport/GetConsolidatedSanctionReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
