(function () {
    ...
    angular
        .module('angle')
        .controller('AgrSuprGradingToolAddController', AgrSuprGradingToolAddController);

    AgrSuprGradingToolAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrSuprGradingToolAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrSuprGradingToolAddController';
        ...
        {
            $location.url('app/AgrSuprGradingToolEdit?application2gradingtool_gid=' + val + '&application_gid='+ application_gid );
        }

        $scope.gradingtooldetails_view = function (val) {
            $location.url('app/AgrSuprGradingToolView?application2gradingtool_gid=' + val + '&application_gid=' + application_gid);
        }
