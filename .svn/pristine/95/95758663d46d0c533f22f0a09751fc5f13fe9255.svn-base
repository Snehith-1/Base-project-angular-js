(function () {
    ...
    angular
        .module('angle')
        .controller('PropertyTaxViewController', PropertyTaxViewController);

    PropertyTaxViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function PropertyTaxViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        ...
        function activate() {
            ...
            var url = 'api/MstAPIVerifications/PropertyTaxViewDetails';
