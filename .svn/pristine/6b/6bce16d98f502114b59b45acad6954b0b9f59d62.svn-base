...
namespace ems.master.Models
{
    public static class getMenuClass
    {
        public const string
             ...
             PhysicalDocument = "CADMGTPYD",
             LSA = "CADMGTLSA",
             ChequeManagement = "CADMGTCMS";
    }
    ...
    { 
        ...
        public string extension_flag { get; set; }
    }
    ...
    public class MdlScannedDocApprovalDetails : result
    {
        public string application_gid { get; set; }
        public string maker_name { get; set; }
        public string checker_name { get; set; }
    ...
    public class tagquery_list
    {
        public string tagquery_gid { get; set; }
    }
    public class getgroupdocumentcheck_list
    {
        public string tagquery_gid { get; set; }
    }
