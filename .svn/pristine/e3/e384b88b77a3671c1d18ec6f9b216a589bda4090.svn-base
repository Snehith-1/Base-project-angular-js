(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadInstitutionViewController', MstCadInstitutionViewController);

    MstCadInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService','cmnfunctionService'];

    function MstCadInstitutionViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadInstitutionViewController';
        ...
        const lspagename = 'MstCadInstitutionView';
        ...
        function activate() {
            ...
            var url = 'api/MstCADApplication/GetCadSocialAndTradeCapital';
        ...
        $scope.bureauinstitution_view = function (institution2bureau_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/GetCadCICInstitutionDtl';
