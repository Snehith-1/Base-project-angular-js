...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAMyApprovalInstitutionDeferredViewController', MstSAMyApprovalInstitutionDeferredViewController);

    MstSAMyApprovalInstitutionDeferredViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAMyApprovalInstitutionDeferredViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAMyApprovalInstitutionDeferredViewController';
