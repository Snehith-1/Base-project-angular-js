...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationMakerIndividualInitiatedController', MstSAVerificationMakerIndividualInitiatedController);

    MstSAVerificationMakerIndividualInitiatedController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSAVerificationMakerIndividualInitiatedController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationMakerIndividualInitiatedController';
        ...
        $scope.back = function () {
            ...
            if (lspage == 'IndividualPending') {
                $location.url('app/MstSAVerificationMakerIndInstSummary');
            }
