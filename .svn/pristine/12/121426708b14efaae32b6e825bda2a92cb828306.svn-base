(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprRMInstitutionViewController', AgrTrnSuprRMInstitutionViewController);

    AgrTrnSuprRMInstitutionViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function AgrTrnSuprRMInstitutionViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprRMInstitutionViewController';
