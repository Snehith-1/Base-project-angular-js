...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This Controllers will provide access to add datas from various stages in Application creation (General, Company, Individual, Overall limit, Product, charges, trade, Bureau & Done)
    /// </summary>
    /// <remarks>Written by Sherin Augusta, Logapriya, Abilash.A, Premchander.K </remarks>


    [RoutePrefix("api/AgrMstApplicationAdd")]
    [Authorize]
    public class AgrMstApplicationAddController : ApiController
    {
        ...
        [ActionName("GetMultipleLoanSubProduct")]
        [HttpPost]
        public HttpResponseMessage GetMultipleLoanSubProduct(MdlMstApplication360 values)
        {
            objMstApplicationAdd.DaGetMultipleLoanSubProduct(values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
       ...
       [ActionName("ImportExcelIndividual")]
        ...
        [ActionName("GetApplCCApprovedSummary")]
        [HttpGet]
        public HttpResponseMessage GetApplCCApprovedSummary()
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstApplicationAdd values = new MdlMstApplicationAdd();
            objMstApplicationAdd.DaGetApplCCApprovedSummary(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("PostInstitutionBank")]
        [HttpPost]
        public HttpResponseMessage PostInstitutionBank(MdlInstitution2BankAcc values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostInstitutionBank(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetInstitutionBankAccDtl()
        {
            ...
            objMstApplicationAdd.DaGetInstitutionBankAccDtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage Institution2bankTmpList(string institution_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlInstitution2BankAcc values = new MdlInstitution2BankAcc();
            objMstApplicationAdd.DaInstitution2bankTmpList(institution_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlInstitution2BankAcc values = new MdlInstitution2BankAcc();
            objMstApplicationAdd.DaEditGetCreditBankAccDtl(institution2bankdtl_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        [HttpPost]
        public HttpResponseMessage UpdateInstitutionBankAccDtl(MdlInstitution2BankAcc values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaUpdateInstitutionBankAccDtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteinstitutionBankAcc(string institution2bankdtl_gid, string institution_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlInstitution2BankAcc values = new MdlInstitution2BankAcc();
            objMstApplicationAdd.DaDeleteinstitutionBankAcc(institution2bankdtl_gid, institution_gid, values, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("Getwarehouseagency")]
        [HttpGet]
        public HttpResponseMessage Getwarehouseagency()
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlcreditorwarehouseagency values = new Mdlcreditorwarehouseagency();
            objMstApplicationAdd.DaGetwarehouseagency(values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("Getcreditor2warehouse")]
        [HttpGet]
        public HttpResponseMessage Getcreditor2warehouse(string creditor_gid)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlcreditor2warehousedtl values = new Mdlcreditor2warehousedtl();
            objMstApplicationAdd.DaGetcreditor2warehouse(creditor_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("PostTrade2WarehouseDetail")]
        [HttpPost]
        public HttpResponseMessage PostTrade2WarehouseDetail(Mdlcreditor2warehouse values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostTrade2WarehouseDetail(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        //Get Warehouse Address List

        [ActionName("GetTrade2WarehouseDetail")]
        [HttpGet]
        public HttpResponseMessage GetTrade2WarehouseDetail()
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlcreditor2warehouse values = new Mdlcreditor2warehouse();
            objMstApplicationAdd.DaGetTrade2WarehouseDetail(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }


        [ActionName("GetTrade2WarehouseTmpDetail")]
        [HttpGet]
        public HttpResponseMessage GetTrade2WarehouseTmpDetail(string application_gid, string application2trade_gid, string tmp_status, string application2loan_gid)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlcreditor2warehouse values = new Mdlcreditor2warehouse();
            objMstApplicationAdd.DaGetTrade2WarehouseTmpDetail(getsessionvalues.employee_gid, application_gid, application2trade_gid, tmp_status, application2loan_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        [ActionName("EditTrade2WarehouseDetail")]
        [HttpGet]
        public HttpResponseMessage EditTrade2WarehouseDetail(string applicationtrade2warehouse_gid)
        {
            Mdlcreditor2warehouse values = new Mdlcreditor2warehouse();
            objMstApplicationAdd.DaEditTrade2WarehouseDetail(applicationtrade2warehouse_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        //Update Warehouse Address Details 

        //[ActionName("UpdateTrade2WarehouseDetail")]
        //[HttpPost]
        //public HttpResponseMessage UpdateTrade2WarehouseDetail(Mdlcreditor2warehouse values)
        //{
        //    string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
        //    getsessionvalues = Objgetgid.gettokenvalues(token);
        //    objMstApplicationAdd.DaUpdateTrade2WarehouseDetail(getsessionvalues.employee_gid, values);
        //    return Request.CreateResponse(HttpStatusCode.OK, values);
        //}

        //Delete Warehouse Address Details 

        [ActionName("DeleteTrade2WarehouseDetail")]
        [HttpGet]
        public HttpResponseMessage DeleteTrade2WarehouseDetail(string applicationtrade2warehouse_gid)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlcreditor2warehouse values = new Mdlcreditor2warehouse();
            objMstApplicationAdd.DaDeleteTrade2WarehouseDetail(applicationtrade2warehouse_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        [HttpPost]
        public HttpResponseMessage PostIndividualBank(Mdlindividual2bankacc values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostIndividualBank(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetIndividualBankAccDtl()
        {
            ...
            objMstApplicationAdd.DaGetIndividualBankAccDtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage Individual2bankTmpList(string contact_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlindividual2bankacc values = new Mdlindividual2bankacc();
            objMstApplicationAdd.DaIndividual2bankTmpList(contact_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("UpdateIndividualBankAccDtl")]
        [HttpPost]
        public HttpResponseMessage UpdateIndividualBankAccDtl(Mdlindividual2bankacc values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaUpdateIndividualBankAccDtl(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteindividualBankAcc(string contact2bankdtl_gid, string contact_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Mdlindividual2bankacc values = new Mdlindividual2bankacc();
            objMstApplicationAdd.DaDeleteIndividualBankAcc(contact2bankdtl_gid, contact_gid, values, getsessionvalues.employee_gid);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            Mdlindividual2bankacc values = new Mdlindividual2bankacc();
            objMstApplicationAdd.DaEditGetIndividualBankAccDtl(contact2bankdtl_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage UpdateGSTHeadOffice(MdlGSTHeadOffice values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaUpdateGSTHeadOffice(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
            }
        ...
        [ActionName("FnKycDcoumentValidation")]
        [HttpGet]
        public HttpResponseMessage FnKycDcoumentValidation(string application_gid)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            Agrupload_list values = new Agrupload_list();
            objMstApplicationAdd.DaFnKycDcoumentValidation(application_gid, getsessionvalues.employee_gid, getsessionvalues.user_gid,  values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
