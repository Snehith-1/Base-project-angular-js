(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditGeneralDtlEditController', AgrTrnSuprCreditGeneralDtlEditController);

    AgrTrnSuprCreditGeneralDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSuprCreditGeneralDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditGeneralDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetApplicationBasicDetailsTempClear';
            SocketService.get(url).then(function (resp) {
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditAppBasicDetail';
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetAppMobileNoList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstmobileno_list = resp.data.mstmobileno_list;
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetAppEmailAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstemailaddress_list = resp.data.mstemailaddress_list;
            });

            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetAppGeneticCodeList';
            SocketService.getparams(url, param).then(function (resp) {
        ...
        $scope.mobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_mobileno == undefined) || ($scope.rdbwhatsapp_mobileno == undefined)) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PostAppMobileNo';
                lockUI();
        ...
        function mobileno_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetAppMobileNoTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstmobileno_list = resp.data.mstmobileno_list;
            });
        }
        ...
        $scope.mobileno_edit = function (application2contact_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditAppMobileNo';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateAppMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.mobileno_delete = function (application2contact_gid) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/DeleteAppMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.emailaddress_add = function () {
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbprimary_emailaddress == undefined)) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PostAppEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function emailaddress_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetAppEmailAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstemailaddress_list = resp.data.mstemailaddress_list;
            });
        }
        ...
        $scope.emailaddress_edit = function (application2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditAppEmailAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateAppEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.emailaddress_delete = function (application2email_gid) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/DeleteAppEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.geneticcode_add = function () {
            if (($scope.cboGeneticCode.geneticcode_name == '') || ($scope.cboGeneticCode.geneticcode_name == undefined) || ($scope.rdbgenetic_status == undefined) || ($scope.txtgenetic_remarks == '')) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/PostAppGeneticCode';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function geneticcode_templist() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/GetAppGeneticCodeTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstgeneticcode_list = resp.data.mstgeneticcode_list;
            });
        }
        ...
        $scope.geneticcode_edit = function (application2geneticcode_gid, application_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditAppGeneticCode';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_geneticcode = function () {
                    ...
                    var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateAppGeneticCode';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.geneticcode_delete = function (application2geneticcode_gid) {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/DeleteAppGeneticCode';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.basicdetail_update = function () {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateAppBasicDetail';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
                    ...
                    if (lspage == "StartCreditUnderwriting") {
                        $location.url('app/AgrTrnSuprStartCreditUnderwriting?application_gid=' + application_gid + '&lspage=' + lspage + '&product_gid=' + product_gid + '&variety_gid=' + variety_gid);
                    }
                    else if (lspage == "CADApplicationEdit") {
                        $location.url('app/AgrTrnSuprCADApplicationEdit?application_gid=' + application_gid + '&lspage=' + lspage + '&product_gid=' + product_gid + '&variety_gid=' + variety_gid);
                    }
