(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnScannedDeferralHistory', AgrTrnScannedDeferralHistory);

        AgrTrnScannedDeferralHistory.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function AgrTrnScannedDeferralHistory($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnScannedDeferralHistory';
