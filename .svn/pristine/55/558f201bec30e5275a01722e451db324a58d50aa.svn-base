...
{
    public class DaMstHRLoanApprovalsRejected
{
        ...
        public void DaGetHRloanApprovalSummary(MdlMstHRLoanApprovalsRejected values, string user_gid, string employee_gid, string request_gid)
        {
            ...
            var getApprovalsummary = new List<RejectedApprovalsummary>();
            if (dt_datatable.Rows.Count != 0)
            {
                foreach (DataRow dt in dt_datatable.Rows)
                {

                    getApprovalsummary.Add(new RejectedApprovalsummary
                    {
                    ...
                    values.RejectedApprovalsummary = getApprovalsummary;
                }
            }
            dt_datatable.Dispose();
        }
        public void DaGetHRloanRequestDetails(MdlMstHRLoanApprovalsRejected values, string user_gid, string employee_gid)
        {
            ...
            var gethrequestList = new List<Rejectedrequestsummary>();
            if (dt_datatable.Rows.Count != 0)
            {
                foreach (DataRow dt in dt_datatable.Rows)
                {

                    gethrequestList.Add(new Rejectedrequestsummary
                    {
                        request_gid = dt["request_gid"].ToString(),
                    ...
                    values.Rejectedrequestsummary = gethrequestList;
                }
            }
            dt_datatable.Dispose();
        }
        public void DaGetHRloanHRheadRequestDetails(MdlMstHRLoanApprovalsRejected values, string user_gid, string employee_gid)
        {
        ...
        public void DaGetHRloanRequestviewDetails(Rejectedrequestsummary values, string user_gid, string employee_gid,string request_gid)
        {
        ...
        public void DaGetEmployeeDetails(MdlMstHRLoanApprovalsRejected objHRLoanRequest, string employee_gid)
        {
            try
            {
