(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditIndividualPSLDataFlagAddController', AgrTrnCreditIndividualPSLDataFlagAddController);

    AgrTrnCreditIndividualPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnCreditIndividualPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditIndividualPSLDataFlagAddController';
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/AgrTrnCreditIndividualPSLDataFlagEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage);
        }
        //KYC API
