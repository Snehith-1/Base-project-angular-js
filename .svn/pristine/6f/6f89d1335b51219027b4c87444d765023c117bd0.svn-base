...
/// <summary>
/// (It's used for Buyer Master) Buyer DataAccess Class accessed by API methods from related Controller class and is returning relevant response to client.
/// </summary>
/// <remarks>Written by Sumala,Logapriya and Abilash</remarks>

namespace ems.master.DataAccess
{
    public class DaMstBuyer
    {
        dbconn objdbconn = new dbconn();
        cmnfunctions objcmnfunctions = new cmnfunctions();
        OdbcDataReader objODBCDatareader, objreader;
        DataTable dt_datatable, dt_table;
        string msSQL, msGetGid, msGetGid1, msGetGidREF, lspath, lsemployeeGID, msGetAPICode;
        ...
        {
            msSQL = "select buyer2mobileno_gid from ocs_mst_tbuyer2mobileno where buyer_gid='" + employee_gid + "' and primary_mobileno='Yes'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select buyer2mobileno_gid from ocs_mst_tbuyer2mobileno where buyer_gid='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msSQL = "select buyer2address_gid from ocs_mst_tbuyer2address where buyer_gid='" + employee_gid + "'";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            ...
            msGetGid = objcmnfunctions.GetMasterGID("BB");
            msGetAPICode = objcmnfunctions.GetApiMasterGID("BUYM");
            msGetGidREF = objcmnfunctions.GetMasterGID("BBCH_");
        ...
        {
            msSQL = " select buyer_gid,api_code,buyer_code,buyer_name,date_format(created_date,'%d-%m-%Y %h:%i %p') as created_date," +
