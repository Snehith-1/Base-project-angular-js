...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstApplcreationBasicdtlEditController', MstApplcreationBasicdtlEditController);

    MstApplcreationBasicdtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstApplcreationBasicdtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstApplcreationBasicdtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationEdit/GetAppMobileNoList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstmobileno_list = resp.data.mstmobileno_list;
            });

            var url = 'api/MstApplicationEdit/GetAppEmailAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstemailaddress_list = resp.data.mstemailaddress_list;
            });

            var url = 'api/MstApplicationEdit/GetAppGeneticCodeList';
            SocketService.getparams(url, param).then(function (resp) {
        ...
        $scope.mobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimary_mobileno == undefined) || ($scope.rdbwhatsapp_mobileno == undefined) || ($scope.rdbprimary_mobileno == '') || ($scope.rdbwhatsapp_mobileno == '')) {
                ...
                var url = 'api/MstApplicationEdit/PostAppMobileNo';
                lockUI();
        ...
        function mobileno_templist() {
            ...
            var url = 'api/MstApplicationEdit/GetAppMobileNoTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstmobileno_list = resp.data.mstmobileno_list;
            });
        }
        ...
        function Tempproductdetaillist() {
            ...
            var url = 'api/MstApplicationEdit/GetAppProductTempList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstproduct_list = resp.data.mstproduct_list;
            });
        }
        ...
        $scope.mobileno_edit = function (application2contact_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstApplicationEdit/EditAppMobileNo';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/MstApplicationEdit/UpdateAppMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.mobileno_delete = function (application2contact_gid) {
            ...
            var url = 'api/MstApplicationEdit/DeleteAppMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.product_delete = function (application2product_gid) {
            ...
            var url = 'api/MstApplicationEdit/DeleteAppProductDtl';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.emailaddress_add = function () {
            if (($scope.txtemail_address == undefined) || ($scope.txtemail_address == '') || ($scope.rdbprimary_emailaddress == undefined) || ($scope.rdbprimary_emailaddress == '')) {
                ...
                var url = 'api/MstApplicationEdit/PostAppEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function emailaddress_templist() {
            ...
            var url = 'api/MstApplicationEdit/GetAppEmailAddressTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstemailaddress_list = resp.data.mstemailaddress_list;
            });
        }
        ...
        $scope.emailaddress_edit = function (application2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstApplicationEdit/EditAppEmailAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/MstApplicationEdit/UpdateAppEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.emailaddress_delete = function (application2email_gid) {
            ...
            var url = 'api/MstApplicationEdit/DeleteAppEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.geneticcode_add = function () {
            if (($scope.cboGeneticCode.geneticcode_name == '') || ($scope.cboGeneticCode.geneticcode_name == undefined) || ($scope.rdbgenetic_status == undefined) || ($scope.txtgenetic_remarks == '')) {
                ...
                var url = 'api/MstApplicationEdit/PostAppGeneticCode';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function geneticcode_templist() {
            ...
            var url = 'api/MstApplicationEdit/GetAppGeneticCodeTempList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstgeneticcode_list = resp.data.mstgeneticcode_list;
            });
        }
        ...
        $scope.geneticcode_edit = function (application2geneticcode_gid, application_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstApplicationEdit/EditAppGeneticCode';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_geneticcode = function () {
                    ...
                    var url = 'api/MstApplicationEdit/UpdateAppGeneticCode';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.geneticcode_delete = function (application2geneticcode_gid) {
            ...
            var url = 'api/MstApplicationEdit/DeleteAppGeneticCode';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.basicdetail_update = function () {
            ...
            if (($scope.cboVernacularLanguage == undefined) || ($scope.cboVernacularLanguage == '' ) || ($scope.cboVernacularLanguage == null )) {
                ...
                var url = 'api/MstApplicationEdit/UpdateAppBasicDetail';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
