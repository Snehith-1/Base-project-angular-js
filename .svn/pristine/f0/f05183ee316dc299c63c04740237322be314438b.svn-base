(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprApplicationCreationRMApprovalController', AgrMstSuprApplicationCreationRMApprovalController);

    AgrMstSuprApplicationCreationRMApprovalController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrMstSuprApplicationCreationRMApprovalController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprApplicationCreationRMApprovalController';
