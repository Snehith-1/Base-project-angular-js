(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditInstitutionDtlEditController', AgrTrnCreditInstitutionDtlEditController);

    AgrTrnCreditInstitutionDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnCreditInstitutionDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditInstitutionDtlEditController ';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/GetIntitutionTempClear';
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionGSTList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutiongst_list = resp.data.mstgst_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionMobileNoList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionmobileno_list = resp.data.mstmobileno_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionEmailAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionemailaddress_list = resp.data.mstemailaddress_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionAddressList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionaddress_list = resp.data.mstaddress_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionLicenseList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionlicense_list = resp.data.mstlicense_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionDocumentList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionupload_list = resp.data.institutionupload_list;
            });

            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionForm60DocumentList';
            SocketService.getparams(url, param).then(function (resp) {
            ...
            SocketService.getparams(url, param).then(function (resp) {
                ...
                {
                    $scope.txtannual_income_edit = (parseInt($scope.txtrevenue.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountseperator = (parseInt($scope.txtannual_income_edit.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountwords = defaultamountwordschange($scope.lblamountseperator);
                ...
                {
                    $scope.txtannual_income_edit = (parseInt($scope.txtprofit.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountseperator = (parseInt($scope.txtannual_income_edit.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountwords = defaultamountwordschange($scope.lblamountseperator);
                ...
                {
                    $scope.txtannual_income_edit = (parseInt($scope.txtfixed_asset.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountseperator = (parseInt($scope.txtannual_income_edit.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountwords = defaultamountwordschange($scope.lblamountseperator);
                ...
                {
                    $scope.txtannual_income_edit = (parseInt($scope.txtsundrydebt_adv.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountseperator = (parseInt($scope.txtannual_income_edit.replace(/[^\d]+/gi, '')) || 0).toLocaleString('en-IN');
                    $scope.lblamountwords = defaultamountwordschange($scope.lblamountseperator);
            ...
            if ($scope.txtpan_number != undefined && $scope.txtpan_number.length == 10) {
                ...
                SocketService.post(url, params).then(function (resp) {
                    ...
                    if (resp.data.statusCode == 101) {
                        ...
                        var url = 'api/AgrTrnAppCreditUnderWriting/PostInstitutionGSTList';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        function license_list() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionLicenseTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionlicense_list = resp.data.mstlicense_list;
        ...
        function institutiongstlist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionGSTTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutiongst_list = resp.data.mstgst_list;
            });
        }
        ...
        function institutionmobilenolist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionMobileNoTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionmobileno_list = resp.data.mstmobileno_list;
            });
        }
        ...
        function institutionmail_list() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionEmailAddressTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionemailaddress_list = resp.data.mstemailaddress_list;
            });
        }
        ...
        function institutionaddresslist() {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionAddressTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionaddress_list = resp.data.mstaddress_list;
            });
        }
        ...
        $scope.gstnumber_add = function () {
            if (($scope.rdbgstregistered == undefined) || ($scope.rdbgstregistered == '') || ($scope.txtgst_state == undefined) || ($scope.txtgst_state == '') || ($scope.txtgst_number == undefined) || ($scope.txtgst_number == '')) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/PostInstitutionGST';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.edit_gstdetails = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditInstitutionGST';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_gst = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateInstitutionGST';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deletegst_details = function (institution2branch_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteInstitutionGST';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Form60DocumentUpload = function () {
            ...
            if (fi.files.length > 0) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionEditForm_60DocumentUpload';
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    var url = "api/AgrTrnAppCreditUnderWriting/InstitutionEditForm60TmpList";
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.institutionform60upload_list = resp.data.institutionupload_list;
                    });
        ...
        $scope.uploaddocumentform60cancel = function (institution2form60documentupload_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionEditForm_60DocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                var params = {
                    institution_gid: $scope.institution_gid
                }
        ...
        $scope.institutionmobileno_add = function () {
            if (($scope.txtmobile_no == undefined) || ($scope.txtmobile_no == '') || ($scope.rdbprimarymobile_no == undefined) || ($scope.rdbprimarywhatsapp_no == undefined)) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/PostInstitutionMobileNo';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionmobileno_edit = function (institution2mobileno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditInstitutionMobileNo';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateInstitutionMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.institutionmobileno_delete = function (institution2mobileno_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteInstitutionMobileNo';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.institutionmaildetails_add = function () {
            if (($scope.txtinstitution_emailaddress == undefined) || ($scope.txtinstitution_emailaddress == '') || ($scope.rdbemailprimarymobile_no == undefined)) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/PostInstitutionEmailAddress';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.institutionemailaddress_edit = function (institution2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditInstitutionEmailAddress';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateInstitutionEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.institutionmaildetails_delete = function (institution2email_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteInstitutionEmailAddress';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addaddress = function () {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                $scope.addressSubmit = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/PostInstitutionAddressDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.editinstitution_address = function (institution2address_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditInstitutionAddressDetail';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_address = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateInstitutionAddressDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteinstitution_address = function (institution2address_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteInstitutionAddressDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.institutionDoc_upload = function () {
            ...
            if ($scope.uploadfrm != undefined) {
                lockUI();
                var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionEditDocumentUpload';
        ...
        $scope.upload_documentcancel = function (institution2documentupload_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/InstitutionEditDocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                var params = {
                    institution_gid: $scope.institution_gid
                }
        ...
        $scope.licensetype_add = function () {
            ...
            if (($scope.cboLicenseType.licensetype_name == '') || ($scope.cboLicenseType.licensetype_name == undefined) || ($scope.txtnumber == '') || ($scope.txtnumber == undefined) || ($scope.txtissue_date == '') || ($scope.txtissue_date == undefined) || ($scope.txtexpiry_date == '') || ($scope.txtexpiry_date == undefined)) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/PostInstitutionLicenseDetail';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.editinstitution_licensetype = function (institution2licensedtl_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/EditInstitutionLicenseDetail';
                SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.update_licensetype = function () {
                    ...
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateInstitutionLicenseDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.deleteinstitution_licensetype = function (institution2licensedtl_gid) {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/DeleteInstitutionLicenseDetail';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.update_institutiondtl = function () {
            ...
            //else
                ...
                var url = 'api/AgrTrnAppCreditUnderWriting/UpdateInstitutionDtl';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.add_creditbankacctdtl = function () {
            ...
            ($scope.cboAccountType == undefined) || ($scope.cboAccountType == '') || ($scope.rdbJoint_Account == undefined) || ($scope.rdbJoint_Account == '') ||
                ($scope.rdbCheque_Book == undefined) || ($scope.rdbCheque_Book == '' || ($scope.txtBranch_Name == undefined) || ($scope.txtBranch_Name == '') || ($scope.txtBank_Address == '')
        ...
        $scope.headoffice_confirm = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                $scope.headoffice_submit = function () {
                    ...
                    lockUI();
                    var url = 'api/AgrTrnAppCreditUnderWriting/UpdateGSTHeadOffice';
                    SocketService.post(url, params).then(function (resp) {
                        if (resp.data.status == true) {
                            unlockUI();
                            Notify.alert(resp.data.message, {
