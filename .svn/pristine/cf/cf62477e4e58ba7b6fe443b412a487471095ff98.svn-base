...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSBAIndividualFinalApprovalController', MstSBAIndividualFinalApprovalController);

    MstSBAIndividualFinalApprovalController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSBAIndividualFinalApprovalController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSBAIndividualFinalApprovalController';
        ...
        $scope.download_allcredit = function (val1, val2) {
