...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This Controllers will provide access to add and edit records for grading tool icon in the Application & Credit stage.
    /// </summary>
    /// <remarks>Written by Abilash.A </remarks>

    [RoutePrefix("api/AgrMstApplicationGradingTool")]
    [Authorize]
    public class AgrMstApplicationGradingToolController : ApiController
    {
        DaAgrMstApplicationGradingTool objAgrMstApplicationGrade = new DaAgrMstApplicationGradingTool();
