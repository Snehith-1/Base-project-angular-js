...
{
    /// <summary>
    /// This DataAccess will provide access to add and edit records for grading tool icon in the Application & Credit stage.
    /// </summary>
    /// <remarks>Written by Abilash.A </remarks>
    public class DaAgrMstApplicationGradingTool
    {
        ...
        public void DaSubmitGradingassesment(string employee_gid, Mdlgradingtool values)
        {
            ...
            msSQL = " insert into agr_mst_tapplication2gradingassessmentcriteria(" +
            ...
            for (var i = 0; i < values.gradingtool_list.Count; i++)
            {
                ...
                msSQL = "Insert into agr_mst_tassessmentcriteria2dropdown( " +
        ...
        public void DaEditAssessmentCriteriaDetails(string application2gradingassesment_gid, Mdlgradingtool values)
        {
            msSQL = " SELECT a.application2gradingassesment_gid,a.application2gradingtool_gid,a.assessmentcriteria,a.maximumscored,a.actualscored,a.assessmentcriteria_in,a.assessmentcriteria_ingrade,a.shareholdermale_in,a.shareholderfemale_in,a.bodmale_in,a.bodfemale_in," +
                    " (select group_concat(distinct assessmentcriteria_name) as assessmentcriteria_name  from agr_mst_tassessmentcriteria2dropdown d " +
                    " where d.application2gradingassesment_gid = a.application2gradingassesment_gid ) as assessmentcriteria_name FROM agr_mst_tapplication2gradingassessmentcriteria a where a.application2gradingassesment_gid='" + application2gradingassesment_gid + "' ";
            ...
            msSQL = " select assessmentcriteria2dropdown_gid,assessmentcriteria_gid,assessmentcriteria_name, application2gradingassesment_gid from agr_mst_tassessmentcriteria2dropdown " +
            ...
            msSQL = " SELECT assessmentcriteria_gid,assessmentcriteria_name from agr_mst_tassessmentcriteria where status='Y'";
            dt_datatable = objdbconn.GetDataTable(msSQL);
        ...
        public void DaUpdateAssessmentCriteriaDetails(string employee_gid, Mdlgradingtool values)
        {
            ...
            msSQL = "select application2gradingassesment_gid from agr_mst_tassessmentcriteria2dropdown where application2gradingassesment_gid='" + values.application2gradingassesment_gid + "'";
            msSQL += " and assessmentcriteria_gid not in " + mspSQL.TrimEnd(',') + "";
            msSQL += ")";

            dt_datatable = objdbconn.GetDataTable(msSQL);

            msSQL = " update agr_mst_tapplication2gradingassessmentcriteria set " +
         ...
         " actualscored='" + values.actual_score + "',";
            ...
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = " delete from agr_mst_tassessmentcriteria2dropdown where application2gradingassesment_gid ='" + values.application2gradingassesment_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
                for (var i = 0; i < values.gradingtool_list.Count; i++)
                {
        ...
        {
            msSQL = "delete from agr_mst_tapplication2gradingassessmentcriteria where application2gradingassesment_gid='" + application2gradingassesment_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        public void DaSaveasDraftGradingToolDetails(string employee_gid, Mdlgeographicdetails values)
        {
            ...
            msSQL = "insert into agr_mst_tapplication2gradingtool (" +
                    " application2gradingtool_gid," +
                    " application_gid," +
                    " dateofsurvey," +
                    " overallfporating," +
            ...
            msSQL = "update agr_mst_tapplication2gradingassessmentcriteria set application2gradingtool_gid ='" + msGetGid + "' where application2gradingtool_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msGetGid1 = objcmnfunctions.GetMasterGID("A2GD");
            msSQL = " insert into agr_mst_tapplication2geographic(" +
        ...
        {
            msSQL = "select date_format(dateofsurvey,'%d-%m-%Y') as dateofsurvey from agr_mst_tapplication2gradingtool where application2gradingtool_gid='" + values.application2gradingtool_gid + "'";
            ...
            msSQL = " update agr_mst_tapplication2gradingtool set ";
            if (values.dateofsurvey == null || values.dateofsurvey == "")
            {
            ...
            msSQL = "update agr_mst_tapplication2gradingassessmentcriteria set application2gradingtool_gid ='" + values.application2gradingtool_gid + "' where application2gradingtool_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);

            msSQL = " update agr_mst_tapplication2geographic set " +
        ...
        {
            msSQL = "select application2gradingtool_gid from agr_mst_tapplication2gradingassessmentcriteria where application2gradingtool_gid='" + employee_gid + "' or application2gradingtool_gid ='" + values.application2gradingtool_gid + "'";
            ...
            msSQL = "select application2gradingtool_gid from agr_mst_tapplication2gradingtool where application2gradingtool_gid='" + values.application2gradingtool_gid + "'";
            ...
            msSQL = "select application2gradingtool_gid from agr_mst_tapplication2geographic where application2gradingtool_gid='" + values.application2gradingtool_gid + "'";
        ...
        public void DaDeleteGradingToolDetails(string application2gradingassesment_gid, Mdlgradingtool values)
        {
            msSQL = "delete from agr_mst_tapplication2gradingassessmentcriteria where application2gradingassesment_gid='" + application2gradingassesment_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            msSQL = "delete from agr_mst_tassessmentcriteria2dropdown where application2gradingassesment_gid='" + application2gradingassesment_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
            if (mnResult != 0)
            {
        ...
        {
            msSQL = "select application2gradingassesment_gid from agr_mst_tapplication2gradingassessmentcriteria where application2gradingtool_gid='" + employee_gid + "' ";
            objODBCDatareader = objdbconn.GetDataReader(msSQL);
            if (objODBCDatareader.HasRows == true)
            {
                msSQL = "delete from agr_mst_tassessmentcriteria2dropdown where application2gradingassesment_gid ='" + objODBCDatareader["application2gradingassesment_gid"].ToString() + "'";
                mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
                objODBCDatareader.Close();
            }
            else
            ...
            msSQL = "delete from agr_mst_tapplication2gradingassessmentcriteria where application2gradingtool_gid='" + employee_gid + "'";
            mnResult = objdbconn.ExecuteNonQuerySQL(msSQL);
