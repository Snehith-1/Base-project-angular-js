(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCreditAssessedScoreViewController', AgrMstSuprCreditAssessedScoreViewController);

    AgrMstSuprCreditAssessedScoreViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];


    function AgrMstSuprCreditAssessedScoreViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCreditAssessedScoreViewController';
