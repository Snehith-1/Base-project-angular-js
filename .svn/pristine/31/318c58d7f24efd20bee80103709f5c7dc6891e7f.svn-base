(function () {
    ...
    angular
        .module('angle')
        .controller('MstTeleCallingFollowupCallController', MstTeleCallingFollowupCallController);

    MstTeleCallingFollowupCallController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams', 'cmnfunctionService'];

    function MstTeleCallingFollowupCallController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstTeleCallingFollowupCallController';
        activate();
        lockUI();
        function activate() {
            var url = 'api/TeleCalling/GetFollowUpIBCallSummary';
        ...
        $scope.view = function (inboundcall_gid) {
            $location.url('app/MstTeleCallingFollowupCallView?hash=' + cmnfunctionService.encryptURL('inboundcall_gid=' + inboundcall_gid));
        }
