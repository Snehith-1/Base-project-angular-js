(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADPSLCSAIndividualPSLDataFlagEditController', MstCADPSLCSAIndividualPSLDataFlagEditController);

        MstCADPSLCSAIndividualPSLDataFlagEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCADPSLCSAIndividualPSLDataFlagEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADPSLCSAIndividualPSLDataFlagEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstCADPSLCSAIndividualPSLDataFlagAdd?application_gid=' + application_gid + '&credit_gid=' + contact_gid + '&lspage=' + lspage);
        }
