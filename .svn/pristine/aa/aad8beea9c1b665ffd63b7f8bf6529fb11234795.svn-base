(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadConsolidatedSoftcopyVettingReportController', MstCadConsolidatedSoftcopyVettingReportController);

    MstCadConsolidatedSoftcopyVettingReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCadConsolidatedSoftcopyVettingReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadConsolidatedSoftcopyVettingReportController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationReport/GetConsolidatedSoftcopyVettingReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
