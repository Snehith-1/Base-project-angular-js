...
namespace ems.mastersamagro.Models
{
    ...
    /// <summary>
    /// This Models will store values to view datas from various stages in Application creation (General, Company, Individual, Overall limit, Product, charges, trade, Bureau & Done)
    /// </summary>
    ...
    public class MdlMstApplicationView : result
    {
        ...
        public string buyeronboard_gid { get; set; }
        public string onboarding_status { get; set; }
        public string document_status { get; set; }
        public string process_type { get; set; }
        public string shortclosing_reason { get; set; }
        public string amendment_remarks { get; set; }
        public string lblbusinessapproved_date { get; set; }
    ...
    public class MdlMstInstitutionDtlView : result
    {
        ...
        public List<Institutioncicdoc_list> Institutioncicdoc_list { get; set; }
    }
    ...
    public class Institutioncicdoc_list : result
    {
        public string cicdocument_name { get; set; }
        public string cicdocument_path { get; set; }
        public string institution2bureau_gid { get; set; }
        public string institution2cicdocumentupload_gid { get; set; }
    }
    ...
    public class MdlMstIndividualDtlView : result
    {
        ...
        public List<Individualcicdoc_list> Individualcicdoc_list { get; set; }
    }
    ...
    public class mstproductdtl_list
    {
        ...
        public string sector_flag { get; set; }
        public string variety_flag { get; set; }
    }
    ...
    public class Individualcicdoc_list
    {
        public string cicdocument_name { get; set; }
        public string cicdocument_path { get; set; }
        public string cicindividualdocument_name { get; set; }
        public string cicindividualdocument_path { get; set; }
        public string contact2bureau_gid { get; set; }
        public string individual2cicdocumentupload_gid { get; set; }
    }
