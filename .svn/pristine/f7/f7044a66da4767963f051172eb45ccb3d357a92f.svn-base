...
/// <summary>
///(It's used for Business Approval in Samfin)ApplicationApproval Model Class accessed by API methods from related DataAccess class and is returning relevant response to client.
/// </summary>
...
namespace ems.master.Models
{
    ...
    public class businessApplicationCount : result
    {
        ...
        public string rejectedapplication_count { get; set; }
        public string holdapplication_count { get; set; }
