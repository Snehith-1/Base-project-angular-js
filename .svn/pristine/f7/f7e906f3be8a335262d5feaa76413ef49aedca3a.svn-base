(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupBankStatementAnalysisAddController', MstCreditGroupBankStatementAnalysisAddController);

    MstCreditGroupBankStatementAnalysisAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', '$resource', 'DownloaddocumentService'];

    function MstCreditGroupBankStatementAnalysisAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, $resource, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupBankStatementAnalysisAddController';
        ...
        $scope.uploadExcel = function () { 
            if ($scope.fileinputvalue == '' || $scope.fileinputvalue == undefined || $scope.fileinputvalue == null) {
                ...
                var url = 'api/MstAppCreditUnderWriting/ImportExcelBankStatement';
                lockUI();
        ...
        $scope.export_excel = function () { 
            ...
            lockUI();
            var url = 'api/MstAppCreditUnderWriting/BankStatementExportExcel';
