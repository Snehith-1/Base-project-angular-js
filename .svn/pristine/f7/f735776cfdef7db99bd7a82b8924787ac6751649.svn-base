(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprVisitReportViewController', AgrMstSuprVisitReportViewController);

    AgrMstSuprVisitReportViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];


    function AgrMstSuprVisitReportViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprVisitReportViewController';
        ...
        $scope.Back = function () {
            $location.url('app/AgrMstSuprVisitReportAdd?visitreport_gid=' + applicationvisit_gid + '&?&application_gid=' + application_gid);
        }
