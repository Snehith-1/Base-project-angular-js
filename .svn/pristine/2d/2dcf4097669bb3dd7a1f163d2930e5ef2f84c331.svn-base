...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationCheckerInstitutionInitiatedViewController', MstSAVerificationCheckerInstitutionInitiatedViewController);

    MstSAVerificationCheckerInstitutionInitiatedViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSAVerificationCheckerInstitutionInitiatedViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationCheckerInstitutionInitiatedViewController';
