(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprPhysicalDeferralHistoryController', AgrTrnSuprPhysicalDeferralHistoryController);

        AgrTrnSuprPhysicalDeferralHistoryController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function AgrTrnSuprPhysicalDeferralHistoryController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprPhysicalDeferralHistoryController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnSuprPhysicalDocument/GetDeferralHistorySummary';
        ...
        $scope.deferraldoc_view = function (deferraltagdoc_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrTrnSuprPhysicalDocument/GettaggedHistoryDeferralinfo';
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
