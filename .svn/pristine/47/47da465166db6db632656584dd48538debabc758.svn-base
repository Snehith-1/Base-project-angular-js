(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCreditAssessedScoreViewController', AgrMstCreditAssessedScoreViewController);

    AgrMstCreditAssessedScoreViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];


    function AgrMstCreditAssessedScoreViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCreditAssessedScoreViewController';
