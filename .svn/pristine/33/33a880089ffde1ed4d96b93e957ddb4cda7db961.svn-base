...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationIndividualDeferredViewController', MstSAVerificationIndividualDeferredViewController);

    MstSAVerificationIndividualDeferredViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstSAVerificationIndividualDeferredViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationIndividualDeferredViewController';
        ...
        $scope.back = function () {
            ...
            $state.go("app.MstSAVerificationIndividualDeferredSummary");
        }
