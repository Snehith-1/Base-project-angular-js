(function () {
    ...
    angular
        .module('angle')
        .controller('MstPSLCSAIndividualPSLDataFlagAddController', MstPSLCSAIndividualPSLDataFlagAddController);

        MstPSLCSAIndividualPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function MstPSLCSAIndividualPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPSLCSAIndividualPSLDataFlagAddController';
        $scope.contact_gid = $location.search().credit_gid;
        ...
        $scope.Back = function () {
            if (lspage == "PSLCSAGuarantor") {
                $location.url('app/MstPSLCSAGuarantorDetails?application_gid=' + application_gid + '&lspage=' + lspage);
            }
        ...
        $scope.Edit_psldataflag = function () {
            $location.url('app/MstPSLCSAIndividualPSLDataFlagEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage);
        }
        //KYC API
