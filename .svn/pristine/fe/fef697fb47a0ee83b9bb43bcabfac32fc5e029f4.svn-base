...
namespace ems.mastersamagro.Controllers
{
    ...
    /// <summary>
    /// This controllers provide access to supplier cheque management flow
    /// </summary>
    /// <remarks>Written by Praveen Raj.R </remarks>

    [RoutePrefix("api/AgrSuprUdcManagement")]
    [Authorize]

    public class AgrSuprUdcManagementController : ApiController
    {


            DaAgrSuprUdcManagement objDaAgrUdcManagement = new DaAgrSuprUdcManagement();
