...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAVerificationCheckerIndividualInitiatedViewController', MstSAVerificationCheckerIndividualInitiatedViewController);

    MstSAVerificationCheckerIndividualInitiatedViewController.$inject = ['DownloaddocumentService', '$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSAVerificationCheckerIndividualInitiatedViewController(DownloaddocumentService, $rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAVerificationCheckerIndividualInitiatedViewController';
