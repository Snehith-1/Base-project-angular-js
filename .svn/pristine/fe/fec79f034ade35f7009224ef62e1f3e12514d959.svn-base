(function () {
    ...
    angular
        .module('angle')
        .controller('MstPSLCSADataFlaggingEditController', MstPSLCSADataFlaggingEditController);

        MstPSLCSADataFlaggingEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstPSLCSADataFlaggingEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPSLCSADataFlaggingEditController';
        ...
        $scope.psldata_Back = function () {
            $location.url('app/MstPSLCSADataFlaggingAdd?application_gid=' + application_gid + '&credit_gid=' + institution_gid + '&lspage=' + lspage);
        }
