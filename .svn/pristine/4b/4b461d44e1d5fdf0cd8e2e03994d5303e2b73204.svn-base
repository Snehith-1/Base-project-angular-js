(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprAppEditOverallLimitAdd', AgrMstSuprAppEditOverallLimitAdd);

    AgrMstSuprAppEditOverallLimitAdd.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrMstSuprAppEditOverallLimitAdd($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprAppEditOverallLimitAdd';
                ...
                SocketService.post(url, params).then(function (resp) {
                    ...
                    if (resp.data.status == true) {
                        ...
                        if (lstab == 'add') {
                            ...
                            $location.url('app/AgrMstSuprAppEditProductAdd?lsapplication_gid=' + $scope.application_gid + '&lstab=edit');
                        }
                    }
                    else {
                        Notify.alert(resp.data.message, {
