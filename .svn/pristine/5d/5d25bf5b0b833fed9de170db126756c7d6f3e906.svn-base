...
{
    /// <summary>
    ///To upload IDFC Statement it digitize the LMS trnascation to get matched cases
    /// </summary>
    /// <remarks>Written by Motches</remarks>
    public class DaIdfcReconcillation
    {
        ...
        string lstrn_date, lstrndate,lspayment_date, lscustref_no, lsacc_no, lsbranch,lsbankremaining_amount, lsknockoff_status;
        ...
        int lsbalance_column, lsknockofffin_column;
        ...
        public bool DaPostBRSExcelSample(HttpRequest httpRequest, MdlIdfcReconcillation objfilename, string employee_gid, string user_gid)
        {
            ...
            path = ConfigurationManager.AppSettings["file_path"] + "/erpdocument" + "/" + lscompany_code + "/" + "BRS/Idfcreconcildoc/" + DateTime.Now.Year + "/" + DateTime.Now.Month;
            {
            ...
            try
            {
                if (httpRequest.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < httpFileCollection.Count; i++)
                    {
                        ...
                        bool status;
                        status = objcmnstorage.UploadStream("erpdocument", lscompany_code + "/" + "BRS/Idfcreconcildoc/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/" + msdocument_gid + FileExtension, ms);

                        lspath = "erpdocument" + "/" + lscompany_code + "/" + "BRS/Idfcreconcildoc/" + DateTime.Now.Year + "/" + DateTime.Now.Month + "/";
                        file.Close();
                        ms.Close();
                        msxlsx.Close();
                        mscsvxlsx.Close();
            ...
            "from brs_mst_tbankconfiguration where brsbank_gid = '" + lsbank_gid + "' ";
                        ...
                        string[] splits1 = lspayment_daterange.Split(',');
                        ...
                        //    lscustref_norow = (lscustref_norow == 0) ? 1 : Convert.ToInt32(splits7[0]);
                        //lscustref_nocolumn = (lsbranch_namerow + ',' + lsbranch_namerow == 0) ? lsbranch_namerow.ToString() + ',' + lsbranch_namerow : "";
                        //lsacc_no = (lsacc_norow + ',' + lsacc_norow == 0) ? lsacc_norow.ToString() + ',' + lsacc_norow : "";
                        ////lscustref_no = (lscustref_nocolumn + ',' + lscustref_nocolumn == 0) ? lscustref_nocolumn.ToString() + ',' + lscustref_nocolumn : "";
                        //lsbranch = (lsbranch_namecolumn + ',' + lsbranch_namecolumn == 0) ? lsbranch_namecolumn.ToString() + ',' + lsbranch_namecolumn : "";
                        //lsacc_no = (lsacc_nocolumn + ',' + lsacc_nocolumn == 0) ? lsacc_nocolumn.ToString() + ',' + lsacc_nocolumn : "";
...

                        {
                         ...
                         lspayment_datecolumn = Convert.ToInt32(splits1[1]);
                            ...
                            if (worksheet.Cells[decsc_row, lstrn_datecolumn].Value != null)
                            {
                                ...
                                if (worksheet.Cells[decsc_row, lstrn_datecolumn].Value != null)
                                {
                                    if ((!string.IsNullOrWhiteSpace(worksheet.Cells[decsc_row, lstrn_datecolumn].Value.ToString()) || (worksheet.Cells[decsc_row, lstrn_datecolumn].Value.ToString() != "")))
                                    {
                                        ...
                                        //string lstrn_date1 = worksheet.Cells[decsc_row, lstrn_datecolumn].Value.ToString();
                                        ...
                                        {
                                            lstrn_date = objcmnfunctions.GetDateFormat(lstrn_date1);
                                            //DateTime date = DateTime.ParseExact(lstrn_date1, "d/M/yyyy hh:mm:ss", CultureInfo.InvariantCulture);
                                ...
                                {
                                    if ((!string.IsNullOrWhiteSpace(worksheet.Cells[decsc_row, lscredit_amtcolumn].Value.ToString()) || (worksheet.Cells[decsc_row, lscredit_amtcolumn].Value.ToString() != "")))
                                    {
                                ...
                                {
                                    if ((!string.IsNullOrWhiteSpace(worksheet.Cells[decsc_row, lsdebit_amtcolumn].Value.ToString()) || (worksheet.Cells[decsc_row, lsdebit_amtcolumn].Value.ToString() != "")))
                                    {
                                ...
                                if (worksheet.Cells[decsc_row, lspayment_datecolumn].Value != null)
                                {
                                    if ((!string.IsNullOrWhiteSpace(worksheet.Cells[decsc_row, lspayment_datecolumn].Value.ToString()) || (worksheet.Cells[decsc_row, lspayment_datecolumn].Value.ToString() != "")))
                                    {
                                        //string lspayment_date1 = worksheet.Cells[decsc_row, lspayment_datecolumn].Value.ToString();
                                        //lspayment_date = Convert.ToDateTime(lspayment_date1).ToString("yyyy-MM-dd HH:mm:ss");
                                        string lspayment_date1 = worksheet.Cells[decsc_row, lspayment_datecolumn].Value.ToString();
                                        try
                                        {
                                            //lspayment_date = Convert.ToDateTime(lspayment_date1).ToString("yyyy-MM-dd HH:mm:ss");
                                            lspayment_date = objcmnfunctions.GetDateFormat(lspayment_date1);
                                        }
                                        catch
                                        {
                                            lspayment_date = objcmnfunctions.GetDateFormat(lspayment_date1);
                                            //DateTime date = DateTime.ParseExact(lspayment_date1, "d/M/yyyy", CultureInfo.InvariantCulture);
                                            //lspayment_date = Convert.ToDateTime(date).ToString("yyyy-MM-dd HH:mm:ss");
                                        }
                                    }
                                }
                                else
                                ...
                                if (worksheet.Cells[decsc_row, lsdebit_amtcolumn].Value != null)
                                {
                                    if ((!string.IsNullOrWhiteSpace(worksheet.Cells[decsc_row, lsdebit_amtcolumn].Value.ToString()) || (worksheet.Cells[decsc_row, lsdebit_amtcolumn].Value.ToString() != "")))
                                    {
                                        if ((!string.IsNullOrEmpty(lsdebit_amt.Trim())) && ((lsdebit_amt.Trim() != "0.00") && (lsdebit_amt.Trim() != "0")))
                                        {
                                            lsdrcr = "DR";
                                        }
                                        //else
                                ...
                                if (worksheet.Cells[decsc_row, lscredit_amtcolumn].Value != null)
                                {
                                    if ((!string.IsNullOrWhiteSpace(worksheet.Cells[decsc_row, lscredit_amtcolumn].Value.ToString()) || (worksheet.Cells[decsc_row, lscredit_amtcolumn].Value.ToString() != "")))
                                    {
                                        if ((!string.IsNullOrEmpty(lscredit_amt.Trim())) && ((lscredit_amt.Trim() != "0.00") && (lscredit_amt.Trim() != "0")))
                                ...
                                //if (lstransact_particulars== null|| lscredit_amt==null||lsdebit_amt==null
                                //    || lscheqref==null||lsbalance==null||lspayment_date==null)
                                //{
                                //    lstransact_particulars= "";
                                //    lscredit_amt = "";
                                //    lsdebit_amt = "";
