(function () {
    ...
    angular
        .module('angle')
        .controller('CADIECDetailedProfileViewController', CADIECDetailedProfileViewController);

    CADIECDetailedProfileViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADIECDetailedProfileViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADIECDetailedProfileViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADAPIVerifications/IECProfileViewDetails';
