(function () {
    ...
    angular
        .module('angle')
        .controller('MstUDCMakerEditChequeController', MstUDCMakerEditChequeController);

    MstUDCMakerEditChequeController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams', 'DownloaddocumentService'];

    function MstUDCMakerEditChequeController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstUDCMakerEditChequeController';       
        ...
        $scope.update_cheque = function () {
            ...
            var url = 'api/UdcManagement/UpdateChequeDetail';
