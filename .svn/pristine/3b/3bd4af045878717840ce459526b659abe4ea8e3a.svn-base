...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditCompanyAPIController', MstCADCreditCompanyAPIController);

    MstCADCreditCompanyAPIController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService'];

    function MstCADCreditCompanyAPIController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditCompanyAPIController';
        ...
        function activate() {
            ...
            $scope.lsapi_name = $location.search().lsapi_name;
            var url = 'api/MstCADAPIVerifications/GetStateList';
            SocketService.get(url).then(function (resp) {
                unlockUI();
                $scope.mstgst_list = resp.data.mstgst_list;
            });
            var url = 'api/MstCADAPIVerifications/GetGSTList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutiongst_list = resp.data.mstgst_list;
            });
            var url = 'api/CADProbeAPI/GetInstitutionDetails';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/CADProbeAPI/InstitutionProbeList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutionprobe_list = resp.data.institutionprobe_list;
            });
            var url = 'api/CADProbeAPI/InstitutionProbeDocList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutionprobedoc_list = resp.data.institutionprobedoc_list;
            });
            var url = 'api/MstCADAPIVerifications/GetTAN';
            var params = {
            ...
            var url = 'api/MstCADAPIVerifications/GetMCASignature';
            var params = {
                function_gid: institution_gid,
            }           
            SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/MstCADAPIVerifications/GetCompanyLLP';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.cin_list = resp.data.cin_list;
            });
            var url = 'api/MstCADAPIVerifications/GetIECDetailed';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.IECDetailed_list = resp.data.IECDetailed_list;
            });
            var url = 'api/MstCADAPIVerifications/GetFDA';
            ...
            var url = 'api/MstCADAPIVerifications/GetFSSAI';
            ...
            var url = 'api/MstCADAPIVerifications/GetLPGIDList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.LPGID_list = resp.data.LPGID_list;
            });
            var url = 'api/MstCADAPIVerifications/GetShopList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.shop_list = resp.data.shop_list;
            });
            var url = 'api/MstCADAPIVerifications/GetRCAuthAdvancedList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.RCAuthAdvanced_list = resp.data.RCAuthAdvanced_list;
            });
            var url = 'api/MstCADAPIVerifications/GetRCSearchList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.RCSearch_list = resp.data.RCSearch_list;
            });
            var url = 'api/MstCADAPIVerifications/GetPropertyTaxList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/CADCrimeCheckAPI/GetCrimeRecordCompanyDetail';
            ...
            var url = 'api/CADCrimeCheckAPI/GetCompanyReportList';
            SocketService.getparams(url, paramcrime).then(function (resp) {
                unlockUI();
        ...
        $scope.verify_gstverification = function (gst_no, institution2branch_gid)
        {
           ...
           lockUI();
            ...
            var url = 'api/CADKyc/GSTVerification';
        ...
        $scope.verify_gstreturnfilling = function (gst_no, institution2branch_gid) {
            ...
            lockUI();
            var url = 'api/CADKyc/GSPGSTReturnFiling';
            SocketService.post(url, params).then(function (resp) {
        ...
        $scope.verify_gstauthentication = function (gst_no, institution2branch_gid) {
            ...
            var url = 'api/CADKyc/GSTAuthentication';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                list();
       ...
       $scope.returnfillingView = function (institution2branch_gid) {
        ...
        $scope.verify_tan = function (txttan_no)
        {
            if (txttan_no == '' || txttan_no == undefined || txttan_no == null) {
                ...
                var url = 'api/CADKyc/TANauthetication';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        {  
            if ($scope.status == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostTAN';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verify_llp = function (txtllp_no) {
            if (txtllp_no == '' || txtllp_no == undefined || txtllp_no == null) {
                ...
                var url = 'api/CADKyc/CompanyLLP_no';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addllp_no = function () {
            if ($scope.llpstatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostCompanyLLP';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.companyLLPnoView = function (companyllpno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/CompanyLLPViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifymca_sign = function (txtmca_sign) {
            ...
            var url = 'api/CADKyc/mcasignatories';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.addmca_sign = function () {
            ...
            var url = 'api/MstCADAPIVerifications/PostMCASignature';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
        ...
        $scope.mcasignView = function (mcasignatories_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/MCASignatoriesViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifyiec_detailed = function (txtiec_detailed) {
            if (txtiec_detailed == '' || txtiec_detailed == undefined || txtiec_detailed == null) {
                ...
                var url = 'api/CADKyc/IECDetailed';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addiec_detailed = function () {
            ...
            var url = 'api/MstCADAPIVerifications/PostIECDetailed';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.addfssai = function () {
            if ($scope.fssaistatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostFSSAI';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.FSSAIView = function (fssailicenseauthentication_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/FSSAIViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addfda = function () {
            if ($scope.fdastatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostFDA';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.FDAView = function (fdalicenseauthentication_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/FDAViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifylpgid = function (txtlpgid) {
            if (txtlpgid == '' || txtlpgid == undefined || txtlpgid == null) {
                ...
                var url = 'api/CADKyc/LPGIDAuthentication';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addlpgid = function () {
            if ($scope.lpgidstatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostLPGID';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.LPGIDView = function (lpgiddtl_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/LPGIDViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifyshop = function () {
            if ($scope.txtregNo == '' || $scope.txtregNo == undefined || $scope.txtregNo == null) {
                ...
                var url = 'api/CADKyc/ShopAndEstablishment';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addshop = function () {
            if ($scope.shopstatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostShop';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.ShopView = function (shopandestablishment_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/ShopViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifyrcauthadv = function (txtregistrationNumber) {
            if (txtregistrationNumber == '' || txtregistrationNumber == undefined || txtregistrationNumber == null) {
                ...
                var url = 'api/CADKyc/VehicleRCAuthAdvanced';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addrcauthadv = function () {
            if ($scope.rcauthadvstatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostRCAuthAdvanced';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.verifyrcsearch = function () {
            if ($scope.txtengine_no == '' || $scope.txtengine_no == undefined || $scope.txtengine_no == null) {
                ...
                var url = 'api/CADKyc/VehicleRCSearch';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addrcsearch = function () {
            if ($scope.rcsearchstatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostRCSearch';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.RCSearchView = function (vehiclercsearch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADAPIVerifications/RCSearchViewDetails';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifypropertytax = function () {
            if ($scope.txtpropertyNo == '' || $scope.txtpropertyNo == undefined || $scope.txtpropertyNo == null) {
                ...
                var url = 'api/CADKyc/PropertyTax';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addpropertytax = function () {
            if ($scope.propertytaxstatus == 'checked') {
                ...
                var url = 'api/MstCADAPIVerifications/PostPropertyTax';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        $scope.baseDetails = function () {
            var probecompanypan_no = $scope.probecompanypan_no;
                ...
                lockUI();
                var url = 'api/CADProbeAPI/GetBaseDetails';
                SocketService.post(url, params).then(function (resp) {
        ...
        $scope.comprehensiveDetails = function () {
            ...
            var probecompanypan_no = $scope.probecompanypan_no;
                ...
                lockUI();
                var url = 'api/CADProbeAPI/GetComprehensiveDetails';
                SocketService.post(url, params).then(function (resp) {
                    if (resp.data.status == true) {
                        Notify.alert(resp.data.message, {
                            status: 'success',
        ...
        $scope.dataStatus = function () {
            ...
            lockUI();
            var url = 'api/CADProbeAPI/GetDataStatus';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.ProbeDetailsView = function (data) {
            if (data.api_name == "Base Details") {
                ...
                var URL = location.protocol + "//" + location.hostname + "/v1/#/app/CADBaseDetailsView?institutionprobedetails_gid=" + institutionprobedetails_gid;
                window.open(URL, '_blank');
            }
            else if (data.api_name == "Comprehensive Details") {
                var institutionprobedetails_gid = data.institutionprobedetails_gid;              
                var URL = location.protocol + "//" + location.hostname + "/v1/#/app/CADComprehensiveDetailsView?institutionprobedetails_gid=" + institutionprobedetails_gid + "&lsdetail_name=BASICDETAIL";
                window.open(URL, '_blank');
            }
        ...
        function ProbeDataStatusView(institutionprobedetails_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/CADProbeAPI/DataStatusView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.articleOfAssociationDoc = function () {
            ...
            lockUI();
            var url = 'api/CADProbeAPI/GetArticleOfAssociationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.memorandumOfAssociationDoc = function () {
            ...
            lockUI();
            var url = 'api/CADProbeAPI/GetMemorandumOfAssociationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.certificateOfIncorporationDoc = function () {
            ...
            lockUI();
            var url = 'api/CADProbeAPI/GetCertificateOfIncorporationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.mgt7formDoc = function () {
            ...
            lockUI();
            var url = 'api/CADProbeAPI/GetFormMGT7Doc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.aoc4formDoc = function () {
            ...
            lockUI();
            var url = 'api/CADProbeAPI/GetFormAOC4Doc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.tandelete = function (tandtl_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/TANdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.companyLLPnoDelete = function (companyllpno_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/CompanyLLPNodelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.mcasignDelete = function (mcasignatories_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/MCASigndelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.IECdelete = function (iecdtl_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/IECdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.FSSAIdelete = function (fssailicenseauthentication_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/FSSAIdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.FDAdelete = function (fdalicenseauthentication_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/FDAdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.LPGIDdelete = function (lpgiddtl_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/LPGIDdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.Shopdelete = function (shopandestablishment_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/Shopdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.RCAuthAdvanceddelete = function (vehiclercauthadvanced_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/RCAuthAdvanceddelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.RCSearchdelete = function (vehiclercsearch_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/RCSearchdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.PropertyTaxdelete = function (propertytax_gid) {
            ...
            var url = 'api/MstCADAPIVerifications/PropertyTaxdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
    ...
    $scope.raise_crimereportrequest = function () {
        ...
        if($scope.cboaddress == '' || $scope.cboaddress == null || $scope.cboaddress == undefined ) {
            ...
            var url = 'api/CADCrimeCheckAPI/RequestCrimeReportCompany';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
    ...
    $scope.crimereport_view = function (crimereportinstitution_gid) {
        ...
        var URL = location.protocol + "//" + location.hostname + "/v1/#/app/MstCADCrimeReportCompanyView";
        window.open(URL, '_blank');
    }
