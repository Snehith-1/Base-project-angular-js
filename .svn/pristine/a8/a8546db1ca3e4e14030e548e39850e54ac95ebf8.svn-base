(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditGroupPSLDataFlagAddController', AgrTrnCreditGroupPSLDataFlagAddController);

    AgrTrnCreditGroupPSLDataFlagAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnCreditGroupPSLDataFlagAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditGroupPSLDataFlagAddController';
        ...
        $scope.Editpsldataflag = function () {
            $location.url('app/AgrTrnCreditGroupPSLDataFlagEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
