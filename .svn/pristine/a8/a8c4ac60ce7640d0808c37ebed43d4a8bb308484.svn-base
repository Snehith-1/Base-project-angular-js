(function () {
    ...
    angular
        .module('angle')
        .controller('AgrSuprGSPGSTINAuthenticationViewController', AgrSuprGSPGSTINAuthenticationViewController);

    AgrSuprGSPGSTINAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function AgrSuprGSPGSTINAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrSuprGSPGSTINAuthenticationViewController';
