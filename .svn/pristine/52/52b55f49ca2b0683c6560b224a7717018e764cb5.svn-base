(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCcCommitteeIndividualViewController', AgrMstSuprCcCommitteeIndividualViewController);

    AgrMstSuprCcCommitteeIndividualViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'DownloaddocumentService'];

    function AgrMstSuprCcCommitteeIndividualViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCcCommitteeIndividualViewController';
