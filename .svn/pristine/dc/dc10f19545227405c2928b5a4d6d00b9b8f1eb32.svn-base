...
{
    [RoutePrefix("api/CADKycView")]
    [Authorize]

    public class CADKycViewController : ApiController
    {
        DaCADKycView objDaCADKycView = new DaCADKycView();
        ...
        public HttpResponseMessage GetPANAuthenticationDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetPANAuthenticationDtl(getsessionvalues.employee_gid, application_gid, values);
        ...
        public HttpResponseMessage GetPANAadhaarLinkDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetPANAadhaarLinkDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetDLAuthenticationDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetDLAuthenticationDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetEPICAuthenticationDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetEPICAuthenticationDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetIFSCAuthenticationDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetIFSCAuthenticationDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetBankAccVerificationDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetBankAccVerificationDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetGSTSBPANDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetGSTSBPANDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetPassportAuthenticationDtl(string application_gid)
        {
            ...
            objDaCADKycView.DaGetPassportAuthenticationDtl(getsessionvalues.employee_gid, application_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DrivingLicenseViewDetails(string kycdlauthentication_gid)
        {
            ...
            //   objDaCADKycView.DaDrivingLicenseViewDetails(kycdlauthentication_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage VoterIDViewDetails(string kycepicauthentication_gid)
        {
            ...
            objODBCDatareader.Close();
            //   objDaCADKycView.DaVoterIDViewDetails(kycepicauthentication_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PassportViewDetails(string kycpassportauthentication_gid)
        {
            ...
            objODBCDatareader.Close();
            //   objDaCADKycView.DaPassportViewDetails(kycpassportauthentication_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GSTSBPANViewDetails(string kycgstsbpan_gid)
        {
            ...
            objODBCDatareader.Close();
            //   objDaCADKycView.DaGSTSBPANViewDetails(kycgstsbpan_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage IFSCViewDetails(string kycifscauthentication_gid)
        {
            ...
            objODBCDatareader.Close();
            //   objDaCADKycView.DaIFSCViewDetails(kycgstsbpan_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage BankAccViewDetails(string kycbankaccverification_gid)
        {
            ...
            objODBCDatareader.Close();
            //   objDaCADKycView.DaBankAccViewDetails(kycbankaccverification_gid, getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
