(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADInstitutionDtlEditController', MstCADInstitutionDtlEditController);

    MstCADInstitutionDtlEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function MstCADInstitutionDtlEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADInstitutionDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADApplication/InstitutionGSTList';
            lockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionMobileNoList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionEmailAddressList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionAddressList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionLicenseList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionDocumentList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionForm60DocumentList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/MstCADApplication/InstitutionDetailsEdit';
            ...
            SocketService.getparams(url, param).then(function (resp) {
                ...
                $scope.lblStakeholdertype = resp.data.stakeholder_type;
            ...
            var url = 'api/MstCADApplication/GetInstitutionEquipmentHoldingList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.mstequipmentholding_list = resp.data.mstequipmentholding_list;
            });

            var url = 'api/MstCADApplication/GetInstitutionLivestockList';
            SocketService.getparams(url, param).then(function (resp) {
        ...
        function license_list() {
            ...
            var url = 'api/MstCADApplication/InstitutionLicenseTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutionlicense_list = resp.data.mstlicense_list;
        ...
        function institutiongstlist() {
            ...
            var url = 'api/MstCADApplication/InstitutionGSTTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutiongst_list = resp.data.mstgst_list;
        ...
        function institutionmobilenolist() {
            ...
            var url = 'api/MstCADApplication/InstitutionMobileNoTmpList';
            lockUI();
        ...
        function institutionmail_list() {
            ...
            var url = 'api/MstCADApplication/InstitutionEmailAddressTmpList';
            SocketService.getparams(url, param).then(function (resp) {
                $scope.institutionemailaddress_list = resp.data.mstemailaddress_list;
            });
        }
        ...
        function institutionaddresslist() {
            ...
            var url = 'api/MstCADApplication/InstitutionAddressTmpList';
            lockUI();
            SocketService.getparams(url, param).then(function (resp) {
                unlockUI();
                $scope.institutionaddress_list = resp.data.mstaddress_list;
        ...
        $scope.edit_gstdetails = function (institution2branch_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditInstitutionGST';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_gst = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateInstitutionGST';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.Form60DocumentUpload = function () {
            ...
            if (fi.files.length > 0) {
                ...
                var url = 'api/MstCADApplication/InstitutionEditForm_60DocumentUpload';
                lockUI();
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    var url = "api/MstCADApplication/InstitutionEditForm60TmpList";
                    lockUI();
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.institutionform60upload_list = resp.data.institutionupload_list;
                    });
        ...
        $scope.uploaddocumentform60cancel = function (institution2form60documentupload_gid) {
            ...
            var url = 'api/MstCADApplication/InstitutionEditForm_60DocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                var params = {
                    institution_gid: $scope.institution_gid
                }
        ...
        $scope.institutionmobileno_edit = function (institution2mobileno_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditInstitutionMobileNo';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_mobileno = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateInstitutionMobileNo';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.institutionemailaddress_edit = function (institution2email_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditInstitutionEmailAddress';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_emailaddress = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateInstitutionEmailAddress';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.editinstitution_address = function (institution2address_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditInstitutionAddressDetail';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_address = function () {
                    ...
                    var url = 'api/MstCADApplication/UpdateInstitutionAddressDetail';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
        ...
        $scope.institutionDoc_upload = function () {
            ...
            if ($scope.uploadfrm != undefined) {
                lockUI();
                var url = 'api/MstCADApplication/InstitutionEditDocumentUpload';
                ...
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    var url = "api/MstCADApplication/InstitutionEditDocumentTmpList";
                    SocketService.getparams(url, params).then(function (resp) {
                        $scope.institutionupload_list = resp.data.institutionupload_list;
                    });
        ...
        $scope.upload_documentcancel = function (institution2documentupload_gid) {
            ...
            var url = 'api/MstCADApplication/InstitutionEditDocumentDelete';
            SocketService.getparams(url, params).then(function (resp) {
                var params = {
                    institution_gid: $scope.institution_gid
                }
        ...
        $scope.editinstitution_licensetype = function (institution2licensedtl_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/MstCADApplication/EditInstitutionLicenseDetail'; 
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                ...
                $scope.update_licensetype = function () {
                    if ($scope.txteditissue_date > $scope.txteditExpiryDate) {
                        ...
                        var url = 'api/MstCADApplication/UpdateInstitutionLicenseDetail';
                        lockUI();
                        SocketService.post(url, params).then(function (resp) {
                            unlockUI();
                            if (resp.data.status == true) {
        ...
        $scope.update_institutiondtl = function () {
            if ($scope.rdburn_status == 'Yes' && ($scope.txt_urn == '' || $scope.txt_urn == undefined || $scope.txt_urn == null)) {
                ...
                var url = 'api/MstCADApplication/UpdateInstitutionDtl';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
        ...
        function equipmentholding_list() {
            ...
            var url = 'api/MstCADApplication/GetEditInstitutionEquipmentHoldingList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstequipmentholding_list = resp.data.mstequipmentholding_list;
        ...
        function livestock_list() {
            ...
            var url = 'api/MstCADApplication/GetEditInstitutionLivestockList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstlivestockholding_list = resp.data.mstlivestockholding_list;
        ...
        function receivable_list() {
            ...
            var url = 'api/MstCADApplication/GetEditInstitutionReceivableList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.mstreceivable_list = resp.data.mstreceivable_list;
