...
/// <summary>
/// (It's used for Application Creation Add in Samfin)ApplicationAdd Controller Class containing API methods for accessing the related DataAccess class and returning relevant response to client. 
/// </summary>
/// <remarks>Written by Sumala,Logapriya and Abilash </remarks>

namespace ems.master.Controllers
{
    [RoutePrefix("api/MstApplicationAdd")]
    [Authorize]
    public class MstApplicationAddController : ApiController
    {
       ...
       [ActionName("ImportExcelIndividual")]
        ...
        [HttpPost]
        public HttpResponseMessage PostRenewalAdd(MdlMstRenewalAdd values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostRenewalAdd(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostInstitutionEquipmentHolding(MdlMstEquipmentHolding values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostInstitutionEquipmentHolding(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetInstitutionEquipmentHoldingList()
        {
            ...
            objMstApplicationAdd.DaGetInstitutionEquipmentHoldingList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteInstitutionEquipmentHolding(string institution2equipment_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaDeleteInstitutionEquipmentHolding(institution2equipment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaGetEquipmentHoldingView(institution2equipment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostInstitutionLivestock(MdlMstLivestock values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostInstitutionLivestock(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetInstitutionLivestockList()
        {
            ...
            objMstApplicationAdd.DaGetInstitutionLivestockList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteInstitutionLivestock(string institution2livestock_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaDeleteInstitutionLivestock(institution2livestock_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaGetLivestockHoldingView(institution2livestock_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostContactEquipmentHolding(MdlMstEquipmentHolding values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostContactEquipmentHolding(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetContactEquipmentHoldingList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaGetContactEquipmentHoldingList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteContactEquipmentHolding(string contact2equipment_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaDeleteContactEquipmentHolding(contact2equipment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaGetContactEquipmentHoldingView(contact2equipment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostContactLivestock(MdlMstLivestock values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostContactLivestock(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetContactLivestockList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaGetContactLivestockList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteContactLivestock(string contact2livestock_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaDeleteContactLivestock(contact2livestock_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaGetContactLivestockHoldingView(contact2livestock_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostGroupEquipmentHolding(MdlMstEquipmentHolding values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostGroupEquipmentHolding(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetGroupEquipmentHoldingList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaGetGroupEquipmentHoldingList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteGroupEquipmentHolding(string group2equipment_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaDeleteGroupEquipmentHolding(group2equipment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstEquipmentHolding values = new MdlMstEquipmentHolding();
            objMstApplicationAdd.DaGetGroupEquipmentHoldingView(group2equipment_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostGroupLivestock(MdlMstLivestock values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostGroupLivestock(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetGroupLivestockList()
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaGetGroupLivestockList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteGroupLivestock(string group2livestock_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaDeleteGroupLivestock(group2livestock_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            MdlMstLivestock values = new MdlMstLivestock();
            objMstApplicationAdd.DaGetGroupLivestockHoldingView(group2livestock_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage PostInstitutionReceivable(MdlMstReceivable values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostInstitutionReceivable(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage GetInstitutionReceivableList()
        {
            ...
            objMstApplicationAdd.DaGetInstitutionReceivableList(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        public HttpResponseMessage DeleteInstitutionReceivable(string institution2receivable_gid)
        {
            ...
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstReceivable values = new MdlMstReceivable();
            objMstApplicationAdd.DaDeleteInstitutionReceivable(institution2receivable_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        // Enhancement Flow
        [ActionName("PostEnhancementAdd")]
        [HttpPost]
        public HttpResponseMessage PostEnhancementAdd(MdlMstEnhancementAdd values)
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            objMstApplicationAdd.DaPostEnhancementAdd(getsessionvalues.employee_gid, getsessionvalues.user_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }

        [ActionName("GetAppAssignedRejectedSummary")]
        [HttpGet]
        public HttpResponseMessage GetAppAssignedRejectedSummary()
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlMstApplicationAdd values = new MdlMstApplicationAdd();
            objMstApplicationAdd.DaGetAppAssignedRejectedSummary(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        //Get Events - CSA Activity Drop Down
        [ActionName("GetCSAActivityDropDown")]
        [HttpGet]
        public HttpResponseMessage GetCSAActivityDropDown()
        {
            string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
            getsessionvalues = Objgetgid.gettokenvalues(token);
            MdlCSAActivityDropDown values = new MdlCSAActivityDropDown();
            objMstApplicationAdd.DaGetCSAActivityDropDown(getsessionvalues.employee_gid, values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        ...
        {
            objMstApplicationAdd.DaGetRenewalAppValidatePANAadhar(values);
            return Request.CreateResponse(HttpStatusCode.OK, values);
        }
        //[ActionName("GetRenewalAppValidatePANAadhar")]
        //[HttpGet]
        //public HttpResponseMessage GetRenewalAppValidatePANAadhar(string institution_gid)
        //{
        //    string token = Request.Headers.GetValues("Authorization").FirstOrDefault();
        //    getsessionvalues = Objgetgid.gettokenvalues(token);
        //    MdlonboardValidatedtl values = new MdlonboardValidatedtl();
        //    objMstApplicationAdd.DaGetRenewalAppValidatePANAadhar(institution_gid, values);
        //    return Request.CreateResponse(HttpStatusCode.OK, values);
        //}
