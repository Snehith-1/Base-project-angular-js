(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditStatusNonApprovedBuyer', MstCreditStatusNonApprovedBuyer);

    MstCreditStatusNonApprovedBuyer.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCreditStatusNonApprovedBuyer($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditStatusNonApprovedBuyer';
        ...
        function activate() {
            ...
            var url = 'api/MstCreditStatusAdd/GetCreditStatusNonApprovedBuyer';
            SocketService.get(url).then(function (resp) {
        ...
        $scope.Addcredit_status = function (val, val1) {
            ...
            localStorage.setItem('lspage', 'CreditStatusNonApprovedBuyer');
