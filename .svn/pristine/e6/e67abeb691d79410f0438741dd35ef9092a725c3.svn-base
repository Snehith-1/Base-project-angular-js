(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditCompanyAPIController', AgrTrnSuprCreditCompanyAPIController);

    AgrTrnSuprCreditCompanyAPIController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnSuprCreditCompanyAPIController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditCompanyAPIController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/GetGSTList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutiongst_list = resp.data.mstgst_list;
            });
            var url = 'api/AgrSuprProbeAPI/GetInstitutionDetails';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/AgrSuprProbeAPI/InstitutionProbeList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutionprobe_list = resp.data.institutionprobe_list;
            });
            var url = 'api/AgrSuprProbeAPI/InstitutionProbeDocList';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                $scope.institutionprobedoc_list = resp.data.institutionprobedoc_list;
            });
            var url = 'api/AgrMstSuprAPIVerifications/GetTAN';
            var params = {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/GetMCASignature';
            var params = {
                function_gid: institution_gid,
            }
            SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/GetCompanyLLP';
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
            ...
            var url = 'api/AgrSuprCrimeCheckAPI/GetCrimeRecordCompanyDetail';
            ...
            var url = 'api/AgrSuprCrimeCheckAPI/GetCompanyReportList';
            SocketService.getparams(url, paramcrime).then(function (resp) {
        ...
        $scope.verify_gstreturnfilling = function (gst_no, institution2branch_gid) {
            ...
            lockUI();
            var url = 'api/AgrSuprKyc/GSPGSTReturnFiling';
            SocketService.post(url, params).then(function (resp) {
        ...
        $scope.verify_gstauthentication = function (gst_no, institution2branch_gid) {
            ...
            var url = 'api/AgrSuprKyc/GSTAuthentication';
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                list();
        ...
        $scope.verify_tan = function (txttan_no) {
            if (txttan_no == '' || txttan_no == undefined || txttan_no == null) {
                ...
                var url = 'api/AgrSuprKyc/TANauthetication';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addtan = function () {
            if ($scope.status == 'checked') {
                ...
                var url = 'api/AgrMstSuprAPIVerifications/PostTAN';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verify_llp = function (txtllp_no) {
            if (txtllp_no == '' || txtllp_no == undefined || txtllp_no == null) {
                ...
                var url = 'api/AgrSuprKyc/CompanyLLP_no';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addllp_no = function () {
            if ($scope.llpstatus == 'checked') {
                ...
                var url = 'api/AgrMstSuprAPIVerifications/PostCompanyLLP';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.verifymca_sign = function (txtmca_sign) {
            if (txtmca_sign == '' || txtmca_sign == undefined || txtmca_sign == null) {
                ...
                var url = 'api/AgrSuprKyc/mcasignatories';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.addmca_sign = function () {
            if ($scope.mcastatus == 'checked') {
                ...
                var url = 'api/AgrMstSuprAPIVerifications/PostMCASignature';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.IECView = function (iecdtl_gid) {
            ...
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrSuprIECDetailedProfileView";
            window.open(URL, '_blank');
        }
        ...
        $scope.baseDetails = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetBaseDetails';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.comprehensiveDetails = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetComprehensiveDetails';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.dataStatus = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetDataStatus';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        function ProbeDataStatusView(institutionprobedetails_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrSuprProbeAPI/DataStatusView';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.articleOfAssociationDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetArticleOfAssociationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.memorandumOfAssociationDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetMemorandumOfAssociationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.certificateOfIncorporationDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetCertificateOfIncorporationDoc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.mgt7formDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetFormMGT7Doc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.aoc4formDoc = function () {
            ...
            lockUI();
            var url = 'api/AgrSuprProbeAPI/GetFormAOC4Doc';
            SocketService.post(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    Notify.alert(resp.data.message, {
                        status: 'success',
        ...
        $scope.tandelete = function (tandtl_gid) {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/TANdelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.companyLLPnoDelete = function (companyllpno_gid) {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/CompanyLLPNodelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.mcasignDelete = function (mcasignatories_gid) {
            ...
            var url = 'api/AgrMstSuprAPIVerifications/MCASigndelete';
            lockUI();
            SocketService.getparams(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.raise_crimereportrequest = function () {
            ...
            if ($scope.cboaddress == '' || $scope.cboaddress == null || $scope.cboaddress == undefined) {
                ...
                var url = 'api/AgrSuprCrimeCheckAPI/RequestCrimeReportCompany';
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
        ...
        $scope.crimereport_view = function (crimereportinstitution_gid) {
            ...
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrTrnSuprCrimeReportCompanyView";
            window.open(URL, '_blank');
        }
