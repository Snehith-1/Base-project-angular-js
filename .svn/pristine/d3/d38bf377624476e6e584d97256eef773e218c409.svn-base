(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditSuppliersDtlEditController', MstCADCreditSuppliersDtlEditController);

        MstCADCreditSuppliersDtlEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCADCreditSuppliersDtlEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditSuppliersDtlEditController';
        ...
        function activate() { 
            ...
            var url = 'api/MstCADCreditAction/EditGetCreditSupplier';
        ...
        $scope.supplierdtl_Back = function () {
            $location.url('app/MstCADCreditSuppliersDtlAdd?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=CADAcceptanceCustomers');
        }
        ...
        $scope.update_supplierdtl = function () {
            ...
            ($scope.txtBankDebitamt == undefined) || ($scope.txtrelationship_supplier == undefined) )
           {
            ...
            var supplier_Name = $('#SupplierName :selected').text();
             ...
             var url = 'api/MstCADCreditAction/UpdateCreditSupplier';
            lockUI();
