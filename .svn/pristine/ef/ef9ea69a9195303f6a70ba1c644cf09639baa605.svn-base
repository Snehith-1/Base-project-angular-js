(function () {
    ...
    angular
        .module('angle')
        .controller('MstRptCadPhysicalDocStatusController', MstRptCadPhysicalDocStatusController);

    MstRptCadPhysicalDocStatusController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstRptCadPhysicalDocStatusController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstRptCadPhysicalDocStatusController';
