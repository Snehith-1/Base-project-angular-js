...
/// <summary>
/// (It's used for CrimeCheckAPI)CrimeCheckAPI Controller Class containing API methods for accessing the related DataAccess class and returning relevant response to client. 
/// </summary>
/// <remarks>Written by Praveen Raj and Abilash </remarks>
namespace ems.master.Controllers
{
    [RoutePrefix("api/CrimeCheckAPI")]
    [Authorize]
    public class CrimeCheckAPIController : ApiController
    {
        session_values ObjGetGID = new session_values();
        logintoken getsessionvalues = new logintoken();
        DaCrimeCheckAPI objDaCrimeCheckAPI = new DaCrimeCheckAPI();
