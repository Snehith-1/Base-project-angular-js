(function () {
    ...
    angular
        .module('angle')
        .controller('MstPhysicalDeferralHistoryController', MstPhysicalDeferralHistoryController);

    MstPhysicalDeferralHistoryController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'AuthenticationService', 'SweetAlert', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', 'ngTableParams'];

    function MstPhysicalDeferralHistoryController($rootScope, $scope, $modal, $state, AuthenticationService, SweetAlert, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstPhysicalDeferralHistoryController';
