(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstProductDescQueryStatusController', AgrMstProductDescQueryStatusController);

    AgrMstProductDescQueryStatusController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService'];

    function AgrMstProductDescQueryStatusController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstProductDescQueryStatusController';
        ...
        $scope.query_close = function (appproductquery_gid) {
            var modalInstance = $modal.open({
