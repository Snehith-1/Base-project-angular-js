(function () {
    ...
    angular
        .module('angle')
        .controller('CADGSTAuthenticationViewController', CADGSTAuthenticationViewController);

    CADGSTAuthenticationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce'];

    function CADGSTAuthenticationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'CADGSTAuthenticationViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADAPIVerifications/GSTAuthenticationViewDetails';
