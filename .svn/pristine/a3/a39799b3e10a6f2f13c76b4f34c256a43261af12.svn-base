(function () {
    ...
    angular
        .module('angle')
        .controller('MstCcCommitteeKycViewController', MstCcCommitteeKycViewController);

        MstCcCommitteeKycViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll'];

    function MstCcCommitteeKycViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCcCommitteeKycViewController';        
       ...
       /*     var url = 'api/KycView/GetPANAadhaarLinkDtl';
        ...
        $scope.Back = function () {
            if (lspage == 'ScheduleMeeting') {
                ...
                $location.url('app/MstCcCompletedScheduledMeeting?application_gid=' + application_gid + '&lspage=CCMmeetingScheduledcompleted');
            }
