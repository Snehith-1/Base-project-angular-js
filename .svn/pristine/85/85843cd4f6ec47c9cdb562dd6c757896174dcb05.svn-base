(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSocialTradeCapitalTabController', AgrMstSocialTradeCapitalTabController);

        AgrMstSocialTradeCapitalTabController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrMstSocialTradeCapitalTabController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSocialTradeCapitalTabController';
        ...
        $scope.save_socialtradecapital = function () {
            ...
            var url = 'api/AgrMstApplicationAdd/SocialAndTradeCapitalSave';
            lockUI();
