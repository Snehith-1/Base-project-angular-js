...
(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingApprovalInstitutionInitiatedViewController', MstSAOnboardingApprovalInstitutionInitiatedViewController);

    MstSAOnboardingApprovalInstitutionInitiatedViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService'];

    function MstSAOnboardingApprovalInstitutionInitiatedViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingApprovalInstitutionInitiatedViewController';
