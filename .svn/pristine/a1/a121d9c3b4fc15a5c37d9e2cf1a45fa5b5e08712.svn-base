(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditBuyerDtlEditController', AgrTrnSuprCreditBuyerDtlEditController);

    AgrTrnSuprCreditBuyerDtlEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrTrnSuprCreditBuyerDtlEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditBuyerDtlEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnSuprAppCreditUnderWriting/EditGetCreditBuyer';
        ...
        $scope.update_buyerdtl = function () {
            ...
            ($scope.txtBankCreditValue == undefined) || ($scope.rdbDeductionat_Source == undefined) || ($scope.txtrelationship_borrower == undefined) || ($scope.txtEndUse_Monitoring == undefined)) {
                ...
                var url = 'api/AgrTrnSuprAppCreditUnderWriting/UpdateCreditBuyer';
                lockUI();
