(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCADApplicationEditController', AgrTrnSuprCADApplicationEditController);

    AgrTrnSuprCADApplicationEditController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll', 'DownloaddocumentService','cmnfunctionService'];

    function AgrTrnSuprCADApplicationEditController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll, DownloaddocumentService,cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCADApplicationEditController';
        ...
        $scope.Back = function () {
            if (lspage == "CADApplicationEdit") {
                $location.url('app/AgrTrnSuprPendingCADReview?application_gid=' + application_gid);
            }
            else if (lspage == "PendingCADReview") {
                $location.url('app/AgrTrnSuprPendingCADReview?application_gid=' + application_gid);
            }
            else if (lspage == "CADAcceptanceCustomers") {
                $location.url('app/AgrTrnSuprCadAcceptedCustomers?application_gid=' + application_gid);
            }
            else {
        ...
        $scope.CAM_generate = function () {
            var application_gid = $scope.application_gid;
            $location.url('app/AgrTrnCSuprAMGenerate?application_gid=' + application_gid);
        }
        ...
        $scope.member_view = function (contact_gid) {
            ...
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrTrnSuprApplGroupMemberdtlView";
            window.open(URL, '_blank');
        }
        ...
        $scope.creditinstitution_add = function (institution_gid) {
            $location.url('app/AgrTrnSuprDocumentCheckList?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=' + lspage + '&lstype=Institution');
        }

        $scope.creditindividual_add = function (contact_gid) {
            $location.url('app/AgrTrnSuprIndividualDocCheckList?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage + '&lstype=Individual');
        }

        $scope.creditgroup_add = function (group_gid) {
            $location.url('app/AgrTrnSuprGroupDocCheckList?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage + '&lstype=Group');
        }
        ...
        $scope.creditgeneraldtl_edit = function (product_gid, variety_gid) {
            $location.url('app/AgrTrnSuprCreditGeneralDtlEdit?application_gid=' + application_gid + '&lspage=' + lspage + '&product_gid=' + product_gid + '&variety_gid=' + variety_gid);
        }

        $scope.applcreainstitution_edit = function (institution_gid) {
            $location.url('app/AgrTrnSuprCreditInstitutionDtlEdit?application_gid=' + application_gid + '&institution_gid=' + institution_gid + '&lspage=' + lspage);
        }

        $scope.appcreaindividual_edit = function (contact_gid) {
            $location.url('app/AgrTrnSuprCreditIndividualDtlEdit?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=' + lspage);
        }

        $scope.appcreagroup_edit = function (group_gid) {
            $location.url('app/AgrTrnSuprCreditGroupDtlEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&lspage=' + lspage);
        }
        ...
        $scope.hypothecation_edit = function () {
            $location.url('app/AgrTrnSuprCreditHypothecationEdit?application_gid=' + application_gid + '&lspage=' + lspage);
        }

        $scope.addcompany_dtl = function () {
            $location.url('app/AgrMstSuprCADInstitutionDtlAdd?application_gid=' + application_gid + '&lspage=' + lspage);
        }

        $scope.addindividual_dtl = function () {
            $location.url('app/AgrMstSuprCADIndividualDtlAdd?application_gid=' + application_gid + '&lspage=' + lspage);
        }

        $scope.addgroup_dtl = function () {
            $location.url('app/AgrMstSuprCADGroupDtlAdd?application_gid=' + application_gid + '&lspage=' + lspage);
        }
