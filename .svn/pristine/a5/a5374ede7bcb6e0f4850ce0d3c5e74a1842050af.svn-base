(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCreditUnderwritingKycLogViewController', AgrTrnSuprCreditUnderwritingKycLogViewController);

    AgrTrnSuprCreditUnderwritingKycLogViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce'];

    function AgrTrnSuprCreditUnderwritingKycLogViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCreditUnderwritingKycLogViewController';
        ...
        function activate() {
            ...
            var url = 'api/AgrSuprProbeAPI/InstitutionProbeLogList';
            SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/AgrSuprProbeAPI/InstitutionProbeDocLogList';
            SocketService.getparams(url, params).then(function (resp) {
