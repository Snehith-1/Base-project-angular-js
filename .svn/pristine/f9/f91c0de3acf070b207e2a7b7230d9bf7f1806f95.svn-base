(function () {
    ...
    angular
        .module('angle')
        .controller('MstSAOnboardingBussDevtVerifcationSummaryController', MstSAOnboardingBussDevtVerifcationSummaryController);

    MstSAOnboardingBussDevtVerifcationSummaryController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstSAOnboardingBussDevtVerifcationSummaryController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstSAOnboardingBussDevtVerifcationSummaryController';
        ...
        function activate() {
            ...
            var url = 'api/MstSAOnboardingBussDevtVerification/GetSaInstitutionSummary';
