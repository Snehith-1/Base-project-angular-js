(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstApplcreationCICUploadInstEditController', AgrMstApplcreationCICUploadInstEditController);

        AgrMstApplcreationCICUploadInstEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', '$filter' ,'ngTableParams','DownloaddocumentService','cmnfunctionService'];

        function AgrMstApplcreationCICUploadInstEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, $filter, ngTableParams, DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstApplcreationCICUploadInstEditController';
        ...
        $scope.CICUploads_Back = function () {
            $location.url('app/AgrMstBureauUpdateInstitution?lsinstitution_gid=' + $scope.institution_gid + '&lsapplication_gid=' + application_gid + '&lstab=' + lstab + '&lsstatus=' + lsstatus);
        }
        ...
        $scope.update_CICUploads = function () {
            ...
            var url = 'api/AgrMstApplicationAdd/UpdateCICUploadInstitution';
            lockUI();
