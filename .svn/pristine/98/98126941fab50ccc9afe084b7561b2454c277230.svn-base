(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadConsolidatedLSAReportController', MstCadConsolidatedLSAReportController);

    MstCadConsolidatedLSAReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCadConsolidatedLSAReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadConsolidatedLSAReportController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationReport/GetConsolidatedLSAReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
