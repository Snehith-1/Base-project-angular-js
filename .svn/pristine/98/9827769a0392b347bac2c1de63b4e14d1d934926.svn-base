(function () {
    ...
    angular
        .module('angle')
        .controller('AgrRptCadApplicationDeferralCovenantViewController', AgrRptCadApplicationDeferralCovenantViewController);

    AgrRptCadApplicationDeferralCovenantViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', '$sce', 'DownloaddocumentService', 'cmnfunctionService'];

    function AgrRptCadApplicationDeferralCovenantViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrRptCadApplicationDeferralCovenantViewController';

        $scope.lspage = $location.search().lspage;
        var lspage = $scope.lspage;
        $scope.lsstatus = $location.search().lsstatus;
        var lsstatus = $scope.lsstatus;
