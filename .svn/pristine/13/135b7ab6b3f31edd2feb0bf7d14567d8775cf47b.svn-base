(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadVisitReportViewController', MstCadVisitReportViewController);

    MstCadVisitReportViewController.$inject = ['$rootScope', '$scope', '$modal', '$state', 'SweetAlert', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$cookies', '$filter', 'ngTableParams', '$resource', '$timeout', 'ngTableDataService', '$anchorScroll', '$sce', 'DownloaddocumentService', 'cmnfunctionService'];

    function MstCadVisitReportViewController($rootScope, $scope, $modal, $state, SweetAlert, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $cookies, $filter, ngTableParams, $resource, $timeout, ngTableDataService, $anchorScroll, $sce, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadVisitReportViewController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADApplication/GetCadVisitReportDtls';
        ...
        $scope.visitreportmobileno_view = function (applicationvisit2person_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                lockUI();
                var url = 'api/MstCADApplication/GetCadVisitContactList';
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
