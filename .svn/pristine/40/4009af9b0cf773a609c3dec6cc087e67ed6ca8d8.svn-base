(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualBureauEditController', MstCADCreditIndividualBureauEditController);

    MstCADCreditIndividualBureauEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'cmnfunctionService', 'DownloaddocumentService'];

    function MstCADCreditIndividualBureauEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, cmnfunctionService, DownloaddocumentService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualBureauEditController';
        ...
        $scope.update_CICUploads = function () {
            ...
            var url = 'api/MstCADCreditAction/UpdateCICUploadIndividual';
            lockUI();
