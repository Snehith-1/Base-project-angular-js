(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstCreditVisitReportEditController', AgrMstCreditVisitReportEditController);

    AgrMstCreditVisitReportEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstCreditVisitReportEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, DownloaddocumentService,cmnfunctionService) {

        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstCreditVisitReportEditController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstApplicationVisitReport/EditApplicationVisitReport';
            ...
            var url = 'api/AgrMstApplicationVisitReport/GetVisitPersondtlList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersondtl_list = resp.data.mstVisitpersondtl_list;

            });
            var url = 'api/AgrMstApplicationVisitReport/GetVisitAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersonaddressdtl_list = resp.data.mstVisitpersonaddress_list;

            });

            var url = 'api/AgrMstApplicationVisitReport/GetVisitPhotosList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.UploadphotoList = resp.data.UploadphotoList;

            });

            var url = 'api/AgrMstApplicationVisitReport/GetVisitDocumentList';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.Back = function () {
            $location.url('app/AgrCreditVisitReportAdd?application_gid=' + application_gid + '&lstab=' + lstab);
        }
        ...
        function address_list() {
            ...
            var url = 'api/AgrMstApplicationVisitReport/GetEditVisitAddressList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersonaddressdtl_list = resp.data.mstVisitpersonaddress_list;
        ...
        function visitedpersondetails_list() {
            ...
            var url = 'api/AgrMstApplicationVisitReport/GetEditVisitPersondtlList';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.Visitpersondtl_list = resp.data.mstVisitpersondtl_list;
        ...
        $scope.saveasdraft_update = function () {
            if ($scope.txtdateof_visit == '' || $scope.txtdateof_visit == null || $scope.txtdateof_visit == undefined) {
                ...
                var url = 'api/AgrMstApplicationVisitReport/PostSaveApplicationVisitReportUpdate';
                lockUI();
                SocketService.post(url, params).then(function (resp) {
                    unlockUI();
                    if (resp.data.status == true) {
                        ...
                        $location.url('app/AgrCreditVisitReportAdd?application_gid=' + application_gid);
                    }
                    else {
                        Notify.alert(resp.data.message, {
                            status: 'warning',
        ...
        $scope.visitreportSubmit = function () {
            ...
            var url = 'api/AgrMstApplicationVisitReport/PostSubmitApplicationVisitReportUpdate';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        $scope.visitreportUpdate = function () {
            ...
            var url = 'api/AgrMstApplicationVisitReport/PostUpdateApplicationVisitReportUpdate';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
            ...
            if (fi.files.length > 0) {
                ...
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    if (resp.data.status == true) {
                        ...
                        var url = 'api/AgrMstApplicationVisitReport/GetEditVisitDocumentList';
                        SocketService.getparams(url, params).then(function (resp) {
                            $scope.UploadDocumentList = resp.data.UploadDocumentList;
            ...
            if (fi.files.length > 0) {
                ...
                SocketService.postFile(url, $scope.uploadfrm).then(function (resp) {
                    ...
                    if (resp.data.status == true) {
                        ...
                        var url = 'api/AgrMstApplicationVisitReport/GetEditVisitPhotosList';
                        SocketService.getparams(url, params).then(function (resp) {
                            $scope.UploadphotoList = resp.data.UploadphotoList;
