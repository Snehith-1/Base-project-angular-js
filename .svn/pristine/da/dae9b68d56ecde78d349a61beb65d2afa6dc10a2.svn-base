(function () {
    ...
    angular
        .module('angle')
        .controller('MstApplicationHypothecationEditController', MstApplicationHypothecationEditController);

    MstApplicationHypothecationEditController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','DownloaddocumentService','cmnfunctionService'];

    function MstApplicationHypothecationEditController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,DownloaddocumentService,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstApplicationHypothecationEditController';
        ...
        $scope.update_Hypothecationdtl = function () {
            var lstxteditSecurity_Value = parseInt($scope.txteditSecurity_Value.replace(/[\s,]+/g, '').trim());
            var securitytype = '';
            ...
            var params = {
                ...
                security_value: lstxteditSecurity_Value,
