(function () {
    ...
    angular
        .module('angle')
        .controller('AgrCCMeetingApprovalController', AgrCCMeetingApprovalController);

    AgrCCMeetingApprovalController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll'];

    function AgrCCMeetingApprovalController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrCCMeetingApprovalController';
        ...
        function activate() {
            ...
            var url = 'api/AgrTrnCCMailApproval/GetApprovalMailList';
            lockUI();
        ...
        $scope.approve_submit = function () {
            ...
            lockUI();
            var url = "api/AgrTrnCCMailApproval/PostCCMailApproved";
