(function () {
    ...
    angular
        .module('angle')
        .controller('MstCADCreditIndividualRepaymentEditController', MstCADCreditIndividualRepaymentEditController);

    MstCADCreditIndividualRepaymentEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function MstCADCreditIndividualRepaymentEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCADCreditIndividualRepaymentEditController';
        ...
        function activate() {
            ...
            var url = 'api/MstCADCreditAction/EditRepaymentTrack';
        ...
        $scope.repaymentdtl_Back = function () {
            $location.url('app/MstCADCreditIndividualRepaymentAdd?application_gid=' + application_gid + '&contact_gid=' + contact_gid + '&lspage=CADAcceptanceCustomers');
        }
            ...
            ($scope.txtBalanceTenure_month == undefined) || ($scope.txtBalanceTenure_days == undefined) || ($scope.cboAcctClassification == undefined) || ($scope.txtOverdue_Amount == undefined) || ($scope.txtnoofdays_overdue == undefined) || ($scope.txtremarks == undefined)) {
                ...
                if((lendertypename =='Bank'))
                {
                         ...
                         ($scope.txtifsc_code == '' ) || ($scope.txtBank_Name == '' ))
                    {
                        ...
                        var url = 'api/MstCADCreditAction/UpdateRepaymentTrack';
                        lockUI();
