(function () {
    ...
    angular
        .module('angle')
        .controller('MstCadConsolidatedDocumentChecklistReportController', MstCadConsolidatedDocumentChecklistReportController);

    MstCadConsolidatedDocumentChecklistReportController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function MstCadConsolidatedDocumentChecklistReportController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCadConsolidatedDocumentChecklistReportController';
        ...
        function activate() {
            ...
            var url = 'api/MstApplicationReport/GetConsolidatedDocumentChecklistReport';
            SocketService.get(url).then(function (resp) {
                unlockUI();
