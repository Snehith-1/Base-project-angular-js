(function () {
    ...
    angular
        .module('angle')
        .controller('MstCreditGroupRepaymentAddController', MstCreditGroupRepaymentAddController);

        MstCreditGroupRepaymentAddController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','$sce','cmnfunctionService'];

    function MstCreditGroupRepaymentAddController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams, $sce,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'MstCreditGroupRepaymentAddController';
        ...
        $scope.creditrepayment_edit = function (creditrepaymentdtl_gid) {
            $location.url('app/MstCreditGroupRepaymentEdit?application_gid=' + application_gid + '&group_gid=' + group_gid + '&creditrepaymentdtl_gid=' + creditrepaymentdtl_gid + '&lspage=' + lspage);
        }
