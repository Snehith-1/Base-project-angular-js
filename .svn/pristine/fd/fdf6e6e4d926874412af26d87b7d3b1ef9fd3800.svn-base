(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCcCommitteeApplicationViewController', AgrTrnCcCommitteeApplicationViewController);

    AgrTrnCcCommitteeApplicationViewController.$inject = ['$rootScope', '$scope', '$state', '$modal', 'AuthenticationService', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', '$route', '$sce', '$anchorScroll', 'DownloaddocumentService', 'cmnfunctionService'];

    function AgrTrnCcCommitteeApplicationViewController($rootScope, $scope, $state, $modal, AuthenticationService, ScopeValueService, $http, SocketService, Notify, $location, apiManage, $route, $sce, $anchorScroll, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCcCommitteeApplicationViewController';

        const lsdynamiclimitmanagementback = 'AgrTrnCcCommitteeApplicationView';
        ...
        const lspagename = 'AgrTrnCcCommitteeApplicationView';
       ...
       var url = "api/AgrMstApplicationEdit/GetGroupSummary";
        ...
        $scope.Back = function () {          
            if (lspage == 'ScheduleMeeting') {
                ...
                $state.go('app.AgrTrnRejectandHoldSummary');
            }
            else if (lstab == 'CCSkippedAppl') {
                $state.go('app.AgrTrnCCSkippedApplicationSummary');
            }
            else if (lstab == 'SubmittedToApproval') {
                $state.go('app.AgrTrnSubmittedtoApprovalSummary');
            }
            else if (lstab == 'SubmittedToCC') {
                $state.go('app.AgrTrnSubmittedtoCCSummary');
            }
                ...
                $state.go('app.AgrTrnApplicationAssignmentSummary');
            }
            else if (lstab == 'Asscreditmapping') {
                $state.go('app.AgrTrnAppassignedAssignmentSummary');
            }
            else if (lstab == 'ApplSubmittedToCC') {
                $state.go('app.AgrTrnApplSubmittedtoCCSummary');
            }
            else if (lspage == 'SentBackToCredit') {
                $state.go('app.AgrTrnSentbackcctoCredit');
            }
            else if (lspage == 'ProductSubmittedtoApproval') {
                $state.go('app.AgrMstProductSubmittedtoApprovalSummary');
            }
            else if (lspage == 'ProductDescRejected') {
                ...
                $state.go('app.AgrTrnProductDeskAutoApprovalSummary');
            }
            else if (lspage == 'CreditAutoApproval') {
                $state.go('app.AgrTrnCreditAutoApprovalSummary');
            }
            else if (lspage == 'AdvanceAC') {
                $state.go('app.AgrTrnACAutoApprovalSummary');
            }
            else if (lspage == 'UpcomingCreditApproval') {
                $state.go('app.AgrTrnUpcomingCreditApprovalSummary');
            }
            else {
        ...
        $scope.Kyc_view = function () {
            var application_gid = $scope.application_gid;
            $location.url('app/AgrMstCcCommitteeKycView?application_gid=' + application_gid + '&lspage=' + lspage + '&lstab=' + lstab);
        }
        ...
        $scope.institution_view = function (institution_gid) {
            ...
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstCcCommitteeInstitutionView?application_gid=" + application_gid + '&institution_gid='+ institution_gid + '&lspage='+ lspage +'&lspagetype='+ lspagetype;
            window.open(URL, '_blank');
        }
        ...
        $scope.individual_view = function (contact_gid) {
            ...
            localStorage.setItem('application_gid', application_gid);
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstCcCommitteeIndividualView?application_gid=" + application_gid + '&contact_gid='+ contact_gid + '&lspage='+ lspage +'&lspagetype='+lspagetype;
            window.open(URL, '_blank');
        }
        ...
        $scope.group_view = function (group_gid) {
            ...
            localStorage.setItem('application_gid', application_gid);
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstCcCommitteeGroupView";
            window.open(URL, '_blank');
        }
        ...
        $scope.member_view = function (contact_gid) {
            ...
            localStorage.setItem('contact_gid', contact_gid);
            localStorage.setItem('application_gid', application_gid);
            var URL = location.protocol + "//" + location.hostname + "/v1/#/app/AgrMstCcCommitteeIndividualView";
            window.open(URL, '_blank');
        }
        ...
        $scope.onboardappdetailinfo = function (onboard_gid) {
            $location.url('app/AgrMstOnboardingApplicationInfo?hash=' + cmnfunctionService.encryptURL('onboard_gid=' + onboard_gid + '&application_gid=' + application_gid + '&selectedIndex=' + $scope.selectedIndex + '&lsdynamiclimitmanagementback=' + lsdynamiclimitmanagementback + '&lspage=' + lspage + '&lsparent=AppTrnCCCommittee'));
        }
        ...
        $scope.productcomaparisonview = function (onboard_gid, program_gid, product_gid) {
          ...
          /*  $location.url('app/AgrMstByrProductcomparisonView?hash=' + cmnfunctionService.encryptURL('onboard_gid = ' + onboard_gid + '&application_gid=' + application_gid + ' &selectedIndex=' + $scope.selectedIndex + ' &lsdynamiclimitmanagementback=' + lsdynamiclimitmanagementback + ' &lspage=' + lspage + ' &lsparent=AppTrnCCCommittee'));*/
            $location.url('app/AgrMstByrProductcomparisonView?hash=' + cmnfunctionService.encryptURL('onboard_gid=' + onboard_gid + '&selectedIndex=' + $scope.selectedIndex + '&lsdynamiclimitmanagementback=' + lsdynamiclimitmanagementback + '&application_gid=' + application_gid + '&lsparent=AppTrnCCCommittee' + '&product_gid=' + product_gid + '&program_gid=' + program_gid + '&lstab=' + lstab + '&lspage=' + lspage));
