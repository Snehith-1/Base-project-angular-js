(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSuprCICUploadTabController', AgrMstSuprCICUploadTabController);

    AgrMstSuprCICUploadTabController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams','cmnfunctionService'];

    function AgrMstSuprCICUploadTabController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams,cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSuprCICUploadTabController';
        ...
        function activate() {
            ...
            var url = 'api/AgrMstSuprApplicationAdd/GetCICIndividualSummary';
            SocketService.get(url).then(function (resp) {
                unlockUI();
