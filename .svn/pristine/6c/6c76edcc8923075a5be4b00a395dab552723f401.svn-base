(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnCreditEconomicCapitalEditController', AgrTrnCreditEconomicCapitalEditController);

        AgrTrnCreditEconomicCapitalEditController.$inject = ['$rootScope', '$sce', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnCreditEconomicCapitalEditController($rootScope, $sce, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnCreditEconomicCapitalEditController';
        ...
        $scope.update_SocialTradeCapital = function () {
            ...
            var url = 'api/AgrTrnAppCreditUnderWriting/SocialAndTradeCapitalUpdate';
            lockUI();
