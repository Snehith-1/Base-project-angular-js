(function () {
    ...
    angular
        .module('angle')
        .controller('AgrMstSupplierOnboardingApprovalcontroller', AgrMstSupplierOnboardingApprovalcontroller);

    AgrMstSupplierOnboardingApprovalcontroller.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', 'SocketService', 'Notify', '$location', '$route', 'ngTableParams', 'DownloaddocumentService','cmnfunctionService'];

    function AgrMstSupplierOnboardingApprovalcontroller($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, SocketService, Notify, $location, $route, ngTableParams, DownloaddocumentService, cmnfunctionService) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrMstSupplierOnboardingApprovalcontroller';
        ...
        var params = {
            ...
            var url = 'api/AgrMstSupplierOnboardEdit/GetOpenSuprQueryStatus';
        SocketService.getparams(url, params).then(function (resp) {
            ...
            var url = 'api/AgrMstSupplierOnboardEdit/GetSuprQuerySummary';
        SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.GetGeneralinfo = function () {
            ...
            var url = 'api/AgrMstSupplierOnboard/GetOnboardApplicationGeneralInfo';
            SocketService.getparams(url, params).then(function (resp) {
                ...
                $scope.txtbuyersuppliertype_name = resp.data.buyersuppliertype_name;
        ...
        $scope.GetIndividualInfo = function () {
            ...
            var url = 'api/AgrMstSupplierOnboard/GetOnboardIndividualInfo';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.GetInstitutionInfo = function () {
            ...
            var url = 'api/AgrMstSupplierOnboard/GetOnboardInstitutionInfo';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
                    unlockUI();
        ...
        $scope.supplierapprove = function () {
            var params = { 
                application_gid: application_gid,
            ...
            lockUI();
            var url = "api/AgrMstSupplierOnboard/PostSupplierOnboardApproval";
        ...
        $scope.appcreainstitution_view = function (institution_gid) {
            ...
            var url = 'api/AgrMstSupplierOnboard/GetOnboardInstitutionView';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) { 
                    ...
                    $scope.txtincometax_returnsstatus= resp.data.incometax_returnsstatus;
            ...
            var url = 'api/AgrMstSupplierOnboard/GetsuprInstitutionRatingList';
            SocketService.getparams(url, params).then(function (resp) {
            ...
            //well, here
            var url = 'api/AgrMstSupplierOnboard/GetSuprInstitutionBankAccDtl';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.appcreaindividual_view = function (contact_gid) {
            ...
            var url = 'api/AgrMstSupplierOnboard/GetOnboardIndividualView';
            SocketService.getparams(url, params).then(function (resp) {
                if (resp.data.status == true) {
            ...
            var url = 'api/AgrMstSupplierOnboard/GetsuprPANForm60List';
            SocketService.getparams(url, params).then(function (resp) {
                $scope.contactpanform60_list = resp.data.contactpanform60_list;

            });

            var url = 'api/AgrMstSupplierOnboard/GetSuprIndividualBankAccDtl';
            SocketService.getparams(url, params).then(function (resp) {
        ...
        $scope.submit = function () {
            ...
            var url = 'api/AgrMstSupplierOnboardEdit/PostSuprRaiseQuery';
            lockUI();
            SocketService.post(url, params).then(function (resp) {
                unlockUI();
                if (resp.data.status == true) {
        ...
        //    }
        //    var url = 'api/AgrMstSupplierOnboardEdit/GetRaiseQuerydesc';
        //    lockUI();
        //    SocketService.getparams(url, params).then(function (resp) {
        //        unlockUI();
        ...
        //    }
        //    var url = 'api/AgrMstSupplierOnboardEdit/GetUpdateByrQueryStatus';
        //    lockUI();
        //    SocketService.getparams(url, params).then(function (resp) {
        //        unlockUI();
        //        if (resp.data.status == true) {
        ...
        $scope.close_query = function (onboardquery_gid) {
            ...
            function ModalInstanceCtrl($scope, $modalInstance) {
                ...
                var url = 'api/AgrMstSupplierOnboardEdit/GetSuprRaiseQuerydesc';
                lockUI();
                SocketService.getparams(url, params).then(function (resp) {
                    unlockUI();
                    $scope.lblquery_title = resp.data.query_title;
                ...
                $scope.submit = function () {
                    ...
                    var url = 'api/AgrMstSupplierOnboardEdit/GetUpdateSuprQueryStatus';
                    lockUI();
                    SocketService.post(url, params).then(function (resp) {
                        unlockUI();
                        if (resp.data.status == true) {
