(function () {
    ...
    angular
        .module('angle')
        .controller('AgrTrnSuprCcScheduledMeetingDtlViewController', AgrTrnSuprCcScheduledMeetingDtlViewController);

    AgrTrnSuprCcScheduledMeetingDtlViewController.$inject = ['$rootScope', '$scope', '$state', 'AuthenticationService', '$modal', 'ScopeValueService', '$http', '$sce', 'SocketService', 'Notify', '$location', 'apiManage', 'SweetAlert', '$route', 'ngTableParams'];

    function AgrTrnSuprCcScheduledMeetingDtlViewController($rootScope, $scope, $state, AuthenticationService, $modal, ScopeValueService, $http, $sce, SocketService, Notify, $location, apiManage, SweetAlert, $route, ngTableParams) {
        /* jshint validthis:true */
        var vm = this;
        vm.title = 'AgrTrnSuprCcScheduledMeetingDtlViewController';
